...
// @generated from protobuf file "AbilityChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AbilityChangeNotify {
    /**
     * @generated from protobuf field: AbilityControlBlock ability_control_block = 6;
     */
...
class AbilityChangeNotify$Type extends MessageType<AbilityChangeNotify> {
    constructor() {
        super("AbilityChangeNotify", [
            { no: 6, name: "ability_control_block", kind: "message", T: () => AbilityControlBlock },
    ...
    internalBinaryWrite(message: AbilityChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.abilityControlBlock)
            AbilityControlBlock.internalBinaryWrite(message.abilityControlBlock, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 10; */
