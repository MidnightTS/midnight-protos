...
// @generated from protobuf file "VehicleInteractRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { VehicleInteractType } from "./VehicleInteractType";
...
export interface VehicleInteractRsp {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: VehicleMember member = 11;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: VehicleInteractType interact_type = 7;
     */
...
class VehicleInteractRsp$Type extends MessageType<VehicleInteractRsp> {
    constructor() {
        super("VehicleInteractRsp", [
            ...
            { no: 11, name: "member", kind: "message", T: () => VehicleMember },
            { no: 6, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 7, name: "interact_type", kind: "enum", T: () => ["VehicleInteractType", VehicleInteractType, "VEHICLE_INTERACT_TYPE_"] }
        ]);
    }
    ...
    internalBinaryWrite(message: VehicleInteractRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.member)
            VehicleMember.internalBinaryWrite(message.member, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 6; */
        if (message.retcode !== 0)
            writer.tag(6, WireType.Varint).int32(message.retcode);
        /* VehicleInteractType interact_type = 7; */
        if (message.interactType !== 0)
            writer.tag(7, WireType.Varint).int32(message.interactType);
