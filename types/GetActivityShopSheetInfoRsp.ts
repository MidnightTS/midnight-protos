...
// @generated from protobuf file "GetActivityShopSheetInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { ActivityShopSheetInfo } from "./ActivityShopSheetInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetActivityShopSheetInfoRsp
 */
export interface GetActivityShopSheetInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated ActivityShopSheetInfo sheet_info_list = 4;
     */
...
class GetActivityShopSheetInfoRsp$Type extends MessageType<GetActivityShopSheetInfoRsp> {
    constructor() {
        super("GetActivityShopSheetInfoRsp", [
            ...
            { no: 4, name: "sheet_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ActivityShopSheetInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: GetActivityShopSheetInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.sheetInfoList.length; i++)
            ActivityShopSheetInfo.internalBinaryWrite(message.sheetInfoList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
