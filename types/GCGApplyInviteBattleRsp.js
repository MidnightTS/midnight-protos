...
exports.GCGApplyInviteBattleRsp = void 0;
...
class GCGApplyInviteBattleRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGApplyInviteBattleRsp", [
            { no: 6, name: "punish_end_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { punishEndTime: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.punishEndTime !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.punishEndTime);
        /* int32 retcode = 8; */
...
/**
 * @generated MessageType for protobuf message GCGApplyInviteBattleRsp
 */
