...
class TakeEffigyRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeEffigyRewardRsp", [
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 14, name: "reward_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message TakeEffigyRewardRsp
 */
