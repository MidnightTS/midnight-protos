...
// @generated from protobuf file "TakeReunionFirstGiftRewardRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeReunionFirstGiftRewardRsp
 */
export interface TakeReunionFirstGiftRewardRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: int32 reward_id = 1;
     */
    rewardId: number;
}
...
class TakeReunionFirstGiftRewardRsp$Type extends MessageType<TakeReunionFirstGiftRewardRsp> {
    ...
    internalBinaryWrite(message: TakeReunionFirstGiftRewardRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardId !== 0)
            writer.tag(1, WireType.Varint).int32(message.rewardId);
