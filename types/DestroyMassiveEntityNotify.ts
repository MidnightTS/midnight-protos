...
// @generated from protobuf file "DestroyMassiveEntityNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DestroyMassiveEntityNotify
 */
export interface DestroyMassiveEntityNotify {
    /**
     * @generated from protobuf field: repeated ClientMassiveEntity massive_entity_list = 15;
     */
...
class DestroyMassiveEntityNotify$Type extends MessageType<DestroyMassiveEntityNotify> {
    constructor() {
        super("DestroyMassiveEntityNotify", [
            { no: 15, name: "massive_entity_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClientMassiveEntity }
        ]);
    }
    ...
    internalBinaryWrite(message: DestroyMassiveEntityNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.massiveEntityList.length; i++)
            ClientMassiveEntity.internalBinaryWrite(message.massiveEntityList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
