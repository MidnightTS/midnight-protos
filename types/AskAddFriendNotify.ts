...
// @generated from protobuf file "AskAddFriendNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AskAddFriendNotify {
    ...
    targetUid: number;
    /**
     * @generated from protobuf field: FriendBrief target_friend_brief = 1;
     */
...
class AskAddFriendNotify$Type extends MessageType<AskAddFriendNotify> {
    constructor() {
        super("AskAddFriendNotify", [
            ...
            { no: 1, name: "target_friend_brief", kind: "message", T: () => FriendBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: AskAddFriendNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetFriendBrief)
            FriendBrief.internalBinaryWrite(message.targetFriendBrief, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
