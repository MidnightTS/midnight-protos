...
// @generated from protobuf file "DungeonWayPointActivateReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonWayPointActivateReq
 */
export interface DungeonWayPointActivateReq {
    /**
     * @generated from protobuf field: uint32 way_point_id = 14;
     */
    wayPointId: number;
}
...
class DungeonWayPointActivateReq$Type extends MessageType<DungeonWayPointActivateReq> {
    ...
    internalBinaryWrite(message: DungeonWayPointActivateReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.wayPointId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.wayPointId);
