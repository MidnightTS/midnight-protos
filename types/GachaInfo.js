...
const dependency_1 = require("./GachaUpInfo");
const pb_1 = require("google-protobuf");
class GachaInfo extends pb_1.Message {
    constructor(data) {
        super();
        _GachaInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1875, 1233, 2006], __classPrivateFieldGet(this, _GachaInfo_one_of_decls, "f"));
    ...
    get display_up4_item_list() {
        return pb_1.Message.getFieldWithDefault(this, 1875, []);
    }
    set display_up4_item_list(value) {
        pb_1.Message.setField(this, 1875, value);
    }
    get Unk3100_JKILPCKLNPI() {
        return pb_1.Message.getFieldWithDefault(this, 469, 0);
    }
    set Unk3100_JKILPCKLNPI(value) {
        pb_1.Message.setField(this, 469, value);
    }
    get gacha_up_info_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.GachaUpInfo, 1233);
    }
    set gacha_up_info_list(value) {
        pb_1.Message.setRepeatedWrapperField(this, 1233, value);
    }
    get gacha_prob_url() {
        return pb_1.Message.getFieldWithDefault(this, 8, "");
    }
    set gacha_prob_url(value) {
        pb_1.Message.setField(this, 8, value);
    }
    get gacha_prefab_path() {
        return pb_1.Message.getFieldWithDefault(this, 15, "");
    }
    set gacha_prefab_path(value) {
        pb_1.Message.setField(this, 15, value);
    }
    get wish_item_id() {
        return pb_1.Message.getFieldWithDefault(this, 1637, 0);
    }
    ...
    get wish_max_progress() {
        return pb_1.Message.getFieldWithDefault(this, 1222, 0);
    }
    ...
    get gacha_prob_url_oversea() {
        return pb_1.Message.getFieldWithDefault(this, 1481, "");
    }
    set gacha_prob_url_oversea(value) {
    ...
    get display_up5_item_list() {
        return pb_1.Message.getFieldWithDefault(this, 2006, []);
    }
    set display_up5_item_list(value) {
    ...
    get is_new_wish() {
        return pb_1.Message.getFieldWithDefault(this, 733, false);
    }
    set is_new_wish(value) {
    ...
    set gacha_preview_prefab_path(value) {
        pb_1.Message.setField(this, 4, value);
    }
    get wish_progress() {
        return pb_1.Message.getFieldWithDefault(this, 1819, 0);
    }
    set wish_progress(value) {
        pb_1.Message.setField(this, 1819, value);
    }
    get title_textmap() {
        return pb_1.Message.getFieldWithDefault(this, 736, "");
    }
    set title_textmap(value) {
        pb_1.Message.setField(this, 736, value);
    }
    get gacha_record_url_oversea() {
        return pb_1.Message.getFieldWithDefault(this, 1854, "");
    }
    set gacha_record_url_oversea(value) {
        pb_1.Message.setField(this, 1854, value);
    }
    get gacha_sort_id() {
        return pb_1.Message.getFieldWithDefault(this, 7, 0);
    }
    set gacha_sort_id(value) {
        pb_1.Message.setField(this, 7, value);
    }
    get gacha_record_url() {
        return pb_1.Message.getFieldWithDefault(this, 12, "");
    }
    set gacha_record_url(value) {
    ...
    toObject() {
        ...
        if (this.gacha_up_info_list != null) {
            data.gacha_up_info_list = this.gacha_up_info_list.map((item) => item.toObject());
        }
    ...
    serialize(w) {
        ...
        if (this.gacha_up_info_list.length)
            writer.writeRepeatedMessage(1233, this.gacha_up_info_list, (item) => item.serialize(writer));
...
exports.GachaInfo = GachaInfo;
_GachaInfo_one_of_decls = new WeakMap();
