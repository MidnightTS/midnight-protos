...
exports.TowerEnterLevelReq = void 0;
...
class TowerEnterLevelReq$Type extends runtime_5.MessageType {
    constructor() {
        super("TowerEnterLevelReq", [
            { no: 3, name: "enter_point_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.enterPointId !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.enterPointId);
