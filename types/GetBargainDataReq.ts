...
// @generated from protobuf file "GetBargainDataReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetBargainDataReq
 */
export interface GetBargainDataReq {
    /**
     * @generated from protobuf field: uint32 bargain_id = 8;
     */
    bargainId: number;
}
...
class GetBargainDataReq$Type extends MessageType<GetBargainDataReq> {
    ...
    internalBinaryWrite(message: GetBargainDataReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bargainId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.bargainId);
