...
// @generated from protobuf file "AbilityActionTriggerAbility.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityActionTriggerAbility
 */
export interface AbilityActionTriggerAbility {
    /**
     * @generated from protobuf field: uint32 other_id = 4;
     */
    otherId: number;
}
...
class AbilityActionTriggerAbility$Type extends MessageType<AbilityActionTriggerAbility> {
    ...
    internalBinaryWrite(message: AbilityActionTriggerAbility, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.otherId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.otherId);
