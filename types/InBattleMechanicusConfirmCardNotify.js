...
class InBattleMechanicusConfirmCardNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("InBattleMechanicusConfirmCardNotify", [
            { no: 11, name: "group_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "player_uid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "play_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { groupId: 0, playerUid: 0, cardId: 0, playIndex: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 group_id */ 11:
                    message.groupId = reader.uint32();
                    break;
                case /* uint32 player_uid */ 12:
...
/**
 * @generated MessageType for protobuf message InBattleMechanicusConfirmCardNotify
 */
