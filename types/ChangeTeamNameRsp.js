...
class ChangeTeamNameRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ChangeTeamNameRsp", [
            ...
            { no: 5, name: "team_id", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, teamName: "", teamId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string team_name = 15; */
        if (message.teamName !== "")
            writer.tag(15, runtime_1.WireType.LengthDelimited).string(message.teamName);
        /* int32 team_id = 5; */
        if (message.teamId !== 0)
            writer.tag(5, runtime_1.WireType.Varint).int32(message.teamId);
