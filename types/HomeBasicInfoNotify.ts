...
// @generated from protobuf file "HomeBasicInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface HomeBasicInfoNotify {
    /**
     * @generated from protobuf field: HomeBasicInfo basic_info = 3;
     */
...
class HomeBasicInfoNotify$Type extends MessageType<HomeBasicInfoNotify> {
    constructor() {
        super("HomeBasicInfoNotify", [
            { no: 3, name: "basic_info", kind: "message", T: () => HomeBasicInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeBasicInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.basicInfo)
            HomeBasicInfo.internalBinaryWrite(message.basicInfo, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
