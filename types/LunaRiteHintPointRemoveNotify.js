...
class LunaRiteHintPointRemoveNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("LunaRiteHintPointRemoveNotify", [
            { no: 12, name: "hint_point_index", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 hint_point_index */ 12:
...
/**
 * @generated MessageType for protobuf message LunaRiteHintPointRemoveNotify
 */
