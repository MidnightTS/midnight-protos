...
// @generated from protobuf file "BlessingAcceptAllGivePicRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BlessingAcceptAllGivePicRsp
 */
export interface BlessingAcceptAllGivePicRsp {
    /**
     * @generated from protobuf field: repeated uint32 accept_index_list = 11;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: map<uint32, uint32> accept_pic_num_map = 15;
     */
    acceptPicNumMap: {
        [key: number]: number;
    };
...
class BlessingAcceptAllGivePicRsp$Type extends MessageType<BlessingAcceptAllGivePicRsp> {
    ...
    private binaryReadMap15(map: BlessingAcceptAllGivePicRsp["acceptPicNumMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: BlessingAcceptAllGivePicRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.acceptPicNumMap))
            writer.tag(15, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.acceptPicNumMap[k as any]).join();
