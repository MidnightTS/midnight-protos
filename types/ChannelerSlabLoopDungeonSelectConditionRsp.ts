...
// @generated from protobuf file "ChannelerSlabLoopDungeonSelectConditionRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChannelerSlabLoopDungeonSelectConditionRsp
 */
export interface ChannelerSlabLoopDungeonSelectConditionRsp {
    /**
...
class ChannelerSlabLoopDungeonSelectConditionRsp$Type extends MessageType<ChannelerSlabLoopDungeonSelectConditionRsp> {
    constructor() {
    ...
    create(value?: PartialMessage<ChannelerSlabLoopDungeonSelectConditionRsp>): ChannelerSlabLoopDungeonSelectConditionRsp {
        const message = { dungeonIndex: 0, conditionIdList: [], difficultyId: 0, retcode: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ChannelerSlabLoopDungeonSelectConditionRsp>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChannelerSlabLoopDungeonSelectConditionRsp): ChannelerSlabLoopDungeonSelectConditionRsp {
    ...
    internalBinaryWrite(message: ChannelerSlabLoopDungeonSelectConditionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
 ...
 */
export const ChannelerSlabLoopDungeonSelectConditionRsp = new ChannelerSlabLoopDungeonSelectConditionRsp$Type();
