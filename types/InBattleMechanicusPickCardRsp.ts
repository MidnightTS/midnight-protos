...
// @generated from protobuf file "InBattleMechanicusPickCardRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message InBattleMechanicusPickCardRsp
 */
export interface InBattleMechanicusPickCardRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 group_id = 14;
     */
    groupId: number;
    /**
     * @generated from protobuf field: uint32 play_index = 10;
     */
    playIndex: number;
    /**
...
class InBattleMechanicusPickCardRsp$Type extends MessageType<InBattleMechanicusPickCardRsp> {
    ...
    internalBinaryWrite(message: InBattleMechanicusPickCardRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.playIndex !== 0)
            writer.tag(10, WireType.Varint).uint32(message.playIndex);
        /* uint32 card_id = 3; */
        if (message.cardId !== 0)
