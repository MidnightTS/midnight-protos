...
// @generated from protobuf file "ScenePlayGuestReplyNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ScenePlayGuestReplyNotify
 */
export interface ScenePlayGuestReplyNotify {
    ...
    playId: number;
    /**
     * @generated from protobuf field: uint32 guest_uid = 5;
     */
    guestUid: number;
    /**
     * @generated from protobuf field: bool is_agree = 2;
     */
    isAgree: boolean;
}
...
class ScenePlayGuestReplyNotify$Type extends MessageType<ScenePlayGuestReplyNotify> {
    ...
    internalBinaryWrite(message: ScenePlayGuestReplyNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.guestUid !== 0)
            writer.tag(5, WireType.Varint).uint32(message.guestUid);
        /* bool is_agree = 2; */
