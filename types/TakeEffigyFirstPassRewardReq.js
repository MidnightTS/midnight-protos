...
exports.TakeEffigyFirstPassRewardReq = void 0;
...
class TakeEffigyFirstPassRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeEffigyFirstPassRewardReq", [
            { no: 13, name: "challenge_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { challengeId: 0 };
...
/**
 * @generated MessageType for protobuf message TakeEffigyFirstPassRewardReq
 */
