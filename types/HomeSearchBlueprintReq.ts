...
// @generated from protobuf file "HomeSearchBlueprintReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeSearchBlueprintReq
 */
export interface HomeSearchBlueprintReq {
    /**
     * @generated from protobuf field: string share_code = 6;
     */
    shareCode: string;
}
...
class HomeSearchBlueprintReq$Type extends MessageType<HomeSearchBlueprintReq> {
    ...
    internalBinaryWrite(message: HomeSearchBlueprintReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.shareCode !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.shareCode);
