...
// @generated from protobuf file "ActivityAcceptAllGiveGiftRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { ActivityAcceptGiftResultInfo } from "./ActivityAcceptGiftResultInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message ActivityAcceptAllGiveGiftRsp
 */
export interface ActivityAcceptAllGiveGiftRsp {
    /**
     * @generated from protobuf field: repeated ActivityAcceptGiftResultInfo accept_gift_result_info_list = 7;
     */
...
class ActivityAcceptAllGiveGiftRsp$Type extends MessageType<ActivityAcceptAllGiveGiftRsp> {
    constructor() {
        super("ActivityAcceptAllGiveGiftRsp", [
            { no: 7, name: "accept_gift_result_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ActivityAcceptGiftResultInfo },
    ...
    internalBinaryWrite(message: ActivityAcceptAllGiveGiftRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.acceptGiftResultInfoList.length; i++)
            ActivityAcceptGiftResultInfo.internalBinaryWrite(message.acceptGiftResultInfoList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
