...
class MechanicusCoinNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MechanicusCoinNotify", [
            { no: 8, name: "coin", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "mechanicus_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { coin: 0, mechanicusId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.mechanicusId !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.mechanicusId);
...
/**
 * @generated MessageType for protobuf message MechanicusCoinNotify
 */
