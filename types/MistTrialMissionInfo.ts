...
// @generated from protobuf file "MistTrialMissionInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message MistTrialMissionInfo
 */
export interface MistTrialMissionInfo {
    ...
    param: number;
    /**
     * @generated from protobuf field: uint32 watcher_list_id = 5;
     */
...
class MistTrialMissionInfo$Type extends MessageType<MistTrialMissionInfo> {
    ...
    internalBinaryWrite(message: MistTrialMissionInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.watcherListId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.watcherListId);
