...
// @generated from protobuf file "PSNFriendListNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PSNFriendListNotify
 */
export interface PSNFriendListNotify {
    /**
     * @generated from protobuf field: repeated FriendBrief psn_friend_list = 1;
     */
...
class PSNFriendListNotify$Type extends MessageType<PSNFriendListNotify> {
    constructor() {
        super("PSNFriendListNotify", [
            { no: 1, name: "psn_friend_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FriendBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: PSNFriendListNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.psnFriendList.length; i++)
            FriendBrief.internalBinaryWrite(message.psnFriendList[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
