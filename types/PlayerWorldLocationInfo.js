...
class PlayerWorldLocationInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerWorldLocationInfo", [
            { no: 3, name: "player_loc", kind: "message", T: () => PlayerLocationInfo_1.PlayerLocationInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* PlayerLocationInfo player_loc */ 3:
                    message.playerLoc = PlayerLocationInfo_1.PlayerLocationInfo.internalBinaryRead(reader, reader.uint32(), options, message.playerLoc);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.playerLoc)
            PlayerLocationInfo_1.PlayerLocationInfo.internalBinaryWrite(message.playerLoc, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 scene_id = 11; */
