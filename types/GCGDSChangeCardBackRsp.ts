...
// @generated from protobuf file "GCGDSChangeCardBackRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSChangeCardBackRsp
 */
export interface GCGDSChangeCardBackRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 card_back_id = 5;
     */
    cardBackId: number;
    /**
     * @generated from protobuf field: uint32 deck_id = 9;
     */
    deckId: number;
}
...
class GCGDSChangeCardBackRsp$Type extends MessageType<GCGDSChangeCardBackRsp> {
    ...
    internalBinaryWrite(message: GCGDSChangeCardBackRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cardBackId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.cardBackId);
        /* uint32 deck_id = 9; */
        if (message.deckId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.deckId);
