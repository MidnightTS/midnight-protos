...
// @generated from protobuf file "AsterMidInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AsterMidInfoNotify
 */
export interface AsterMidInfoNotify {
    /**
     * @generated from protobuf field: AsterMidDetailInfo info = 7;
     */
...
class AsterMidInfoNotify$Type extends MessageType<AsterMidInfoNotify> {
    constructor() {
        super("AsterMidInfoNotify", [
            { no: 7, name: "info", kind: "message", T: () => AsterMidDetailInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: AsterMidInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            AsterMidDetailInfo.internalBinaryWrite(message.info, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
