...
// @generated from protobuf file "StartBuoyantCombatGalleryRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StartBuoyantCombatGalleryRsp
 */
export interface StartBuoyantCombatGalleryRsp {
    /**
     * @generated from protobuf field: uint32 gallery_level = 6;
     */
    galleryLevel: number;
    /**
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 gallery_id = 12;
     */
    galleryId: number;
}
...
class StartBuoyantCombatGalleryRsp$Type extends MessageType<StartBuoyantCombatGalleryRsp> {
    ...
    internalBinaryWrite(message: StartBuoyantCombatGalleryRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.galleryLevel !== 0)
            writer.tag(6, WireType.Varint).uint32(message.galleryLevel);
        /* int32 retcode = 5; */
