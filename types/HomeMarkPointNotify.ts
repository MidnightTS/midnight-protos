...
// @generated from protobuf file "HomeMarkPointNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { HomeMarkPointSceneData } from "./HomeMarkPointSceneData";
/**
 * enum CmdId {
...
export interface HomeMarkPointNotify {
    /**
     * @generated from protobuf field: repeated HomeMarkPointSceneData mark_point_data_list = 11;
     */
...
class HomeMarkPointNotify$Type extends MessageType<HomeMarkPointNotify> {
    constructor() {
        super("HomeMarkPointNotify", [
            { no: 11, name: "mark_point_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeMarkPointSceneData }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeMarkPointNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.markPointDataList.length; i++)
            HomeMarkPointSceneData.internalBinaryWrite(message.markPointDataList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
