...
exports.ChannelerSlabOneoffDungeon = void 0;
...
class ChannelerSlabOneoffDungeon$Type extends runtime_5.MessageType {
    constructor() {
        super("ChannelerSlabOneoffDungeon", [
    ...
    create(value) {
        const message = { dungeonId: 0, isDone: false, rewardId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isDone !== false)
            writer.tag(1, runtime_1.WireType.Varint).bool(message.isDone);
        /* uint32 reward_id = 5; */
...
/**
 * @generated MessageType for protobuf message ChannelerSlabOneoffDungeon
 */
