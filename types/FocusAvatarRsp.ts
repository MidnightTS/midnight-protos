...
// @generated from protobuf file "FocusAvatarRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FocusAvatarRsp
 */
export interface FocusAvatarRsp {
    /**
     * @generated from protobuf field: bool is_focus = 2;
     */
    isFocus: boolean;
    /**
...
class FocusAvatarRsp$Type extends MessageType<FocusAvatarRsp> {
    ...
    internalBinaryWrite(message: FocusAvatarRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isFocus !== false)
            writer.tag(2, WireType.Varint).bool(message.isFocus);
