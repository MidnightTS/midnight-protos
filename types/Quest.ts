...
export class Quest extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        ...
        accept_time?: number;
        lacked_npc_list?: number[];
        finish_progress_list?: number[];
        fail_progress_list?: number[];
        lacked_npc_map?: Map<number, number>;
        lacked_place_list?: number[];
        lacked_place_map?: Map<number, number>;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [10, 11, 12, 14], this.#one_of_decls);
    ...
    set start_game_time(value: number) {
        pb_1.Message.setField(this, 8, value);
    }
    get accept_time() {
        return pb_1.Message.getFieldWithDefault(this, 9, 0) as number;
    }
    set accept_time(value: number) {
        pb_1.Message.setField(this, 9, value);
    }
    get lacked_npc_list() {
        return pb_1.Message.getFieldWithDefault(this, 10, []) as number[];
    }
    set lacked_npc_list(value: number[]) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Quest {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.lacked_npc_map as any, reader, reader.readUint32, reader.readUint32));
                    break;
                case 14:
                    message.lacked_place_list = reader.readPackedUint32();
                    break;
                case 15:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.lacked_place_map as any, reader, reader.readUint32, reader.readUint32));
                    break;
