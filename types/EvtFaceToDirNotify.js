...
const EvtFaceToDirInfo_1 = require("./EvtFaceToDirInfo");
// @generated message type with reflection information, may provide speed optimized methods
class EvtFaceToDirNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("EvtFaceToDirNotify", [
            { no: 2, name: "evt_face_to_dir_info", kind: "message", T: () => EvtFaceToDirInfo_1.EvtFaceToDirInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* EvtFaceToDirInfo evt_face_to_dir_info */ 2:
                    message.evtFaceToDirInfo = EvtFaceToDirInfo_1.EvtFaceToDirInfo.internalBinaryRead(reader, reader.uint32(), options, message.evtFaceToDirInfo);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.evtFaceToDirInfo)
            EvtFaceToDirInfo_1.EvtFaceToDirInfo.internalBinaryWrite(message.evtFaceToDirInfo, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
