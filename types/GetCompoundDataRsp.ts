...
// @generated from protobuf file "GetCompoundDataRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetCompoundDataRsp
 */
export interface GetCompoundDataRsp {
    /**
     * @generated from protobuf field: repeated CompoundQueueData compound_queue_data_list = 4;
     */
    compoundQueueDataList: CompoundQueueData[];
    /**
     * @generated from protobuf field: repeated uint32 unlock_compound_list = 10;
     */
...
class GetCompoundDataRsp$Type extends MessageType<GetCompoundDataRsp> {
    constructor() {
        super("GetCompoundDataRsp", [
            { no: 4, name: "compound_queue_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CompoundQueueData },
    ...
    internalBinaryWrite(message: GetCompoundDataRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.compoundQueueDataList.length; i++)
            CompoundQueueData.internalBinaryWrite(message.compoundQueueDataList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
