...
class DungeonWayPointActivateRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonWayPointActivateRsp", [
            { no: 1, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 10, name: "way_point_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, wayPointId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.wayPointId !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.wayPointId);
...
/**
 * @generated MessageType for protobuf message DungeonWayPointActivateRsp
 */
