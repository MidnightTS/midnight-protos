...
exports.EnterFungusFighterPlotDungeonRsp = void 0;
...
class EnterFungusFighterPlotDungeonRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("EnterFungusFighterPlotDungeonRsp", [
            { no: 14, name: "fungus_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "dungeon_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { fungusIdList: [], dungeonId: 0, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 fungus_id_list */ 14:
...
/**
 * @generated MessageType for protobuf message EnterFungusFighterPlotDungeonRsp
 */
