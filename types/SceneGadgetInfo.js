...
const CoinCollectOperatorInfo_1 = require("./CoinCollectOperatorInfo");
...
class SceneGadgetInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneGadgetInfo", [
            ...
            { no: 5, name: "born_type", kind: "enum", T: () => ["GadgetBornType", GadgetBornType_1.GadgetBornType, "GADGET_BORN_TYPE_"] },
            ...
            { no: 64, name: "coin_collect_operator_info", kind: "message", oneof: "content", T: () => CoinCollectOperatorInfo_1.CoinCollectOperatorInfo }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* RoguelikeGadgetInfo roguelike_gadget_info */ 61:
                    ...
                    break;
                case /* NightCrowGadgetInfo night_crow_gadget_info */ 62:
                    message.content = {
                    ...
                    break;
                case /* DeshretObeliskGadgetInfo deshret_obelisk_gadget_info */ 63:
                    message.content = {
                    ...
                    break;
                case /* CoinCollectOperatorInfo coin_collect_operator_info */ 64:
                    message.content = {
                        oneofKind: "coinCollectOperatorInfo",
                        coinCollectOperatorInfo: CoinCollectOperatorInfo_1.CoinCollectOperatorInfo.internalBinaryRead(reader, reader.uint32(), options, message.content.coinCollectOperatorInfo)
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.content.oneofKind === "coinCollectOperatorInfo")
            CoinCollectOperatorInfo_1.CoinCollectOperatorInfo.internalBinaryWrite(message.content.coinCollectOperatorInfo, writer.tag(64, runtime_2.WireType.LengthDelimited).fork(), options).join();
