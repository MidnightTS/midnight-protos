...
exports.VintageMarketDeliverItemRsp = void 0;
...
class VintageMarketDeliverItemRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("VintageMarketDeliverItemRsp", [
            { no: 9, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 6, name: "trader_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, traderId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.traderId !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.traderId);
...
/**
 * @generated MessageType for protobuf message VintageMarketDeliverItemRsp
 */
