...
exports.GCGMsgSelectOnStageByEffect = void 0;
...
class GCGMsgSelectOnStageByEffect$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGMsgSelectOnStageByEffect", [
            { no: 15, name: "card_guid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "controller_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "skill_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { cardGuid: 0, controllerId: 0, skillId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.cardGuid !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.cardGuid);
...
/**
 * @generated MessageType for protobuf message GCGMsgSelectOnStageByEffect
 */
