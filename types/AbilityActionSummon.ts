...
// @generated from protobuf file "AbilityActionSummon.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityActionSummon
 */
export interface AbilityActionSummon {
    ...
    pos?: Vector;
    /**
     * @generated from protobuf field: Vector rot = 10;
     */
    rot?: Vector;
}
...
class AbilityActionSummon$Type extends MessageType<AbilityActionSummon> {
    constructor() {
        super("AbilityActionSummon", [
            ...
            { no: 10, name: "rot", kind: "message", T: () => Vector }
        ]);
    }
    ...
    internalBinaryWrite(message: AbilityActionSummon, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* Vector rot = 10; */
        if (message.rot)
            Vector.internalBinaryWrite(message.rot, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
