...
exports.FinishLanternProjectionReq = void 0;
...
class FinishLanternProjectionReq$Type extends runtime_5.MessageType {
    constructor() {
        super("FinishLanternProjectionReq", [
            { no: 8, name: "finish_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 15, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { finishTime: 0, levelId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.finishTime !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.finishTime);
        /* uint32 level_id = 15; */
...
/**
 * @generated MessageType for protobuf message FinishLanternProjectionReq
 */
