...
exports.UpdatePS4FriendListRsp = void 0;
...
class UpdatePS4FriendListRsp$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { psnIdList: [], retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.psnIdList.length; i++)
            writer.tag(14, runtime_1.WireType.LengthDelimited).string(message.psnIdList[i]);
        /* int32 retcode = 3; */
...
/**
 * @generated MessageType for protobuf message UpdatePS4FriendListRsp
 */
