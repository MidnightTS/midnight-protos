...
exports.EvtHittingOtherInfo = void 0;
...
class EvtHittingOtherInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("EvtHittingOtherInfo", [
            ...
            { no: 7, name: "attack_result", kind: "message", T: () => AttackResult_1.AttackResult }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.attackResult)
            AttackResult_1.AttackResult.internalBinaryWrite(message.attackResult, writer.tag(7, runtime_1.WireType.LengthDelimited).fork(), options).join();
