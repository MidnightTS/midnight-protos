...
// @generated from protobuf file "MichiaeMatsuriInteractStatueReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MichiaeMatsuriInteractStatueReq
 */
export interface MichiaeMatsuriInteractStatueReq {
    /**
     * @generated from protobuf field: uint32 statue_entity_id = 9;
     */
...
class MichiaeMatsuriInteractStatueReq$Type extends MessageType<MichiaeMatsuriInteractStatueReq> {
    ...
    internalBinaryWrite(message: MichiaeMatsuriInteractStatueReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.statueEntityId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.statueEntityId);
