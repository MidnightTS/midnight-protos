...
// @generated from protobuf file "SubmitInferenceWordReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SubmitInferenceWordReq
 */
export interface SubmitInferenceWordReq {
    /**
     * @generated from protobuf field: uint32 page_id = 10;
     */
    pageId: number;
    /**
     * @generated from protobuf field: uint32 word_id = 14;
     */
    wordId: number;
}
...
class SubmitInferenceWordReq$Type extends MessageType<SubmitInferenceWordReq> {
    ...
    internalBinaryWrite(message: SubmitInferenceWordReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 page_id = 10; */
        if (message.pageId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.pageId);
        /* uint32 word_id = 14; */
        if (message.wordId !== 0)
