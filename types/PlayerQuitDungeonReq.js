...
class PlayerQuitDungeonReq$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerQuitDungeonReq", [
            { no: 3, name: "is_quit_immediately", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 8, name: "point_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isQuitImmediately: false, pointId: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_quit_immediately */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isQuitImmediately !== false)
            writer.tag(3, runtime_1.WireType.Varint).bool(message.isQuitImmediately);
        /* uint32 point_id = 8; */
