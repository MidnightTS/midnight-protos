...
var _SummerTimeStageInfo_one_of_decls;
...
class SummerTimeStageInfo extends pb_1.Message {
    constructor(data) {
        super();
        _SummerTimeStageInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SummerTimeStageInfo_one_of_decls, "f"));
...
exports.SummerTimeStageInfo = SummerTimeStageInfo;
_SummerTimeStageInfo_one_of_decls = new WeakMap();
