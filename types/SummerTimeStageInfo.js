...
exports.SummerTimeStageInfo = void 0;
...
class SummerTimeStageInfo$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { openTime: 0, stageId: 0, isOpen: false };
...
/**
 * @generated MessageType for protobuf message SummerTimeStageInfo
 */
