...
// @generated from protobuf file "GCGInviteBattleNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGInviteBattleNotify
 */
export interface GCGInviteBattleNotify {
    /**
     * @generated from protobuf field: uint32 confirm_end_time = 1;
     */
...
class GCGInviteBattleNotify$Type extends MessageType<GCGInviteBattleNotify> {
    ...
    internalBinaryWrite(message: GCGInviteBattleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.confirmEndTime !== 0)
            writer.tag(1, WireType.Varint).uint32(message.confirmEndTime);
