...
class PullRecentChatRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PullRecentChatRsp", [
            { no: 13, name: "chat_info", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ChatInfo_1.ChatInfo },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated ChatInfo chat_info */ 13:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.chatInfo.length; i++)
            ChatInfo_1.ChatInfo.internalBinaryWrite(message.chatInfo[i], writer.tag(13, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 11; */
