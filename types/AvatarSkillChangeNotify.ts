...
// @generated from protobuf file "AvatarSkillChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarSkillChangeNotify {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: uint32 old_level = 7;
     */
    oldLevel: number;
    /**
     * @generated from protobuf field: uint32 cur_level = 15;
     */
    curLevel: number;
    /**
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 avatar_skill_id = 11;
     */
...
class AvatarSkillChangeNotify$Type extends MessageType<AvatarSkillChangeNotify> {
    ...
    internalBinaryWrite(message: AvatarSkillChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.oldLevel !== 0)
            writer.tag(7, WireType.Varint).uint32(message.oldLevel);
        /* uint32 cur_level = 15; */
        if (message.curLevel !== 0)
            writer.tag(15, WireType.Varint).uint32(message.curLevel);
        ...
        if (message.avatarSkillId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.avatarSkillId);
