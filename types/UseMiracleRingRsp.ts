...
// @generated from protobuf file "UseMiracleRingRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message UseMiracleRingRsp
 */
export interface UseMiracleRingRsp {
    /**
     * @generated from protobuf field: uint32 miracle_ring_op_type = 14;
     */
...
class UseMiracleRingRsp$Type extends MessageType<UseMiracleRingRsp> {
    ...
    internalBinaryWrite(message: UseMiracleRingRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.miracleRingOpType !== 0)
            writer.tag(14, WireType.Varint).uint32(message.miracleRingOpType);
        /* int32 retcode = 10; */
