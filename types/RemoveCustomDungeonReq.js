...
exports.RemoveCustomDungeonReq = void 0;
...
class RemoveCustomDungeonReq$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.dungeonGuid !== 0n)
            writer.tag(7, runtime_1.WireType.Varint).uint64(message.dungeonGuid);
...
/**
 * @generated MessageType for protobuf message RemoveCustomDungeonReq
 */
