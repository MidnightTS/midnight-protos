...
class ChangeWorldToSingleModeRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ChangeWorldToSingleModeRsp", [
            { no: 6, name: "quit_mp_valid_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { quitMpValidTime: 0, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 quit_mp_valid_time */ 6:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.quitMpValidTime !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.quitMpValidTime);
        /* int32 retcode = 14; */
...
/**
 * @generated MessageType for protobuf message ChangeWorldToSingleModeRsp
 */
