...
// @generated from protobuf file "GetReunionPrivilegeInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetReunionPrivilegeInfoRsp
 */
export interface GetReunionPrivilegeInfoRsp {
    /**
     * @generated from protobuf field: ReunionPrivilegeInfo privilege_info = 6;
     */
...
class GetReunionPrivilegeInfoRsp$Type extends MessageType<GetReunionPrivilegeInfoRsp> {
    constructor() {
        super("GetReunionPrivilegeInfoRsp", [
            { no: 6, name: "privilege_info", kind: "message", T: () => ReunionPrivilegeInfo },
    ...
    internalBinaryWrite(message: GetReunionPrivilegeInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.privilegeInfo)
            ReunionPrivilegeInfo.internalBinaryWrite(message.privilegeInfo, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 3; */
