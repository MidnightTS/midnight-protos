...
// @generated from protobuf file "TakeRegionSearchRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeRegionSearchRewardReq
 */
export interface TakeRegionSearchRewardReq {
    ...
    id: number;
    /**
     * @generated from protobuf field: uint32 search_id = 6;
     */
    searchId: number;
}
...
class TakeRegionSearchRewardReq$Type extends MessageType<TakeRegionSearchRewardReq> {
    ...
    internalBinaryWrite(message: TakeRegionSearchRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.searchId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.searchId);
