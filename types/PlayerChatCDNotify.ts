...
// @generated from protobuf file "PlayerChatCDNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerChatCDNotify
 */
export interface PlayerChatCDNotify {
    /**
     * @generated from protobuf field: uint32 over_time = 14;
     */
    overTime: number;
}
...
class PlayerChatCDNotify$Type extends MessageType<PlayerChatCDNotify> {
    ...
    internalBinaryWrite(message: PlayerChatCDNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.overTime !== 0)
            writer.tag(14, WireType.Varint).uint32(message.overTime);
