...
// @generated from protobuf file "GetWidgetSlotRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface GetWidgetSlotRsp {
    /**
     * @generated from protobuf field: repeated WidgetSlotData slot_list = 3;
     */
...
class GetWidgetSlotRsp$Type extends MessageType<GetWidgetSlotRsp> {
    constructor() {
        super("GetWidgetSlotRsp", [
            { no: 3, name: "slot_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WidgetSlotData },
    ...
    internalBinaryWrite(message: GetWidgetSlotRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.slotList.length; i++)
            WidgetSlotData.internalBinaryWrite(message.slotList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 10; */
