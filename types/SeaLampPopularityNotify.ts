...
// @generated from protobuf file "SeaLampPopularityNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SeaLampPopularityNotify
 */
export interface SeaLampPopularityNotify {
    /**
     * @generated from protobuf field: uint32 popularity = 6;
     */
    popularity: number;
}
...
class SeaLampPopularityNotify$Type extends MessageType<SeaLampPopularityNotify> {
    ...
    internalBinaryWrite(message: SeaLampPopularityNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.popularity !== 0)
            writer.tag(6, WireType.Varint).uint32(message.popularity);
