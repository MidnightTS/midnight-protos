...
exports.CustomDungeonRecoverNotify = void 0;
...
class CustomDungeonRecoverNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CustomDungeonRecoverNotify", [
            { no: 15, name: "custom_dungeon", kind: "message", T: () => CustomDungeon_1.CustomDungeon },
            ...
            { no: 8, name: "try_type", kind: "enum", T: () => ["TryCustomDungeonType", TryCustomDungeonType_1.TryCustomDungeonType, "TRY_CUSTOM_DUNGEON_TYPE_"] },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customDungeon)
            CustomDungeon_1.CustomDungeon.internalBinaryWrite(message.customDungeon, writer.tag(15, runtime_2.WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.tryType !== 0)
            writer.tag(8, runtime_2.WireType.Varint).int32(message.tryType);
