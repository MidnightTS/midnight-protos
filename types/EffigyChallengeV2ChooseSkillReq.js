...
exports.EffigyChallengeV2ChooseSkillReq = void 0;
...
class EffigyChallengeV2ChooseSkillReq$Type extends runtime_5.MessageType {
    constructor() {
        super("EffigyChallengeV2ChooseSkillReq", [
    ...
    create(value) {
        const message = { challengeModeSkillNo: 0, levelId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.challengeModeSkillNo !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.challengeModeSkillNo);
        /* uint32 level_id = 7; */
...
/**
 * @generated MessageType for protobuf message EffigyChallengeV2ChooseSkillReq
 */
