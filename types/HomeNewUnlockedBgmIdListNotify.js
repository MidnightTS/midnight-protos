...
exports.HomeNewUnlockedBgmIdListNotify = void 0;
...
class HomeNewUnlockedBgmIdListNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeNewUnlockedBgmIdListNotify", [
            { no: 1, name: "new_unlocked_bgm_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 new_unlocked_bgm_id_list */ 1:
...
/**
 * @generated MessageType for protobuf message HomeNewUnlockedBgmIdListNotify
 */
