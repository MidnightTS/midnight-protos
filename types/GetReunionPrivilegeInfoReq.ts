...
// @generated from protobuf file "GetReunionPrivilegeInfoReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetReunionPrivilegeInfoReq
 */
export interface GetReunionPrivilegeInfoReq {
    /**
     * @generated from protobuf field: uint32 privilege_id = 15;
     */
    privilegeId: number;
}
...
class GetReunionPrivilegeInfoReq$Type extends MessageType<GetReunionPrivilegeInfoReq> {
    ...
    internalBinaryWrite(message: GetReunionPrivilegeInfoReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.privilegeId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.privilegeId);
