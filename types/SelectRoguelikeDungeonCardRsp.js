...
class SelectRoguelikeDungeonCardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SelectRoguelikeDungeonCardRsp", [
            { no: 14, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { cardId: 0, retcode: 0 };
...
/**
 * @generated MessageType for protobuf message SelectRoguelikeDungeonCardRsp
 */
