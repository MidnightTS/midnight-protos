...
// @generated from protobuf file "TaskVarNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TaskVarNotify
 */
export interface TaskVarNotify {
    /**
     * @generated from protobuf field: repeated TaskVar task_var_list = 13;
     */
    taskVarList: TaskVar[];
}
...
class TaskVarNotify$Type extends MessageType<TaskVarNotify> {
    constructor() {
        super("TaskVarNotify", [
            { no: 13, name: "task_var_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TaskVar }
        ]);
    }
    ...
    internalBinaryWrite(message: TaskVarNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.taskVarList.length; i++)
            TaskVar.internalBinaryWrite(message.taskVarList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
