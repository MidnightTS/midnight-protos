...
// @generated from protobuf file "cmd_group_link.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class GroupLinkAllNotify$Type extends MessageType<GroupLinkAllNotify> {
    constructor() {
        super("com.midnights.game.GroupLinkAllNotify", [
            { no: 5, name: "bundle_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GroupLinkBundle }
        ]);
    }
