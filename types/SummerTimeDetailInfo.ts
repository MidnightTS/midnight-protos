...
import * as dependency_1 from "./SummerTimeSprintBoatInfo";
import * as dependency_2 from "./SummerTimeStageInfo";
import * as pb_1 from "google-protobuf";
export class SummerTimeDetailInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        stage_map?: Map<number, dependency_2.SummerTimeStageInfo>;
        content_close_time?: number;
        is_content_closed?: boolean;
        sprint_boat_info?: dependency_1.SummerTimeSprintBoatInfo;
    }) {
        super();
    ...
    get stage_map() {
        return pb_1.Message.getField(this, 3) as any as Map<number, dependency_2.SummerTimeStageInfo>;
    }
    set stage_map(value: Map<number, dependency_2.SummerTimeStageInfo>) {
    ...
    get sprint_boat_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.SummerTimeSprintBoatInfo, 4) as dependency_1.SummerTimeSprintBoatInfo;
    }
    set sprint_boat_info(value: dependency_1.SummerTimeSprintBoatInfo) {
    ...
    static fromObject(data: {
        stage_map?: {
            [key: number]: ReturnType<typeof dependency_2.SummerTimeStageInfo.prototype.toObject>;
        };
        content_close_time?: number;
        is_content_closed?: boolean;
        sprint_boat_info?: ReturnType<typeof dependency_1.SummerTimeSprintBoatInfo.prototype.toObject>;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SummerTimeDetailInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): SummerTimeDetailInfo {
