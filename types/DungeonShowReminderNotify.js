...
exports.DungeonShowReminderNotify = void 0;
...
class DungeonShowReminderNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonShowReminderNotify", [
            { no: 12, name: "reminder_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.reminderId !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.reminderId);
