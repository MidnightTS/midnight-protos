...
export interface AbilityIdentifier {
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_IHCKJKLCICI = 10 [json_name = "Unk3300IHCKJKLCICI"];
     */
    unk3300IHCKJKLCICI: number;
    /**
    ...
    localId: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_OOOLELPBDHJ = 1 [json_name = "Unk3300OOOLELPBDHJ"];
     */
    unk3300OOOLELPBDHJ: number;
    /**
...
class AbilityIdentifier$Type extends MessageType<AbilityIdentifier> {
    ...
    internalBinaryWrite(message: AbilityIdentifier, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300IHCKJKLCICI !== 0)
            writer.tag(10, WireType.Varint).uint32(message.unk3300IHCKJKLCICI);
        ...
        if (message.unk3300OOOLELPBDHJ !== 0)
            writer.tag(1, WireType.Varint).uint32(message.unk3300OOOLELPBDHJ);
