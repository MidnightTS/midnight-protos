...
// @generated from protobuf file "HomeBlueprintInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeBlueprintInfoNotify
 */
export interface HomeBlueprintInfoNotify {
    /**
     * @generated from protobuf field: bool is_allow_friend_copy = 1;
     */
...
class HomeBlueprintInfoNotify$Type extends MessageType<HomeBlueprintInfoNotify> {
    ...
    internalBinaryWrite(message: HomeBlueprintInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAllowFriendCopy !== false)
            writer.tag(1, WireType.Varint).bool(message.isAllowFriendCopy);
