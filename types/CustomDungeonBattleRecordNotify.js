...
exports.CustomDungeonBattleRecordNotify = void 0;
...
class CustomDungeonBattleRecordNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CustomDungeonBattleRecordNotify", [
            { no: 1, name: "dungeon_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 12, name: "min_cost_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.minCostTime !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.minCostTime);
...
/**
 * @generated MessageType for protobuf message CustomDungeonBattleRecordNotify
 */
