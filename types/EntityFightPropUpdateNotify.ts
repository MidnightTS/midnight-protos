...
// @generated from protobuf file "EntityFightPropUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
...
class EntityFightPropUpdateNotify$Type extends MessageType<EntityFightPropUpdateNotify> {
    ...
    private binaryReadMap7(map: EntityFightPropUpdateNotify["fightPropMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
