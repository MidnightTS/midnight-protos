...
// @generated from protobuf file "BargainTerminateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BargainTerminateNotify
 */
export interface BargainTerminateNotify {
    /**
     * @generated from protobuf field: uint32 bargain_id = 7;
     */
    bargainId: number;
}
...
class BargainTerminateNotify$Type extends MessageType<BargainTerminateNotify> {
    ...
    internalBinaryWrite(message: BargainTerminateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bargainId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.bargainId);
