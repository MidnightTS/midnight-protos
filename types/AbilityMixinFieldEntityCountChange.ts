...
// @generated from protobuf file "AbilityMixinFieldEntityCountChange.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityMixinFieldEntityCountChange
 */
export interface AbilityMixinFieldEntityCountChange {
    /**
     * @generated from protobuf field: uint32 field_entity_count = 8;
     */
...
class AbilityMixinFieldEntityCountChange$Type extends MessageType<AbilityMixinFieldEntityCountChange> {
    ...
    internalBinaryWrite(message: AbilityMixinFieldEntityCountChange, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fieldEntityCount !== 0)
            writer.tag(8, WireType.Varint).uint32(message.fieldEntityCount);
