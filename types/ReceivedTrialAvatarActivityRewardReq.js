...
exports.ReceivedTrialAvatarActivityRewardReq = void 0;
...
class ReceivedTrialAvatarActivityRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("ReceivedTrialAvatarActivityRewardReq", [
            { no: 9, name: "trial_avatar_index_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 trial_avatar_index_id */ 9:
...
/**
 * @generated MessageType for protobuf message ReceivedTrialAvatarActivityRewardReq
 */
