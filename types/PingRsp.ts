...
// @generated from protobuf file "PingRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface PingRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 client_time = 10;
     */
    clientTime: number;
    /**
     * @generated from protobuf field: uint32 seq = 15;
     */
    seq: number;
}
...
class PingRsp$Type extends MessageType<PingRsp> {
    ...
    internalBinaryWrite(message: PingRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.clientTime !== 0)
            writer.tag(10, WireType.Varint).uint32(message.clientTime);
        /* uint32 seq = 15; */
        if (message.seq !== 0)
            writer.tag(15, WireType.Varint).uint32(message.seq);
