...
// @generated from protobuf file "BlessingRecvFriendPicNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BlessingRecvFriendPicNotify
 */
export interface BlessingRecvFriendPicNotify {
    /**
     * @generated from protobuf field: uint32 pic_id = 4;
     */
    picId: number;
    /**
...
class BlessingRecvFriendPicNotify$Type extends MessageType<BlessingRecvFriendPicNotify> {
    ...
    internalBinaryWrite(message: BlessingRecvFriendPicNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 pic_id = 4; */
        if (message.picId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.picId);
        /* uint32 uid = 14; */
        if (message.uid !== 0)
