...
var _AvatarFightPropNotify_one_of_decls;
...
class AvatarFightPropNotify extends pb_1.Message {
    constructor(data) {
        super();
        _AvatarFightPropNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AvatarFightPropNotify_one_of_decls, "f"));
...
exports.AvatarFightPropNotify = AvatarFightPropNotify;
_AvatarFightPropNotify_one_of_decls = new WeakMap();
