...
import * as dependency_1 from "./CityReputationExploreInfo";
import * as dependency_2 from "./CityReputationHuntInfo";
import * as dependency_3 from "./CityReputationQuestInfo";
import * as dependency_4 from "./CityReputationRequestInfo";
import * as pb_1 from "google-protobuf";
export class CityReputationInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        level?: number;
        next_refresh_time?: number;
        hunt_info?: dependency_2.CityReputationHuntInfo;
        taken_level_reward_list?: number[];
        total_accept_request_num?: number;
        request_info?: dependency_4.CityReputationRequestInfo;
        quest_info?: dependency_3.CityReputationQuestInfo;
        exp?: number;
        explore_info?: dependency_1.CityReputationExploreInfo;
    }) {
        super();
    ...
    get hunt_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.CityReputationHuntInfo, 11) as dependency_2.CityReputationHuntInfo;
    }
    set hunt_info(value: dependency_2.CityReputationHuntInfo) {
    ...
    set total_accept_request_num(value: number) {
        pb_1.Message.setField(this, 6, value);
    }
    get request_info() {
        return pb_1.Message.getWrapperField(this, dependency_4.CityReputationRequestInfo, 5) as dependency_4.CityReputationRequestInfo;
    }
    set request_info(value: dependency_4.CityReputationRequestInfo) {
    ...
    get quest_info() {
        return pb_1.Message.getWrapperField(this, dependency_3.CityReputationQuestInfo, 9) as dependency_3.CityReputationQuestInfo;
    }
    set quest_info(value: dependency_3.CityReputationQuestInfo) {
    ...
    get explore_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.CityReputationExploreInfo, 10) as dependency_1.CityReputationExploreInfo;
    }
    set explore_info(value: dependency_1.CityReputationExploreInfo) {
    ...
    static fromObject(data: {
        level?: number;
        next_refresh_time?: number;
        hunt_info?: ReturnType<typeof dependency_2.CityReputationHuntInfo.prototype.toObject>;
        taken_level_reward_list?: number[];
        total_accept_request_num?: number;
        request_info?: ReturnType<typeof dependency_4.CityReputationRequestInfo.prototype.toObject>;
        quest_info?: ReturnType<typeof dependency_3.CityReputationQuestInfo.prototype.toObject>;
        exp?: number;
        explore_info?: ReturnType<typeof dependency_1.CityReputationExploreInfo.prototype.toObject>;
    }): CityReputationInfo {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CityReputationInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): CityReputationInfo {
