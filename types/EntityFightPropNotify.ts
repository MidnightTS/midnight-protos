...
// @generated from protobuf file "EntityFightPropNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EntityFightPropNotify
 */
export interface EntityFightPropNotify {
    /**
     * @generated from protobuf field: map<uint32, float> fight_prop_map = 9;
     */
    fightPropMap: {
        [key: number]: number;
    };
...
class EntityFightPropNotify$Type extends MessageType<EntityFightPropNotify> {
    ...
    private binaryReadMap9(map: EntityFightPropNotify["fightPropMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: EntityFightPropNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.fightPropMap))
            writer.tag(9, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Bit32).float(message.fightPropMap[k as any]).join();
        /* uint32 entity_id = 10; */
