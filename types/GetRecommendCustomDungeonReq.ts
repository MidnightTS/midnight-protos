...
// @generated from protobuf file "GetRecommendCustomDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetRecommendCustomDungeonReq
 */
export interface GetRecommendCustomDungeonReq {
    /**
     * @generated from protobuf field: bool is_refresh = 6;
     */
    isRefresh: boolean;
}
...
class GetRecommendCustomDungeonReq$Type extends MessageType<GetRecommendCustomDungeonReq> {
    ...
    internalBinaryWrite(message: GetRecommendCustomDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isRefresh !== false)
            writer.tag(6, WireType.Varint).bool(message.isRefresh);
