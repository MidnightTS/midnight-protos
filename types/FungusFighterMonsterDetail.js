...
exports.FungusFighterMonsterDetail = void 0;
...
class FungusFighterMonsterDetail$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.curHpPercentage !== 0)
            writer.tag(9, runtime_1.WireType.Bit32).float(message.curHpPercentage);
        /* bool is_alive = 10; */
        if (message.isAlive !== false)
            writer.tag(10, runtime_1.WireType.Varint).bool(message.isAlive);
        /* uint32 fungus_id = 13; */
        if (message.fungusId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.fungusId);
