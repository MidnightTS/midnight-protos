...
// @generated from protobuf file "WorldRoutineTypeRefreshNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message WorldRoutineTypeRefreshNotify
 */
export interface WorldRoutineTypeRefreshNotify {
    /**
     * @generated from protobuf field: WorldRoutineTypeInfo world_routine_type = 1;
     */
...
class WorldRoutineTypeRefreshNotify$Type extends MessageType<WorldRoutineTypeRefreshNotify> {
    constructor() {
        super("WorldRoutineTypeRefreshNotify", [
            { no: 1, name: "world_routine_type", kind: "message", T: () => WorldRoutineTypeInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WorldRoutineTypeRefreshNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.worldRoutineType)
            WorldRoutineTypeInfo.internalBinaryWrite(message.worldRoutineType, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
