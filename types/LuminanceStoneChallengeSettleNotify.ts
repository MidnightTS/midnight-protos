...
// @generated from protobuf file "LuminanceStoneChallengeSettleNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { LuminanceStoneChallengeSettleInfo } from "./LuminanceStoneChallengeSettleInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message LuminanceStoneChallengeSettleNotify
 */
export interface LuminanceStoneChallengeSettleNotify {
    ...
    galleryId: number;
    /**
     * @generated from protobuf field: LuminanceStoneChallengeSettleInfo settle_info = 5;
     */
...
class LuminanceStoneChallengeSettleNotify$Type extends MessageType<LuminanceStoneChallengeSettleNotify> {
    constructor() {
        super("LuminanceStoneChallengeSettleNotify", [
            ...
            { no: 5, name: "settle_info", kind: "message", T: () => LuminanceStoneChallengeSettleInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: LuminanceStoneChallengeSettleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.settleInfo)
            LuminanceStoneChallengeSettleInfo.internalBinaryWrite(message.settleInfo, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
