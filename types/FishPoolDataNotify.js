...
class FishPoolDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("FishPoolDataNotify", [
            { no: 3, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "today_fish_num", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { entityId: 0, todayFishNum: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.todayFishNum !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.todayFishNum);
...
/**
 * @generated MessageType for protobuf message FishPoolDataNotify
 */
