...
// @generated from protobuf file "VintageHuntingStageData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message VintageHuntingStageData
 */
export interface VintageHuntingStageData {
    /**
     * @generated from protobuf field: uint32 record_value = 11;
     */
    recordValue: number;
    /**
    ...
    stageId: number;
    /**
     * @generated from protobuf field: bool is_finish = 12;
     */
    isFinish: boolean;
    /**
...
class VintageHuntingStageData$Type extends MessageType<VintageHuntingStageData> {
    ...
    internalBinaryWrite(message: VintageHuntingStageData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.recordValue !== 0)
            writer.tag(11, WireType.Varint).uint32(message.recordValue);
        /* uint32 open_time = 5; */
        ...
        if (message.isFinish !== false)
            writer.tag(12, WireType.Varint).bool(message.isFinish);
        /* bool is_open = 4; */
