...
// @generated from protobuf file "HomeLimitedShopInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeLimitedShopInfoRsp
 */
export interface HomeLimitedShopInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: HomeLimitedShopInfo shop_info = 12;
     */
...
class HomeLimitedShopInfoRsp$Type extends MessageType<HomeLimitedShopInfoRsp> {
    constructor() {
        super("HomeLimitedShopInfoRsp", [
            ...
            { no: 12, name: "shop_info", kind: "message", T: () => HomeLimitedShopInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeLimitedShopInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.shopInfo)
            HomeLimitedShopInfo.internalBinaryWrite(message.shopInfo, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
