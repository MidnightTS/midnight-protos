...
export interface CoopChapter {
    ...
    /**
     * @generated from protobuf field: repeated uint32 Unk3300_MOOKBLFKOLC = 6 [json_name = "Unk3300MOOKBLFKOLC"];
     */
    unk3300MOOKBLFKOLC: number[];
    /**
     * @generated from protobuf field: CoopChapter.State state = 7;
     */
    state: CoopChapter_State;
    /**
     * @generated from protobuf field: uint32 Unk3300_KDLGLOIIINH = 11 [json_name = "Unk3300KDLGLOIIINH"];
     */
    unk3300KDLGLOIIINH: number;
    /**
     * @generated from protobuf field: repeated CoopReward coop_reward_list = 3;
     */
    coopRewardList: CoopReward[];
    /**
     * @generated from protobuf field: repeated uint32 Unk3300_MJLMJBMGJPP = 4 [json_name = "Unk3300MJLMJBMGJPP"];
     */
    unk3300MJLMJBMGJPP: number[];
    /**
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_KMJHIMBIGJF = 8 [json_name = "Unk3300KMJHIMBIGJF"];
     */
    unk3300KMJHIMBIGJF: number;
}
/**
...
class CoopChapter$Type extends MessageType<CoopChapter> {
    ...
    internalBinaryWrite(message: CoopChapter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300KDLGLOIIINH !== 0)
            writer.tag(11, WireType.Varint).uint32(message.unk3300KDLGLOIIINH);
        ...
        if (message.unk3300KMJHIMBIGJF !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300KMJHIMBIGJF);
