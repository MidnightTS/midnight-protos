...
exports.ActivitySelectAvatarCardReq = void 0;
...
class ActivitySelectAvatarCardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("ActivitySelectAvatarCardReq", [
            { no: 14, name: "reward_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "activity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { rewardId: 0, activityId: 0 };
...
/**
 * @generated MessageType for protobuf message ActivitySelectAvatarCardReq
 */
