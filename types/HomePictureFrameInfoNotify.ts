...
// @generated from protobuf file "HomePictureFrameInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomePictureFrameInfoNotify
 */
export interface HomePictureFrameInfoNotify {
    /**
     * @generated from protobuf field: repeated HomePictureFrameInfo picture_frame_info_list = 7;
     */
...
class HomePictureFrameInfoNotify$Type extends MessageType<HomePictureFrameInfoNotify> {
    constructor() {
        super("HomePictureFrameInfoNotify", [
            { no: 7, name: "picture_frame_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomePictureFrameInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomePictureFrameInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.pictureFrameInfoList.length; i++)
            HomePictureFrameInfo.internalBinaryWrite(message.pictureFrameInfoList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
