...
// @generated from protobuf file "GetNextResourceInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetNextResourceInfoRsp
 */
export interface GetNextResourceInfoRsp {
    /**
     * @generated from protobuf field: ResVersionConfig next_res_version_config = 6;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: string next_resource_url = 15;
     */
...
class GetNextResourceInfoRsp$Type extends MessageType<GetNextResourceInfoRsp> {
    constructor() {
        super("GetNextResourceInfoRsp", [
            { no: 6, name: "next_res_version_config", kind: "message", T: () => ResVersionConfig },
    ...
    internalBinaryWrite(message: GetNextResourceInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.nextResVersionConfig)
            ResVersionConfig.internalBinaryWrite(message.nextResVersionConfig, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 8; */
        if (message.retcode !== 0)
            writer.tag(8, WireType.Varint).int32(message.retcode);
        /* string next_resource_url = 15; */
        if (message.nextResourceUrl !== "")
            writer.tag(15, WireType.LengthDelimited).string(message.nextResourceUrl);
