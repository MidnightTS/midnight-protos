...
export class GetNextResourceInfoRsp extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        next_resource_url?: string;
        next_res_version_config?: dependency_1.ResVersionConfig;
        retcode?: number;
    }) {
        super();
    ...
    get next_res_version_config() {
        return pb_1.Message.getWrapperField(this, dependency_1.ResVersionConfig, 2) as dependency_1.ResVersionConfig;
    }
    set next_res_version_config(value: dependency_1.ResVersionConfig) {
    ...
    static fromObject(data: {
        next_resource_url?: string;
        next_res_version_config?: ReturnType<typeof dependency_1.ResVersionConfig.prototype.toObject>;
        retcode?: number;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetNextResourceInfoRsp {
    ...
    static deserializeBinary(bytes: Uint8Array): GetNextResourceInfoRsp {
