...
// @generated from protobuf file "GachaActivityCreateRobotRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GachaActivityCreateRobotRsp
 */
export interface GachaActivityCreateRobotRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 robot_id = 11;
     */
    robotId: number;
}
...
class GachaActivityCreateRobotRsp$Type extends MessageType<GachaActivityCreateRobotRsp> {
    ...
    internalBinaryWrite(message: GachaActivityCreateRobotRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.robotId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.robotId);
