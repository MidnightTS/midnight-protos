...
// @generated from protobuf file "AbilityApplyLevelModifier.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityApplyLevelModifier
 */
export interface AbilityApplyLevelModifier {
    /**
     * @generated from protobuf field: uint32 apply_entity_id = 1;
     */
...
class AbilityApplyLevelModifier$Type extends MessageType<AbilityApplyLevelModifier> {
    ...
    internalBinaryWrite(message: AbilityApplyLevelModifier, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.applyEntityId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.applyEntityId);
