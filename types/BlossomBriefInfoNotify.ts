...
// @generated from protobuf file "BlossomBriefInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BlossomBriefInfoNotify
 */
export interface BlossomBriefInfoNotify {
    /**
     * @generated from protobuf field: repeated BlossomBriefInfo brief_info_list = 8;
     */
...
class BlossomBriefInfoNotify$Type extends MessageType<BlossomBriefInfoNotify> {
    constructor() {
        super("BlossomBriefInfoNotify", [
            { no: 8, name: "brief_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BlossomBriefInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: BlossomBriefInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.briefInfoList.length; i++)
            BlossomBriefInfo.internalBinaryWrite(message.briefInfoList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
