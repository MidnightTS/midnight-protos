...
class RedeemLegendaryKeyRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("RedeemLegendaryKeyRsp", [
            { no: 6, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "legendary_key_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, legendaryKeyCount: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 6:
                    ...
                    break;
                case /* uint32 legendary_key_count */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.legendaryKeyCount !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.legendaryKeyCount);
...
/**
 * @generated MessageType for protobuf message RedeemLegendaryKeyRsp
 */
