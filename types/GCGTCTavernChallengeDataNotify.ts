...
// @generated from protobuf file "GCGTCTavernChallengeDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGTCTavernChallengeDataNotify
 */
export interface GCGTCTavernChallengeDataNotify {
    /**
     * @generated from protobuf field: repeated GCGTCTavernChallengeData tavern_challenge_list = 5;
     */
...
class GCGTCTavernChallengeDataNotify$Type extends MessageType<GCGTCTavernChallengeDataNotify> {
    constructor() {
        super("GCGTCTavernChallengeDataNotify", [
            { no: 5, name: "tavern_challenge_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GCGTCTavernChallengeData }
        ]);
    }
    ...
    internalBinaryWrite(message: GCGTCTavernChallengeDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.tavernChallengeList.length; i++)
            GCGTCTavernChallengeData.internalBinaryWrite(message.tavernChallengeList[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
