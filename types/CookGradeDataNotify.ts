...
// @generated from protobuf file "CookGradeDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface CookGradeDataNotify {
    /**
     * @generated from protobuf field: uint32 grade = 13;
     */
    grade: number;
}
...
class CookGradeDataNotify$Type extends MessageType<CookGradeDataNotify> {
    ...
    internalBinaryWrite(message: CookGradeDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 grade = 13; */
        if (message.grade !== 0)
            writer.tag(13, WireType.Varint).uint32(message.grade);
