...
export interface ChatInfo {
    ...
    time: number;
    /**
     * @generated from protobuf field: uint32 to_uid = 10;
     */
    toUid: number;
    /**
    ...
    uid: number;
    /**
     * @generated from protobuf field: uint32 sequence = 5;
     */
    sequence: number;
    /**
...
class ChatInfo$Type extends MessageType<ChatInfo> {
    ...
    internalBinaryWrite(message: ChatInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 to_uid = 10; */
        if (message.toUid !== 0)
            writer.tag(10, WireType.Varint).uint32(message.toUid);
        /* uint32 uid = 11; */
        if (message.uid !== 0)
            writer.tag(11, WireType.Varint).uint32(message.uid);
        /* uint32 sequence = 5; */
        if (message.sequence !== 0)
            writer.tag(5, WireType.Varint).uint32(message.sequence);
        /* string text = 909; */
