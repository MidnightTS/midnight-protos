...
// @generated from protobuf file "FinishMainCoopRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FinishMainCoopRsp
 */
export interface FinishMainCoopRsp {
    /**
     * @generated from protobuf field: uint32 ending_save_point_id = 4;
     */
...
class FinishMainCoopRsp$Type extends MessageType<FinishMainCoopRsp> {
    ...
    internalBinaryWrite(message: FinishMainCoopRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.endingSavePointId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.endingSavePointId);
        /* int32 retcode = 1; */
