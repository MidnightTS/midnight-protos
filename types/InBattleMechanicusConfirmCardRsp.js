...
class InBattleMechanicusConfirmCardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("InBattleMechanicusConfirmCardRsp", [
    ...
    create(value) {
        const message = { retcode: 0, groupId: 0, cardId: 0, playIndex: 0 };
...
/**
 * @generated MessageType for protobuf message InBattleMechanicusConfirmCardRsp
 */
