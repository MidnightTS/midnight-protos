...
// @generated from protobuf file "CoopPointUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CoopPointUpdateNotify
 */
export interface CoopPointUpdateNotify {
    /**
     * @generated from protobuf field: CoopPoint coop_point = 8;
     */
    coopPoint?: CoopPoint;
}
...
class CoopPointUpdateNotify$Type extends MessageType<CoopPointUpdateNotify> {
    constructor() {
        super("CoopPointUpdateNotify", [
            { no: 8, name: "coop_point", kind: "message", T: () => CoopPoint }
        ]);
    }
    ...
    internalBinaryWrite(message: CoopPointUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.coopPoint)
            CoopPoint.internalBinaryWrite(message.coopPoint, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
