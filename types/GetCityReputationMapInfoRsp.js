...
var _GetCityReputationMapInfoRsp_one_of_decls;
...
class GetCityReputationMapInfoRsp extends pb_1.Message {
    constructor(data) {
        super();
        _GetCityReputationMapInfoRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [9, 3], __classPrivateFieldGet(this, _GetCityReputationMapInfoRsp_one_of_decls, "f"));
...
exports.GetCityReputationMapInfoRsp = GetCityReputationMapInfoRsp;
_GetCityReputationMapInfoRsp_one_of_decls = new WeakMap();
