...
// @generated from protobuf file "CheckSegmentCRCReq.proto" (syntax proto3)
// tslint:disable
//
...
import { SegmentCRCInfo } from "./SegmentCRCInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message CheckSegmentCRCReq
 */
export interface CheckSegmentCRCReq {
    /**
     * @generated from protobuf field: repeated SegmentCRCInfo info_list = 4;
     */
...
class CheckSegmentCRCReq$Type extends MessageType<CheckSegmentCRCReq> {
    constructor() {
        super("CheckSegmentCRCReq", [
            { no: 4, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SegmentCRCInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: CheckSegmentCRCReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.infoList.length; i++)
            SegmentCRCInfo.internalBinaryWrite(message.infoList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
