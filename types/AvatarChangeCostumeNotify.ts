...
// @generated from protobuf file "AvatarChangeCostumeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarChangeCostumeNotify {
    /**
     * @generated from protobuf field: SceneEntityInfo entity_info = 11;
     */
...
class AvatarChangeCostumeNotify$Type extends MessageType<AvatarChangeCostumeNotify> {
    constructor() {
        super("AvatarChangeCostumeNotify", [
            { no: 11, name: "entity_info", kind: "message", T: () => SceneEntityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: AvatarChangeCostumeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.entityInfo)
            SceneEntityInfo.internalBinaryWrite(message.entityInfo, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
