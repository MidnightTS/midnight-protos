...
// @generated from protobuf file "DungeonCandidateTeamSetChangingAvatarReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonCandidateTeamSetChangingAvatarReq
 */
export interface DungeonCandidateTeamSetChangingAvatarReq {
    /**
     * @generated from protobuf field: bool is_changing_avatar = 11;
     */
...
class DungeonCandidateTeamSetChangingAvatarReq$Type extends MessageType<DungeonCandidateTeamSetChangingAvatarReq> {
    ...
    internalBinaryWrite(message: DungeonCandidateTeamSetChangingAvatarReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isChangingAvatar !== false)
            writer.tag(11, WireType.Varint).bool(message.isChangingAvatar);
