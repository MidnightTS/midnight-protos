...
exports.HomeAllUnlockedBgmIdListNotify = void 0;
...
class HomeAllUnlockedBgmIdListNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeAllUnlockedBgmIdListNotify", [
            { no: 14, name: "all_unlocked_bgm_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 all_unlocked_bgm_id_list */ 14:
...
/**
 * @generated MessageType for protobuf message HomeAllUnlockedBgmIdListNotify
 */
