...
export class PlantFlowerFriendFlowerWishData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get profile_picture() {
        return pb_1.Message.getWrapperField(this, dependency_1.ProfilePicture, 3) as dependency_1.ProfilePicture;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PlantFlowerFriendFlowerWishData {
    ...
    static deserializeBinary(bytes: Uint8Array): PlantFlowerFriendFlowerWishData {
