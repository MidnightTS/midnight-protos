...
class DropHintNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DropHintNotify", [
            ...
            { no: 9, name: "position", kind: "message", T: () => Vector_1.Vector }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Vector position = 9; */
        if (message.position)
            Vector_1.Vector.internalBinaryWrite(message.position, writer.tag(9, runtime_2.WireType.LengthDelimited).fork(), options).join();
