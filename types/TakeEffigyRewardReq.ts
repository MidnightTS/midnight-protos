...
// @generated from protobuf file "TakeEffigyRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeEffigyRewardReq
 */
export interface TakeEffigyRewardReq {
    /**
     * @generated from protobuf field: uint32 reward_index = 1;
     */
    rewardIndex: number;
}
...
class TakeEffigyRewardReq$Type extends MessageType<TakeEffigyRewardReq> {
    ...
    internalBinaryWrite(message: TakeEffigyRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardIndex !== 0)
            writer.tag(1, WireType.Varint).uint32(message.rewardIndex);
