...
export class AnnounceData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        count_down_text?: string;
        center_system_text?: string;
        count_down_frequency?: number;
        config_id?: number;
        begin_time?: number;
        center_system_frequency?: number;
        dungeon_confirm_text?: string;
        is_center_system_last5_every_minutes?: boolean;
        end_time?: number;
    }) {
        super();
    ...
    set count_down_text(value: string) {
        pb_1.Message.setField(this, 9, value);
    }
    get center_system_text() {
        return pb_1.Message.getFieldWithDefault(this, 8, "") as string;
    }
    set center_system_text(value: string) {
        pb_1.Message.setField(this, 8, value);
    }
    get count_down_frequency() {
        return pb_1.Message.getFieldWithDefault(this, 1, 0) as number;
    }
    set count_down_frequency(value: number) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AnnounceData {
    ...
    static deserializeBinary(bytes: Uint8Array): AnnounceData {
