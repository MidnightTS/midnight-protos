...
// @generated from protobuf file "GetParentQuestVideoKeyReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetParentQuestVideoKeyReq
 */
export interface GetParentQuestVideoKeyReq {
    /**
     * @generated from protobuf field: uint32 parent_quest_id = 13;
     */
...
class GetParentQuestVideoKeyReq$Type extends MessageType<GetParentQuestVideoKeyReq> {
    ...
    internalBinaryWrite(message: GetParentQuestVideoKeyReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.parentQuestId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.parentQuestId);
