...
class FoundationNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("FoundationNotify", [
            { no: 6, name: "info", kind: "message", T: () => FoundationInfo_1.FoundationInfo },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* FoundationInfo info */ 6:
                    message.info = FoundationInfo_1.FoundationInfo.internalBinaryRead(reader, reader.uint32(), options, message.info);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.info)
            FoundationInfo_1.FoundationInfo.internalBinaryWrite(message.info, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message FoundationNotify
 */
