...
export class PlayerLoginReq extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        Unk2700_NGKCNPKKIKB?: string;
        country_code?: string;
        psn_id?: string;
        Unk2700_GPPBEMDGEHH?: number;
        device_name?: string;
        cps?: string;
        login_rand?: number;
        target_home_param?: number;
    ...
    get reg_platform() {
        return pb_1.Message.getFieldWithDefault(this, 615, 0) as number;
    }
    set reg_platform(value: number) {
        pb_1.Message.setField(this, 615, value);
    }
    get tracking_io_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.TrackingIOInfo, 1660) as dependency_2.TrackingIOInfo;
    }
    ...
    get extra_bin_data() {
        return pb_1.Message.getFieldWithDefault(this, 1458, new Uint8Array()) as Uint8Array;
    }
    set extra_bin_data(value: Uint8Array) {
        pb_1.Message.setField(this, 1458, value);
    }
    get channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 1314, 0) as number;
    }
    set channel_id(value: number) {
        pb_1.Message.setField(this, 1314, value);
    }
    get client_data_version() {
        return pb_1.Message.getFieldWithDefault(this, 688, 0) as number;
    }
    ...
    get Unk2700_NGKCNPKKIKB() {
        return pb_1.Message.getFieldWithDefault(this, 772, "") as string;
    }
    set Unk2700_NGKCNPKKIKB(value: string) {
        pb_1.Message.setField(this, 772, value);
    }
    get country_code() {
        return pb_1.Message.getFieldWithDefault(this, 2000, "") as string;
    }
    set country_code(value: string) {
        pb_1.Message.setField(this, 2000, value);
    }
    get psn_id() {
        return pb_1.Message.getFieldWithDefault(this, 1268, "") as string;
    }
    set psn_id(value: string) {
        pb_1.Message.setField(this, 1268, value);
    }
    get Unk2700_GPPBEMDGEHH() {
        return pb_1.Message.getFieldWithDefault(this, 431, 0) as number;
    }
    set Unk2700_GPPBEMDGEHH(value: number) {
    ...
    get cps() {
        return pb_1.Message.getFieldWithDefault(this, 1163, "") as string;
    }
    ...
    get target_home_param() {
        return pb_1.Message.getFieldWithDefault(this, 984, 0) as number;
    }
    set target_home_param(value: number) {
        pb_1.Message.setField(this, 984, value);
    }
    get adjust_tracking_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.AdjustTrackingInfo, 1816) as dependency_1.AdjustTrackingInfo;
    }
    ...
    get is_transfer() {
        return pb_1.Message.getFieldWithDefault(this, 908, false) as boolean;
    }
    set is_transfer(value: boolean) {
        pb_1.Message.setField(this, 908, value);
    }
    get tag() {
        return pb_1.Message.getFieldWithDefault(this, 1787, 0) as number;
    }
    ...
    get environment_error_code() {
        return pb_1.Message.getFieldWithDefault(this, 2026, new Uint8Array()) as Uint8Array;
    }
    set environment_error_code(value: Uint8Array) {
        pb_1.Message.setField(this, 2026, value);
    }
    get online_id() {
        return pb_1.Message.getFieldWithDefault(this, 903, "") as string;
    }
    ...
    get checksum_client_version() {
        return pb_1.Message.getFieldWithDefault(this, 861, "") as string;
    }
    set checksum_client_version(value: string) {
        pb_1.Message.setField(this, 861, value);
    }
    get security_cmd_reply() {
        return pb_1.Message.getFieldWithDefault(this, 1995, new Uint8Array()) as Uint8Array;
    }
    set security_cmd_reply(value: Uint8Array) {
        pb_1.Message.setField(this, 1995, value);
    }
    get Unk2700_JNDKPBBCACB() {
        return pb_1.Message.getFieldWithDefault(this, 1213, "") as string;
    }
    set Unk2700_JNDKPBBCACB(value: string) {
        pb_1.Message.setField(this, 1213, value);
    }
    get birthday() {
        return pb_1.Message.getFieldWithDefault(this, 1652, "") as string;
    }
    ...
    get client_token() {
        return pb_1.Message.getFieldWithDefault(this, 1546, 0) as number;
    }
    set client_token(value: number) {
    ...
    get client_verison_hash() {
        return pb_1.Message.getFieldWithDefault(this, 1707, "") as string;
    }
    set client_verison_hash(value: string) {
        pb_1.Message.setField(this, 1707, value);
    }
    get checksum() {
        return pb_1.Message.getFieldWithDefault(this, 1532, "") as string;
    }
    ...
    get target_home_owner_uid() {
        return pb_1.Message.getFieldWithDefault(this, 1864, 0) as number;
    }
    set target_home_owner_uid(value: number) {
        pb_1.Message.setField(this, 1864, value);
    }
    get cloud_client_ip() {
        return pb_1.Message.getFieldWithDefault(this, 1335, 0) as number;
    }
    set cloud_client_ip(value: number) {
        pb_1.Message.setField(this, 1335, value);
    }
    get gm_uid() {
        return pb_1.Message.getFieldWithDefault(this, 612, 0) as number;
    }
    set gm_uid(value: number) {
