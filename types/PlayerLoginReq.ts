...
import * as dependency_1 from "./AdjustTrackingInfo";
import * as dependency_2 from "./TrackingIOInfo";
import * as pb_1 from "google-protobuf";
export class PlayerLoginReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        device_uuid?: string;
        target_uid?: number;
        extra_bin_data?: Uint8Array;
        platform?: string;
        checksum?: string;
        channel_id?: number;
        client_verison_hash?: string;
        language_type?: number;
        client_data_version?: number;
        account_type?: number;
        security_library_md5?: string;
        online_id?: string;
        Unk3300_PMGFBMJNNCL?: number;
        device_name?: string;
        birthday?: string;
        tag?: number;
        account_uid?: string;
        ...
        token?: string;
        reg_platform?: number;
        checksum_client_version?: string;
        Unk3300_OOBHAIIIPHH?: number;
        Unk3300_NDLANBEIGEG?: number;
        country_code?: string;
        Unk3300_PIPLDEAPMMN?: number;
        tracking_io_info?: dependency_2.TrackingIOInfo;
        is_transfer?: boolean;
        security_library_version?: string;
        client_version?: string;
        is_guest?: boolean;
        system_version?: string;
        target_home_owner_uid?: number;
        psn_id?: string;
        security_cmd_reply?: Uint8Array;
        Unk3300_OFFHPAFIFGD?: number;
        login_rand?: number;
        adjust_tracking_info?: dependency_1.AdjustTrackingInfo;
        environment_error_code?: Uint8Array;
    ...
    get extra_bin_data() {
        return pb_1.Message.getFieldWithDefault(this, 2046, new Uint8Array()) as Uint8Array;
    }
    set extra_bin_data(value: Uint8Array) {
    ...
    get checksum() {
        return pb_1.Message.getFieldWithDefault(this, 1334, "") as string;
    }
    set checksum(value: string) {
        pb_1.Message.setField(this, 1334, value);
    }
    get channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 1565, 0) as number;
    }
    ...
    set client_verison_hash(value: string) {
    ...
    get client_data_version() {
        return pb_1.Message.getFieldWithDefault(this, 847, 0) as number;
    }
    ...
    set account_type(value: number) {
        pb_1.Message.setField(this, 7, value);
    }
    get security_library_md5() {
        return pb_1.Message.getFieldWithDefault(this, 868, "") as string;
    }
    set security_library_md5(value: string) {
        pb_1.Message.setField(this, 868, value);
    }
    get online_id() {
        return pb_1.Message.getFieldWithDefault(this, 577, "") as string;
    }
    set online_id(value: string) {
        pb_1.Message.setField(this, 577, value);
    }
    get Unk3300_PMGFBMJNNCL() {
        return pb_1.Message.getFieldWithDefault(this, 82, 0) as number;
    }
    set Unk3300_PMGFBMJNNCL(value: number) {
    ...
    get birthday() {
        return pb_1.Message.getFieldWithDefault(this, 875, "") as string;
    }
    set birthday(value: string) {
        pb_1.Message.setField(this, 875, value);
    }
    get tag() {
        return pb_1.Message.getFieldWithDefault(this, 525, 0) as number;
    }
    ...
    get sub_channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 1458, 0) as number;
    }
    set sub_channel_id(value: number) {
    ...
    get reg_platform() {
        return pb_1.Message.getFieldWithDefault(this, 424, 0) as number;
    }
    set reg_platform(value: number) {
        pb_1.Message.setField(this, 424, value);
    }
    get checksum_client_version() {
        return pb_1.Message.getFieldWithDefault(this, 581, "") as string;
    }
    set checksum_client_version(value: string) {
        pb_1.Message.setField(this, 581, value);
    }
    get Unk3300_OOBHAIIIPHH() {
        return pb_1.Message.getFieldWithDefault(this, 85, 0) as number;
    }
    set Unk3300_OOBHAIIIPHH(value: number) {
        pb_1.Message.setField(this, 85, value);
    }
    get Unk3300_NDLANBEIGEG() {
        return pb_1.Message.getFieldWithDefault(this, 1320, 0) as number;
    }
    set Unk3300_NDLANBEIGEG(value: number) {
    ...
    get Unk3300_PIPLDEAPMMN() {
        return pb_1.Message.getFieldWithDefault(this, 1790, 0) as number;
    }
    set Unk3300_PIPLDEAPMMN(value: number) {
        pb_1.Message.setField(this, 1790, value);
    }
    get tracking_io_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.TrackingIOInfo, 1713) as dependency_2.TrackingIOInfo;
    }
    set tracking_io_info(value: dependency_2.TrackingIOInfo) {
    ...
    get is_transfer() {
        return pb_1.Message.getFieldWithDefault(this, 624, false) as boolean;
    }
    set is_transfer(value: boolean) {
        pb_1.Message.setField(this, 624, value);
    }
    get security_library_version() {
        return pb_1.Message.getFieldWithDefault(this, 828, "") as string;
    }
    set security_library_version(value: string) {
    ...
    set is_guest(value: boolean) {
        pb_1.Message.setField(this, 13, value);
    }
    get system_version() {
        return pb_1.Message.getFieldWithDefault(this, 6, "") as string;
    }
    set system_version(value: string) {
        pb_1.Message.setField(this, 6, value);
    }
    get target_home_owner_uid() {
        return pb_1.Message.getFieldWithDefault(this, 899, 0) as number;
    }
    set target_home_owner_uid(value: number) {
        pb_1.Message.setField(this, 899, value);
    }
    get psn_id() {
        return pb_1.Message.getFieldWithDefault(this, 1146, "") as string;
    }
    set psn_id(value: string) {
        pb_1.Message.setField(this, 1146, value);
    }
    get security_cmd_reply() {
        return pb_1.Message.getFieldWithDefault(this, 874, new Uint8Array()) as Uint8Array;
    }
    set security_cmd_reply(value: Uint8Array) {
        pb_1.Message.setField(this, 874, value);
    }
    get Unk3300_OFFHPAFIFGD() {
        return pb_1.Message.getFieldWithDefault(this, 1028, 0) as number;
    }
    set Unk3300_OFFHPAFIFGD(value: number) {
    ...
    get adjust_tracking_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.AdjustTrackingInfo, 64) as dependency_1.AdjustTrackingInfo;
    }
    set adjust_tracking_info(value: dependency_1.AdjustTrackingInfo) {
    ...
    get environment_error_code() {
        return pb_1.Message.getFieldWithDefault(this, 256, new Uint8Array()) as Uint8Array;
    }
    set environment_error_code(value: Uint8Array) {
    ...
    get cps() {
        return pb_1.Message.getFieldWithDefault(this, 1983, "") as string;
    }
    ...
    static fromObject(data: {
        ...
        country_code?: string;
        Unk3300_PIPLDEAPMMN?: number;
        tracking_io_info?: ReturnType<typeof dependency_2.TrackingIOInfo.prototype.toObject>;
        is_transfer?: boolean;
        security_library_version?: string;
        client_version?: string;
        is_guest?: boolean;
        ...
        Unk3300_OFFHPAFIFGD?: number;
        login_rand?: number;
        adjust_tracking_info?: ReturnType<typeof dependency_1.AdjustTrackingInfo.prototype.toObject>;
        environment_error_code?: Uint8Array;
        platform_type?: number;
        cps?: string;
    }): PlayerLoginReq {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PlayerLoginReq {
    ...
    static deserializeBinary(bytes: Uint8Array): PlayerLoginReq {
