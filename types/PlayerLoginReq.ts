...
export interface PlayerLoginReq {
    ...
    accountType: number;
    /**
     * @generated from protobuf field: string Unk3300_BBAABEHNFOE = 868 [json_name = "Unk3300BBAABEHNFOE"];
     */
    unk3300BBAABEHNFOE: string;
    /**
    ...
    deviceInfo: string;
    /**
     * @generated from protobuf field: uint32 Unk3300_IADFJHNFKIB = 1458 [json_name = "Unk3300IADFJHNFKIB"];
     */
    ...
    countryCode: string;
    /**
     * @generated from protobuf field: uint32 Unk3300_PIPLDEAPMMN = 1790 [json_name = "Unk3300PIPLDEAPMMN"];
     */
    ...
    isTransfer: boolean;
    /**
     * @generated from protobuf field: string Unk3300_BIAKNIALBFJ = 828 [json_name = "Unk3300BIAKNIALBFJ"];
     */
    unk3300BIAKNIALBFJ: string;
    /**
...
class PlayerLoginReq$Type extends MessageType<PlayerLoginReq> {
    ...
    internalBinaryWrite(message: PlayerLoginReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300BBAABEHNFOE !== "")
            writer.tag(868, WireType.LengthDelimited).string(message.unk3300BBAABEHNFOE);
        ...
        if (message.unk3300IADFJHNFKIB !== 0)
            writer.tag(1458, WireType.Varint).uint32(message.unk3300IADFJHNFKIB);
        /* bool is_editor = 1; */
        ...
        if (message.unk3300PIPLDEAPMMN !== 0)
            writer.tag(1790, WireType.Varint).uint32(message.unk3300PIPLDEAPMMN);
        ...
        if (message.unk3300BIAKNIALBFJ !== "")
            writer.tag(828, WireType.LengthDelimited).string(message.unk3300BIAKNIALBFJ);
