...
// @generated from protobuf file "SceneGalleryBalloonInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { BalloonPlayerInfo } from "./BalloonPlayerInfo";
/**
 * @generated from protobuf message SceneGalleryBalloonInfo
 */
export interface SceneGalleryBalloonInfo {
    /**
     * @generated from protobuf field: map<uint32, BalloonPlayerInfo> scene_player_balloon_info_map = 13;
     */
...
class SceneGalleryBalloonInfo$Type extends MessageType<SceneGalleryBalloonInfo> {
    constructor() {
        super("SceneGalleryBalloonInfo", [
            { no: 13, name: "scene_player_balloon_info_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => BalloonPlayerInfo } },
    ...
    private binaryReadMap13(map: SceneGalleryBalloonInfo["scenePlayerBalloonInfoMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
