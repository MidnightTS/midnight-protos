...
// @generated from protobuf file "GalleryBulletHitNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GalleryBulletHitNotify
 */
export interface GalleryBulletHitNotify {
    ...
    galleryId: number;
    /**
     * @generated from protobuf field: uint32 hit_count = 7;
     */
    hitCount: number;
}
...
class GalleryBulletHitNotify$Type extends MessageType<GalleryBulletHitNotify> {
    ...
    internalBinaryWrite(message: GalleryBulletHitNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hitCount !== 0)
            writer.tag(7, WireType.Varint).uint32(message.hitCount);
