...
var _ReliquaryPromoteRsp_one_of_decls;
...
class ReliquaryPromoteRsp extends pb_1.Message {
    constructor(data) {
        super();
        _ReliquaryPromoteRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [9, 8], __classPrivateFieldGet(this, _ReliquaryPromoteRsp_one_of_decls, "f"));
...
exports.ReliquaryPromoteRsp = ReliquaryPromoteRsp;
_ReliquaryPromoteRsp_one_of_decls = new WeakMap();
