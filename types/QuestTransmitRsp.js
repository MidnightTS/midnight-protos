...
class QuestTransmitRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("QuestTransmitRsp", [
            { no: 2, name: "quest_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 6, name: "point_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { questId: 0, retcode: 0, pointId: 0 };
...
/**
 * @generated MessageType for protobuf message QuestTransmitRsp
 */
