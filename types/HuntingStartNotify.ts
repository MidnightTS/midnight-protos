...
export class HuntingStartNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get hunting_pair() {
        return pb_1.Message.getWrapperField(this, dependency_1.HuntingPair, 3) as dependency_1.HuntingPair;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HuntingStartNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): HuntingStartNotify {
