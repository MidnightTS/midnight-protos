...
// @generated from protobuf file "MechanicusCandidateTeamCreateReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MechanicusCandidateTeamCreateReq
 */
export interface MechanicusCandidateTeamCreateReq {
    /**
     * @generated from protobuf field: uint32 difficult_level = 2;
     */
...
class MechanicusCandidateTeamCreateReq$Type extends MessageType<MechanicusCandidateTeamCreateReq> {
    ...
    internalBinaryWrite(message: MechanicusCandidateTeamCreateReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.difficultLevel !== 0)
            writer.tag(2, WireType.Varint).uint32(message.difficultLevel);
