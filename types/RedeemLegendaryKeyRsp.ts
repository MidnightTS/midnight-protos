...
// @generated from protobuf file "RedeemLegendaryKeyRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RedeemLegendaryKeyRsp
 */
export interface RedeemLegendaryKeyRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 legendary_key_count = 2;
     */
...
class RedeemLegendaryKeyRsp$Type extends MessageType<RedeemLegendaryKeyRsp> {
    ...
    internalBinaryWrite(message: RedeemLegendaryKeyRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.legendaryKeyCount !== 0)
            writer.tag(2, WireType.Varint).uint32(message.legendaryKeyCount);
