...
class StartBuoyantCombatGalleryRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("StartBuoyantCombatGalleryRsp", [
            { no: 6, name: "gallery_level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 12, name: "gallery_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { galleryLevel: 0, retcode: 0, galleryId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.galleryLevel !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.galleryLevel);
        /* int32 retcode = 5; */
...
/**
 * @generated MessageType for protobuf message StartBuoyantCombatGalleryRsp
 */
