...
// @generated from protobuf file "PlatformChangeRouteNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlatformChangeRouteNotify
 */
export interface PlatformChangeRouteNotify {
    /**
     * @generated from protobuf field: uint32 scene_time = 13;
     */
    sceneTime: number;
    /**
     * @generated from protobuf field: PlatformInfo platform = 14;
     */
...
class PlatformChangeRouteNotify$Type extends MessageType<PlatformChangeRouteNotify> {
    constructor() {
        super("PlatformChangeRouteNotify", [
            ...
            { no: 14, name: "platform", kind: "message", T: () => PlatformInfo },
    ...
    internalBinaryWrite(message: PlatformChangeRouteNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sceneTime !== 0)
            writer.tag(13, WireType.Varint).uint32(message.sceneTime);
        /* PlatformInfo platform = 14; */
        if (message.platform)
            PlatformInfo.internalBinaryWrite(message.platform, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 8; */
