...
// @generated from protobuf file "DeathZoneInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { DeathZoneInfo } from "./DeathZoneInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message DeathZoneInfoNotify
 */
export interface DeathZoneInfoNotify {
    /**
     * @generated from protobuf field: repeated DeathZoneInfo death_zone_info_list = 15;
     */
...
class DeathZoneInfoNotify$Type extends MessageType<DeathZoneInfoNotify> {
    constructor() {
        super("DeathZoneInfoNotify", [
            { no: 15, name: "death_zone_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DeathZoneInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: DeathZoneInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.deathZoneInfoList.length; i++)
            DeathZoneInfo.internalBinaryWrite(message.deathZoneInfoList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
