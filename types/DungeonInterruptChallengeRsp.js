...
var _DungeonInterruptChallengeRsp_one_of_decls;
...
class DungeonInterruptChallengeRsp extends pb_1.Message {
    constructor(data) {
        super();
        _DungeonInterruptChallengeRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DungeonInterruptChallengeRsp_one_of_decls, "f"));
...
exports.DungeonInterruptChallengeRsp = DungeonInterruptChallengeRsp;
_DungeonInterruptChallengeRsp_one_of_decls = new WeakMap();
