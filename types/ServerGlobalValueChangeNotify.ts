...
// @generated from protobuf file "ServerGlobalValueChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ServerGlobalValueChangeNotify
 */
export interface ServerGlobalValueChangeNotify {
    /**
     * @generated from protobuf field: uint32 key_hash = 3;
     */
    keyHash: number;
    /**
     * @generated from protobuf field: float value = 15;
     */
    value: number;
    /**
...
class ServerGlobalValueChangeNotify$Type extends MessageType<ServerGlobalValueChangeNotify> {
    ...
    internalBinaryWrite(message: ServerGlobalValueChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.keyHash !== 0)
            writer.tag(3, WireType.Varint).uint32(message.keyHash);
        /* float value = 15; */
        if (message.value !== 0)
            writer.tag(15, WireType.Bit32).float(message.value);
        /* uint32 entity_id = 7; */
