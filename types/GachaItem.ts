...
export interface GachaItem {
    /**
     * @generated from protobuf field: bool is_flash_card = 8;
     */
    isFlashCard: boolean;
    /**
    ...
    /**
     * @generated from protobuf field: bool is_gacha_item_new = 13;
     */
...
class GachaItem$Type extends MessageType<GachaItem> {
    ...
    internalBinaryWrite(message: GachaItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isGachaItemNew !== false)
            writer.tag(13, WireType.Varint).bool(message.isGachaItemNew);
