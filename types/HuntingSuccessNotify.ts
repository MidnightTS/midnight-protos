...
// @generated from protobuf file "HuntingSuccessNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HuntingSuccessNotify
 */
export interface HuntingSuccessNotify {
    /**
     * @generated from protobuf field: HuntingPair hunting_pair = 7;
     */
...
class HuntingSuccessNotify$Type extends MessageType<HuntingSuccessNotify> {
    constructor() {
        super("HuntingSuccessNotify", [
            { no: 7, name: "hunting_pair", kind: "message", T: () => HuntingPair }
        ]);
    }
    ...
    internalBinaryWrite(message: HuntingSuccessNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.huntingPair)
            HuntingPair.internalBinaryWrite(message.huntingPair, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
