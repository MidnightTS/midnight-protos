...
exports.DraftTwiceConfirmResultNotify = void 0;
...
class DraftTwiceConfirmResultNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DraftTwiceConfirmResultNotify", [
            { no: 14, name: "is_all_agree", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 1, name: "draft_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_all_agree */ 14:
                    message.isAllAgree = reader.bool();
                    break;
                case /* uint32 draft_id */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isAllAgree !== false)
            writer.tag(14, runtime_1.WireType.Varint).bool(message.isAllAgree);
        /* uint32 draft_id = 1; */
...
/**
 * @generated MessageType for protobuf message DraftTwiceConfirmResultNotify
 */
