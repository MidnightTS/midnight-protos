...
class BuoyantCombatDailyInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("BuoyantCombatDailyInfo", [
            { no: 5, name: "best_score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "start_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { bestScore: 0, startTime: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.startTime !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.startTime);
...
/**
 * @generated MessageType for protobuf message BuoyantCombatDailyInfo
 */
