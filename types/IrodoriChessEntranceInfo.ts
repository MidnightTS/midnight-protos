...
// @generated from protobuf file "IrodoriChessEntranceInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { IrodoriChessMonsterInfo } from "./IrodoriChessMonsterInfo";
/**
 * @generated from protobuf message IrodoriChessEntranceInfo
 */
export interface IrodoriChessEntranceInfo {
    /**
     * @generated from protobuf field: uint32 entrance_point_id = 11;
     */
    entrancePointId: number;
    /**
     * @generated from protobuf field: repeated IrodoriChessMonsterInfo monster_info_list = 8;
     */
...
class IrodoriChessEntranceInfo$Type extends MessageType<IrodoriChessEntranceInfo> {
    constructor() {
        super("IrodoriChessEntranceInfo", [
            ...
            { no: 8, name: "monster_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => IrodoriChessMonsterInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: IrodoriChessEntranceInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.entrancePointId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.entrancePointId);
        /* repeated IrodoriChessMonsterInfo monster_info_list = 8; */
        for (let i = 0; i < message.monsterInfoList.length; i++)
            IrodoriChessMonsterInfo.internalBinaryWrite(message.monsterInfoList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
