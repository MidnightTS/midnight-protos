...
// @generated from protobuf file "NicknameAuditConfigNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message NicknameAuditConfigNotify
 */
export interface NicknameAuditConfigNotify {
    /**
     * @generated from protobuf field: uint32 submit_limit = 3;
     */
    submitLimit: number;
    /**
...
class NicknameAuditConfigNotify$Type extends MessageType<NicknameAuditConfigNotify> {
    ...
    internalBinaryWrite(message: NicknameAuditConfigNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.submitLimit !== 0)
            writer.tag(3, WireType.Varint).uint32(message.submitLimit);
        /* bool is_open = 8; */
