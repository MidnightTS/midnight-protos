...
const BuoyantCombatGallerySettleInfo_1 = require("./BuoyantCombatGallerySettleInfo");
// @generated message type with reflection information, may provide speed optimized methods
class BuoyantCombatSettleInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("BuoyantCombatSettleInfo", [
            { no: 14, name: "settle_info", kind: "message", T: () => BuoyantCombatGallerySettleInfo_1.BuoyantCombatGallerySettleInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* BuoyantCombatGallerySettleInfo settle_info */ 14:
                    message.settleInfo = BuoyantCombatGallerySettleInfo_1.BuoyantCombatGallerySettleInfo.internalBinaryRead(reader, reader.uint32(), options, message.settleInfo);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.settleInfo)
            BuoyantCombatGallerySettleInfo_1.BuoyantCombatGallerySettleInfo.internalBinaryWrite(message.settleInfo, writer.tag(14, runtime_1.WireType.LengthDelimited).fork(), options).join();
