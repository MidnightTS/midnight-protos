...
exports.IrodoriChessUnequipCardReq = void 0;
...
class IrodoriChessUnequipCardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("IrodoriChessUnequipCardReq", [
            { no: 1, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "is_hard_map", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
        const message = { levelId: 0, cardId: 0, isHardMap: false };
...
/**
 * @generated MessageType for protobuf message IrodoriChessUnequipCardReq
 */
