...
exports.GCGDSCardProficiencyNotify = void 0;
...
class GCGDSCardProficiencyNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.proficiency !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.proficiency);
        /* uint32 card_id = 13; */
        if (message.cardId !== 0)
...
/**
 * @generated MessageType for protobuf message GCGDSCardProficiencyNotify
 */
