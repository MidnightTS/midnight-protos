...
// @generated from protobuf file "PSNBlackListNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PSNBlackListNotify
 */
export interface PSNBlackListNotify {
    /**
     * @generated from protobuf field: repeated FriendBrief psn_blacklist = 13;
     */
...
class PSNBlackListNotify$Type extends MessageType<PSNBlackListNotify> {
    constructor() {
        super("PSNBlackListNotify", [
            { no: 13, name: "psn_blacklist", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FriendBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: PSNBlackListNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.psnBlacklist.length; i++)
            FriendBrief.internalBinaryWrite(message.psnBlacklist[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
