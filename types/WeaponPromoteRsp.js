...
class WeaponPromoteRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("WeaponPromoteRsp", [
            { no: 4, name: "old_promote_level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "target_weapon_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "cur_promote_level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { oldPromoteLevel: 0, targetWeaponGuid: 0n, curPromoteLevel: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.oldPromoteLevel !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.oldPromoteLevel);
        ...
        if (message.curPromoteLevel !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.curPromoteLevel);
        /* int32 retcode = 8; */
