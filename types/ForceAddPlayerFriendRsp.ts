...
// @generated from protobuf file "ForceAddPlayerFriendRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ForceAddPlayerFriendRsp
 */
export interface ForceAddPlayerFriendRsp {
    /**
     * @generated from protobuf field: FriendBrief target_friend_brief = 3;
     */
...
class ForceAddPlayerFriendRsp$Type extends MessageType<ForceAddPlayerFriendRsp> {
    constructor() {
        super("ForceAddPlayerFriendRsp", [
            { no: 3, name: "target_friend_brief", kind: "message", T: () => FriendBrief },
    ...
    internalBinaryWrite(message: ForceAddPlayerFriendRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetFriendBrief)
            FriendBrief.internalBinaryWrite(message.targetFriendBrief, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 13; */
