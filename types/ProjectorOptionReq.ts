...
// @generated from protobuf file "ProjectorOptionReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ProjectorOptionReq
 */
export interface ProjectorOptionReq {
    /**
     * @generated from protobuf field: uint32 op_type = 2;
     */
    opType: number;
    /**
...
class ProjectorOptionReq$Type extends MessageType<ProjectorOptionReq> {
    ...
    internalBinaryWrite(message: ProjectorOptionReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 op_type = 2; */
        if (message.opType !== 0)
            writer.tag(2, WireType.Varint).uint32(message.opType);
        /* uint32 entity_id = 8; */
