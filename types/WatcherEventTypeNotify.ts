...
// @generated from protobuf file "WatcherEventTypeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message WatcherEventTypeNotify
 */
export interface WatcherEventTypeNotify {
    ...
    paramList: number[];
    /**
     * @generated from protobuf field: uint32 add_progress = 13;
     */
    addProgress: number;
    /**
     * @generated from protobuf field: uint32 watcher_trigger_type = 2;
     */
...
class WatcherEventTypeNotify$Type extends MessageType<WatcherEventTypeNotify> {
    ...
    internalBinaryWrite(message: WatcherEventTypeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.addProgress !== 0)
            writer.tag(13, WireType.Varint).uint32(message.addProgress);
        /* uint32 watcher_trigger_type = 2; */
        if (message.watcherTriggerType !== 0)
            writer.tag(2, WireType.Varint).uint32(message.watcherTriggerType);
