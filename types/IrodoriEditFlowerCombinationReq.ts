...
// @generated from protobuf file "IrodoriEditFlowerCombinationReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriEditFlowerCombinationReq
 */
export interface IrodoriEditFlowerCombinationReq {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: CustomGadgetTreeInfo combination_info = 12;
     */
...
class IrodoriEditFlowerCombinationReq$Type extends MessageType<IrodoriEditFlowerCombinationReq> {
    constructor() {
        super("IrodoriEditFlowerCombinationReq", [
            ...
            { no: 12, name: "combination_info", kind: "message", T: () => CustomGadgetTreeInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: IrodoriEditFlowerCombinationReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.combinationInfo)
            CustomGadgetTreeInfo.internalBinaryWrite(message.combinationInfo, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
