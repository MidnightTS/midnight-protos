...
exports.NightCrowGadgetObservationMatchReq = void 0;
...
class NightCrowGadgetObservationMatchReq$Type extends runtime_5.MessageType {
    constructor() {
        super("NightCrowGadgetObservationMatchReq", [
            { no: 7, name: "gadget_entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "target_gadget_state", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { gadgetEntityId: 0, targetGadgetState: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 gadget_entity_id */ 7:
                    ...
                    break;
                case /* uint32 target_gadget_state */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.targetGadgetState !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.targetGadgetState);
...
/**
 * @generated MessageType for protobuf message NightCrowGadgetObservationMatchReq
 */
