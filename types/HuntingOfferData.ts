...
// @generated from protobuf file "HuntingOfferData.proto" (syntax proto3)
// tslint:disable
//
...
import { HuntingOfferState } from "./HuntingOfferState";
import { HuntingPair } from "./HuntingPair";
/**
 * @generated from protobuf message HuntingOfferData
 */
export interface HuntingOfferData {
    /**
     * @generated from protobuf field: HuntingPair hunting_pair = 15;
     */
    huntingPair?: HuntingPair;
    /**
     * @generated from protobuf field: HuntingOfferState state = 1;
     */
...
class HuntingOfferData$Type extends MessageType<HuntingOfferData> {
    constructor() {
        super("HuntingOfferData", [
            ...
            { no: 1, name: "state", kind: "enum", T: () => ["HuntingOfferState", HuntingOfferState, "HUNTING_OFFER_STATE_"] },
