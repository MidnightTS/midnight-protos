...
// @generated from protobuf file "cmd_region_search.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class RegionSearchInfo$Type extends MessageType<RegionSearchInfo> {
    constructor() {
        super("com.midnights.game.RegionSearchInfo", [
            ...
            { no: 1, name: "region_search_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RegionSearch },
...
class RegionSearchNotify$Type extends MessageType<RegionSearchNotify> {
    constructor() {
        super("com.midnights.game.RegionSearchNotify", [
            { no: 1, name: "region_search_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RegionSearchInfo },
