...
class SetPlayerBirthdayRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SetPlayerBirthdayRsp", [
            { no: 1, name: "birthday", kind: "message", T: () => Birthday_1.Birthday },
    ...
    internalBinaryWrite(message, writer, options) {
        /* Birthday birthday = 1; */
        if (message.birthday)
            Birthday_1.Birthday.internalBinaryWrite(message.birthday, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 4; */
