...
exports.GCGDSChangeCurDeckRsp = void 0;
...
class GCGDSChangeCurDeckRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSChangeCurDeckRsp", [
            { no: 6, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "deck_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, deckId: 0 };
...
/**
 * @generated MessageType for protobuf message GCGDSChangeCurDeckRsp
 */
