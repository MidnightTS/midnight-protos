...
// @generated from protobuf file "BuyGoodsReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface BuyGoodsReq {
    /**
     * @generated from protobuf field: uint32 shop_type = 9;
     */
    shopType: number;
    /**
     * @generated from protobuf field: ShopGoods goods = 10;
     */
    goods?: ShopGoods;
    /**
...
class BuyGoodsReq$Type extends MessageType<BuyGoodsReq> {
    constructor() {
        super("BuyGoodsReq", [
            ...
            { no: 10, name: "goods", kind: "message", T: () => ShopGoods },
    ...
    internalBinaryWrite(message: BuyGoodsReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.shopType !== 0)
            writer.tag(9, WireType.Varint).uint32(message.shopType);
        /* ShopGoods goods = 10; */
        if (message.goods)
            ShopGoods.internalBinaryWrite(message.goods, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* uint32 buy_count = 13; */
