...
class HomeResource$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeResource", [
            { no: 6, name: "store_limit", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "next_refresh_time", kind: "scalar", T: 7 /*ScalarType.FIXED32*/ },
            { no: 1, name: "store_value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { storeLimit: 0, nextRefreshTime: 0, storeValue: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.storeLimit !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.storeLimit);
        ...
        if (message.storeValue !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.storeValue);
