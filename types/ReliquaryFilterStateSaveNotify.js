...
exports.ReliquaryFilterStateSaveNotify = void 0;
...
class ReliquaryFilterStateSaveNotify$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.reliquaryFilterStateMap))
            writer.tag(4, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_1.WireType.Varint).uint32(message.reliquaryFilterStateMap[k]).join();
 ...
 */
exports.ReliquaryFilterStateSaveNotify = new ReliquaryFilterStateSaveNotify$Type();
