...
// @generated from protobuf file "RockBoardExploreDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { RockBoardExploreStageData } from "./RockBoardExploreStageData";
/**
 * @generated from protobuf message RockBoardExploreDetailInfo
 */
export interface RockBoardExploreDetailInfo {
    /**
     * @generated from protobuf field: repeated RockBoardExploreStageData stage_data_list = 13;
     */
...
class RockBoardExploreDetailInfo$Type extends MessageType<RockBoardExploreDetailInfo> {
    constructor() {
        super("RockBoardExploreDetailInfo", [
            { no: 13, name: "stage_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RockBoardExploreStageData }
        ]);
    }
    ...
    internalBinaryWrite(message: RockBoardExploreDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.stageDataList.length; i++)
            RockBoardExploreStageData.internalBinaryWrite(message.stageDataList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
