...
export class SumoSelectTeamAndEnterDungeonReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get team_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.SumoTeamData, 10) as dependency_1.SumoTeamData[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.team_list.length)
            writer.writeRepeatedMessage(10, this.team_list, (item: dependency_1.SumoTeamData) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SumoSelectTeamAndEnterDungeonReq {
    ...
    static deserializeBinary(bytes: Uint8Array): SumoSelectTeamAndEnterDungeonReq {
