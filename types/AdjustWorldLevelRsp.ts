...
// @generated from protobuf file "AdjustWorldLevelRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AdjustWorldLevelRsp
 */
export interface AdjustWorldLevelRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 after_world_level = 11;
     */
    afterWorldLevel: number;
    /**
     * @generated from protobuf field: uint32 cd_over_time = 5;
     */
    cdOverTime: number;
}
...
class AdjustWorldLevelRsp$Type extends MessageType<AdjustWorldLevelRsp> {
    ...
    internalBinaryWrite(message: AdjustWorldLevelRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.afterWorldLevel !== 0)
            writer.tag(11, WireType.Varint).uint32(message.afterWorldLevel);
        /* uint32 cd_over_time = 5; */
        if (message.cdOverTime !== 0)
            writer.tag(5, WireType.Varint).uint32(message.cdOverTime);
