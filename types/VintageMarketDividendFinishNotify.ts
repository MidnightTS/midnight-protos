...
// @generated from protobuf file "VintageMarketDividendFinishNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintageMarketDividendFinishNotify
 */
export interface VintageMarketDividendFinishNotify {
    /**
     * @generated from protobuf field: uint32 coin_a = 2;
     */
    coinA: number;
    /**
     * @generated from protobuf field: uint32 coin_c = 14;
     */
    coinC: number;
}
...
class VintageMarketDividendFinishNotify$Type extends MessageType<VintageMarketDividendFinishNotify> {
    ...
    internalBinaryWrite(message: VintageMarketDividendFinishNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 coin_a = 2; */
        if (message.coinA !== 0)
            writer.tag(2, WireType.Varint).uint32(message.coinA);
        /* uint32 coin_c = 14; */
        if (message.coinC !== 0)
            writer.tag(14, WireType.Varint).uint32(message.coinC);
