...
// @generated from protobuf file "MonsterAIConfigHashNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MonsterAIConfigHashNotify
 */
export interface MonsterAIConfigHashNotify {
    /**
     * @generated from protobuf field: int32 hash_value = 7;
     */
    hashValue: number;
    /**
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 job_id = 11;
     */
    jobId: number;
}
...
class MonsterAIConfigHashNotify$Type extends MessageType<MonsterAIConfigHashNotify> {
    ...
    internalBinaryWrite(message: MonsterAIConfigHashNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hashValue !== 0)
            writer.tag(7, WireType.Varint).int32(message.hashValue);
        /* uint32 entity_id = 14; */
        if (message.entityId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.entityId);
        /* uint32 job_id = 11; */
        if (message.jobId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.jobId);
