...
// @generated from protobuf file "HomeAvatarTalkReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeAvatarTalkReq
 */
export interface HomeAvatarTalkReq {
    /**
     * @generated from protobuf field: uint32 talk_id = 10;
     */
    talkId: number;
    /**
...
class HomeAvatarTalkReq$Type extends MessageType<HomeAvatarTalkReq> {
    ...
    internalBinaryWrite(message: HomeAvatarTalkReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 talk_id = 10; */
        if (message.talkId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.talkId);
        /* uint32 avatar_id = 5; */
