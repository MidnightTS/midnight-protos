...
// @generated from protobuf file "MassiveEntityStateChangedNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { MassiveEntityState } from "./MassiveEntityState";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message MassiveEntityStateChangedNotify
 */
export interface MassiveEntityStateChangedNotify {
    /**
     * @generated from protobuf field: repeated MassiveEntityState massive_entity_state_list = 14;
     */
...
class MassiveEntityStateChangedNotify$Type extends MessageType<MassiveEntityStateChangedNotify> {
    constructor() {
        super("MassiveEntityStateChangedNotify", [
            { no: 14, name: "massive_entity_state_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MassiveEntityState }
        ]);
    }
    ...
    internalBinaryWrite(message: MassiveEntityStateChangedNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.massiveEntityStateList.length; i++)
            MassiveEntityState.internalBinaryWrite(message.massiveEntityStateList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
