...
// @generated from protobuf file "GetReunionSignInInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetReunionSignInInfoRsp
 */
export interface GetReunionSignInInfoRsp {
    /**
     * @generated from protobuf field: ReunionSignInInfo sign_in_info = 2;
     */
...
class GetReunionSignInInfoRsp$Type extends MessageType<GetReunionSignInInfoRsp> {
    constructor() {
        super("GetReunionSignInInfoRsp", [
            { no: 2, name: "sign_in_info", kind: "message", T: () => ReunionSignInInfo },
    ...
    internalBinaryWrite(message: GetReunionSignInInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.signInInfo)
            ReunionSignInInfo.internalBinaryWrite(message.signInInfo, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 13; */
