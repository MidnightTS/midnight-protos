...
class DraftOwnerStartInviteReq$Type extends runtime_5.MessageType {
    constructor() {
        super("DraftOwnerStartInviteReq", [
            { no: 14, name: "draft_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { draftId: 0 };
...
/**
 * @generated MessageType for protobuf message DraftOwnerStartInviteReq
 */
