...
// @generated from protobuf file "OfferingInteractRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message OfferingInteractRsp
 */
export interface OfferingInteractRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: PlayerOfferingData offering_data = 4;
     */
...
class OfferingInteractRsp$Type extends MessageType<OfferingInteractRsp> {
    constructor() {
        super("OfferingInteractRsp", [
            ...
            { no: 4, name: "offering_data", kind: "message", T: () => PlayerOfferingData }
        ]);
    }
    ...
    internalBinaryWrite(message: OfferingInteractRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.offeringData)
            PlayerOfferingData.internalBinaryWrite(message.offeringData, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
