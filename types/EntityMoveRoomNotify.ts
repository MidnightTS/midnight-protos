...
// @generated from protobuf file "EntityMoveRoomNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EntityMoveRoomNotify
 */
export interface EntityMoveRoomNotify {
    /**
     * @generated from protobuf field: uint32 dest_room_id = 1;
     */
    destRoomId: number;
    /**
...
class EntityMoveRoomNotify$Type extends MessageType<EntityMoveRoomNotify> {
    ...
    internalBinaryWrite(message: EntityMoveRoomNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.destRoomId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.destRoomId);
        /* uint32 entity_id = 4; */
