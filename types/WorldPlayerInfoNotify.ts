...
// @generated from protobuf file "WorldPlayerInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface WorldPlayerInfoNotify {
    /**
     * @generated from protobuf field: repeated PlayerWidgetInfo player_widget_info_list = 7;
     */
    playerWidgetInfoList: PlayerWidgetInfo[];
    /**
     * @generated from protobuf field: repeated uint32 player_uid_list = 12;
     */
    playerUidList: number[];
    /**
     * @generated from protobuf field: repeated OnlinePlayerInfo player_info_list = 15;
     */
...
class WorldPlayerInfoNotify$Type extends MessageType<WorldPlayerInfoNotify> {
    constructor() {
        super("WorldPlayerInfoNotify", [
            { no: 7, name: "player_widget_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlayerWidgetInfo },
            { no: 12, name: "player_uid_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 15, name: "player_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => OnlinePlayerInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WorldPlayerInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.playerWidgetInfoList.length; i++)
            PlayerWidgetInfo.internalBinaryWrite(message.playerWidgetInfoList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        ...
        for (let i = 0; i < message.playerInfoList.length; i++)
            OnlinePlayerInfo.internalBinaryWrite(message.playerInfoList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
