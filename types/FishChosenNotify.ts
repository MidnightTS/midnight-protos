...
// @generated from protobuf file "FishChosenNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FishChosenNotify
 */
export interface FishChosenNotify {
    /**
     * @generated from protobuf field: uint32 fish_id = 4;
     */
    fishId: number;
}
...
class FishChosenNotify$Type extends MessageType<FishChosenNotify> {
    ...
    internalBinaryWrite(message: FishChosenNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 fish_id = 4; */
        if (message.fishId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.fishId);
