...
import * as dependency_1 from "./EvtFaceToDirInfo";
import * as dependency_2 from "./ForwardType";
import * as pb_1 from "google-protobuf";
export class EvtFaceToDirNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        forward_type?: dependency_2.ForwardType;
        evt_face_to_dir_info?: dependency_1.EvtFaceToDirInfo;
    }) {
        super();
    ...
    get forward_type() {
        return pb_1.Message.getFieldWithDefault(this, 13, dependency_2.ForwardType.FORWARD_TYPE_LOCAL) as dependency_2.ForwardType;
    }
    set forward_type(value: dependency_2.ForwardType) {
        pb_1.Message.setField(this, 13, value);
    }
    get evt_face_to_dir_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.EvtFaceToDirInfo, 5) as dependency_1.EvtFaceToDirInfo;
    }
    set evt_face_to_dir_info(value: dependency_1.EvtFaceToDirInfo) {
    ...
    static fromObject(data: {
        forward_type?: dependency_2.ForwardType;
        evt_face_to_dir_info?: ReturnType<typeof dependency_1.EvtFaceToDirInfo.prototype.toObject>;
    }): EvtFaceToDirNotify {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): EvtFaceToDirNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): EvtFaceToDirNotify {
