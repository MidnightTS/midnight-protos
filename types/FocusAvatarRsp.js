...
class FocusAvatarRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("FocusAvatarRsp", [
            { no: 2, name: "is_focus", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
    ...
    create(value) {
        const message = { isFocus: false, avatarGuid: 0n, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isFocus !== false)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.isFocus);
...
/**
 * @generated MessageType for protobuf message FocusAvatarRsp
 */
