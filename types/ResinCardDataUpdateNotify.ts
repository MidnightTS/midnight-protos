...
// @generated from protobuf file "ResinCardDataUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { ResinCardData } from "./ResinCardData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message ResinCardDataUpdateNotify
 */
export interface ResinCardDataUpdateNotify {
    /**
     * @generated from protobuf field: uint32 today_start_time = 4;
     */
    todayStartTime: number;
    /**
     * @generated from protobuf field: repeated ResinCardData card_data_list = 14;
     */
...
class ResinCardDataUpdateNotify$Type extends MessageType<ResinCardDataUpdateNotify> {
    constructor() {
        super("ResinCardDataUpdateNotify", [
            ...
            { no: 14, name: "card_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ResinCardData }
        ]);
    }
    ...
    internalBinaryWrite(message: ResinCardDataUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.todayStartTime !== 0)
            writer.tag(4, WireType.Varint).uint32(message.todayStartTime);
        /* repeated ResinCardData card_data_list = 14; */
        for (let i = 0; i < message.cardDataList.length; i++)
            ResinCardData.internalBinaryWrite(message.cardDataList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
