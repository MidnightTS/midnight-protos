...
exports.AvatarDelNotify = void 0;
...
class AvatarDelNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("AvatarDelNotify", [
            { no: 6, name: "avatar_guid_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint64 avatar_guid_list */ 6:
...
/**
 * @generated MessageType for protobuf message AvatarDelNotify
 */
