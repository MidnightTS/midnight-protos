...
class AvatarExpeditionStartRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("AvatarExpeditionStartRsp", [
            ...
            { no: 8, name: "expedition_info_map", kind: "map", K: 4 /*ScalarType.UINT64*/, V: { kind: "message", T: () => AvatarExpeditionInfo_1.AvatarExpeditionInfo } }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 4:
                    ...
                    break;
                case /* map<uint64, AvatarExpeditionInfo> expedition_info_map */ 8:
                    this.binaryReadMap8(message.expeditionInfoMap, reader, options);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.expeditionInfoMap)) {
            writer.tag(8, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.Varint).uint64(k);
