...
// @generated from protobuf file "HomeSeekFurnitureAllRecord.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message HomeSeekFurnitureAllRecord
 */
export interface HomeSeekFurnitureAllRecord {
    /**
     * @generated from protobuf field: repeated HomeSeekFurnitureOneRecord record_list = 9;
     */
...
class HomeSeekFurnitureAllRecord$Type extends MessageType<HomeSeekFurnitureAllRecord> {
    constructor() {
        super("HomeSeekFurnitureAllRecord", [
            { no: 9, name: "record_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeSeekFurnitureOneRecord }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeSeekFurnitureAllRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.recordList.length; i++)
            HomeSeekFurnitureOneRecord.internalBinaryWrite(message.recordList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
