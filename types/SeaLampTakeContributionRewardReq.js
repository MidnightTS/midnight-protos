...
class SeaLampTakeContributionRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("SeaLampTakeContributionRewardReq", [
            { no: 15, name: "config_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "activity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { configId: 0, activityId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.configId !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.configId);
...
/**
 * @generated MessageType for protobuf message SeaLampTakeContributionRewardReq
 */
