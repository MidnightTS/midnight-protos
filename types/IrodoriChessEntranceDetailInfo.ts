...
// @generated from protobuf file "IrodoriChessEntranceDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { IrodoriChessEntranceInfo } from "./IrodoriChessEntranceInfo";
/**
 * @generated from protobuf message IrodoriChessEntranceDetailInfo
 */
export interface IrodoriChessEntranceDetailInfo {
    /**
     * @generated from protobuf field: repeated IrodoriChessEntranceInfo info_list = 14;
     */
...
class IrodoriChessEntranceDetailInfo$Type extends MessageType<IrodoriChessEntranceDetailInfo> {
    constructor() {
        super("IrodoriChessEntranceDetailInfo", [
            { no: 14, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => IrodoriChessEntranceInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: IrodoriChessEntranceDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.infoList.length; i++)
            IrodoriChessEntranceInfo.internalBinaryWrite(message.infoList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
