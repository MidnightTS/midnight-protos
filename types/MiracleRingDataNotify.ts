...
export interface MiracleRingDataNotify {
    ...
    /**
     * @generated from protobuf field: uint32 miracle_ring_cd = 9;
     */
    miracleRingCd: number;
    /**
     * @generated from protobuf field: uint32 last_deliver_item_time = 8;
     */
...
class MiracleRingDataNotify$Type extends MessageType<MiracleRingDataNotify> {
    ...
    internalBinaryWrite(message: MiracleRingDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.miracleRingCd !== 0)
            writer.tag(9, WireType.Varint).uint32(message.miracleRingCd);
        /* uint32 last_deliver_item_time = 8; */
        if (message.lastDeliverItemTime !== 0)
            writer.tag(8, WireType.Varint).uint32(message.lastDeliverItemTime);
