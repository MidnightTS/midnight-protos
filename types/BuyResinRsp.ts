...
// @generated from protobuf file "BuyResinRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BuyResinRsp
 */
export interface BuyResinRsp {
    /**
     * @generated from protobuf field: uint32 cur_value = 7;
     */
    curValue: number;
    /**
...
class BuyResinRsp$Type extends MessageType<BuyResinRsp> {
    ...
    internalBinaryWrite(message: BuyResinRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curValue !== 0)
            writer.tag(7, WireType.Varint).uint32(message.curValue);
        /* int32 retcode = 13; */
