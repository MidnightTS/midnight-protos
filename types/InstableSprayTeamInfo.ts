...
// @generated from protobuf file "InstableSprayTeamInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message InstableSprayTeamInfo
 */
export interface InstableSprayTeamInfo {
    /**
     * @generated from protobuf field: repeated InstableSprayAvatarInfo avatar_info_list = 5;
     */
...
class InstableSprayTeamInfo$Type extends MessageType<InstableSprayTeamInfo> {
    constructor() {
        super("InstableSprayTeamInfo", [
            { no: 5, name: "avatar_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => InstableSprayAvatarInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: InstableSprayTeamInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.avatarInfoList.length; i++)
            InstableSprayAvatarInfo.internalBinaryWrite(message.avatarInfoList[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
