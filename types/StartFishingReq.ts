...
// @generated from protobuf file "StartFishingReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StartFishingReq
 */
export interface StartFishingReq {
    /**
     * @generated from protobuf field: uint32 fish_pool_id = 2;
     */
    fishPoolId: number;
    /**
     * @generated from protobuf field: uint32 rod_entity_id = 6;
     */
    rodEntityId: number;
}
...
class StartFishingReq$Type extends MessageType<StartFishingReq> {
    ...
    internalBinaryWrite(message: StartFishingReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fishPoolId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.fishPoolId);
        /* uint32 rod_entity_id = 6; */
        if (message.rodEntityId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.rodEntityId);
