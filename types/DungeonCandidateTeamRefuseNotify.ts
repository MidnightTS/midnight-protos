...
// @generated from protobuf file "DungeonCandidateTeamRefuseNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonCandidateTeamRefuseNotify
 */
export interface DungeonCandidateTeamRefuseNotify {
    /**
     * @generated from protobuf field: uint32 player_uid = 8;
     */
    playerUid: number;
}
...
class DungeonCandidateTeamRefuseNotify$Type extends MessageType<DungeonCandidateTeamRefuseNotify> {
    ...
    internalBinaryWrite(message: DungeonCandidateTeamRefuseNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.playerUid !== 0)
            writer.tag(8, WireType.Varint).uint32(message.playerUid);
