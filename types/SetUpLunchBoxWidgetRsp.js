...
exports.SetUpLunchBoxWidgetRsp = void 0;
...
class SetUpLunchBoxWidgetRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SetUpLunchBoxWidgetRsp", [
            ...
            { no: 2, name: "lunch_box_data", kind: "message", T: () => LunchBoxData_1.LunchBoxData }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.lunchBoxData)
            LunchBoxData_1.LunchBoxData.internalBinaryWrite(message.lunchBoxData, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
