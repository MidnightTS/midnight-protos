...
export interface AbilityMetaUpdateBaseReactionDamage {
    /**
     * @generated from protobuf field: uint32 reaction_type = 2;
     */
    reactionType: number;
    /**
     * @generated from protobuf field: uint32 source_caster_id = 13;
     */
...
class AbilityMetaUpdateBaseReactionDamage$Type extends MessageType<AbilityMetaUpdateBaseReactionDamage> {
    ...
    internalBinaryWrite(message: AbilityMetaUpdateBaseReactionDamage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reactionType !== 0)
            writer.tag(2, WireType.Varint).uint32(message.reactionType);
        /* uint32 source_caster_id = 13; */
        if (message.sourceCasterId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.sourceCasterId);
