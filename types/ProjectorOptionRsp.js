...
class ProjectorOptionRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ProjectorOptionRsp", [
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 1, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "op_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, entityId: 0, opType: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 op_type = 14; */
        if (message.opType !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.opType);
...
/**
 * @generated MessageType for protobuf message ProjectorOptionRsp
 */
