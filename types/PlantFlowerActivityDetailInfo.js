...
var _PlantFlowerActivityDetailInfo_one_of_decls;
...
class PlantFlowerActivityDetailInfo extends pb_1.Message {
    constructor(data) {
        super();
        _PlantFlowerActivityDetailInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PlantFlowerActivityDetailInfo_one_of_decls, "f"));
    ...
    set wish_flower_num_map(value) {
        pb_1.Message.setField(this, 10, value);
    }
    get today_seed_reward_id() {
        return pb_1.Message.getFieldWithDefault(this, 11, 0);
    }
    set today_seed_reward_id(value) {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 3:
                    ...
                    break;
                case 10:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.wish_flower_num_map, reader, reader.readUint32, reader.readUint32));
                    break;
                case 11:
                ...
                case 13:
                    ...
                    break;
                case 7:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.used_flower_num_map, reader, reader.readUint32, reader.readUint32));
                    break;
...
exports.PlantFlowerActivityDetailInfo = PlantFlowerActivityDetailInfo;
_PlantFlowerActivityDetailInfo_one_of_decls = new WeakMap();
