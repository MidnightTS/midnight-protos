...
// @generated from protobuf file "WorldPlayerRTTNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { PlayerRTTInfo } from "./PlayerRTTInfo";
/**
 * enum CmdId {
...
export interface WorldPlayerRTTNotify {
    /**
     * @generated from protobuf field: repeated PlayerRTTInfo player_rtt_list = 6;
     */
...
class WorldPlayerRTTNotify$Type extends MessageType<WorldPlayerRTTNotify> {
    constructor() {
        super("WorldPlayerRTTNotify", [
            { no: 6, name: "player_rtt_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlayerRTTInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WorldPlayerRTTNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.playerRttList.length; i++)
            PlayerRTTInfo.internalBinaryWrite(message.playerRttList[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
