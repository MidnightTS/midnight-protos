...
exports.HomeFurnitureArrangementMuipData = void 0;
...
class HomeFurnitureArrangementMuipData$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Vector spawn_rot = 3; */
        if (message.spawnRot)
            Vector_1.Vector.internalBinaryWrite(message.spawnRot, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message HomeFurnitureArrangementMuipData
 */
