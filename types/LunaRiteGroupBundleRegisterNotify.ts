...
// @generated from protobuf file "LunaRiteGroupBundleRegisterNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LunaRiteGroupBundleRegisterNotify
 */
export interface LunaRiteGroupBundleRegisterNotify {
    /**
     * @generated from protobuf field: uint32 group_link_bundle_id = 7;
     */
...
class LunaRiteGroupBundleRegisterNotify$Type extends MessageType<LunaRiteGroupBundleRegisterNotify> {
    ...
    internalBinaryWrite(message: LunaRiteGroupBundleRegisterNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.groupLinkBundleId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.groupLinkBundleId);
