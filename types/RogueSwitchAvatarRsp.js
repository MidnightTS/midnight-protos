...
var _RogueSwitchAvatarRsp_one_of_decls;
...
class RogueSwitchAvatarRsp extends pb_1.Message {
    constructor(data) {
        super();
        _RogueSwitchAvatarRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [8, 9], __classPrivateFieldGet(this, _RogueSwitchAvatarRsp_one_of_decls, "f"));
...
exports.RogueSwitchAvatarRsp = RogueSwitchAvatarRsp;
_RogueSwitchAvatarRsp_one_of_decls = new WeakMap();
