...
// @generated from protobuf file "cmd_draft.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class DraftOwnerStartInviteRsp$Type extends MessageType<DraftOwnerStartInviteRsp> {
    constructor() {
        super("com.midnights.game.DraftOwnerStartInviteRsp", [
            { no: 15, name: "invite_fail_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DraftInviteFailInfo },
