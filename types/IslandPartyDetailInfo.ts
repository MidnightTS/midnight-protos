...
// @generated from protobuf file "IslandPartyDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { IslandPartyStageData } from "./IslandPartyStageData";
/**
 * @generated from protobuf message IslandPartyDetailInfo
 */
export interface IslandPartyDetailInfo {
    /**
     * @generated from protobuf field: repeated IslandPartyStageData stage_data_list = 9;
     */
...
class IslandPartyDetailInfo$Type extends MessageType<IslandPartyDetailInfo> {
    constructor() {
        super("IslandPartyDetailInfo", [
            { no: 9, name: "stage_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => IslandPartyStageData }
        ]);
    }
    ...
    internalBinaryWrite(message: IslandPartyDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.stageDataList.length; i++)
            IslandPartyStageData.internalBinaryWrite(message.stageDataList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
