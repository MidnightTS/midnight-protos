...
// @generated from protobuf file "MusicGameRecord.proto" (syntax proto3)
// tslint:disable
//
...
export interface MusicGameRecord {
    /**
     * @generated from protobuf field: bool is_unlock = 3;
     */
    isUnlock: boolean;
    /**
     * @generated from protobuf field: uint32 max_combo = 14;
     */
    maxCombo: number;
    /**
...
class MusicGameRecord$Type extends MessageType<MusicGameRecord> {
    ...
    internalBinaryWrite(message: MusicGameRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isUnlock !== false)
            writer.tag(3, WireType.Varint).bool(message.isUnlock);
        /* uint32 max_combo = 14; */
        if (message.maxCombo !== 0)
            writer.tag(14, WireType.Varint).uint32(message.maxCombo);
        /* uint32 max_score = 7; */
