...
// @generated from protobuf file "PlayerEnterDungeonReq.proto" (syntax proto3)
// tslint:disable
//
...
import { DungeonEnterPosInfo } from "./DungeonEnterPosInfo";
/**
 * enum CmdId {
...
export interface PlayerEnterDungeonReq {
    ...
    dungeonId: number;
    /**
     * @generated from protobuf field: DungeonEnterPosInfo enter_pos_info = 9;
     */
...
class PlayerEnterDungeonReq$Type extends MessageType<PlayerEnterDungeonReq> {
    constructor() {
        super("PlayerEnterDungeonReq", [
            ...
            { no: 9, name: "enter_pos_info", kind: "message", T: () => DungeonEnterPosInfo },
    ...
    internalBinaryWrite(message: PlayerEnterDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.enterPosInfo)
            DungeonEnterPosInfo.internalBinaryWrite(message.enterPosInfo, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* uint32 point_id = 1; */
