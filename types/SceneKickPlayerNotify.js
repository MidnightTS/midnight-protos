...
var _SceneKickPlayerNotify_one_of_decls;
...
class SceneKickPlayerNotify extends pb_1.Message {
    constructor(data) {
        super();
        _SceneKickPlayerNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SceneKickPlayerNotify_one_of_decls, "f"));
...
exports.SceneKickPlayerNotify = SceneKickPlayerNotify;
_SceneKickPlayerNotify_one_of_decls = new WeakMap();
