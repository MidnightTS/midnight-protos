...
export interface RegionalPlayVar {
    ...
    type: number;
    /**
     * @generated from protobuf field: float Unk3300_FOBMHHNIPPH = 4 [json_name = "Unk3300FOBMHHNIPPH"];
     */
    unk3300FOBMHHNIPPH: number;
    /**
     * @generated from protobuf field: float Unk3300_PIDHFABKIJN = 3 [json_name = "Unk3300PIDHFABKIJN"];
     */
    unk3300PIDHFABKIJN: number;
    /**
...
class RegionalPlayVar$Type extends MessageType<RegionalPlayVar> {
    ...
    internalBinaryWrite(message: RegionalPlayVar, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300FOBMHHNIPPH !== 0)
            writer.tag(4, WireType.Bit32).float(message.unk3300FOBMHHNIPPH);
        /* float Unk3300_PIDHFABKIJN = 3 [json_name = "Unk3300PIDHFABKIJN"]; */
        if (message.unk3300PIDHFABKIJN !== 0)
            writer.tag(3, WireType.Bit32).float(message.unk3300PIDHFABKIJN);
        /* float value = 2; */
        if (message.value !== 0)
