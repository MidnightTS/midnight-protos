...
// @generated from protobuf file "TanukiTravelLevelData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message TanukiTravelLevelData
 */
export interface TanukiTravelLevelData {
    ...
    isOpen: boolean;
    /**
     * @generated from protobuf field: uint32 route_id = 8;
     */
    routeId: number;
}
...
class TanukiTravelLevelData$Type extends MessageType<TanukiTravelLevelData> {
    ...
    internalBinaryWrite(message: TanukiTravelLevelData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.routeId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.routeId);
