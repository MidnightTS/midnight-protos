...
// @generated from protobuf file "StartCoopPointReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StartCoopPointReq
 */
export interface StartCoopPointReq {
    /**
     * @generated from protobuf field: uint32 coop_point = 4;
     */
    coopPoint: number;
}
...
class StartCoopPointReq$Type extends MessageType<StartCoopPointReq> {
    ...
    internalBinaryWrite(message: StartCoopPointReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.coopPoint !== 0)
            writer.tag(4, WireType.Varint).uint32(message.coopPoint);
