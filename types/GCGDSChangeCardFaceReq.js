...
exports.GCGDSChangeCardFaceReq = void 0;
...
class GCGDSChangeCardFaceReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSChangeCardFaceReq", [
            { no: 9, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "face_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.faceType !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.faceType);
...
/**
 * @generated MessageType for protobuf message GCGDSChangeCardFaceReq
 */
