...
// @generated from protobuf file "ProudSkillUpgradeRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ProudSkillUpgradeRsp
 */
export interface ProudSkillUpgradeRsp {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: uint32 proud_skill_id = 15;
     */
    proudSkillId: number;
    /**
...
class ProudSkillUpgradeRsp$Type extends MessageType<ProudSkillUpgradeRsp> {
    ...
    internalBinaryWrite(message: ProudSkillUpgradeRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.proudSkillId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.proudSkillId);
        /* int32 retcode = 13; */
