...
// @generated from protobuf file "PlayerChatReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface PlayerChatReq {
    /**
     * @generated from protobuf field: uint32 channel_id = 3;
     */
    channelId: number;
    /**
     * @generated from protobuf field: ChatInfo chat_info = 9;
     */
    chatInfo?: ChatInfo;
}
...
class PlayerChatReq$Type extends MessageType<PlayerChatReq> {
    constructor() {
        super("PlayerChatReq", [
            ...
            { no: 9, name: "chat_info", kind: "message", T: () => ChatInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerChatReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chatInfo)
            ChatInfo.internalBinaryWrite(message.chatInfo, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
