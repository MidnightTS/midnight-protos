...
// @generated from protobuf file "MistTrialSelectAvatarAndEnterDungeonRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MistTrialSelectAvatarAndEnterDungeonRsp
 */
export interface MistTrialSelectAvatarAndEnterDungeonRsp {
    /**
     * @generated from protobuf field: uint32 trial_id = 2;
     */
    trialId: number;
    /**
...
class MistTrialSelectAvatarAndEnterDungeonRsp$Type extends MessageType<MistTrialSelectAvatarAndEnterDungeonRsp> {
    ...
    internalBinaryWrite(message: MistTrialSelectAvatarAndEnterDungeonRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.trialId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.trialId);
        /* int32 retcode = 7; */
