...
exports.GachaActivityCreateRobotRsp = void 0;
...
class GachaActivityCreateRobotRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GachaActivityCreateRobotRsp", [
            { no: 15, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 11, name: "robot_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, robotId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.robotId !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.robotId);
...
/**
 * @generated MessageType for protobuf message GachaActivityCreateRobotRsp
 */
