...
// @generated from protobuf file "DraftInviteResultNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DraftInviteResultNotify
 */
export interface DraftInviteResultNotify {
    ...
    isAllAgree: boolean;
    /**
     * @generated from protobuf field: uint32 draft_id = 12;
     */
    draftId: number;
}
...
class DraftInviteResultNotify$Type extends MessageType<DraftInviteResultNotify> {
    ...
    internalBinaryWrite(message: DraftInviteResultNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.draftId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.draftId);
