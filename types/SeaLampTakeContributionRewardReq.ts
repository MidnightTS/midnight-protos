...
// @generated from protobuf file "SeaLampTakeContributionRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SeaLampTakeContributionRewardReq
 */
export interface SeaLampTakeContributionRewardReq {
    /**
     * @generated from protobuf field: uint32 config_id = 15;
     */
    configId: number;
    /**
...
class SeaLampTakeContributionRewardReq$Type extends MessageType<SeaLampTakeContributionRewardReq> {
    ...
    internalBinaryWrite(message: SeaLampTakeContributionRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.configId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.configId);
