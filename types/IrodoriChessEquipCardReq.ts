...
// @generated from protobuf file "IrodoriChessEquipCardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriChessEquipCardReq
 */
export interface IrodoriChessEquipCardReq {
    /**
     * @generated from protobuf field: bool is_hard_map = 8;
     */
    isHardMap: boolean;
    /**
...
class IrodoriChessEquipCardReq$Type extends MessageType<IrodoriChessEquipCardReq> {
    ...
    internalBinaryWrite(message: IrodoriChessEquipCardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isHardMap !== false)
            writer.tag(8, WireType.Varint).bool(message.isHardMap);
        /* uint32 level_id = 1; */
