...
// @generated from protobuf file "GCGMsgModifyAdd.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgModifyAdd
 */
export interface GCGMsgModifyAdd {
    /**
     * @generated from protobuf field: uint32 owner_card_guid = 11;
     */
    ownerCardGuid: number;
    /**
     * @generated from protobuf field: uint32 pos = 9;
     */
    pos: number;
    /**
     * @generated from protobuf field: repeated uint32 card_guid_list = 3;
     */
    cardGuidList: number[];
    /**
    ...
    controllerId: number;
    /**
     * @generated from protobuf field: GCGReason reason = 15;
     */
    reason: GCGReason;
}
...
class GCGMsgModifyAdd$Type extends MessageType<GCGMsgModifyAdd> {
    constructor() {
        super("GCGMsgModifyAdd", [
            ...
            { no: 15, name: "reason", kind: "enum", T: () => ["GCGReason", GCGReason] }
        ]);
    }
