...
// @generated from protobuf file "EnterIrodoriChessDungeonRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EnterIrodoriChessDungeonRsp
 */
export interface EnterIrodoriChessDungeonRsp {
    /**
     * @generated from protobuf field: bool is_hard_map = 5;
     */
    isHardMap: boolean;
    /**
...
class EnterIrodoriChessDungeonRsp$Type extends MessageType<EnterIrodoriChessDungeonRsp> {
    ...
    internalBinaryWrite(message: EnterIrodoriChessDungeonRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isHardMap !== false)
            writer.tag(5, WireType.Varint).bool(message.isHardMap);
        /* uint32 level_id = 15; */
