...
exports.AvatarBuffDelNotify = void 0;
...
class AvatarBuffDelNotify$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { buffId: 0, avatarGuid: 0n };
...
/**
 * @generated MessageType for protobuf message AvatarBuffDelNotify
 */
