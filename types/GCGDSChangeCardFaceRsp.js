...
exports.GCGDSChangeCardFaceRsp = void 0;
...
class GCGDSChangeCardFaceRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSChangeCardFaceRsp", [
            { no: 9, name: "face_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 8, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { faceType: 0, retcode: 0, cardId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.faceType !== 0)
            writer.tag(9, runtime_1.WireType.Varint).uint32(message.faceType);
        /* int32 retcode = 5; */
...
/**
 * @generated MessageType for protobuf message GCGDSChangeCardFaceRsp
 */
