...
class ChessMonsterInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("ChessMonsterInfo", [
            { no: 9, name: "monster_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.monsterId !== 0)
            writer.tag(9, runtime_2.WireType.Varint).uint32(message.monsterId);
        /* uint32 level = 15; */
        if (message.level !== 0)
...
/**
 * @generated MessageType for protobuf message ChessMonsterInfo
 */
