...
exports.ToTheMoonRemoveObstacleRsp = void 0;
...
class ToTheMoonRemoveObstacleRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ToTheMoonRemoveObstacleRsp", [
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 12, name: "dynamic_nodes", kind: "message", T: () => DynamicNodes_1.DynamicNodes },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 14:
                    ...
                    break;
                case /* DynamicNodes dynamic_nodes */ 12:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.dynamicNodes)
            DynamicNodes_1.DynamicNodes.internalBinaryWrite(message.dynamicNodes, writer.tag(12, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 query_id = 5; */
...
/**
 * @generated MessageType for protobuf message ToTheMoonRemoveObstacleRsp
 */
