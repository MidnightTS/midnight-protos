...
// @generated from protobuf file "GCGMsgSelectOnStage.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgSelectOnStage
 */
export interface GCGMsgSelectOnStage {
    /**
     * @generated from protobuf field: GCGReason reason = 11;
     */
    reason: GCGReason;
    /**
...
class GCGMsgSelectOnStage$Type extends MessageType<GCGMsgSelectOnStage> {
    constructor() {
        super("GCGMsgSelectOnStage", [
            { no: 11, name: "reason", kind: "enum", T: () => ["GCGReason", GCGReason] },
