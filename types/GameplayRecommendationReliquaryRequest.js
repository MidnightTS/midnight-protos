...
exports.GameplayRecommendationReliquaryRequest = void 0;
...
class GameplayRecommendationReliquaryRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("GameplayRecommendationReliquaryRequest", [
            { no: 9, name: "equip_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { equipType: 0 };
...
/**
 * @generated MessageType for protobuf message GameplayRecommendationReliquaryRequest
 */
