...
class ServerTimeNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ServerTimeNotify", [
            { no: 13, name: "server_time", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.serverTime !== 0n)
            writer.tag(13, runtime_1.WireType.Varint).uint64(message.serverTime);
