...
class GalleryFlowerCatchNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GalleryFlowerCatchNotify", [
            { no: 13, name: "gallery_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "cur_score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "add_score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { galleryId: 0, curScore: 0, addScore: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.addScore !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.addScore);
...
/**
 * @generated MessageType for protobuf message GalleryFlowerCatchNotify
 */
