...
// @generated from protobuf file "PullRecentChatRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface PullRecentChatRsp {
    /**
     * @generated from protobuf field: repeated ChatInfo chat_info = 13;
     */
    chatInfo: ChatInfo[];
    /**
...
class PullRecentChatRsp$Type extends MessageType<PullRecentChatRsp> {
    constructor() {
        super("PullRecentChatRsp", [
            { no: 13, name: "chat_info", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ChatInfo },
    ...
    internalBinaryWrite(message: PullRecentChatRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.chatInfo.length; i++)
            ChatInfo.internalBinaryWrite(message.chatInfo[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 11; */
