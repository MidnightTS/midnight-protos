...
// @generated from protobuf file "ScenePlayGuestReplyInviteReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ScenePlayGuestReplyInviteReq
 */
export interface ScenePlayGuestReplyInviteReq {
    /**
     * @generated from protobuf field: bool is_agree = 7;
     */
    isAgree: boolean;
    /**
...
class ScenePlayGuestReplyInviteReq$Type extends MessageType<ScenePlayGuestReplyInviteReq> {
    ...
    internalBinaryWrite(message: ScenePlayGuestReplyInviteReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAgree !== false)
            writer.tag(7, WireType.Varint).bool(message.isAgree);
        /* uint32 play_id = 4; */
        if (message.playId !== 0)
