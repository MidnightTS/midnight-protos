...
// @generated from protobuf file "PlayerApplyEnterHomeResultReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerApplyEnterHomeResultReq
 */
export interface PlayerApplyEnterHomeResultReq {
    /**
     * @generated from protobuf field: uint32 apply_uid = 9;
     */
    applyUid: number;
    /**
...
class PlayerApplyEnterHomeResultReq$Type extends MessageType<PlayerApplyEnterHomeResultReq> {
    ...
    internalBinaryWrite(message: PlayerApplyEnterHomeResultReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.applyUid !== 0)
            writer.tag(9, WireType.Varint).uint32(message.applyUid);
        /* bool is_agreed = 2; */
