...
// @generated from protobuf file "GCGSettleOptionRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGSettleOptionRsp
 */
export interface GCGSettleOptionRsp {
    /**
     * @generated from protobuf field: GCGSettleOption option = 2;
     */
...
class GCGSettleOptionRsp$Type extends MessageType<GCGSettleOptionRsp> {
    constructor() {
        super("GCGSettleOptionRsp", [
            { no: 2, name: "option", kind: "enum", T: () => ["GCGSettleOption", GCGSettleOption] },
