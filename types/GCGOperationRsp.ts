...
// @generated from protobuf file "GCGOperationRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGOperationRsp
 */
export interface GCGOperationRsp {
    /**
     * @generated from protobuf field: uint32 op_seq = 8;
     */
    opSeq: number;
    /**
...
class GCGOperationRsp$Type extends MessageType<GCGOperationRsp> {
    ...
    internalBinaryWrite(message: GCGOperationRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 op_seq = 8; */
        if (message.opSeq !== 0)
            writer.tag(8, WireType.Varint).uint32(message.opSeq);
        /* int32 retcode = 7; */
