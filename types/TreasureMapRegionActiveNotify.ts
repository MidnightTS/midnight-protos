...
// @generated from protobuf file "TreasureMapRegionActiveNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TreasureMapRegionActiveNotify
 */
export interface TreasureMapRegionActiveNotify {
    /**
     * @generated from protobuf field: uint32 active_region_index = 5;
     */
...
class TreasureMapRegionActiveNotify$Type extends MessageType<TreasureMapRegionActiveNotify> {
    ...
    internalBinaryWrite(message: TreasureMapRegionActiveNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.activeRegionIndex !== 0)
            writer.tag(5, WireType.Varint).uint32(message.activeRegionIndex);
