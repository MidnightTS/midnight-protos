...
// @generated from protobuf file "OpenBlossomCircleCampGuideNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message OpenBlossomCircleCampGuideNotify
 */
export interface OpenBlossomCircleCampGuideNotify {
    /**
     * @generated from protobuf field: uint32 refresh_id = 8;
     */
    refreshId: number;
    /**
     * @generated from protobuf field: repeated uint32 circle_camp_id_list = 6;
     */
...
class OpenBlossomCircleCampGuideNotify$Type extends MessageType<OpenBlossomCircleCampGuideNotify> {
    ...
    internalBinaryWrite(message: OpenBlossomCircleCampGuideNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.refreshId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.refreshId);
