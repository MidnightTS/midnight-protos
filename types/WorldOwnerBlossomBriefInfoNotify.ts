...
// @generated from protobuf file "WorldOwnerBlossomBriefInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message WorldOwnerBlossomBriefInfoNotify
 */
export interface WorldOwnerBlossomBriefInfoNotify {
    /**
     * @generated from protobuf field: repeated BlossomBriefInfo brief_info_list = 14;
     */
...
class WorldOwnerBlossomBriefInfoNotify$Type extends MessageType<WorldOwnerBlossomBriefInfoNotify> {
    constructor() {
        super("WorldOwnerBlossomBriefInfoNotify", [
            { no: 14, name: "brief_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BlossomBriefInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WorldOwnerBlossomBriefInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.briefInfoList.length; i++)
            BlossomBriefInfo.internalBinaryWrite(message.briefInfoList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
