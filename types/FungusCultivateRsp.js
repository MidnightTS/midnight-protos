...
exports.FungusCultivateRsp = void 0;
...
class FungusCultivateRsp$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { retcode: 0, cultivateId: 0, isNewRecord: false };
...
/**
 * @generated MessageType for protobuf message FungusCultivateRsp
 */
