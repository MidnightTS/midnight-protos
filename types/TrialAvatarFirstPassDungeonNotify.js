...
class TrialAvatarFirstPassDungeonNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("TrialAvatarFirstPassDungeonNotify", [
            { no: 1, name: "trial_avatar_index_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 trial_avatar_index_id */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.trialAvatarIndexId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.trialAvatarIndexId);
