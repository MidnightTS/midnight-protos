...
// @generated from protobuf file "PotionDungeonAvatar.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message PotionDungeonAvatar
 */
export interface PotionDungeonAvatar {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: bool is_trial = 1;
     */
    isTrial: boolean;
}
...
class PotionDungeonAvatar$Type extends MessageType<PotionDungeonAvatar> {
    ...
    internalBinaryWrite(message: PotionDungeonAvatar, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isTrial !== false)
            writer.tag(1, WireType.Varint).bool(message.isTrial);
