...
// @generated from protobuf file "GCGDSChangeCardFaceRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSChangeCardFaceRsp
 */
export interface GCGDSChangeCardFaceRsp {
    /**
     * @generated from protobuf field: uint32 face_type = 9;
     */
    faceType: number;
    /**
...
class GCGDSChangeCardFaceRsp$Type extends MessageType<GCGDSChangeCardFaceRsp> {
    ...
    internalBinaryWrite(message: GCGDSChangeCardFaceRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.faceType !== 0)
            writer.tag(9, WireType.Varint).uint32(message.faceType);
        /* int32 retcode = 5; */
