...
// @generated from protobuf file "GCGDSCardBackUnlockNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSCardBackUnlockNotify
 */
export interface GCGDSCardBackUnlockNotify {
    /**
     * @generated from protobuf field: uint32 card_back_id = 13;
     */
    cardBackId: number;
}
...
class GCGDSCardBackUnlockNotify$Type extends MessageType<GCGDSCardBackUnlockNotify> {
    ...
    internalBinaryWrite(message: GCGDSCardBackUnlockNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cardBackId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.cardBackId);
