...
// @generated from protobuf file "FungusRenameRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FungusRenameRsp
 */
export interface FungusRenameRsp {
    /**
     * @generated from protobuf field: uint32 fungus_id = 1;
     */
    fungusId: number;
    /**
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 name_id = 6;
     */
    nameId: number;
}
...
class FungusRenameRsp$Type extends MessageType<FungusRenameRsp> {
    ...
    internalBinaryWrite(message: FungusRenameRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fungusId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.fungusId);
        /* int32 retcode = 7; */
        if (message.retcode !== 0)
            writer.tag(7, WireType.Varint).int32(message.retcode);
        /* uint32 name_id = 6; */
        if (message.nameId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.nameId);
