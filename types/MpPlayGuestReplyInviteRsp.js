...
class MpPlayGuestReplyInviteRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("MpPlayGuestReplyInviteRsp", [
            { no: 7, name: "mp_play_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { mpPlayId: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.mpPlayId !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.mpPlayId);
        /* int32 retcode = 2; */
...
/**
 * @generated MessageType for protobuf message MpPlayGuestReplyInviteRsp
 */
