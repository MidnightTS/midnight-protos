...
var _WeekendDjinnInfo_one_of_decls;
...
class WeekendDjinnInfo extends pb_1.Message {
    constructor(data) {
        super();
        _WeekendDjinnInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _WeekendDjinnInfo_one_of_decls, "f"));
    ...
    static fromObject(data) {
        const message = new WeekendDjinnInfo({});
        if (data.rot != null) {
    ...
    static deserialize(bytes) {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new WeekendDjinnInfo();
    ...
    static deserializeBinary(bytes) {
        return WeekendDjinnInfo.deserialize(bytes);
    }
}
exports.WeekendDjinnInfo = WeekendDjinnInfo;
_WeekendDjinnInfo_one_of_decls = new WeakMap();
