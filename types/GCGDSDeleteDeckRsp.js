...
exports.GCGDSDeleteDeckRsp = void 0;
...
class GCGDSDeleteDeckRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSDeleteDeckRsp", [
            { no: 14, name: "deck_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { deckId: 0, retcode: 0 };
...
/**
 * @generated MessageType for protobuf message GCGDSDeleteDeckRsp
 */
