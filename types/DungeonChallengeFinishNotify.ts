...
import * as dependency_2 from "./CustomDungeonResultInfo";
import * as dependency_3 from "./EffigyChallengeDungeonResultInfo";
import * as dependency_4 from "./PotionDungeonResultInfo";
import * as dependency_5 from "./StrengthenPointData";
import * as dependency_6 from "./Unk2700_FHOKHHBGPEG";
import * as pb_1 from "google-protobuf";
export class DungeonChallengeFinishNotify extends pb_1.Message {
    #one_of_decls: number[][] = [[1521, 1627, 1824, 1664]];
    constructor(data?: any[] | ({
        strengthen_point_data_map?: Map<number, dependency_5.StrengthenPointData>;
        Unk2700_ONCDLPDHFAB?: dependency_6.Unk2700_FHOKHHBGPEG;
        ...
        potion_dungeon_result_info?: never;
        custom_dungeon_result_info?: never;
    } | {
        channeller_slab_loop_dungeon_result_info?: never;
        effigy_challenge_dungeon_result_info?: dependency_3.EffigyChallengeDungeonResultInfo;
        potion_dungeon_result_info?: never;
        custom_dungeon_result_info?: never;
    } | {
        channeller_slab_loop_dungeon_result_info?: never;
        effigy_challenge_dungeon_result_info?: never;
        potion_dungeon_result_info?: dependency_4.PotionDungeonResultInfo;
        custom_dungeon_result_info?: never;
    } | {
        channeller_slab_loop_dungeon_result_info?: never;
        effigy_challenge_dungeon_result_info?: never;
        potion_dungeon_result_info?: never;
        custom_dungeon_result_info?: dependency_2.CustomDungeonResultInfo;
    })))) {
        super();
    ...
    get strengthen_point_data_map() {
        return pb_1.Message.getField(this, 13) as any as Map<number, dependency_5.StrengthenPointData>;
    }
    set strengthen_point_data_map(value: Map<number, dependency_5.StrengthenPointData>) {
        pb_1.Message.setField(this, 13, value as any);
    }
    get Unk2700_ONCDLPDHFAB() {
        return pb_1.Message.getFieldWithDefault(this, 9, dependency_6.Unk2700_FHOKHHBGPEG.Unk2700_FHOKHHBGPEG_NONE) as dependency_6.Unk2700_FHOKHHBGPEG;
    }
    set Unk2700_ONCDLPDHFAB(value: dependency_6.Unk2700_FHOKHHBGPEG) {
    ...
    get channeller_slab_loop_dungeon_result_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.ChannelerSlabLoopDungeonResultInfo, 1521) as dependency_1.ChannelerSlabLoopDungeonResultInfo;
    }
    set channeller_slab_loop_dungeon_result_info(value: dependency_1.ChannelerSlabLoopDungeonResultInfo) {
        pb_1.Message.setOneofWrapperField(this, 1521, this.#one_of_decls[0], value);
    }
    ...
    get effigy_challenge_dungeon_result_info() {
        return pb_1.Message.getWrapperField(this, dependency_3.EffigyChallengeDungeonResultInfo, 1627) as dependency_3.EffigyChallengeDungeonResultInfo;
    }
    set effigy_challenge_dungeon_result_info(value: dependency_3.EffigyChallengeDungeonResultInfo) {
        pb_1.Message.setOneofWrapperField(this, 1627, this.#one_of_decls[0], value);
    }
    get has_effigy_challenge_dungeon_result_info() {
        return pb_1.Message.getField(this, 1627) != null;
    }
    get potion_dungeon_result_info() {
        return pb_1.Message.getWrapperField(this, dependency_4.PotionDungeonResultInfo, 1824) as dependency_4.PotionDungeonResultInfo;
    }
    set potion_dungeon_result_info(value: dependency_4.PotionDungeonResultInfo) {
        pb_1.Message.setOneofWrapperField(this, 1824, this.#one_of_decls[0], value);
    }
    get has_potion_dungeon_result_info() {
        return pb_1.Message.getField(this, 1824) != null;
    }
    get custom_dungeon_result_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.CustomDungeonResultInfo, 1664) as dependency_2.CustomDungeonResultInfo;
    }
    set custom_dungeon_result_info(value: dependency_2.CustomDungeonResultInfo) {
        pb_1.Message.setOneofWrapperField(this, 1664, this.#one_of_decls[0], value);
    }
    ...
    get detail() {
        const cases: {
            [index: number]: "none" | "channeller_slab_loop_dungeon_result_info" | "effigy_challenge_dungeon_result_info" | "potion_dungeon_result_info" | "custom_dungeon_result_info";
        } = {
            0: "none",
    ...
    static fromObject(data: {
        strengthen_point_data_map?: {
            [key: number]: ReturnType<typeof dependency_5.StrengthenPointData.prototype.toObject>;
        };
        Unk2700_ONCDLPDHFAB?: dependency_6.Unk2700_FHOKHHBGPEG;
        is_new_record?: boolean;
        challenge_record_type?: number;
        ...
        effigy_challenge_dungeon_result_info?: ReturnType<typeof dependency_3.EffigyChallengeDungeonResultInfo.prototype.toObject>;
        potion_dungeon_result_info?: ReturnType<typeof dependency_4.PotionDungeonResultInfo.prototype.toObject>;
        custom_dungeon_result_info?: ReturnType<typeof dependency_2.CustomDungeonResultInfo.prototype.toObject>;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DungeonChallengeFinishNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): DungeonChallengeFinishNotify {
