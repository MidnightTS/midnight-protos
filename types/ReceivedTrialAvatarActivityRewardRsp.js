...
exports.ReceivedTrialAvatarActivityRewardRsp = void 0;
...
class ReceivedTrialAvatarActivityRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ReceivedTrialAvatarActivityRewardRsp", [
            { no: 6, name: "activity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 10, name: "trial_avatar_index_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { activityId: 0, retcode: 0, trialAvatarIndexId: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 retcode */ 8:
                    ...
                    break;
                case /* uint32 trial_avatar_index_id */ 10:
...
/**
 * @generated MessageType for protobuf message ReceivedTrialAvatarActivityRewardRsp
 */
