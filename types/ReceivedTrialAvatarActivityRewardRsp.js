...
var _ReceivedTrialAvatarActivityRewardRsp_one_of_decls;
...
class ReceivedTrialAvatarActivityRewardRsp extends pb_1.Message {
    constructor(data) {
        super();
        _ReceivedTrialAvatarActivityRewardRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ReceivedTrialAvatarActivityRewardRsp_one_of_decls, "f"));
...
exports.ReceivedTrialAvatarActivityRewardRsp = ReceivedTrialAvatarActivityRewardRsp;
_ReceivedTrialAvatarActivityRewardRsp_one_of_decls = new WeakMap();
