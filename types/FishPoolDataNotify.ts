...
// @generated from protobuf file "FishPoolDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FishPoolDataNotify
 */
export interface FishPoolDataNotify {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 today_fish_num = 12;
     */
    todayFishNum: number;
}
...
class FishPoolDataNotify$Type extends MessageType<FishPoolDataNotify> {
    ...
    internalBinaryWrite(message: FishPoolDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.todayFishNum !== 0)
            writer.tag(12, WireType.Varint).uint32(message.todayFishNum);
