...
// @generated from protobuf file "GadgetChainLevelChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GadgetChainLevelChangeNotify
 */
export interface GadgetChainLevelChangeNotify {
    /**
     * @generated from protobuf field: map<uint32, uint32> gadget_chain_level_map = 13;
     */
    gadgetChainLevelMap: {
        [key: number]: number;
    };
...
class GadgetChainLevelChangeNotify$Type extends MessageType<GadgetChainLevelChangeNotify> {
    ...
    private binaryReadMap13(map: GadgetChainLevelChangeNotify["gadgetChainLevelMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: GadgetChainLevelChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.gadgetChainLevelMap))
            writer.tag(13, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.gadgetChainLevelMap[k as any]).join();
