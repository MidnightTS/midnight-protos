...
// @generated from protobuf file "ExclusiveRuleInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message ExclusiveRuleInfo
 */
export interface ExclusiveRuleInfo {
    /**
     * @generated from protobuf field: uint32 rule_type = 2;
     */
    ruleType: number;
    /**
     * @generated from protobuf field: repeated uint32 object_id_list = 15;
     */
    objectIdList: number[];
}
...
class ExclusiveRuleInfo$Type extends MessageType<ExclusiveRuleInfo> {
    ...
    internalBinaryWrite(message: ExclusiveRuleInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.ruleType !== 0)
            writer.tag(2, WireType.Varint).uint32(message.ruleType);
