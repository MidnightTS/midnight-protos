...
// @generated from protobuf file "ActivityInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface ActivityInfoNotify {
    /**
     * @generated from protobuf field: ActivityInfo activity_info = 12;
     */
...
class ActivityInfoNotify$Type extends MessageType<ActivityInfoNotify> {
    constructor() {
        super("ActivityInfoNotify", [
            { no: 12, name: "activity_info", kind: "message", T: () => ActivityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: ActivityInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.activityInfo)
            ActivityInfo.internalBinaryWrite(message.activityInfo, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
