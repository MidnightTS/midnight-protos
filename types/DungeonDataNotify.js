...
exports.DungeonDataNotify = void 0;
...
class DungeonDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonDataNotify", [
            { no: 7, name: "dungeon_data_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "scalar", T: 13 /*ScalarType.UINT32*/ } }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* map<uint32, uint32> dungeon_data_map */ 7:
                    this.binaryReadMap7(message.dungeonDataMap, reader, options);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.dungeonDataMap))
            writer.tag(7, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_1.WireType.Varint).uint32(message.dungeonDataMap[k]).join();
