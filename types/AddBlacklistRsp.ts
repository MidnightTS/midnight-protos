...
// @generated from protobuf file "AddBlacklistRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AddBlacklistRsp
 */
export interface AddBlacklistRsp {
    /**
     * @generated from protobuf field: FriendBrief target_friend_brief = 9;
     */
...
class AddBlacklistRsp$Type extends MessageType<AddBlacklistRsp> {
    constructor() {
        super("AddBlacklistRsp", [
            { no: 9, name: "target_friend_brief", kind: "message", T: () => FriendBrief },
    ...
    internalBinaryWrite(message: AddBlacklistRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetFriendBrief)
            FriendBrief.internalBinaryWrite(message.targetFriendBrief, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 13; */
