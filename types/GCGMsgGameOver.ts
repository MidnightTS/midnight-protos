...
// @generated from protobuf file "GCGMsgGameOver.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgGameOver
 */
export interface GCGMsgGameOver {
    /**
     * @generated from protobuf field: GCGEndReason end_reason = 6;
     */
    endReason: GCGEndReason;
    /**
     * @generated from protobuf field: uint32 win_controller_id = 3;
     */
...
class GCGMsgGameOver$Type extends MessageType<GCGMsgGameOver> {
    constructor() {
        super("GCGMsgGameOver", [
            { no: 6, name: "end_reason", kind: "enum", T: () => ["GCGEndReason", GCGEndReason] },
    ...
    internalBinaryWrite(message: GCGMsgGameOver, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.endReason !== 0)
            writer.tag(6, WireType.Varint).int32(message.endReason);
        /* uint32 win_controller_id = 3; */
        if (message.winControllerId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.winControllerId);
