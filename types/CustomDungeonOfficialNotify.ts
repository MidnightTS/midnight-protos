...
// @generated from protobuf file "CustomDungeonOfficialNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CustomDungeonOfficialNotify
 */
export interface CustomDungeonOfficialNotify {
    /**
     * @generated from protobuf field: TryCustomDungeonType try_type = 2;
     */
    ...
    /**
     * @generated from protobuf field: repeated uint32 official_black_coin_list = 5;
     */
...
class CustomDungeonOfficialNotify$Type extends MessageType<CustomDungeonOfficialNotify> {
    constructor() {
        super("CustomDungeonOfficialNotify", [
            { no: 2, name: "try_type", kind: "enum", T: () => ["TryCustomDungeonType", TryCustomDungeonType, "TRY_CUSTOM_DUNGEON_TYPE_"] },
    ...
    internalBinaryWrite(message: CustomDungeonOfficialNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.tryType !== 0)
            writer.tag(2, WireType.Varint).int32(message.tryType);
