...
class SetOpenStateRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SetOpenStateRsp", [
            { no: 4, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 5, name: "value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "key", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, value: 0, key: 0 };
...
/**
 * @generated MessageType for protobuf message SetOpenStateRsp
 */
