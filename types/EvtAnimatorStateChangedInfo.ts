...
export interface EvtAnimatorStateChangedInfo {
    ...
    fadeDuration: number;
    /**
     * @generated from protobuf field: uint32 to_state_hash = 11;
     */
    toStateHash: number;
    /**
     * @generated from protobuf field: uint32 layer = 1;
     */
    layer: number;
    /**
...
class EvtAnimatorStateChangedInfo$Type extends MessageType<EvtAnimatorStateChangedInfo> {
    ...
    internalBinaryWrite(message: EvtAnimatorStateChangedInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.toStateHash !== 0)
            writer.tag(11, WireType.Varint).uint32(message.toStateHash);
        /* uint32 layer = 1; */
        if (message.layer !== 0)
            writer.tag(1, WireType.Varint).uint32(message.layer);
        /* Vector pos = 5; */
        if (message.pos)
