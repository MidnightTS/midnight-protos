...
// @generated from protobuf file "VintagePresentFinishNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintagePresentFinishNotify
 */
export interface VintagePresentFinishNotify {
    /**
     * @generated from protobuf field: uint32 present_id = 2;
     */
    presentId: number;
}
...
class VintagePresentFinishNotify$Type extends MessageType<VintagePresentFinishNotify> {
    ...
    internalBinaryWrite(message: VintagePresentFinishNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.presentId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.presentId);
