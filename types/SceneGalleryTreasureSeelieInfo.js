...
class SceneGalleryTreasureSeelieInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneGalleryTreasureSeelieInfo", [
            { no: 1, name: "progress", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "goal", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { progress: 0, goal: 0 };
...
/**
 * @generated MessageType for protobuf message SceneGalleryTreasureSeelieInfo
 */
