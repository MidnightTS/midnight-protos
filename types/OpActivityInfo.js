...
var _OpActivityInfo_one_of_decls;
...
const dependency_1 = require("./BonusOpActivityInfo");
const pb_1 = require("google-protobuf");
class OpActivityInfo extends pb_1.Message {
    constructor(data) {
        super();
        _OpActivityInfo_one_of_decls.set(this, [[12]]);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _OpActivityInfo_one_of_decls, "f"));
    ...
    get bonus_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.BonusOpActivityInfo, 12);
    }
    set bonus_info(value) {
        pb_1.Message.setOneofWrapperField(this, 12, __classPrivateFieldGet(this, _OpActivityInfo_one_of_decls, "f")[0], value);
    }
    get has_bonus_info() {
...
exports.OpActivityInfo = OpActivityInfo;
_OpActivityInfo_one_of_decls = new WeakMap();
