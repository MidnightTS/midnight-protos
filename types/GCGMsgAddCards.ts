...
// @generated from protobuf file "GCGMsgAddCards.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgAddCards
 */
export interface GCGMsgAddCards {
    /**
     * @generated from protobuf field: GCGZoneType zone = 5;
     */
    zone: GCGZoneType;
    /**
     * @generated from protobuf field: GCGReason reason = 7;
     */
    reason: GCGReason;
    /**
    ...
    controllerId: number;
    /**
     * @generated from protobuf field: uint32 pos = 14;
     */
    pos: number;
}
...
class GCGMsgAddCards$Type extends MessageType<GCGMsgAddCards> {
    constructor() {
        super("GCGMsgAddCards", [
            { no: 5, name: "zone", kind: "enum", T: () => ["GCGZoneType", GCGZoneType] },
            { no: 7, name: "reason", kind: "enum", T: () => ["GCGReason", GCGReason] },
    ...
    internalBinaryWrite(message: GCGMsgAddCards, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 pos = 14; */
        if (message.pos !== 0)
            writer.tag(14, WireType.Varint).uint32(message.pos);
