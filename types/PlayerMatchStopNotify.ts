...
// @generated from protobuf file "PlayerMatchStopNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerMatchStopNotify
 */
export interface PlayerMatchStopNotify {
    /**
     * @generated from protobuf field: MatchReason reason = 10;
     */
    reason: MatchReason;
    /**
     * @generated from protobuf field: uint32 host_uid = 8;
     */
    hostUid: number;
}
...
class PlayerMatchStopNotify$Type extends MessageType<PlayerMatchStopNotify> {
    constructor() {
        super("PlayerMatchStopNotify", [
            { no: 10, name: "reason", kind: "enum", T: () => ["MatchReason", MatchReason, "MATCH_REASON_"] },
    ...
    internalBinaryWrite(message: PlayerMatchStopNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hostUid !== 0)
            writer.tag(8, WireType.Varint).uint32(message.hostUid);
