...
export class AvatarBuffDelNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AvatarBuffDelNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): AvatarBuffDelNotify {
