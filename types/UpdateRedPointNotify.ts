...
// @generated from protobuf file "UpdateRedPointNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message UpdateRedPointNotify
 */
export interface UpdateRedPointNotify {
    /**
     * @generated from protobuf field: repeated RedPointData red_point_list = 10;
     */
...
class UpdateRedPointNotify$Type extends MessageType<UpdateRedPointNotify> {
    constructor() {
        super("UpdateRedPointNotify", [
            { no: 10, name: "red_point_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RedPointData }
        ]);
    }
    ...
    internalBinaryWrite(message: UpdateRedPointNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.redPointList.length; i++)
            RedPointData.internalBinaryWrite(message.redPointList[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
