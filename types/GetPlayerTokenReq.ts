...
export interface GetPlayerTokenReq {
    ...
    uid: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_DILMOPPLPEM = 1735 [json_name = "Unk3300DILMOPPLPEM"];
     */
    ...
    birthday: string;
    /**
     * @generated from protobuf field: uint32 Unk3300_IADFJHNFKIB = 7 [json_name = "Unk3300IADFJHNFKIB"];
     */
...
class GetPlayerTokenReq$Type extends MessageType<GetPlayerTokenReq> {
    ...
    internalBinaryWrite(message: GetPlayerTokenReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300DILMOPPLPEM !== 0)
            writer.tag(1735, WireType.Varint).uint32(message.unk3300DILMOPPLPEM);
        ...
        if (message.unk3300IADFJHNFKIB !== 0)
            writer.tag(7, WireType.Varint).uint32(message.unk3300IADFJHNFKIB);
