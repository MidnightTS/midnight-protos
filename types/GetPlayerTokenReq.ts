...
export class GetPlayerTokenReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    set account_token(value: string) {
    ...
    get client_seed() {
        return pb_1.Message.getFieldWithDefault(this, 760, "") as string;
    }
    set client_seed(value: string) {
    ...
    get birthday() {
        return pb_1.Message.getFieldWithDefault(this, 1718, "") as string;
    }
    ...
    get Unk2700_NOJPEHIBDJH() {
        return pb_1.Message.getFieldWithDefault(this, 995, 0) as number;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetPlayerTokenReq {
    ...
    static deserializeBinary(bytes: Uint8Array): GetPlayerTokenReq {
