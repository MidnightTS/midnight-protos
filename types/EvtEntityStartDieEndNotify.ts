...
// @generated from protobuf file "EvtEntityStartDieEndNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EvtEntityStartDieEndNotify
 */
export interface EvtEntityStartDieEndNotify {
    /**
     * @generated from protobuf field: bool immediately = 9;
     */
    immediately: boolean;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 die_state_flag = 4;
     */
    dieStateFlag: number;
    /**
...
class EvtEntityStartDieEndNotify$Type extends MessageType<EvtEntityStartDieEndNotify> {
    ...
    internalBinaryWrite(message: EvtEntityStartDieEndNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.immediately !== false)
            writer.tag(9, WireType.Varint).bool(message.immediately);
        ...
        if (message.dieStateFlag !== 0)
            writer.tag(4, WireType.Varint).uint32(message.dieStateFlag);
        /* uint32 entity_id = 6; */
