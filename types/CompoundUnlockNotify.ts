...
// @generated from protobuf file "CompoundUnlockNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CompoundUnlockNotify
 */
export interface CompoundUnlockNotify {
    /**
     * @generated from protobuf field: uint32 compound_id = 7;
     */
    compoundId: number;
}
...
class CompoundUnlockNotify$Type extends MessageType<CompoundUnlockNotify> {
    ...
    internalBinaryWrite(message: CompoundUnlockNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.compoundId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.compoundId);
