...
// @generated from protobuf file "DungeonWayPointActivateRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonWayPointActivateRsp
 */
export interface DungeonWayPointActivateRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 way_point_id = 10;
     */
    wayPointId: number;
}
...
class DungeonWayPointActivateRsp$Type extends MessageType<DungeonWayPointActivateRsp> {
    ...
    internalBinaryWrite(message: DungeonWayPointActivateRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.wayPointId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.wayPointId);
