...
exports.GetStoreCustomDungeonRsp = void 0;
...
class GetStoreCustomDungeonRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GetStoreCustomDungeonRsp", [
            { no: 2, name: "custom_dungeon_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => OtherCustomDungeonBrief_1.OtherCustomDungeonBrief },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.customDungeonList.length; i++)
            OtherCustomDungeonBrief_1.OtherCustomDungeonBrief.internalBinaryWrite(message.customDungeonList[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 15; */
