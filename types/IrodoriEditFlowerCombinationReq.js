...
exports.IrodoriEditFlowerCombinationReq = void 0;
...
class IrodoriEditFlowerCombinationReq$Type extends runtime_5.MessageType {
    constructor() {
        super("IrodoriEditFlowerCombinationReq", [
            { no: 1, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "combination_info", kind: "message", T: () => CustomGadgetTreeInfo_1.CustomGadgetTreeInfo }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 entity_id */ 1:
                    ...
                    break;
                case /* CustomGadgetTreeInfo combination_info */ 12:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.combinationInfo)
            CustomGadgetTreeInfo_1.CustomGadgetTreeInfo.internalBinaryWrite(message.combinationInfo, writer.tag(12, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message IrodoriEditFlowerCombinationReq
 */
