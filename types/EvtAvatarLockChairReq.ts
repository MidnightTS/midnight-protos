...
// @generated from protobuf file "EvtAvatarLockChairReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface EvtAvatarLockChairReq {
    /**
     * @generated from protobuf field: Vector position = 2;
     */
    position?: Vector;
    /**
     * @generated from protobuf field: uint64 chair_id = 5;
     */
    chairId: bigint;
}
...
class EvtAvatarLockChairReq$Type extends MessageType<EvtAvatarLockChairReq> {
    constructor() {
        super("EvtAvatarLockChairReq", [
            { no: 2, name: "position", kind: "message", T: () => Vector },
    ...
    internalBinaryWrite(message: EvtAvatarLockChairReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* Vector position = 2; */
        if (message.position)
            Vector.internalBinaryWrite(message.position, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* uint64 chair_id = 5; */
