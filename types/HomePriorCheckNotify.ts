...
// @generated from protobuf file "HomePriorCheckNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomePriorCheckNotify
 */
export interface HomePriorCheckNotify {
    /**
     * @generated from protobuf field: fixed32 end_time = 3;
     */
    endTime: number;
}
...
class HomePriorCheckNotify$Type extends MessageType<HomePriorCheckNotify> {
    ...
    internalBinaryWrite(message: HomePriorCheckNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.endTime !== 0)
            writer.tag(3, WireType.Bit32).fixed32(message.endTime);
