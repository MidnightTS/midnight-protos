...
export class QuestCreateEntityRsp extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get entity() {
        return pb_1.Message.getWrapperField(this, dependency_1.CreateEntityInfo, 11) as dependency_1.CreateEntityInfo;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QuestCreateEntityRsp {
    ...
    static deserializeBinary(bytes: Uint8Array): QuestCreateEntityRsp {
