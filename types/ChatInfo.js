...
class ChatInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("ChatInfo", [
            ...
            { no: 10, name: "to_uid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { isRead: false, time: 0, toUid: 0, uid: 0, sequence: 0, content: { oneofKind: undefined } };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 time */ 1:
                    ...
                    break;
                case /* uint32 to_uid */ 10:
                    message.toUid = reader.uint32();
                    break;
                case /* uint32 uid */ 11:
                    message.uid = reader.uint32();
                    break;
                case /* uint32 sequence */ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 to_uid = 10; */
        if (message.toUid !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.toUid);
        /* uint32 uid = 11; */
        if (message.uid !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.uid);
        /* uint32 sequence = 5; */
        if (message.sequence !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.sequence);
        /* string text = 909; */
