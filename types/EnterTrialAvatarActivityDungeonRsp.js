...
class EnterTrialAvatarActivityDungeonRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("EnterTrialAvatarActivityDungeonRsp", [
    ...
    create(value) {
        const message = { trialAvatarIndexId: 0, retcode: 0, activityId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.trialAvatarIndexId !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.trialAvatarIndexId);
        /* int32 retcode = 1; */
...
/**
 * @generated MessageType for protobuf message EnterTrialAvatarActivityDungeonRsp
 */
