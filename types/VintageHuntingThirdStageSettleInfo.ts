...
// @generated from protobuf file "VintageHuntingThirdStageSettleInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message VintageHuntingThirdStageSettleInfo
 */
export interface VintageHuntingThirdStageSettleInfo {
    ...
    isSuccess: boolean;
    /**
     * @generated from protobuf field: uint32 left_time = 3;
     */
    leftTime: number;
}
...
class VintageHuntingThirdStageSettleInfo$Type extends MessageType<VintageHuntingThirdStageSettleInfo> {
    ...
    internalBinaryWrite(message: VintageHuntingThirdStageSettleInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.leftTime !== 0)
            writer.tag(3, WireType.Varint).uint32(message.leftTime);
