...
// @generated from protobuf file "AbilityActionHitEffect.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityActionHitEffect
 */
export interface AbilityActionHitEffect {
    /**
     * @generated from protobuf field: uint32 trigger_id = 13;
     */
    triggerId: number;
}
...
class AbilityActionHitEffect$Type extends MessageType<AbilityActionHitEffect> {
    ...
    internalBinaryWrite(message: AbilityActionHitEffect, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.triggerId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.triggerId);
