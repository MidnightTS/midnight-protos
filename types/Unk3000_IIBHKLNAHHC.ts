...
export class Unk3000_IIBHKLNAHHC extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Unk3000_IIBHKLNAHHC {
    ...
    static deserializeBinary(bytes: Uint8Array): Unk3000_IIBHKLNAHHC {
