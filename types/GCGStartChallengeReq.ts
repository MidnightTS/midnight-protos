...
// @generated from protobuf file "GCGStartChallengeReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGStartChallengeReq
 */
export interface GCGStartChallengeReq {
    /**
     * @generated from protobuf field: GCGLevelType level_type = 12;
     */
...
class GCGStartChallengeReq$Type extends MessageType<GCGStartChallengeReq> {
    constructor() {
        super("GCGStartChallengeReq", [
            { no: 12, name: "level_type", kind: "enum", T: () => ["GCGLevelType", GCGLevelType] },
