...
// @generated from protobuf file "PlayerWidgetInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message PlayerWidgetInfo
 */
export interface PlayerWidgetInfo {
    ...
    uid: number;
    /**
     * @generated from protobuf field: repeated WidgetSlotData slot_list = 4;
     */
...
class PlayerWidgetInfo$Type extends MessageType<PlayerWidgetInfo> {
    constructor() {
        super("PlayerWidgetInfo", [
            ...
            { no: 4, name: "slot_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WidgetSlotData }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerWidgetInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.slotList.length; i++)
            WidgetSlotData.internalBinaryWrite(message.slotList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
