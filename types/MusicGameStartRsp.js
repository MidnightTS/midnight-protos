...
class MusicGameStartRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("MusicGameStartRsp", [
            ...
            { no: 13, name: "music_basic_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "ugc_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, musicBasicId: 0, ugcGuid: 0n };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.musicBasicId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.musicBasicId);
        /* uint64 ugc_guid = 5; */
