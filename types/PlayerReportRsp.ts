...
// @generated from protobuf file "PlayerReportRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerReportRsp
 */
export interface PlayerReportRsp {
    /**
     * @generated from protobuf field: uint32 cd_time = 8;
     */
    cdTime: number;
    /**
...
class PlayerReportRsp$Type extends MessageType<PlayerReportRsp> {
    ...
    internalBinaryWrite(message: PlayerReportRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 cd_time = 8; */
        if (message.cdTime !== 0)
            writer.tag(8, WireType.Varint).uint32(message.cdTime);
        /* int32 retcode = 7; */
