...
// @generated from protobuf file "MechanicusCandidateTeamCreateRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MechanicusCandidateTeamCreateRsp
 */
export interface MechanicusCandidateTeamCreateRsp {
    /**
     * @generated from protobuf field: uint32 difficult_level = 11;
     */
...
class MechanicusCandidateTeamCreateRsp$Type extends MessageType<MechanicusCandidateTeamCreateRsp> {
    ...
    internalBinaryWrite(message: MechanicusCandidateTeamCreateRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.difficultLevel !== 0)
            writer.tag(11, WireType.Varint).uint32(message.difficultLevel);
        /* uint32 dungeon_id = 5; */
