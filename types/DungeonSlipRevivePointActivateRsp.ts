...
// @generated from protobuf file "DungeonSlipRevivePointActivateRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonSlipRevivePointActivateRsp
 */
export interface DungeonSlipRevivePointActivateRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 slip_revive_point_id = 13;
     */
...
class DungeonSlipRevivePointActivateRsp$Type extends MessageType<DungeonSlipRevivePointActivateRsp> {
    ...
    internalBinaryWrite(message: DungeonSlipRevivePointActivateRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.slipRevivePointId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.slipRevivePointId);
