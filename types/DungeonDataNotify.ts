...
// @generated from protobuf file "DungeonDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface DungeonDataNotify {
    /**
     * @generated from protobuf field: map<uint32, uint32> dungeon_data_map = 7;
     */
    dungeonDataMap: {
        [key: number]: number;
    };
...
class DungeonDataNotify$Type extends MessageType<DungeonDataNotify> {
    ...
    private binaryReadMap7(map: DungeonDataNotify["dungeonDataMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: DungeonDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.dungeonDataMap))
            writer.tag(7, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.dungeonDataMap[k as any]).join();
