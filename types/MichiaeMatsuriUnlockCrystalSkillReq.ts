...
// @generated from protobuf file "MichiaeMatsuriUnlockCrystalSkillReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MichiaeMatsuriUnlockCrystalSkillReq
 */
export interface MichiaeMatsuriUnlockCrystalSkillReq {
    /**
     * @generated from protobuf field: uint32 crystal_skill_id = 10;
     */
...
class MichiaeMatsuriUnlockCrystalSkillReq$Type extends MessageType<MichiaeMatsuriUnlockCrystalSkillReq> {
    ...
    internalBinaryWrite(message: MichiaeMatsuriUnlockCrystalSkillReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.crystalSkillId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.crystalSkillId);
