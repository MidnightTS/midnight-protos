...
// @generated from protobuf file "BonusActivityUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BonusActivityUpdateNotify
 */
export interface BonusActivityUpdateNotify {
    /**
     * @generated from protobuf field: repeated BonusActivityInfo bonus_activity_info_list = 7;
     */
...
class BonusActivityUpdateNotify$Type extends MessageType<BonusActivityUpdateNotify> {
    constructor() {
        super("BonusActivityUpdateNotify", [
            { no: 7, name: "bonus_activity_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BonusActivityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: BonusActivityUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.bonusActivityInfoList.length; i++)
            BonusActivityInfo.internalBinaryWrite(message.bonusActivityInfoList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
