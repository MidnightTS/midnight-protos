...
class TakeReunionSignInRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeReunionSignInRewardRsp", [
            { no: 13, name: "sign_in_info", kind: "message", T: () => ReunionSignInInfo_1.ReunionSignInInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.signInInfo)
            ReunionSignInInfo_1.ReunionSignInInfo.internalBinaryWrite(message.signInInfo, writer.tag(13, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 7; */
