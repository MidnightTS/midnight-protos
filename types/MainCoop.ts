...
export interface MainCoop {
    ...
    /**
     * @generated from protobuf field: map<uint32, int32> Unk3300_JFPLEDLNJPF = 5 [json_name = "Unk3300JFPLEDLNJPF"];
     */
    unk3300JFPLEDLNJPF: {
        [key: number]: number;
    };
    /**
     * @generated from protobuf field: map<uint32, int32> Unk3300_OMEEMFJFKBH = 7 [json_name = "Unk3300OMEEMFJFKBH"];
     */
    unk3300OMEEMFJFKBH: {
        [key: number]: number;
    };
...
class MainCoop$Type extends MessageType<MainCoop> {
    ...
    private binaryReadMap5(map: MainCoop["unk3300JFPLEDLNJPF"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof MainCoop["unk3300JFPLEDLNJPF"] | undefined, val: MainCoop["unk3300JFPLEDLNJPF"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    private binaryReadMap7(map: MainCoop["unk3300OMEEMFJFKBH"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof MainCoop["unk3300OMEEMFJFKBH"] | undefined, val: MainCoop["unk3300OMEEMFJFKBH"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: MainCoop, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.unk3300JFPLEDLNJPF))
            writer.tag(5, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).int32(message.unk3300JFPLEDLNJPF[k as any]).join();
        /* map<uint32, int32> Unk3300_OMEEMFJFKBH = 7 [json_name = "Unk3300OMEEMFJFKBH"]; */
        for (let k of Object.keys(message.unk3300OMEEMFJFKBH))
            writer.tag(7, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).int32(message.unk3300OMEEMFJFKBH[k as any]).join();
