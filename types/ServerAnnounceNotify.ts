...
// @generated from protobuf file "ServerAnnounceNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface ServerAnnounceNotify {
    /**
     * @generated from protobuf field: repeated AnnounceData announce_data_list = 14;
     */
...
class ServerAnnounceNotify$Type extends MessageType<ServerAnnounceNotify> {
    constructor() {
        super("ServerAnnounceNotify", [
            { no: 14, name: "announce_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AnnounceData }
        ]);
    }
    ...
    internalBinaryWrite(message: ServerAnnounceNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.announceDataList.length; i++)
            AnnounceData.internalBinaryWrite(message.announceDataList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
