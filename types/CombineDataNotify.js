...
exports.CombineDataNotify = void 0;
...
class CombineDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CombineDataNotify", [
            { no: 7, name: "combine_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 combine_id_list */ 7:
