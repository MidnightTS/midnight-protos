...
// @generated from protobuf file "TriggerRoguelikeRuneReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TriggerRoguelikeRuneReq
 */
export interface TriggerRoguelikeRuneReq {
    /**
     * @generated from protobuf field: uint32 rune_id = 11;
     */
    runeId: number;
}
...
class TriggerRoguelikeRuneReq$Type extends MessageType<TriggerRoguelikeRuneReq> {
    ...
    internalBinaryWrite(message: TriggerRoguelikeRuneReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 rune_id = 11; */
        if (message.runeId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.runeId);
