...
export interface CombineRsp {
    /**
     * @generated from protobuf field: repeated ItemParam total_return_item_list = 11;
     */
    totalReturnItemList: ItemParam[];
    /**
     * @generated from protobuf field: repeated ItemParam total_extra_item_list = 13;
     */
    totalExtraItemList: ItemParam[];
    /**
     * @generated from protobuf field: repeated ItemParam total_random_item_list = 6;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated ItemParam result_item_list = 4;
     */
...
class CombineRsp$Type extends MessageType<CombineRsp> {
    constructor() {
        super("CombineRsp", [
            { no: 11, name: "total_return_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
            { no: 13, name: "total_extra_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
            { no: 6, name: "total_random_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
            ...
            { no: 4, name: "result_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam }
        ]);
    }
    ...
    internalBinaryWrite(message: CombineRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.totalReturnItemList.length; i++)
            ItemParam.internalBinaryWrite(message.totalReturnItemList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* repeated ItemParam total_extra_item_list = 13; */
        for (let i = 0; i < message.totalExtraItemList.length; i++)
            ItemParam.internalBinaryWrite(message.totalExtraItemList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* repeated ItemParam total_random_item_list = 6; */
        for (let i = 0; i < message.totalRandomItemList.length; i++)
            ItemParam.internalBinaryWrite(message.totalRandomItemList[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        ...
        for (let i = 0; i < message.resultItemList.length; i++)
            ItemParam.internalBinaryWrite(message.resultItemList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
