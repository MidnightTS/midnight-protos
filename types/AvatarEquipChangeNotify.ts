...
// @generated from protobuf file "AvatarEquipChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarEquipChangeNotify {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: uint32 equip_type = 10;
     */
    equipType: number;
    /**
    ...
    itemId: number;
    /**
     * @generated from protobuf field: SceneReliquaryInfo reliquary = 4;
     */
    reliquary?: SceneReliquaryInfo;
    /**
     * @generated from protobuf field: SceneWeaponInfo weapon = 15;
     */
...
class AvatarEquipChangeNotify$Type extends MessageType<AvatarEquipChangeNotify> {
    constructor() {
        super("AvatarEquipChangeNotify", [
            ...
            { no: 4, name: "reliquary", kind: "message", T: () => SceneReliquaryInfo },
    ...
    internalBinaryWrite(message: AvatarEquipChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.equipType !== 0)
            writer.tag(10, WireType.Varint).uint32(message.equipType);
        /* uint64 equip_guid = 5; */
        ...
        if (message.reliquary)
            SceneReliquaryInfo.internalBinaryWrite(message.reliquary, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
