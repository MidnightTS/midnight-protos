...
exports.SalvageBundleChallengeInfo = void 0;
...
class SalvageBundleChallengeInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("SalvageBundleChallengeInfo", [
            { no: 11, name: "finished_bundle_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 finished_bundle_list */ 11:
...
/**
 * @generated MessageType for protobuf message SalvageBundleChallengeInfo
 */
