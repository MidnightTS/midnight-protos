...
export interface PlayerCookRsp {
    ...
    itemList: ItemParam[];
    /**
     * @generated from protobuf field: uint32 Unk3300_NDPHNNOFEBL = 1 [json_name = "Unk3300NDPHNNOFEBL"];
     */
    unk3300NDPHNNOFEBL: number;
    /**
     * @generated from protobuf field: repeated ItemParam extra_item_list = 3;
     */
    extraItemList: ItemParam[];
    /**
     * @generated from protobuf field: uint32 Unk3300_JPICLIDLIEC = 11 [json_name = "Unk3300JPICLIDLIEC"];
     */
    unk3300JPICLIDLIEC: number;
}
...
class PlayerCookRsp$Type extends MessageType<PlayerCookRsp> {
    ...
    internalBinaryWrite(message: PlayerCookRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300NDPHNNOFEBL !== 0)
            writer.tag(1, WireType.Varint).uint32(message.unk3300NDPHNNOFEBL);
        ...
        if (message.unk3300JPICLIDLIEC !== 0)
            writer.tag(11, WireType.Varint).uint32(message.unk3300JPICLIDLIEC);
