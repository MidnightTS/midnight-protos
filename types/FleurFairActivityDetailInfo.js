...
class FleurFairActivityDetailInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("FleurFairActivityDetailInfo", [
            ...
            { no: 8, name: "dungeon_section_info_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => FleurFairDungeonSectionInfo_1.FleurFairDungeonSectionInfo } },
            { no: 13, name: "is_content_closed", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 9, name: "minigame_info_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => FleurFairMinigameInfo_1.FleurFairMinigameInfo } },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.dungeonSectionInfoMap)) {
            ...
            FleurFairDungeonSectionInfo_1.FleurFairDungeonSectionInfo.internalBinaryWrite(message.dungeonSectionInfoMap[k], writer, options);
            writer.join().join();
        }
        ...
        for (let k of Object.keys(message.minigameInfoMap)) {
            ...
            writer.tag(2, runtime_1.WireType.LengthDelimited).fork();
            FleurFairMinigameInfo_1.FleurFairMinigameInfo.internalBinaryWrite(message.minigameInfoMap[k], writer, options);
            writer.join().join();
        }
