...
exports.FindHilichurlDayContentInfo = void 0;
...
class FindHilichurlDayContentInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("FindHilichurlDayContentInfo", [
            { no: 13, name: "start_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message FindHilichurlDayContentInfo
 */
