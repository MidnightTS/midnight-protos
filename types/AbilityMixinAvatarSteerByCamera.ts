...
// @generated from protobuf file "AbilityMixinAvatarSteerByCamera.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityMixinAvatarSteerByCamera
 */
export interface AbilityMixinAvatarSteerByCamera {
    /**
     * @generated from protobuf field: Vector target_dir = 7;
     */
    targetDir?: Vector;
    /**
     * @generated from protobuf field: Vector target_pos = 2;
     */
    targetPos?: Vector;
}
...
class AbilityMixinAvatarSteerByCamera$Type extends MessageType<AbilityMixinAvatarSteerByCamera> {
    constructor() {
        super("AbilityMixinAvatarSteerByCamera", [
            ...
            { no: 2, name: "target_pos", kind: "message", T: () => Vector }
        ]);
    }
    ...
    internalBinaryWrite(message: AbilityMixinAvatarSteerByCamera, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetPos)
            Vector.internalBinaryWrite(message.targetPos, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
