...
// @generated from protobuf file "DynamicNodes.proto" (syntax proto3)
// tslint:disable
//
...
import { DynamicLayerNodes } from "./DynamicLayerNodes";
/**
 * @generated from protobuf message DynamicNodes
 */
export interface DynamicNodes {
    /**
     * @generated from protobuf field: repeated DynamicLayerNodes nodes = 4;
     */
...
class DynamicNodes$Type extends MessageType<DynamicNodes> {
    constructor() {
        super("DynamicNodes", [
            { no: 4, name: "nodes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DynamicLayerNodes }
        ]);
    }
    ...
    internalBinaryWrite(message: DynamicNodes, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.nodes.length; i++)
            DynamicLayerNodes.internalBinaryWrite(message.nodes[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
