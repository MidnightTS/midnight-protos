...
exports.CoinCollectChooseSkillRsp = void 0;
...
class CoinCollectChooseSkillRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("CoinCollectChooseSkillRsp", [
    ...
    create(value) {
        const message = { levelId: 0, chooseSkillNo: 0, retcode: 0 };
...
/**
 * @generated MessageType for protobuf message CoinCollectChooseSkillRsp
 */
exports.CoinCollectChooseSkillRsp = new CoinCollectChooseSkillRsp$Type();
