...
// @generated from protobuf file "GetReunionSignInInfoReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetReunionSignInInfoReq
 */
export interface GetReunionSignInInfoReq {
    /**
     * @generated from protobuf field: uint32 sign_in_config_id = 3;
     */
...
class GetReunionSignInInfoReq$Type extends MessageType<GetReunionSignInInfoReq> {
    ...
    internalBinaryWrite(message: GetReunionSignInInfoReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.signInConfigId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.signInConfigId);
