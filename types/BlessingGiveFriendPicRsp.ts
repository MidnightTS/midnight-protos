...
// @generated from protobuf file "BlessingGiveFriendPicRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BlessingGiveFriendPicRsp
 */
export interface BlessingGiveFriendPicRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 pic_id = 6;
     */
    picId: number;
    /**
...
class BlessingGiveFriendPicRsp$Type extends MessageType<BlessingGiveFriendPicRsp> {
    ...
    internalBinaryWrite(message: BlessingGiveFriendPicRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 pic_id = 6; */
        if (message.picId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.picId);
        /* uint32 uid = 9; */
        if (message.uid !== 0)
