...
class TowerLevelEndNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("TowerLevelEndNotify", [
            ...
            { no: 4, name: "next_floor_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { continueState: 0, finishedStarCondList: [], nextFloorId: 0, isSuccess: false, rewardItemList: [] };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.continueState !== 0)
            writer.tag(2, runtime_2.WireType.Varint).uint32(message.continueState);
