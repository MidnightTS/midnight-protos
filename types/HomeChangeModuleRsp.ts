...
// @generated from protobuf file "HomeChangeModuleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeChangeModuleRsp
 */
export interface HomeChangeModuleRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 target_module_id = 8;
     */
...
class HomeChangeModuleRsp$Type extends MessageType<HomeChangeModuleRsp> {
    ...
    internalBinaryWrite(message: HomeChangeModuleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetModuleId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.targetModuleId);
