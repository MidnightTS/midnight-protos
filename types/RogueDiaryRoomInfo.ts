...
// @generated from protobuf file "RogueDiaryRoomInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message RogueDiaryRoomInfo
 */
export interface RogueDiaryRoomInfo {
    /**
     * @generated from protobuf field: bool is_boss = 6;
     */
    isBoss: boolean;
    /**
    ...
    configId: number;
    /**
     * @generated from protobuf field: repeated Uint32Pair monster_list = 4;
     */
...
class RogueDiaryRoomInfo$Type extends MessageType<RogueDiaryRoomInfo> {
    constructor() {
        super("RogueDiaryRoomInfo", [
            ...
            { no: 4, name: "monster_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Uint32Pair }
        ]);
    }
    ...
    internalBinaryWrite(message: RogueDiaryRoomInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isBoss !== false)
            writer.tag(6, WireType.Varint).bool(message.isBoss);
        /* uint32 config_id = 3; */
        ...
        for (let i = 0; i < message.monsterList.length; i++)
            Uint32Pair.internalBinaryWrite(message.monsterList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
