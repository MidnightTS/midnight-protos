...
// @generated from protobuf file "DailyTaskScoreRewardNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DailyTaskScoreRewardNotify
 */
export interface DailyTaskScoreRewardNotify {
    /**
     * @generated from protobuf field: uint32 reward_id = 8;
     */
    rewardId: number;
}
...
class DailyTaskScoreRewardNotify$Type extends MessageType<DailyTaskScoreRewardNotify> {
    ...
    internalBinaryWrite(message: DailyTaskScoreRewardNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.rewardId);
