...
export interface GetPlayerTokenRsp {
    ...
    /**
     * @generated from protobuf field: uint32 gm_uid = 7;
     */
    gmUid: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 cloud_client_ip = 1670;
     */
    ...
    clientIpStr: string;
    /**
     * @generated from protobuf field: uint32 sub_channel_id = 1038;
     */
    subChannelId: number;
    /**
    ...
    psnId: string;
    /**
     * @generated from protobuf field: bool is_proficient_player = 9;
     */
    ...
    /**
     * @generated from protobuf field: uint32 black_uid_end_time = 12;
     */
...
class GetPlayerTokenRsp$Type extends MessageType<GetPlayerTokenRsp> {
    ...
    internalBinaryWrite(message: GetPlayerTokenRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 gm_uid = 7; */
        if (message.gmUid !== 0)
            writer.tag(7, WireType.Varint).uint32(message.gmUid);
        /* bool is_guest = 11; */
        ...
        if (message.cloudClientIp !== 0)
            writer.tag(1670, WireType.Varint).uint32(message.cloudClientIp);
        ...
        if (message.subChannelId !== 0)
            writer.tag(1038, WireType.Varint).uint32(message.subChannelId);
        /* int32 retcode = 2; */
        ...
        if (message.blackUidEndTime !== 0)
            writer.tag(12, WireType.Varint).uint32(message.blackUidEndTime);
