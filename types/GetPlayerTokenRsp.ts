...
export class GetPlayerTokenRsp extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        birthday?: string;
        retcode?: number;
        security_cmd_buffer?: Uint8Array;
        secret_key_seed?: number;
        country_code?: string;
        extra_bin_data?: Uint8Array;
        secret_key?: string;
        Unk2700_NOJPEHIBDJH?: number;
        black_uid_end_time?: number;
        tag?: number;
        token?: string;
        gm_uid?: number;
        channel_id?: number;
        ...
        Unk2700_FLBKPCPGPDH?: boolean;
        encrypted_seed?: string;
        is_proficient_player?: boolean;
        key_id?: number;
        uid?: number;
        account_uid?: string;
        is_guest?: boolean;
        client_version_random_key?: string;
        Unk2800_NNBFCEAOEPB?: number[];
        platform_type?: number;
        reg_platform?: number;
        is_login_white_list?: boolean;
        seed_signature?: string;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1640], this.#one_of_decls);
    ...
    get birthday() {
        return pb_1.Message.getFieldWithDefault(this, 937, "") as string;
    }
    ...
    set security_cmd_buffer(value: Uint8Array) {
        pb_1.Message.setField(this, 6, value);
    }
    get secret_key_seed() {
        return pb_1.Message.getFieldWithDefault(this, 13, 0) as number;
    }
    set secret_key_seed(value: number) {
        pb_1.Message.setField(this, 13, value);
    }
    get country_code() {
        return pb_1.Message.getFieldWithDefault(this, 2013, "") as string;
    }
    ...
    get Unk2700_NOJPEHIBDJH() {
        return pb_1.Message.getFieldWithDefault(this, 1561, 0) as number;
    }
    set Unk2700_NOJPEHIBDJH(value: number) {
        pb_1.Message.setField(this, 1561, value);
    }
    get black_uid_end_time() {
        return pb_1.Message.getFieldWithDefault(this, 14, 0) as number;
    }
    set black_uid_end_time(value: number) {
        pb_1.Message.setField(this, 14, value);
    }
    get tag() {
        return pb_1.Message.getFieldWithDefault(this, 1635, 0) as number;
    }
    ...
    get channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 896, 0) as number;
    }
    set channel_id(value: number) {
        pb_1.Message.setField(this, 896, value);
    }
    get psn_id() {
        return pb_1.Message.getFieldWithDefault(this, 1811, "") as string;
    }
    set psn_id(value: string) {
        pb_1.Message.setField(this, 1811, value);
    }
    get client_ip_str() {
        return pb_1.Message.getFieldWithDefault(this, 860, "") as string;
    }
    set client_ip_str(value: string) {
    ...
    get sub_channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 1802, 0) as number;
    }
    set sub_channel_id(value: number) {
        pb_1.Message.setField(this, 1802, value);
    }
    get Unk2700_FLBKPCPGPDH() {
        return pb_1.Message.getFieldWithDefault(this, 2028, false) as boolean;
    }
    set Unk2700_FLBKPCPGPDH(value: boolean) {
        pb_1.Message.setField(this, 2028, value);
    }
    get encrypted_seed() {
        return pb_1.Message.getFieldWithDefault(this, 1493, "") as string;
    }
    set encrypted_seed(value: string) {
        pb_1.Message.setField(this, 1493, value);
    }
    get is_proficient_player() {
        return pb_1.Message.getFieldWithDefault(this, 9, false) as boolean;
    }
    set is_proficient_player(value: boolean) {
        pb_1.Message.setField(this, 9, value);
    }
    get key_id() {
        return pb_1.Message.getFieldWithDefault(this, 1172, 0) as number;
    }
    ...
    get client_version_random_key() {
        return pb_1.Message.getFieldWithDefault(this, 1529, "") as string;
    }
    set client_version_random_key(value: string) {
        pb_1.Message.setField(this, 1529, value);
    }
    get Unk2800_NNBFCEAOEPB() {
        return pb_1.Message.getFieldWithDefault(this, 1640, []) as number[];
    }
    set Unk2800_NNBFCEAOEPB(value: number[]) {
    ...
    get reg_platform() {
        return pb_1.Message.getFieldWithDefault(this, 1112, 0) as number;
    }
    set reg_platform(value: number) {
        pb_1.Message.setField(this, 1112, value);
    }
    get is_login_white_list() {
        return pb_1.Message.getFieldWithDefault(this, 573, false) as boolean;
    }
    set is_login_white_list(value: boolean) {
        pb_1.Message.setField(this, 573, value);
    }
    get seed_signature() {
        return pb_1.Message.getFieldWithDefault(this, 1140, "") as string;
    }
    set seed_signature(value: string) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetPlayerTokenRsp {
    ...
    static deserializeBinary(bytes: Uint8Array): GetPlayerTokenRsp {
