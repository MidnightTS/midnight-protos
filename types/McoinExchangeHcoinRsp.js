...
class McoinExchangeHcoinRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.mcoinCost !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.mcoinCost);
        /* int32 retcode = 10; */
