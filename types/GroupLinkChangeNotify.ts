...
// @generated from protobuf file "GroupLinkChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GroupLinkChangeNotify
 */
export interface GroupLinkChangeNotify {
    /**
     * @generated from protobuf field: GroupLinkBundle bundle = 5;
     */
...
class GroupLinkChangeNotify$Type extends MessageType<GroupLinkChangeNotify> {
    constructor() {
        super("GroupLinkChangeNotify", [
            { no: 5, name: "bundle", kind: "message", T: () => GroupLinkBundle }
        ]);
    }
    ...
    internalBinaryWrite(message: GroupLinkChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bundle)
            GroupLinkBundle.internalBinaryWrite(message.bundle, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
