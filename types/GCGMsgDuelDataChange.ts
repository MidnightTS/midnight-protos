...
// @generated from protobuf file "GCGMsgDuelDataChange.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgDuelDataChange
 */
export interface GCGMsgDuelDataChange {
    /**
     * @generated from protobuf field: uint32 round = 6;
     */
    round: number;
}
...
class GCGMsgDuelDataChange$Type extends MessageType<GCGMsgDuelDataChange> {
    ...
    internalBinaryWrite(message: GCGMsgDuelDataChange, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 round = 6; */
        if (message.round !== 0)
            writer.tag(6, WireType.Varint).uint32(message.round);
