...
// @generated from protobuf file "ClientLockGameTimeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ClientLockGameTimeNotify
 */
export interface ClientLockGameTimeNotify {
    /**
     * @generated from protobuf field: bool is_lock = 11;
     */
    isLock: boolean;
}
...
class ClientLockGameTimeNotify$Type extends MessageType<ClientLockGameTimeNotify> {
    ...
    internalBinaryWrite(message: ClientLockGameTimeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isLock !== false)
            writer.tag(11, WireType.Varint).bool(message.isLock);
