...
class CancelCityReputationRequestRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.requestId !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.requestId);
...
/**
 * @generated MessageType for protobuf message CancelCityReputationRequestRsp
 */
