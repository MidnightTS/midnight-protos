...
// @generated from protobuf file "AsterProgressInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AsterProgressInfoNotify
 */
export interface AsterProgressInfoNotify {
    /**
     * @generated from protobuf field: AsterProgressDetailInfo info = 2;
     */
...
class AsterProgressInfoNotify$Type extends MessageType<AsterProgressInfoNotify> {
    constructor() {
        super("AsterProgressInfoNotify", [
            { no: 2, name: "info", kind: "message", T: () => AsterProgressDetailInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: AsterProgressInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            AsterProgressDetailInfo.internalBinaryWrite(message.info, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
