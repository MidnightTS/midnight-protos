...
// @generated from protobuf file "GCGInviteGuestBattleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGInviteGuestBattleRsp
 */
export interface GCGInviteGuestBattleRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 punish_end_time = 3;
     */
    punishEndTime: number;
    /**
     * @generated from protobuf field: uint32 confirm_end_time = 7;
     */
...
class GCGInviteGuestBattleRsp$Type extends MessageType<GCGInviteGuestBattleRsp> {
    ...
    internalBinaryWrite(message: GCGInviteGuestBattleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.punishEndTime !== 0)
            writer.tag(3, WireType.Varint).uint32(message.punishEndTime);
        /* uint32 confirm_end_time = 7; */
        if (message.confirmEndTime !== 0)
            writer.tag(7, WireType.Varint).uint32(message.confirmEndTime);
