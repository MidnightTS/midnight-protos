...
// @generated from protobuf file "AbilityMetaSetPoseParameter.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityMetaSetPoseParameter
 */
export interface AbilityMetaSetPoseParameter {
    /**
     * @generated from protobuf field: AnimatorParameterValueInfoPair value = 7;
     */
...
class AbilityMetaSetPoseParameter$Type extends MessageType<AbilityMetaSetPoseParameter> {
    constructor() {
        super("AbilityMetaSetPoseParameter", [
            { no: 7, name: "value", kind: "message", T: () => AnimatorParameterValueInfoPair }
        ]);
    }
    ...
    internalBinaryWrite(message: AbilityMetaSetPoseParameter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.value)
            AnimatorParameterValueInfoPair.internalBinaryWrite(message.value, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
