...
// @generated from protobuf file "LiveEndNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LiveEndNotify
 */
export interface LiveEndNotify {
    /**
     * @generated from protobuf field: uint32 live_id = 12;
     */
    liveId: number;
}
...
class LiveEndNotify$Type extends MessageType<LiveEndNotify> {
    ...
    internalBinaryWrite(message: LiveEndNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 live_id = 12; */
        if (message.liveId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.liveId);
