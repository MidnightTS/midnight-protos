...
class MultistagePlayStageEndNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MultistagePlayStageEndNotify", [
            { no: 3, name: "group_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "play_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { groupId: 0, playIndex: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.playIndex !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.playIndex);
...
/**
 * @generated MessageType for protobuf message MultistagePlayStageEndNotify
 */
