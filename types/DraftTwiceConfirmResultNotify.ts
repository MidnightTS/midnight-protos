...
// @generated from protobuf file "DraftTwiceConfirmResultNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DraftTwiceConfirmResultNotify
 */
export interface DraftTwiceConfirmResultNotify {
    /**
     * @generated from protobuf field: bool is_all_agree = 14;
     */
    isAllAgree: boolean;
    /**
     * @generated from protobuf field: uint32 draft_id = 1;
     */
    draftId: number;
}
...
class DraftTwiceConfirmResultNotify$Type extends MessageType<DraftTwiceConfirmResultNotify> {
    ...
    internalBinaryWrite(message: DraftTwiceConfirmResultNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAllAgree !== false)
            writer.tag(14, WireType.Varint).bool(message.isAllAgree);
        /* uint32 draft_id = 1; */
