...
export interface PlayerLoginRsp {
    ...
    /**
     * @generated from protobuf field: string client_silence_md5 = 16;
     */
    ...
    /**
     * @generated from protobuf field: bool is_use_ability_hash = 5;
     */
    ...
    targetUid: number;
    /**
     * @generated from protobuf field: string register_cps = 99;
     */
    registerCps: string;
    /**
     * @generated from protobuf field: bool is_sc_open = 1522;
     */
    isScOpen: boolean;
    /**
    ...
    /**
     * @generated from protobuf field: bytes sc_info = 1888;
     */
    scInfo: Uint8Array;
    /**
    ...
    /**
     * @generated from protobuf field: string client_md5 = 1299;
     */
    clientMd5: string;
    /**
...
class PlayerLoginRsp$Type extends MessageType<PlayerLoginRsp> {
    ...
    internalBinaryWrite(message: PlayerLoginRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.clientSilenceMd5 !== "")
            writer.tag(16, WireType.LengthDelimited).string(message.clientSilenceMd5);
        ...
        if (message.isUseAbilityHash !== false)
            writer.tag(5, WireType.Varint).bool(message.isUseAbilityHash);
        /* bool is_audit = 930; */
        ...
        if (message.registerCps !== "")
            writer.tag(99, WireType.LengthDelimited).string(message.registerCps);
        /* bool is_sc_open = 1522; */
        if (message.isScOpen !== false)
            writer.tag(1522, WireType.Varint).bool(message.isScOpen);
        ...
        if (message.scInfo.length)
            writer.tag(1888, WireType.LengthDelimited).bytes(message.scInfo);
        ...
        if (message.clientMd5 !== "")
            writer.tag(1299, WireType.LengthDelimited).string(message.clientMd5);
        /* int32 retcode = 7; */
