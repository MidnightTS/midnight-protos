...
class SocialDetail$Type extends runtime_5.MessageType {
    constructor() {
        super("SocialDetail", [
            ...
            { no: 9, name: "online_state", kind: "enum", T: () => ["FriendOnlineState", FriendOnlineState_1.FriendOnlineState, "FRIEND_ONLINE_STATE_"] },
            ...
            { no: 24, name: "friend_enter_home_option", kind: "enum", T: () => ["FriendEnterHomeOption", FriendEnterHomeOption_1.FriendEnterHomeOption, "FRIEND_ENTER_HOME_OPTION_"] },
