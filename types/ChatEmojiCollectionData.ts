...
export class ChatEmojiCollectionData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        emoji_id_list?: number[];
    }) {
        super();
    ...
    set emoji_id_list(value: number[]) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ChatEmojiCollectionData {
    ...
    static deserializeBinary(bytes: Uint8Array): ChatEmojiCollectionData {
