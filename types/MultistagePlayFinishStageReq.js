...
exports.MultistagePlayFinishStageReq = void 0;
...
class MultistagePlayFinishStageReq$Type extends runtime_5.MessageType {
    constructor() {
        super("MultistagePlayFinishStageReq", [
            { no: 12, name: "group_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "play_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message MultistagePlayFinishStageReq
 */
