...
// @generated from protobuf file "DealAddFriendReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface DealAddFriendReq {
    /**
     * @generated from protobuf field: DealAddFriendResultType deal_add_friend_result = 7;
     */
...
class DealAddFriendReq$Type extends MessageType<DealAddFriendReq> {
    constructor() {
        super("DealAddFriendReq", [
            { no: 7, name: "deal_add_friend_result", kind: "enum", T: () => ["DealAddFriendResultType", DealAddFriendResultType, "DEAL_ADD_FRIEND_RESULT_TYPE_"] },
    ...
    internalBinaryWrite(message: DealAddFriendReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dealAddFriendResult !== 0)
            writer.tag(7, WireType.Varint).int32(message.dealAddFriendResult);
