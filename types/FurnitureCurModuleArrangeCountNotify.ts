...
// @generated from protobuf file "FurnitureCurModuleArrangeCountNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface FurnitureCurModuleArrangeCountNotify {
    /**
     * @generated from protobuf field: repeated Uint32Pair furniture_arrange_count_list = 3;
     */
...
class FurnitureCurModuleArrangeCountNotify$Type extends MessageType<FurnitureCurModuleArrangeCountNotify> {
    constructor() {
        super("FurnitureCurModuleArrangeCountNotify", [
            { no: 3, name: "furniture_arrange_count_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Uint32Pair }
        ]);
    }
    ...
    internalBinaryWrite(message: FurnitureCurModuleArrangeCountNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.furnitureArrangeCountList.length; i++)
            Uint32Pair.internalBinaryWrite(message.furnitureArrangeCountList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
