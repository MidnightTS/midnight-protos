...
// @generated from protobuf file "SignatureAuditConfigNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SignatureAuditConfigNotify
 */
export interface SignatureAuditConfigNotify {
    ...
    isOpen: boolean;
    /**
     * @generated from protobuf field: uint32 submit_limit = 11;
     */
    submitLimit: number;
}
...
class SignatureAuditConfigNotify$Type extends MessageType<SignatureAuditConfigNotify> {
    ...
    internalBinaryWrite(message: SignatureAuditConfigNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.submitLimit !== 0)
            writer.tag(11, WireType.Varint).uint32(message.submitLimit);
