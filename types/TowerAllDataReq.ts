...
// @generated from protobuf file "TowerAllDataReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TowerAllDataReq
 */
export interface TowerAllDataReq {
    /**
     * @generated from protobuf field: bool is_interact = 15;
     */
    isInteract: boolean;
}
...
class TowerAllDataReq$Type extends MessageType<TowerAllDataReq> {
    ...
    internalBinaryWrite(message: TowerAllDataReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isInteract !== false)
            writer.tag(15, WireType.Varint).bool(message.isInteract);
