...
// @generated from protobuf file "RogueDungeonPlayerCellChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RogueDungeonPlayerCellChangeNotify
 */
export interface RogueDungeonPlayerCellChangeNotify {
    ...
    cellId: number;
    /**
     * @generated from protobuf field: uint32 old_cell_id = 7;
     */
    oldCellId: number;
}
...
class RogueDungeonPlayerCellChangeNotify$Type extends MessageType<RogueDungeonPlayerCellChangeNotify> {
    ...
    internalBinaryWrite(message: RogueDungeonPlayerCellChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.oldCellId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.oldCellId);
