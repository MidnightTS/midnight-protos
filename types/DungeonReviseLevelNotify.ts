...
export interface DungeonReviseLevelNotify {
    ...
    dungeonId: number;
    /**
     * @generated from protobuf field: uint32 revise_level = 3;
     */
    reviseLevel: number;
    /**
     * @generated from protobuf field: uint32 scene_level = 15;
     */
    sceneLevel: number;
}
...
class DungeonReviseLevelNotify$Type extends MessageType<DungeonReviseLevelNotify> {
    ...
    internalBinaryWrite(message: DungeonReviseLevelNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reviseLevel !== 0)
            writer.tag(3, WireType.Varint).uint32(message.reviseLevel);
        /* uint32 scene_level = 15; */
        if (message.sceneLevel !== 0)
            writer.tag(15, WireType.Varint).uint32(message.sceneLevel);
