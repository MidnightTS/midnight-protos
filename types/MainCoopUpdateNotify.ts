...
// @generated from protobuf file "MainCoopUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MainCoopUpdateNotify
 */
export interface MainCoopUpdateNotify {
    /**
     * @generated from protobuf field: repeated MainCoop main_coop_list = 10;
     */
...
class MainCoopUpdateNotify$Type extends MessageType<MainCoopUpdateNotify> {
    constructor() {
        super("MainCoopUpdateNotify", [
            { no: 10, name: "main_coop_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MainCoop }
        ]);
    }
    ...
    internalBinaryWrite(message: MainCoopUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.mainCoopList.length; i++)
            MainCoop.internalBinaryWrite(message.mainCoopList[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
