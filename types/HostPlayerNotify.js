...
class HostPlayerNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("HostPlayerNotify", [
            ...
            { no: 14, name: "host_uid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { hostPeerId: 0, hostUid: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.hostUid !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.hostUid);
