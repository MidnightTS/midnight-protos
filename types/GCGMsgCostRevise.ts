...
// @generated from protobuf file "GCGMsgCostRevise.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgCostRevise
 */
export interface GCGMsgCostRevise {
    /**
     * @generated from protobuf field: GCGCostReviseInfo cost_revise = 3;
     */
    costRevise?: GCGCostReviseInfo;
    /**
     * @generated from protobuf field: uint32 controller_id = 1;
     */
    controllerId: number;
}
...
class GCGMsgCostRevise$Type extends MessageType<GCGMsgCostRevise> {
    constructor() {
        super("GCGMsgCostRevise", [
            { no: 3, name: "cost_revise", kind: "message", T: () => GCGCostReviseInfo },
    ...
    internalBinaryWrite(message: GCGMsgCostRevise, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.costRevise)
            GCGCostReviseInfo.internalBinaryWrite(message.costRevise, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* uint32 controller_id = 1; */
        if (message.controllerId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.controllerId);
