...
// @generated from protobuf file "HomeFishFarmingInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeFishFarmingInfoNotify
 */
export interface HomeFishFarmingInfoNotify {
    /**
     * @generated from protobuf field: repeated HomeFishFarmingInfo fish_farming_info_list = 8;
     */
...
class HomeFishFarmingInfoNotify$Type extends MessageType<HomeFishFarmingInfoNotify> {
    constructor() {
        super("HomeFishFarmingInfoNotify", [
            { no: 8, name: "fish_farming_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeFishFarmingInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeFishFarmingInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fishFarmingInfoList.length; i++)
            HomeFishFarmingInfo.internalBinaryWrite(message.fishFarmingInfoList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
