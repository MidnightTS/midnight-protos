...
// @generated from protobuf file "PlantFlowerEditFlowerCombinationReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlantFlowerEditFlowerCombinationReq
 */
export interface PlantFlowerEditFlowerCombinationReq {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: CustomGadgetTreeInfo flower_combination_info = 8;
     */
...
class PlantFlowerEditFlowerCombinationReq$Type extends MessageType<PlantFlowerEditFlowerCombinationReq> {
    constructor() {
        super("PlantFlowerEditFlowerCombinationReq", [
            ...
            { no: 8, name: "flower_combination_info", kind: "message", T: () => CustomGadgetTreeInfo },
    ...
    internalBinaryWrite(message: PlantFlowerEditFlowerCombinationReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.flowerCombinationInfo)
            CustomGadgetTreeInfo.internalBinaryWrite(message.flowerCombinationInfo, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
