...
// @generated from protobuf file "GCGApplyInviteBattleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGApplyInviteBattleRsp
 */
export interface GCGApplyInviteBattleRsp {
    /**
     * @generated from protobuf field: uint32 punish_end_time = 6;
     */
...
class GCGApplyInviteBattleRsp$Type extends MessageType<GCGApplyInviteBattleRsp> {
    ...
    internalBinaryWrite(message: GCGApplyInviteBattleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.punishEndTime !== 0)
            writer.tag(6, WireType.Varint).uint32(message.punishEndTime);
        /* int32 retcode = 8; */
