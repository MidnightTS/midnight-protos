...
exports.GCGClientSettleRsp = void 0;
...
class GCGClientSettleRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGClientSettleRsp", [
            { no: 5, name: "close_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 9, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { closeTime: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.closeTime !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.closeTime);
        /* int32 retcode = 9; */
...
/**
 * @generated MessageType for protobuf message GCGClientSettleRsp
 */
