...
// @generated from protobuf file "AISnapshotInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { AISnapshotEntityData } from "./AISnapshotEntityData";
/**
 * @generated from protobuf message AISnapshotInfo
 */
export interface AISnapshotInfo {
    /**
     * @generated from protobuf field: repeated AISnapshotEntityData ai_snapshots = 1;
     */
...
class AISnapshotInfo$Type extends MessageType<AISnapshotInfo> {
    constructor() {
        super("AISnapshotInfo", [
            { no: 1, name: "ai_snapshots", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AISnapshotEntityData }
        ]);
    }
    ...
    internalBinaryWrite(message: AISnapshotInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.aiSnapshots.length; i++)
            AISnapshotEntityData.internalBinaryWrite(message.aiSnapshots[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
