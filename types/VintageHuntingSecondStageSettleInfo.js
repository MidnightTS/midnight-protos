...
exports.VintageHuntingSecondStageSettleInfo = void 0;
...
class VintageHuntingSecondStageSettleInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.captureAnimalNum !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.captureAnimalNum);
        /* map<uint32, uint32> animal_count_map = 3; */
        for (let k of Object.keys(message.animalCountMap))
            writer.tag(3, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_1.WireType.Varint).uint32(message.animalCountMap[k]).join();
        /* uint32 total_num = 1; */
        if (message.totalNum !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.totalNum);
