...
// @generated from protobuf file "FungusRenameReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FungusRenameReq
 */
export interface FungusRenameReq {
    /**
     * @generated from protobuf field: uint32 fungus_id = 12;
     */
    fungusId: number;
    /**
     * @generated from protobuf field: uint32 name_id = 11;
     */
    nameId: number;
}
...
class FungusRenameReq$Type extends MessageType<FungusRenameReq> {
    ...
    internalBinaryWrite(message: FungusRenameReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fungusId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.fungusId);
        /* uint32 name_id = 11; */
        if (message.nameId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.nameId);
