...
// @generated from protobuf file "FoundationNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FoundationNotify
 */
export interface FoundationNotify {
    /**
     * @generated from protobuf field: FoundationInfo info = 6;
     */
    info?: FoundationInfo;
    /**
...
class FoundationNotify$Type extends MessageType<FoundationNotify> {
    constructor() {
        super("FoundationNotify", [
            { no: 6, name: "info", kind: "message", T: () => FoundationInfo },
    ...
    internalBinaryWrite(message: FoundationNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            FoundationInfo.internalBinaryWrite(message.info, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
