...
class ExitSceneWeatherAreaNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ExitSceneWeatherAreaNotify", [
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.weatherGadgetId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.weatherGadgetId);
...
/**
 * @generated MessageType for protobuf message ExitSceneWeatherAreaNotify
 */
