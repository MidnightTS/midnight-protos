...
// @generated from protobuf file "FleurFairBuffEnergyNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FleurFairBuffEnergyNotify
 */
export interface FleurFairBuffEnergyNotify {
    /**
     * @generated from protobuf field: uint32 energy = 13;
     */
    energy: number;
}
...
class FleurFairBuffEnergyNotify$Type extends MessageType<FleurFairBuffEnergyNotify> {
    ...
    internalBinaryWrite(message: FleurFairBuffEnergyNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 energy = 13; */
        if (message.energy !== 0)
            writer.tag(13, WireType.Varint).uint32(message.energy);
