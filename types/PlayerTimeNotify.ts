...
// @generated from protobuf file "PlayerTimeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface PlayerTimeNotify {
    /**
     * @generated from protobuf field: bool is_paused = 12;
     */
    isPaused: boolean;
    /**
     * @generated from protobuf field: uint64 player_time = 11;
     */
    playerTime: bigint;
    /**
     * @generated from protobuf field: uint64 server_time = 5;
     */
    serverTime: bigint;
}
...
class PlayerTimeNotify$Type extends MessageType<PlayerTimeNotify> {
    ...
    internalBinaryWrite(message: PlayerTimeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isPaused !== false)
            writer.tag(12, WireType.Varint).bool(message.isPaused);
