...
// @generated from protobuf file "SetUpLunchBoxWidgetReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface SetUpLunchBoxWidgetReq {
    /**
     * @generated from protobuf field: LunchBoxData lunch_box_data = 7;
     */
...
class SetUpLunchBoxWidgetReq$Type extends MessageType<SetUpLunchBoxWidgetReq> {
    constructor() {
        super("SetUpLunchBoxWidgetReq", [
            { no: 7, name: "lunch_box_data", kind: "message", T: () => LunchBoxData }
        ]);
    }
    ...
    internalBinaryWrite(message: SetUpLunchBoxWidgetReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.lunchBoxData)
            LunchBoxData.internalBinaryWrite(message.lunchBoxData, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
