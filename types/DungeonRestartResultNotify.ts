...
export class DungeonRestartResultNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        is_add_accpet?: boolean;
    }) {
        super();
    ...
    set is_add_accpet(value: boolean) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DungeonRestartResultNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): DungeonRestartResultNotify {
