...
// @generated from protobuf file "DungeonRestartResultNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonRestartResultNotify
 */
export interface DungeonRestartResultNotify {
    /**
     * @generated from protobuf field: bool is_add_accept = 9;
     */
    isAddAccept: boolean;
}
...
class DungeonRestartResultNotify$Type extends MessageType<DungeonRestartResultNotify> {
    ...
    internalBinaryWrite(message: DungeonRestartResultNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAddAccept !== false)
            writer.tag(9, WireType.Varint).bool(message.isAddAccept);
