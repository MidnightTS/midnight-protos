...
// @generated from protobuf file "GachaOpenWishNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GachaOpenWishNotify
 */
export interface GachaOpenWishNotify {
    /**
     * @generated from protobuf field: uint32 gacha_schedule_id = 1;
     */
...
class GachaOpenWishNotify$Type extends MessageType<GachaOpenWishNotify> {
    ...
    internalBinaryWrite(message: GachaOpenWishNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.gachaScheduleId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.gachaScheduleId);
