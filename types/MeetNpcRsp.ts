...
// @generated from protobuf file "MeetNpcRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MeetNpcRsp
 */
export interface MeetNpcRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 npc_first_met_id = 7;
     */
...
class MeetNpcRsp$Type extends MessageType<MeetNpcRsp> {
    ...
    internalBinaryWrite(message: MeetNpcRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.npcFirstMetId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.npcFirstMetId);
