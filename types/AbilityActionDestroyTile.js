...
exports.AbilityActionDestroyTile = void 0;
...
class AbilityActionDestroyTile$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Vector rot = 5; */
        if (message.rot)
            Vector_1.Vector.internalBinaryWrite(message.rot, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
