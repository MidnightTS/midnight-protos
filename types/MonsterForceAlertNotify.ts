...
// @generated from protobuf file "MonsterForceAlertNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MonsterForceAlertNotify
 */
export interface MonsterForceAlertNotify {
    /**
     * @generated from protobuf field: uint32 monster_entity_id = 1;
     */
...
class MonsterForceAlertNotify$Type extends MessageType<MonsterForceAlertNotify> {
    ...
    internalBinaryWrite(message: MonsterForceAlertNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.monsterEntityId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.monsterEntityId);
