...
// @generated from protobuf file "SeaLampSectionInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SeaLampSectionInfo
 */
export interface SeaLampSectionInfo {
    /**
     * @generated from protobuf field: uint32 section_id = 8;
     */
    sectionId: number;
}
...
class SeaLampSectionInfo$Type extends MessageType<SeaLampSectionInfo> {
    ...
    internalBinaryWrite(message: SeaLampSectionInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sectionId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.sectionId);
