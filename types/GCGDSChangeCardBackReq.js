...
exports.GCGDSChangeCardBackReq = void 0;
...
class GCGDSChangeCardBackReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSChangeCardBackReq", [
            { no: 15, name: "card_back_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "deck_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { cardBackId: 0, deckId: 0 };
...
/**
 * @generated MessageType for protobuf message GCGDSChangeCardBackReq
 */
