...
// @generated from protobuf file "RequestLiveInfoReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RequestLiveInfoReq
 */
export interface RequestLiveInfoReq {
    /**
     * @generated from protobuf field: uint32 live_id = 13;
     */
    liveId: number;
}
...
class RequestLiveInfoReq$Type extends MessageType<RequestLiveInfoReq> {
    ...
    internalBinaryWrite(message: RequestLiveInfoReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 live_id = 13; */
        if (message.liveId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.liveId);
