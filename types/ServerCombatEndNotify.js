...
exports.ServerCombatEndNotify = void 0;
...
class ServerCombatEndNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ServerCombatEndNotify", [
            { no: 15, name: "combat_end_type_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 combat_end_type_list */ 15:
...
/**
 * @generated MessageType for protobuf message ServerCombatEndNotify
 */
