...
// @generated from protobuf file "GCGMsgCardUpdate.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgCardUpdate
 */
export interface GCGMsgCardUpdate {
    /**
     * @generated from protobuf field: GCGCard card = 14;
     */
    card?: GCGCard;
}
...
class GCGMsgCardUpdate$Type extends MessageType<GCGMsgCardUpdate> {
    constructor() {
        super("GCGMsgCardUpdate", [
            { no: 14, name: "card", kind: "message", T: () => GCGCard }
        ]);
    }
    ...
    internalBinaryWrite(message: GCGMsgCardUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* GCGCard card = 14; */
        if (message.card)
            GCGCard.internalBinaryWrite(message.card, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
