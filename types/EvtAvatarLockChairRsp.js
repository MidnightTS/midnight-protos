...
class EvtAvatarLockChairRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("EvtAvatarLockChairRsp", [
            ...
            { no: 15, name: "position", kind: "message", T: () => Vector_1.Vector }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Vector position = 15; */
        if (message.position)
            Vector_1.Vector.internalBinaryWrite(message.position, writer.tag(15, runtime_1.WireType.LengthDelimited).fork(), options).join();
