...
// @generated from protobuf file "SumoStageData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SumoStageData
 */
export interface SumoStageData {
    ...
    openTime: number;
    /**
     * @generated from protobuf field: repeated SumoTeamData team_list = 1;
     */
...
class SumoStageData$Type extends MessageType<SumoStageData> {
    constructor() {
        super("SumoStageData", [
            ...
            { no: 1, name: "team_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SumoTeamData },
    ...
    internalBinaryWrite(message: SumoStageData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.teamList.length; i++)
            SumoTeamData.internalBinaryWrite(message.teamList[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* uint32 max_score = 7; */
