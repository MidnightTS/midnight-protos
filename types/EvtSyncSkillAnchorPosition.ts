...
// @generated from protobuf file "EvtSyncSkillAnchorPosition.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message EvtSyncSkillAnchorPosition
 */
export interface EvtSyncSkillAnchorPosition {
    /**
     * @generated from protobuf field: Vector skill_anchor_position = 12;
     */
...
class EvtSyncSkillAnchorPosition$Type extends MessageType<EvtSyncSkillAnchorPosition> {
    constructor() {
        super("EvtSyncSkillAnchorPosition", [
            { no: 12, name: "skill_anchor_position", kind: "message", T: () => Vector },
    ...
    internalBinaryWrite(message: EvtSyncSkillAnchorPosition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.skillAnchorPosition)
            Vector.internalBinaryWrite(message.skillAnchorPosition, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 7; */
