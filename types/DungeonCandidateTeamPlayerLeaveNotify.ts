...
// @generated from protobuf file "DungeonCandidateTeamPlayerLeaveNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { DungeonCandidateTeamPlayerLeaveReason } from "./DungeonCandidateTeamPlayerLeaveReason";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message DungeonCandidateTeamPlayerLeaveNotify
 */
export interface DungeonCandidateTeamPlayerLeaveNotify {
    ...
    playerUid: number;
    /**
     * @generated from protobuf field: DungeonCandidateTeamPlayerLeaveReason reason = 1;
     */
...
class DungeonCandidateTeamPlayerLeaveNotify$Type extends MessageType<DungeonCandidateTeamPlayerLeaveNotify> {
    constructor() {
        super("DungeonCandidateTeamPlayerLeaveNotify", [
            ...
            { no: 1, name: "reason", kind: "enum", T: () => ["DungeonCandidateTeamPlayerLeaveReason", DungeonCandidateTeamPlayerLeaveReason, "DUNGEON_CANDIDATE_TEAM_PLAYER_LEAVE_REASON_"] }
        ]);
    }
