...
import * as dependency_1 from "./DungeonCandidateTeamPlayerLeaveReason";
import * as pb_1 from "google-protobuf";
export class DungeonCandidateTeamPlayerLeaveNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        reason?: dependency_1.DungeonCandidateTeamPlayerLeaveReason;
        player_uid?: number;
    }) {
        super();
    ...
    get reason() {
        return pb_1.Message.getFieldWithDefault(this, 3, dependency_1.DungeonCandidateTeamPlayerLeaveReason.DUNGEON_CANDIDATE_TEAM_PLAYER_LEAVE_REASON_TPLR_NORMAL) as dependency_1.DungeonCandidateTeamPlayerLeaveReason;
    }
    set reason(value: dependency_1.DungeonCandidateTeamPlayerLeaveReason) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DungeonCandidateTeamPlayerLeaveNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): DungeonCandidateTeamPlayerLeaveNotify {
