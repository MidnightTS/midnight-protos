...
class CoopCgUpdateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CoopCgUpdateNotify", [
            { no: 8, name: "cg_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 cg_list */ 8:
...
/**
 * @generated MessageType for protobuf message CoopCgUpdateNotify
 */
