...
// @generated from protobuf file "WidgetSlotData.proto" (syntax proto3)
// tslint:disable
//
...
export interface WidgetSlotData {
    /**
     * @generated from protobuf field: uint32 cd_over_time = 15;
     */
    cdOverTime: number;
    /**
    ...
    isActive: boolean;
    /**
     * @generated from protobuf field: uint32 material_id = 8;
     */
    materialId: number;
    /**
     * @generated from protobuf field: WidgetSlotTag tag = 11;
     */
    tag: WidgetSlotTag;
}
...
class WidgetSlotData$Type extends MessageType<WidgetSlotData> {
    constructor() {
        super("WidgetSlotData", [
            ...
            { no: 11, name: "tag", kind: "enum", T: () => ["WidgetSlotTag", WidgetSlotTag, "WIDGET_SLOT_TAG_"] }
        ]);
    }
    ...
    internalBinaryWrite(message: WidgetSlotData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.tag !== 0)
            writer.tag(11, WireType.Varint).int32(message.tag);
