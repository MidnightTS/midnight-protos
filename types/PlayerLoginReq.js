...
class PlayerLoginReq$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.securityLibraryMd5 !== "")
            writer.tag(868, runtime_1.WireType.LengthDelimited).string(message.securityLibraryMd5);
        ...
        if (message.subChannelId !== 0)
            writer.tag(1458, runtime_1.WireType.Varint).uint32(message.subChannelId);
        /* bool is_editor = 1; */
        ...
        /* uint32 gm_uid = 1790; */
        if (message.gmUid !== 0)
            writer.tag(1790, runtime_1.WireType.Varint).uint32(message.gmUid);
        ...
        if (message.securityLibraryVersion !== "")
            writer.tag(828, runtime_1.WireType.LengthDelimited).string(message.securityLibraryVersion);
