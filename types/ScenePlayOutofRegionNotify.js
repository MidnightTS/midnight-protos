...
exports.ScenePlayOutofRegionNotify = void 0;
...
class ScenePlayOutofRegionNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ScenePlayOutofRegionNotify", [
            { no: 6, name: "play_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { playId: 0 };
...
/**
 * @generated MessageType for protobuf message ScenePlayOutofRegionNotify
 */
