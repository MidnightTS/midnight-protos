...
var _GetHuntingOfferRewardRsp_one_of_decls;
...
class GetHuntingOfferRewardRsp extends pb_1.Message {
    constructor(data) {
        super();
        _GetHuntingOfferRewardRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _GetHuntingOfferRewardRsp_one_of_decls, "f"));
...
exports.GetHuntingOfferRewardRsp = GetHuntingOfferRewardRsp;
_GetHuntingOfferRewardRsp_one_of_decls = new WeakMap();
