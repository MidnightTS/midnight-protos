...
var _GetBlossomBriefInfoListReq_one_of_decls;
...
class GetBlossomBriefInfoListReq extends pb_1.Message {
    constructor(data) {
        super();
        _GetBlossomBriefInfoListReq_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _GetBlossomBriefInfoListReq_one_of_decls, "f"));
...
exports.GetBlossomBriefInfoListReq = GetBlossomBriefInfoListReq;
_GetBlossomBriefInfoListReq_one_of_decls = new WeakMap();
