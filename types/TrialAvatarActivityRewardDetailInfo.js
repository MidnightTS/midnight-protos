...
class TrialAvatarActivityRewardDetailInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("TrialAvatarActivityRewardDetailInfo", [
            ...
            { no: 14, name: "Unk3300_IFEPGCKHODL", kind: "scalar", jsonName: "Unk3300IFEPGCKHODL", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "Unk3300_NEJLGBBFDPH", kind: "scalar", jsonName: "Unk3300NEJLGBBFDPH", T: 8 /*ScalarType.BOOL*/ },
            { no: 11, name: "reward_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { trialAvatarIndexId: 0, unk3300IFEPGCKHODL: false, unk3300NEJLGBBFDPH: false, rewardId: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 trial_avatar_index_id */ 4:
                    ...
                    break;
                case /* bool Unk3300_IFEPGCKHODL = 14 [json_name = "Unk3300IFEPGCKHODL"];*/ 14:
                    message.unk3300IFEPGCKHODL = reader.bool();
                    break;
                case /* bool Unk3300_NEJLGBBFDPH = 5 [json_name = "Unk3300NEJLGBBFDPH"];*/ 5:
                    message.unk3300NEJLGBBFDPH = reader.bool();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* bool Unk3300_IFEPGCKHODL = 14 [json_name = "Unk3300IFEPGCKHODL"]; */
        if (message.unk3300IFEPGCKHODL !== false)
            writer.tag(14, runtime_1.WireType.Varint).bool(message.unk3300IFEPGCKHODL);
        /* bool Unk3300_NEJLGBBFDPH = 5 [json_name = "Unk3300NEJLGBBFDPH"]; */
        if (message.unk3300NEJLGBBFDPH !== false)
            writer.tag(5, runtime_1.WireType.Varint).bool(message.unk3300NEJLGBBFDPH);
        /* uint32 reward_id = 11; */
