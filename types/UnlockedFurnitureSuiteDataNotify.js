...
exports.UnlockedFurnitureSuiteDataNotify = void 0;
...
class UnlockedFurnitureSuiteDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("UnlockedFurnitureSuiteDataNotify", [
            { no: 1, name: "is_all", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "furniture_suite_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_all */ 1:
                    ...
                    break;
                case /* repeated uint32 furniture_suite_id_list */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isAll !== false)
            writer.tag(1, runtime_2.WireType.Varint).bool(message.isAll);
