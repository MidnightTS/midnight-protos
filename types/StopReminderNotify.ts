...
// @generated from protobuf file "StopReminderNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StopReminderNotify
 */
export interface StopReminderNotify {
    /**
     * @generated from protobuf field: uint32 reminder_id = 3;
     */
    reminderId: number;
}
...
class StopReminderNotify$Type extends MessageType<StopReminderNotify> {
    ...
    internalBinaryWrite(message: StopReminderNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reminderId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.reminderId);
