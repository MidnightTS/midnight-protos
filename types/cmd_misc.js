...
// @generated from protobuf file "cmd_misc.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class ShowMessageNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.ShowMessageNotify", [
            ...
            { no: 13, name: "params", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MsgParam }
        ]);
    }
    create(value) {
...
class GetOnlinePlayerListRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.GetOnlinePlayerListRsp", [
            ...
            { no: 5, name: "player_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => define_2.OnlinePlayerInfo }
        ]);
    }
    create(value) {
...
class UnionCmdNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.UnionCmdNotify", [
            { no: 1, name: "cmd_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.UnionCmd }
        ]);
    }
    create(value) {
...
class CheckSegmentCRCNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.CheckSegmentCRCNotify", [
            { no: 6, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.SegmentInfo }
        ]);
    }
    create(value) {
...
class CheckSegmentCRCReq$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.CheckSegmentCRCReq", [
            { no: 1, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.SegmentCRCInfo }
        ]);
    }
    create(value) {
        const message = { infoList: [] };
...
class WorldPlayerRTTNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.WorldPlayerRTTNotify", [
            { no: 1, name: "player_rtt_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.PlayerRTTInfo }
        ]);
    }
    create(value) {
...
class UpdateRedPointNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.UpdateRedPointNotify", [
            { no: 12, name: "red_point_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => define_1.RedPointData }
        ]);
    }
    create(value) {
