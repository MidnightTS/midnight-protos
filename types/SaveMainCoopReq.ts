...
export interface SaveMainCoopReq {
    /**
     * @generated from protobuf field: map<uint32, int32> Unk3300_JFPLEDLNJPF = 14 [json_name = "Unk3300JFPLEDLNJPF"];
     */
    unk3300JFPLEDLNJPF: {
        [key: number]: number;
    };
    ...
    savePointId: number;
    /**
     * @generated from protobuf field: map<uint32, int32> Unk3300_OMEEMFJFKBH = 12 [json_name = "Unk3300OMEEMFJFKBH"];
     */
    unk3300OMEEMFJFKBH: {
        [key: number]: number;
    };
...
class SaveMainCoopReq$Type extends MessageType<SaveMainCoopReq> {
    ...
    private binaryReadMap14(map: SaveMainCoopReq["unk3300JFPLEDLNJPF"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof SaveMainCoopReq["unk3300JFPLEDLNJPF"] | undefined, val: SaveMainCoopReq["unk3300JFPLEDLNJPF"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    private binaryReadMap12(map: SaveMainCoopReq["unk3300OMEEMFJFKBH"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof SaveMainCoopReq["unk3300OMEEMFJFKBH"] | undefined, val: SaveMainCoopReq["unk3300OMEEMFJFKBH"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: SaveMainCoopReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.unk3300JFPLEDLNJPF))
            writer.tag(14, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).int32(message.unk3300JFPLEDLNJPF[k as any]).join();
        ...
        for (let k of Object.keys(message.unk3300OMEEMFJFKBH))
            writer.tag(12, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).int32(message.unk3300OMEEMFJFKBH[k as any]).join();
