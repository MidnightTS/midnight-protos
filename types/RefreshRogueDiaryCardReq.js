...
exports.RefreshRogueDiaryCardReq = void 0;
...
class RefreshRogueDiaryCardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("RefreshRogueDiaryCardReq", [
            { no: 9, name: "refresh_card_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 refresh_card_list */ 9:
...
/**
 * @generated MessageType for protobuf message RefreshRogueDiaryCardReq
 */
