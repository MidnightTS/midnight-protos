...
// @generated from protobuf file "HomeSetBlueprintFriendOptionRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeSetBlueprintFriendOptionRsp
 */
export interface HomeSetBlueprintFriendOptionRsp {
    /**
     * @generated from protobuf field: bool is_allow_friend_copy = 14;
     */
...
class HomeSetBlueprintFriendOptionRsp$Type extends MessageType<HomeSetBlueprintFriendOptionRsp> {
    ...
    internalBinaryWrite(message: HomeSetBlueprintFriendOptionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAllowFriendCopy !== false)
            writer.tag(14, WireType.Varint).bool(message.isAllowFriendCopy);
        /* int32 retcode = 13; */
