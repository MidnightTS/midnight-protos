...
class MistTrialSelectAvatarAndEnterDungeonRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("MistTrialSelectAvatarAndEnterDungeonRsp", [
            { no: 2, name: "trial_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { trialId: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.trialId !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.trialId);
        /* int32 retcode = 7; */
...
/**
 * @generated MessageType for protobuf message MistTrialSelectAvatarAndEnterDungeonRsp
 */
