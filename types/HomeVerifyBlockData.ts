...
// @generated from protobuf file "HomeVerifyBlockData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message HomeVerifyBlockData
 */
export interface HomeVerifyBlockData {
    /**
     * @generated from protobuf field: uint32 block_id = 11;
     */
    blockId: number;
    /**
     * @generated from protobuf field: uint32 furniture_count = 13;
     */
...
class HomeVerifyBlockData$Type extends MessageType<HomeVerifyBlockData> {
    ...
    internalBinaryWrite(message: HomeVerifyBlockData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.blockId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.blockId);
        /* uint32 furniture_count = 13; */
        if (message.furnitureCount !== 0)
            writer.tag(13, WireType.Varint).uint32(message.furnitureCount);
