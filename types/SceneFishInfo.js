...
class SceneFishInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneFishInfo", [
            ...
            { no: 5, name: "last_shock_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { fishId: 0, fishPoolEntityId: 0, fishPoolGadgetId: 0, lastShockTime: 0 };
