...
// @generated from protobuf file "cmd_mail.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class MailChangeNotify$Type extends MessageType<MailChangeNotify> {
    constructor() {
        super("com.midnights.game.MailChangeNotify", [
            { no: 14, name: "mail_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MailData },
...
class GetMailItemRsp$Type extends MessageType<GetMailItemRsp> {
    constructor() {
        super("com.midnights.game.GetMailItemRsp", [
            ...
            { no: 2, name: "item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => EquipParam }
        ]);
    }
...
class GetAllMailResultNotify$Type extends MessageType<GetAllMailResultNotify> {
    constructor() {
        super("com.midnights.game.GetAllMailResultNotify", [
            ...
            { no: 5, name: "mail_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MailData },
