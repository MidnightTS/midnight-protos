...
class HomeLimitedShopBuyGoodsReq$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeLimitedShopBuyGoodsReq", [
            { no: 6, name: "goods", kind: "message", T: () => HomeLimitedShopGoods_1.HomeLimitedShopGoods },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.goods)
            HomeLimitedShopGoods_1.HomeLimitedShopGoods.internalBinaryWrite(message.goods, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 buy_count = 13; */
