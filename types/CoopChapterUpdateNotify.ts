...
// @generated from protobuf file "CoopChapterUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CoopChapterUpdateNotify
 */
export interface CoopChapterUpdateNotify {
    /**
     * @generated from protobuf field: repeated CoopChapter chapter_list = 4;
     */
...
class CoopChapterUpdateNotify$Type extends MessageType<CoopChapterUpdateNotify> {
    constructor() {
        super("CoopChapterUpdateNotify", [
            { no: 4, name: "chapter_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CoopChapter }
        ]);
    }
    ...
    internalBinaryWrite(message: CoopChapterUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.chapterList.length; i++)
            CoopChapter.internalBinaryWrite(message.chapterList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
