...
// @generated from protobuf file "cmd_property.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class LifeStateChangeNotify$Type extends MessageType<LifeStateChangeNotify> {
    constructor() {
        super("com.midnights.game.LifeStateChangeNotify", [
            ...
            { no: 6, name: "server_buff_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ServerBuff },
...
class AvatarLifeStateChangeNotify$Type extends MessageType<AvatarLifeStateChangeNotify> {
    constructor() {
        super("com.midnights.game.AvatarLifeStateChangeNotify", [
            ...
            { no: 12, name: "server_buff_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ServerBuff },
