...
// @generated from protobuf file "cmd_reunion.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class ReunionMissionInfo$Type extends MessageType<ReunionMissionInfo> {
    constructor() {
        super("com.midnights.game.ReunionMissionInfo", [
            { no: 3, name: "cur_day_watcher_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ReunionWatcherInfo },
            ...
            { no: 2, name: "watcher_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ReunionWatcherInfo }
        ]);
    }
