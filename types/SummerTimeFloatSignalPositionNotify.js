...
var _SummerTimeFloatSignalPositionNotify_one_of_decls;
...
class SummerTimeFloatSignalPositionNotify extends pb_1.Message {
    constructor(data) {
        super();
        _SummerTimeFloatSignalPositionNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SummerTimeFloatSignalPositionNotify_one_of_decls, "f"));
...
exports.SummerTimeFloatSignalPositionNotify = SummerTimeFloatSignalPositionNotify;
_SummerTimeFloatSignalPositionNotify_one_of_decls = new WeakMap();
