...
// @generated from protobuf file "AddQuestContentProgressReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface AddQuestContentProgressReq {
    /**
     * @generated from protobuf field: uint32 content_type = 1;
     */
    contentType: number;
    /**
     * @generated from protobuf field: uint32 add_progress = 6;
     */
    addProgress: number;
    /**
...
class AddQuestContentProgressReq$Type extends MessageType<AddQuestContentProgressReq> {
    ...
    internalBinaryWrite(message: AddQuestContentProgressReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.contentType !== 0)
            writer.tag(1, WireType.Varint).uint32(message.contentType);
