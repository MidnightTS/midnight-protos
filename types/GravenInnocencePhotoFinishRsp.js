...
exports.GravenInnocencePhotoFinishRsp = void 0;
...
class GravenInnocencePhotoFinishRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GravenInnocencePhotoFinishRsp", [
            { no: 15, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "object_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "param", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, objectId: 0, param: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.objectId !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.objectId);
        /* uint32 param = 10; */
        if (message.param !== 0)
...
/**
 * @generated MessageType for protobuf message GravenInnocencePhotoFinishRsp
 */
