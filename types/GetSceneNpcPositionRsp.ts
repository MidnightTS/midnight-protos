...
// @generated from protobuf file "GetSceneNpcPositionRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { NpcPositionInfo } from "./NpcPositionInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetSceneNpcPositionRsp
 */
export interface GetSceneNpcPositionRsp {
    ...
    sceneId: number;
    /**
     * @generated from protobuf field: repeated NpcPositionInfo npc_info_list = 2;
     */
...
class GetSceneNpcPositionRsp$Type extends MessageType<GetSceneNpcPositionRsp> {
    constructor() {
        super("GetSceneNpcPositionRsp", [
            ...
            { no: 2, name: "npc_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => NpcPositionInfo },
    ...
    internalBinaryWrite(message: GetSceneNpcPositionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.npcInfoList.length; i++)
            NpcPositionInfo.internalBinaryWrite(message.npcInfoList[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 5; */
