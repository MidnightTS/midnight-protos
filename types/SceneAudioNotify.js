...
var _SceneAudioNotify_one_of_decls;
...
class SceneAudioNotify extends pb_1.Message {
    constructor(data) {
        super();
        _SceneAudioNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [14, 11, 4], __classPrivateFieldGet(this, _SceneAudioNotify_one_of_decls, "f"));
...
exports.SceneAudioNotify = SceneAudioNotify;
_SceneAudioNotify_one_of_decls = new WeakMap();
