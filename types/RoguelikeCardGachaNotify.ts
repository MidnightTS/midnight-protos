...
// @generated from protobuf file "RoguelikeCardGachaNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RoguelikeCardGachaNotify
 */
export interface RoguelikeCardGachaNotify {
    /**
     * @generated from protobuf field: bool is_can_refresh = 7;
     */
...
class RoguelikeCardGachaNotify$Type extends MessageType<RoguelikeCardGachaNotify> {
    ...
    internalBinaryWrite(message: RoguelikeCardGachaNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isCanRefresh !== false)
            writer.tag(7, WireType.Varint).bool(message.isCanRefresh);
