...
class GCGTCInviteReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGTCInviteReq", [
            { no: 8, name: "character_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { characterId: 0, levelId: 0 };
...
/**
 * @generated MessageType for protobuf message GCGTCInviteReq
 */
