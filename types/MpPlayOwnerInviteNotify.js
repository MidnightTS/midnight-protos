...
class MpPlayOwnerInviteNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MpPlayOwnerInviteNotify", [
            { no: 11, name: "mp_play_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "is_remain_reward", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 7, name: "cd", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { mpPlayId: 0, isRemainReward: false, cd: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isRemainReward !== false)
            writer.tag(4, runtime_1.WireType.Varint).bool(message.isRemainReward);
        /* uint32 cd = 7; */
        if (message.cd !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.cd);
...
/**
 * @generated MessageType for protobuf message MpPlayOwnerInviteNotify
 */
