...
export interface GCGMsgPhaseChange {
    /**
     * @generated from protobuf field: GCGPhaseType before_phase = 15;
     */
    beforePhase: GCGPhaseType;
    /**
     * @generated from protobuf field: GCGPhaseType after_phase = 3;
     */
...
class GCGMsgPhaseChange$Type extends MessageType<GCGMsgPhaseChange> {
    constructor() {
        super("GCGMsgPhaseChange", [
            { no: 15, name: "before_phase", kind: "enum", T: () => ["GCGPhaseType", GCGPhaseType] },
            { no: 3, name: "after_phase", kind: "enum", T: () => ["GCGPhaseType", GCGPhaseType] },
    ...
    internalBinaryWrite(message: GCGMsgPhaseChange, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.beforePhase !== 0)
            writer.tag(15, WireType.Varint).int32(message.beforePhase);
        /* GCGPhaseType after_phase = 3; */
        if (message.afterPhase !== 0)
            writer.tag(3, WireType.Varint).int32(message.afterPhase);
