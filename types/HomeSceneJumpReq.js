...
class HomeSceneJumpReq$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeSceneJumpReq", [
            { no: 2, name: "is_enter_room_scene", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_enter_room_scene */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isEnterRoomScene !== false)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.isEnterRoomScene);
