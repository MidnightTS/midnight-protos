...
// @generated from protobuf file "AvatarChangeAnimHashRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AvatarChangeAnimHashRsp
 */
export interface AvatarChangeAnimHashRsp {
    /**
     * @generated from protobuf field: uint32 anim_hash = 3;
     */
    animHash: number;
    /**
...
class AvatarChangeAnimHashRsp$Type extends MessageType<AvatarChangeAnimHashRsp> {
    ...
    internalBinaryWrite(message: AvatarChangeAnimHashRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.animHash !== 0)
            writer.tag(3, WireType.Varint).uint32(message.animHash);
        /* int32 retcode = 1; */
