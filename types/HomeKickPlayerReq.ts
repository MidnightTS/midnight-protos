...
// @generated from protobuf file "HomeKickPlayerReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeKickPlayerReq
 */
export interface HomeKickPlayerReq {
    /**
     * @generated from protobuf field: bool is_kick_all = 14;
     */
    isKickAll: boolean;
    /**
...
class HomeKickPlayerReq$Type extends MessageType<HomeKickPlayerReq> {
    ...
    internalBinaryWrite(message: HomeKickPlayerReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isKickAll !== false)
            writer.tag(14, WireType.Varint).bool(message.isKickAll);
        /* uint32 target_uid = 2; */
