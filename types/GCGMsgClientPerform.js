...
exports.GCGMsgClientPerform = void 0;
const runtime_1 = require("@protobuf-ts/runtime");
const runtime_2 = require("@protobuf-ts/runtime");
const runtime_3 = require("@protobuf-ts/runtime");
const runtime_4 = require("@protobuf-ts/runtime");
const runtime_5 = require("@protobuf-ts/runtime");
const GCGClientPerformType_1 = require("./GCGClientPerformType");
...
class GCGMsgClientPerform$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGMsgClientPerform", [
            ...
            { no: 1, name: "perform_type", kind: "enum", T: () => ["GCGClientPerformType", GCGClientPerformType_1.GCGClientPerformType] }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.performType !== 0)
            writer.tag(1, runtime_2.WireType.Varint).int32(message.performType);
