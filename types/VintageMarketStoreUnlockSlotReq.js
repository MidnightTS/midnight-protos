...
exports.VintageMarketStoreUnlockSlotReq = void 0;
...
class VintageMarketStoreUnlockSlotReq$Type extends runtime_5.MessageType {
    constructor() {
        super("VintageMarketStoreUnlockSlotReq", [
            { no: 8, name: "store_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { storeId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.storeId !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.storeId);
...
/**
 * @generated MessageType for protobuf message VintageMarketStoreUnlockSlotReq
 */
