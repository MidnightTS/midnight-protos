...
import * as dependency_1 from "./Unk2700_IBEKDNOGMLA";
import * as pb_1 from "google-protobuf";
export class IrodoriChessInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        mystery_info?: dependency_1.Unk2700_IBEKDNOGMLA;
        left_monsters?: number;
        Unk2700_MABMPAAGHCJ?: number[];
    ...
    get mystery_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.Unk2700_IBEKDNOGMLA, 3) as dependency_1.Unk2700_IBEKDNOGMLA;
    }
    set mystery_info(value: dependency_1.Unk2700_IBEKDNOGMLA) {
    ...
    set Unk2700_MABMPAAGHCJ(value: number[]) {
    ...
    static fromObject(data: {
        mystery_info?: ReturnType<typeof dependency_1.Unk2700_IBEKDNOGMLA.prototype.toObject>;
        left_monsters?: number;
        Unk2700_MABMPAAGHCJ?: number[];
        building_points?: number;
        Unk2700_CDOKENJJJMH?: number;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): IrodoriChessInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): IrodoriChessInfo {
