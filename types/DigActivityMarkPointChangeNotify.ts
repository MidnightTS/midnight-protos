...
// @generated from protobuf file "DigActivityMarkPointChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { DigMarkPoint } from "./DigMarkPoint";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message DigActivityMarkPointChangeNotify
 */
export interface DigActivityMarkPointChangeNotify {
    /**
     * @generated from protobuf field: repeated DigMarkPoint dig_mark_point_list = 1;
     */
...
class DigActivityMarkPointChangeNotify$Type extends MessageType<DigActivityMarkPointChangeNotify> {
    constructor() {
        super("DigActivityMarkPointChangeNotify", [
            { no: 1, name: "dig_mark_point_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DigMarkPoint }
        ]);
    }
    ...
    internalBinaryWrite(message: DigActivityMarkPointChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.digMarkPointList.length; i++)
            DigMarkPoint.internalBinaryWrite(message.digMarkPointList[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
