...
// @generated from protobuf file "GCGMatchInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMatchInfo
 */
export interface GCGMatchInfo {
    /**
     * @generated from protobuf field: repeated MatchPlayerInfo player_list = 15;
     */
...
class GCGMatchInfo$Type extends MessageType<GCGMatchInfo> {
    constructor() {
        super("GCGMatchInfo", [
            { no: 15, name: "player_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MatchPlayerInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: GCGMatchInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.playerList.length; i++)
            MatchPlayerInfo.internalBinaryWrite(message.playerList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
