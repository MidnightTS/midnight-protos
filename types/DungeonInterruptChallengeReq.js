...
class DungeonInterruptChallengeReq$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonInterruptChallengeReq", [
    ...
    create(value) {
        const message = { challengeId: 0, groupId: 0, challengeIndex: 0 };
...
/**
 * @generated MessageType for protobuf message DungeonInterruptChallengeReq
 */
