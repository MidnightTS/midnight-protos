...
// @generated from protobuf file "TakeBackGivingItemReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeBackGivingItemReq
 */
export interface TakeBackGivingItemReq {
    /**
     * @generated from protobuf field: uint32 giving_id = 2;
     */
    givingId: number;
}
...
class TakeBackGivingItemReq$Type extends MessageType<TakeBackGivingItemReq> {
    ...
    internalBinaryWrite(message: TakeBackGivingItemReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.givingId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.givingId);
