...
// @generated from protobuf file "VehicleInteractReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface VehicleInteractReq {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 pos = 4;
     */
    pos: number;
}
...
class VehicleInteractReq$Type extends MessageType<VehicleInteractReq> {
    ...
    internalBinaryWrite(message: VehicleInteractReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 pos = 4; */
        if (message.pos !== 0)
            writer.tag(4, WireType.Varint).uint32(message.pos);
