...
// @generated from protobuf file "GroupLinkMarkUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GroupLinkMarkUpdateNotify
 */
export interface GroupLinkMarkUpdateNotify {
    /**
     * @generated from protobuf field: GroupLinkBundle bundle = 15;
     */
...
class GroupLinkMarkUpdateNotify$Type extends MessageType<GroupLinkMarkUpdateNotify> {
    constructor() {
        super("GroupLinkMarkUpdateNotify", [
            { no: 15, name: "bundle", kind: "message", T: () => GroupLinkBundle }
        ]);
    }
    ...
    internalBinaryWrite(message: GroupLinkMarkUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bundle)
            GroupLinkBundle.internalBinaryWrite(message.bundle, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
