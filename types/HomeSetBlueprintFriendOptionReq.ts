...
// @generated from protobuf file "HomeSetBlueprintFriendOptionReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeSetBlueprintFriendOptionReq
 */
export interface HomeSetBlueprintFriendOptionReq {
    /**
     * @generated from protobuf field: bool is_allow_friend_copy = 8;
     */
...
class HomeSetBlueprintFriendOptionReq$Type extends MessageType<HomeSetBlueprintFriendOptionReq> {
    ...
    internalBinaryWrite(message: HomeSetBlueprintFriendOptionReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAllowFriendCopy !== false)
            writer.tag(8, WireType.Varint).bool(message.isAllowFriendCopy);
