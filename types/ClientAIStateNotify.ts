...
// @generated from protobuf file "ClientAIStateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ClientAIStateNotify
 */
export interface ClientAIStateNotify {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 cur_tactic = 3;
     */
    curTactic: number;
}
...
class ClientAIStateNotify$Type extends MessageType<ClientAIStateNotify> {
    ...
    internalBinaryWrite(message: ClientAIStateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curTactic !== 0)
            writer.tag(3, WireType.Varint).uint32(message.curTactic);
