...
export class ScenePlayBattleUidOpNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        op?: number;
        param_target_list?: number[];
        entity_id?: number;
        param_str?: string;
        uid_list?: number[];
        param_index?: number;
        play_type?: number;
        param_duration?: number;
        param_list?: number[];
        play_id?: number;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [9, 6, 15], this.#one_of_decls);
    ...
    set param_target_list(value: number[]) {
    ...
    set param_duration(value: number) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ScenePlayBattleUidOpNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): ScenePlayBattleUidOpNotify {
