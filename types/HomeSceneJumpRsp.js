...
class HomeSceneJumpRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeSceneJumpRsp", [
            { no: 6, name: "is_enter_room_scene", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { isEnterRoomScene: false, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_enter_room_scene */ 6:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isEnterRoomScene !== false)
            writer.tag(6, runtime_1.WireType.Varint).bool(message.isEnterRoomScene);
        /* int32 retcode = 5; */
