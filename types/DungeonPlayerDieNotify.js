...
var _DungeonPlayerDieNotify_one_of_decls;
...
const dependency_2 = require("./StrengthenPointData");
const pb_1 = require("google-protobuf");
class DungeonPlayerDieNotify extends pb_1.Message {
    constructor(data) {
        super();
        _DungeonPlayerDieNotify_one_of_decls.set(this, [[4, 8]]);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DungeonPlayerDieNotify_one_of_decls, "f"));
    ...
    get die_type() {
        return pb_1.Message.getFieldWithDefault(this, 3, dependency_1.PlayerDieType.PLAYER_DIE_TYPE_NONE);
    }
    set die_type(value) {
    ...
    set monster_id(value) {
        pb_1.Message.setOneofField(this, 4, __classPrivateFieldGet(this, _DungeonPlayerDieNotify_one_of_decls, "f")[0], value);
    }
    get has_monster_id() {
    ...
    set gadget_id(value) {
        pb_1.Message.setOneofField(this, 8, __classPrivateFieldGet(this, _DungeonPlayerDieNotify_one_of_decls, "f")[0], value);
    }
    get has_gadget_id() {
...
exports.DungeonPlayerDieNotify = DungeonPlayerDieNotify;
_DungeonPlayerDieNotify_one_of_decls = new WeakMap();
