...
// @generated from protobuf file "SceneAreaWeatherNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface SceneAreaWeatherNotify {
    /**
     * @generated from protobuf field: uint32 weather_gadget_id = 6;
     */
    weatherGadgetId: number;
    /**
     * @generated from protobuf field: map<uint32, string> weather_value_map = 11;
     */
    weatherValueMap: {
        [key: number]: string;
    };
    /**
     * @generated from protobuf field: uint32 climate_type = 7;
     */
    climateType: number;
    /**
     * @generated from protobuf field: float trans_duration = 10;
     */
...
class SceneAreaWeatherNotify$Type extends MessageType<SceneAreaWeatherNotify> {
    ...
    private binaryReadMap11(map: SceneAreaWeatherNotify["weatherValueMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: SceneAreaWeatherNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.weatherGadgetId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.weatherGadgetId);
        /* map<uint32, string> weather_value_map = 11; */
        for (let k of Object.keys(message.weatherValueMap))
            writer.tag(11, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.LengthDelimited).string(message.weatherValueMap[k as any]).join();
        /* uint32 climate_type = 7; */
        if (message.climateType !== 0)
            writer.tag(7, WireType.Varint).uint32(message.climateType);
        /* float trans_duration = 10; */
        if (message.transDuration !== 0)
            writer.tag(10, WireType.Bit32).float(message.transDuration);
