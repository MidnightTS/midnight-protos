...
class TowerFightRecordPair$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 data = 1; */
        if (message.data !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.data);
...
/**
 * @generated MessageType for protobuf message TowerFightRecordPair
 */
