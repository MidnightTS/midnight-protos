...
class MpPlayGuestReplyInviteReq$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isAgree !== false)
            writer.tag(12, runtime_1.WireType.Varint).bool(message.isAgree);
...
/**
 * @generated MessageType for protobuf message MpPlayGuestReplyInviteReq
 */
