...
// @generated from protobuf file "TakeRegionSearchRewardRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeRegionSearchRewardRsp
 */
export interface TakeRegionSearchRewardRsp {
    /**
     * @generated from protobuf field: uint32 search_id = 8;
     */
    searchId: number;
    /**
...
class TakeRegionSearchRewardRsp$Type extends MessageType<TakeRegionSearchRewardRsp> {
    ...
    internalBinaryWrite(message: TakeRegionSearchRewardRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.searchId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.searchId);
        /* int32 retcode = 3; */
