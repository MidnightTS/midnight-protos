...
// @generated from protobuf file "GameplayRecommendationSkillRequest.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GameplayRecommendationSkillRequest
 */
export interface GameplayRecommendationSkillRequest {
    /**
     * @generated from protobuf field: uint32 skill_depot_id = 4;
     */
    skillDepotId: number;
}
...
class GameplayRecommendationSkillRequest$Type extends MessageType<GameplayRecommendationSkillRequest> {
    ...
    internalBinaryWrite(message: GameplayRecommendationSkillRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.skillDepotId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.skillDepotId);
