...
// @generated from protobuf file "WidgetActiveChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface WidgetActiveChangeNotify {
    /**
     * @generated from protobuf field: repeated WidgetSlotData widget_data_list = 15;
     */
...
class WidgetActiveChangeNotify$Type extends MessageType<WidgetActiveChangeNotify> {
    constructor() {
        super("WidgetActiveChangeNotify", [
            { no: 15, name: "widget_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WidgetSlotData }
        ]);
    }
    ...
    internalBinaryWrite(message: WidgetActiveChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.widgetDataList.length; i++)
            WidgetSlotData.internalBinaryWrite(message.widgetDataList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
