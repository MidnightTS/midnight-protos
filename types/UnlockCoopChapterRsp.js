...
exports.UnlockCoopChapterRsp = void 0;
...
class UnlockCoopChapterRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chapterId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.chapterId);
...
/**
 * @generated MessageType for protobuf message UnlockCoopChapterRsp
 */
