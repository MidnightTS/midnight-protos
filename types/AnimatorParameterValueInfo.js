...
class AnimatorParameterValueInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.paraType !== undefined)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.paraType);
        /* int32 int_val = 2; */
        if (message.paraVal.oneofKind === "intVal")
            writer.tag(2, runtime_1.WireType.Varint).int32(message.paraVal.intVal);
        /* float float_val = 3; */
        if (message.paraVal.oneofKind === "floatVal")
            writer.tag(3, runtime_1.WireType.Bit32).float(message.paraVal.floatVal);
        /* bool bool_val = 4; */
        if (message.paraVal.oneofKind === "boolVal")
            writer.tag(4, runtime_1.WireType.Varint).bool(message.paraVal.boolVal);
