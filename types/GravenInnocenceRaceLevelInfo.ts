...
// @generated from protobuf file "GravenInnocenceRaceLevelInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GravenInnocenceRaceLevelInfo
 */
export interface GravenInnocenceRaceLevelInfo {
    ...
    levelId: number;
    /**
     * @generated from protobuf field: uint32 max_score = 5;
     */
    maxScore: number;
    /**
...
class GravenInnocenceRaceLevelInfo$Type extends MessageType<GravenInnocenceRaceLevelInfo> {
    ...
    internalBinaryWrite(message: GravenInnocenceRaceLevelInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.maxScore !== 0)
            writer.tag(5, WireType.Varint).uint32(message.maxScore);
        /* bool is_open = 2; */
