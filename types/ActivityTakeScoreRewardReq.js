...
class ActivityTakeScoreRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("ActivityTakeScoreRewardReq", [
            { no: 12, name: "reward_config_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "activity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { rewardConfigId: 0, activityId: 0 };
...
/**
 * @generated MessageType for protobuf message ActivityTakeScoreRewardReq
 */
