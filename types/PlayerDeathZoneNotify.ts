...
// @generated from protobuf file "PlayerDeathZoneNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerDeathZoneNotify
 */
export interface PlayerDeathZoneNotify {
    /**
     * @generated from protobuf field: uint32 cur_death_zone_id = 11;
     */
...
class PlayerDeathZoneNotify$Type extends MessageType<PlayerDeathZoneNotify> {
    ...
    internalBinaryWrite(message: PlayerDeathZoneNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curDeathZoneId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.curDeathZoneId);
