...
// @generated from protobuf file "PotionResetChallengeRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { PotionStageData } from "./PotionStageData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message PotionResetChallengeRsp
 */
export interface PotionResetChallengeRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: PotionStageData stage_data = 5;
     */
...
class PotionResetChallengeRsp$Type extends MessageType<PotionResetChallengeRsp> {
    constructor() {
        super("PotionResetChallengeRsp", [
            ...
            { no: 5, name: "stage_data", kind: "message", T: () => PotionStageData }
        ]);
    }
    ...
    internalBinaryWrite(message: PotionResetChallengeRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.stageData)
            PotionStageData.internalBinaryWrite(message.stageData, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
