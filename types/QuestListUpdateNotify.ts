...
// @generated from protobuf file "QuestListUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface QuestListUpdateNotify {
    /**
     * @generated from protobuf field: repeated Quest quest_list = 7;
     */
    questList: Quest[];
}
...
class QuestListUpdateNotify$Type extends MessageType<QuestListUpdateNotify> {
    constructor() {
        super("QuestListUpdateNotify", [
            { no: 7, name: "quest_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Quest }
        ]);
    }
    ...
    internalBinaryWrite(message: QuestListUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.questList.length; i++)
            Quest.internalBinaryWrite(message.questList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
