...
// @generated from protobuf file "FireworksLaunchDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { FireworksLaunchSchemeData } from "./FireworksLaunchSchemeData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message FireworksLaunchDataNotify
 */
export interface FireworksLaunchDataNotify {
    /**
     * @generated from protobuf field: repeated FireworksLaunchSchemeData scheme_data_list = 8;
     */
    schemeDataList: FireworksLaunchSchemeData[];
    /**
     * @generated from protobuf field: uint32 last_use_scheme_id = 15;
     */
...
class FireworksLaunchDataNotify$Type extends MessageType<FireworksLaunchDataNotify> {
    constructor() {
        super("FireworksLaunchDataNotify", [
            { no: 8, name: "scheme_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FireworksLaunchSchemeData },
    ...
    internalBinaryWrite(message: FireworksLaunchDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.schemeDataList.length; i++)
            FireworksLaunchSchemeData.internalBinaryWrite(message.schemeDataList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* uint32 last_use_scheme_id = 15; */
        if (message.lastUseSchemeId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.lastUseSchemeId);
