...
// @generated from protobuf file "SpiceStageData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SpiceStageData
 */
export interface SpiceStageData {
    ...
    stageId: number;
    /**
     * @generated from protobuf field: uint32 success_times = 12;
     */
    successTimes: number;
}
...
class SpiceStageData$Type extends MessageType<SpiceStageData> {
    ...
    internalBinaryWrite(message: SpiceStageData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.successTimes !== 0)
            writer.tag(12, WireType.Varint).uint32(message.successTimes);
