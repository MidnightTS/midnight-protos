...
// @generated from protobuf file "GadgetStateNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface GadgetStateNotify {
    ...
    /**
     * @generated from protobuf field: uint32 gadget_state = 5;
     */
    gadgetState: number;
    /**
     * @generated from protobuf field: bool is_enable_interact = 6;
     */
...
class GadgetStateNotify$Type extends MessageType<GadgetStateNotify> {
    ...
    internalBinaryWrite(message: GadgetStateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.gadgetState !== 0)
            writer.tag(5, WireType.Varint).uint32(message.gadgetState);
        /* bool is_enable_interact = 6; */
        if (message.isEnableInteract !== false)
            writer.tag(6, WireType.Varint).bool(message.isEnableInteract);
