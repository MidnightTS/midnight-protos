...
class DailyTaskUnlockedCitiesNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DailyTaskUnlockedCitiesNotify", [
            { no: 15, name: "unlocked_city_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 unlocked_city_list */ 15:
...
/**
 * @generated MessageType for protobuf message DailyTaskUnlockedCitiesNotify
 */
