...
// @generated from protobuf file "GalleryFlowerCatchNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GalleryFlowerCatchNotify
 */
export interface GalleryFlowerCatchNotify {
    ...
    curScore: number;
    /**
     * @generated from protobuf field: uint32 add_score = 12;
     */
    addScore: number;
}
...
class GalleryFlowerCatchNotify$Type extends MessageType<GalleryFlowerCatchNotify> {
    ...
    internalBinaryWrite(message: GalleryFlowerCatchNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.addScore !== 0)
            writer.tag(12, WireType.Varint).uint32(message.addScore);
