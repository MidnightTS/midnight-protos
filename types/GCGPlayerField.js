...
class GCGPlayerField$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGPlayerField", [
            ...
            { no: 3, name: "Unk3300_FJNPFBIHFGD", kind: "scalar", jsonName: "Unk3300FJNPFBIHFGD", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "Unk3300_GLNIFLOKBPM", kind: "scalar", jsonName: "Unk3300GLNIFLOKBPM", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { unk3300IKJMGAHCFPM: 0, modifyZoneMap: {}, unk3300GGHKFFADEAL: 0, unk3300FDFPHNDOJML: 0, waitingList: [], unk3300PBECINKKHND: 0, controllerId: 0, isPassed: false, intentionList: [], diceSideList: [], unk3300FJNPFBIHFGD: 0, unk3300GLNIFLOKBPM: 0 };
            ...
            switch (fieldNo) {
                ...
                case /* repeated GCGDiceSideType dice_side_list */ 13:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        ...
                        message.diceSideList.push(reader.int32());
                    break;
                case /* uint32 Unk3300_FJNPFBIHFGD = 3 [json_name = "Unk3300FJNPFBIHFGD"];*/ 3:
                    message.unk3300FJNPFBIHFGD = reader.uint32();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 Unk3300_FJNPFBIHFGD = 3 [json_name = "Unk3300FJNPFBIHFGD"]; */
        if (message.unk3300FJNPFBIHFGD !== 0)
            writer.tag(3, runtime_2.WireType.Varint).uint32(message.unk3300FJNPFBIHFGD);
