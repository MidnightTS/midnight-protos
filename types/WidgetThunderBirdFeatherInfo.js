...
exports.WidgetThunderBirdFeatherInfo = void 0;
...
class WidgetThunderBirdFeatherInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("WidgetThunderBirdFeatherInfo", [
            { no: 9, name: "entity_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 entity_id_list */ 9:
