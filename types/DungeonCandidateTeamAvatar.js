...
class DungeonCandidateTeamAvatar$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonCandidateTeamAvatar", [
            { no: 6, name: "avatar_info", kind: "message", T: () => AvatarInfo_1.AvatarInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.avatarInfo)
            AvatarInfo_1.AvatarInfo.internalBinaryWrite(message.avatarInfo, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 player_uid = 7; */
