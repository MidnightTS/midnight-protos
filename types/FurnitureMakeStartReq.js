...
class FurnitureMakeStartReq$Type extends runtime_5.MessageType {
    constructor() {
        super("FurnitureMakeStartReq", [
            { no: 15, name: "make_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        /* uint32 make_id = 15; */
        if (message.makeId !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.makeId);
        /* uint32 avatar_id = 13; */
        if (message.avatarId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.avatarId);
