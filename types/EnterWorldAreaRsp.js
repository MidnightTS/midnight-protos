...
class EnterWorldAreaRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.areaType !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.areaType);
        /* int32 retcode = 11; */
        if (message.retcode !== 0)
            writer.tag(11, runtime_1.WireType.Varint).int32(message.retcode);
        /* uint32 area_id = 1; */
        if (message.areaId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.areaId);
