...
class SceneCreateEntityRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneCreateEntityRsp", [
            ...
            { no: 4, name: "entity", kind: "message", T: () => CreateEntityInfo_1.CreateEntityInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.entity)
            CreateEntityInfo_1.CreateEntityInfo.internalBinaryWrite(message.entity, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 5; */
