...
// @generated from protobuf file "TakeCoopRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeCoopRewardReq
 */
export interface TakeCoopRewardReq {
    /**
     * @generated from protobuf field: uint32 reward_config_id = 13;
     */
...
class TakeCoopRewardReq$Type extends MessageType<TakeCoopRewardReq> {
    ...
    internalBinaryWrite(message: TakeCoopRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardConfigId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.rewardConfigId);
