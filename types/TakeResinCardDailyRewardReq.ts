...
// @generated from protobuf file "TakeResinCardDailyRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeResinCardDailyRewardReq
 */
export interface TakeResinCardDailyRewardReq {
    /**
     * @generated from protobuf field: uint32 product_config_id = 1;
     */
...
class TakeResinCardDailyRewardReq$Type extends MessageType<TakeResinCardDailyRewardReq> {
    ...
    internalBinaryWrite(message: TakeResinCardDailyRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.productConfigId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.productConfigId);
