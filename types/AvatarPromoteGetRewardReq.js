...
class AvatarPromoteGetRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("AvatarPromoteGetRewardReq", [
            ...
            { no: 5, name: "promote_level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.promoteLevel !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.promoteLevel);
