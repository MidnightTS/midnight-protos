...
// @generated from protobuf file "EvtAnimatorParameterNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { EvtAnimatorParameterInfo } from "./EvtAnimatorParameterInfo";
 ...
 * }
 *
 * @generated from protobuf message EvtAnimatorParameterNotify
 */
export interface EvtAnimatorParameterNotify {
    ...
    /**
     * @generated from protobuf field: EvtAnimatorParameterInfo animator_param_info = 13;
     */
...
class EvtAnimatorParameterNotify$Type extends MessageType<EvtAnimatorParameterNotify> {
    constructor() {
        super("EvtAnimatorParameterNotify", [
            ...
            { no: 13, name: "animator_param_info", kind: "message", T: () => EvtAnimatorParameterInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: EvtAnimatorParameterNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.animatorParamInfo)
            EvtAnimatorParameterInfo.internalBinaryWrite(message.animatorParamInfo, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
