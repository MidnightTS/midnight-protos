...
// @generated from protobuf file "HomeDeleteBlueprintReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeDeleteBlueprintReq
 */
export interface HomeDeleteBlueprintReq {
    /**
     * @generated from protobuf field: uint32 slot_id = 14;
     */
    slotId: number;
}
...
class HomeDeleteBlueprintReq$Type extends MessageType<HomeDeleteBlueprintReq> {
    ...
    internalBinaryWrite(message: HomeDeleteBlueprintReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 slot_id = 14; */
        if (message.slotId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.slotId);
