...
// @generated from protobuf file "TowerRecordHandbookRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { TowerMonthlyDetail } from "./TowerMonthlyDetail";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message TowerRecordHandbookRsp
 */
export interface TowerRecordHandbookRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated TowerMonthlyDetail monthly_detail_list = 4;
     */
...
class TowerRecordHandbookRsp$Type extends MessageType<TowerRecordHandbookRsp> {
    constructor() {
        super("TowerRecordHandbookRsp", [
            ...
            { no: 4, name: "monthly_detail_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TowerMonthlyDetail }
        ]);
    }
    ...
    internalBinaryWrite(message: TowerRecordHandbookRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.monthlyDetailList.length; i++)
            TowerMonthlyDetail.internalBinaryWrite(message.monthlyDetailList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
