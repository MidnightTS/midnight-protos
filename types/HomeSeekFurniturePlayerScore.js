...
exports.HomeSeekFurniturePlayerScore = void 0;
...
class HomeSeekFurniturePlayerScore$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeSeekFurniturePlayerScore", [
            ...
            { no: 6, name: "player_info", kind: "message", T: () => HomeGroupPlayerInfo_1.HomeGroupPlayerInfo }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.playerInfo)
            HomeGroupPlayerInfo_1.HomeGroupPlayerInfo.internalBinaryWrite(message.playerInfo, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
