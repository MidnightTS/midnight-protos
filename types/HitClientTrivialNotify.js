...
class HitClientTrivialNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("HitClientTrivialNotify", [
            { no: 14, name: "owner_entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "position", kind: "message", T: () => Vector_1.Vector }
        ]);
    }
    create(value) {
        const message = { ownerEntityId: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 owner_entity_id */ 14:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.ownerEntityId !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.ownerEntityId);
        /* Vector position = 1; */
        if (message.position)
...
/**
 * @generated MessageType for protobuf message HitClientTrivialNotify
 */
