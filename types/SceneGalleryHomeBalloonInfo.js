...
class SceneGalleryHomeBalloonInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneGalleryHomeBalloonInfo", [
            { no: 11, name: "score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message SceneGalleryHomeBalloonInfo
 */
