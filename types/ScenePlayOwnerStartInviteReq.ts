...
// @generated from protobuf file "ScenePlayOwnerStartInviteReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ScenePlayOwnerStartInviteReq
 */
export interface ScenePlayOwnerStartInviteReq {
    /**
     * @generated from protobuf field: bool is_skip_match = 4;
     */
    isSkipMatch: boolean;
    /**
...
class ScenePlayOwnerStartInviteReq$Type extends MessageType<ScenePlayOwnerStartInviteReq> {
    ...
    internalBinaryWrite(message: ScenePlayOwnerStartInviteReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isSkipMatch !== false)
            writer.tag(4, WireType.Varint).bool(message.isSkipMatch);
        /* uint32 play_id = 7; */
        if (message.playId !== 0)
