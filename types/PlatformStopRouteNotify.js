...
class PlatformStopRouteNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("PlatformStopRouteNotify", [
            { no: 7, name: "platform", kind: "message", T: () => PlatformInfo_1.PlatformInfo },
            { no: 10, name: "scene_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.platform)
            PlatformInfo_1.PlatformInfo.internalBinaryWrite(message.platform, writer.tag(7, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 scene_time = 10; */
        if (message.sceneTime !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.sceneTime);
        /* uint32 entity_id = 6; */
...
/**
 * @generated MessageType for protobuf message PlatformStopRouteNotify
 */
