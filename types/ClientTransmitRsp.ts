...
// @generated from protobuf file "ClientTransmitRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ClientTransmitRsp
 */
export interface ClientTransmitRsp {
    /**
     * @generated from protobuf field: TransmitReason reason = 11;
     */
...
class ClientTransmitRsp$Type extends MessageType<ClientTransmitRsp> {
    constructor() {
        super("ClientTransmitRsp", [
            { no: 11, name: "reason", kind: "enum", T: () => ["TransmitReason", TransmitReason, "TRANSMIT_REASON_"] },
