...
exports.UpdateSalvageBundleMarkRsp = void 0;
...
class UpdateSalvageBundleMarkRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("UpdateSalvageBundleMarkRsp", [
            { no: 2, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "stage_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "challenge_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, stageId: 0, challengeType: 0 };
...
/**
 * @generated MessageType for protobuf message UpdateSalvageBundleMarkRsp
 */
