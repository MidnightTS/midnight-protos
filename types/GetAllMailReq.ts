...
// @generated from protobuf file "GetAllMailReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface GetAllMailReq {
    /**
     * @generated from protobuf field: bool is_collected = 4;
     */
    isCollected: boolean;
}
...
class GetAllMailReq$Type extends MessageType<GetAllMailReq> {
    ...
    internalBinaryWrite(message: GetAllMailReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isCollected !== false)
            writer.tag(4, WireType.Varint).bool(message.isCollected);
