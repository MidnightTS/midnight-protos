...
// @generated from protobuf file "EvtBeingHitsCombineNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface EvtBeingHitsCombineNotify {
    /**
     * @generated from protobuf field: repeated EvtBeingHitInfo evt_being_hit_info_list = 9;
     */
    evtBeingHitInfoList: EvtBeingHitInfo[];
    /**
     * @generated from protobuf field: ForwardType forward_type = 7;
     */
...
class EvtBeingHitsCombineNotify$Type extends MessageType<EvtBeingHitsCombineNotify> {
    constructor() {
        super("EvtBeingHitsCombineNotify", [
            { no: 9, name: "evt_being_hit_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => EvtBeingHitInfo },
            { no: 7, name: "forward_type", kind: "enum", T: () => ["ForwardType", ForwardType, "FORWARD_TYPE_"] }
        ]);
    }
    ...
    internalBinaryWrite(message: EvtBeingHitsCombineNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.evtBeingHitInfoList.length; i++)
            EvtBeingHitInfo.internalBinaryWrite(message.evtBeingHitInfoList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
