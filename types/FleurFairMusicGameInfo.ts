...
// @generated from protobuf file "FleurFairMusicGameInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { FleurFairMusicRecord } from "./FleurFairMusicRecord";
/**
 * @generated from protobuf message FleurFairMusicGameInfo
 */
export interface FleurFairMusicGameInfo {
    /**
     * @generated from protobuf field: map<uint32, FleurFairMusicRecord> music_record_map = 6;
     */
    musicRecordMap: {
...
class FleurFairMusicGameInfo$Type extends MessageType<FleurFairMusicGameInfo> {
    constructor() {
        super("FleurFairMusicGameInfo", [
            { no: 6, name: "music_record_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => FleurFairMusicRecord } }
        ]);
    }
    ...
    private binaryReadMap6(map: FleurFairMusicGameInfo["musicRecordMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
