...
// @generated from protobuf file "HomePictureFrameInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message HomePictureFrameInfo
 */
export interface HomePictureFrameInfo {
    /**
     * @generated from protobuf field: uint32 picture_id = 9;
     */
    pictureId: number;
    /**
...
class HomePictureFrameInfo$Type extends MessageType<HomePictureFrameInfo> {
    ...
    internalBinaryWrite(message: HomePictureFrameInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.pictureId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.pictureId);
        /* uint32 guid = 5; */
        if (message.guid !== 0)
