...
// @generated from protobuf file "HomeComfortInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { HomeModuleComfortInfo } from "./HomeModuleComfortInfo";
/**
 * enum CmdId {
...
export interface HomeComfortInfoNotify {
    /**
     * @generated from protobuf field: repeated HomeModuleComfortInfo module_info_list = 3;
     */
...
class HomeComfortInfoNotify$Type extends MessageType<HomeComfortInfoNotify> {
    constructor() {
        super("HomeComfortInfoNotify", [
            { no: 3, name: "module_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeModuleComfortInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeComfortInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.moduleInfoList.length; i++)
            HomeModuleComfortInfo.internalBinaryWrite(message.moduleInfoList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
