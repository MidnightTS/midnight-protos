...
// @generated from protobuf file "CharAmusementSettleNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CharAmusementSettleNotify
 */
export interface CharAmusementSettleNotify {
    ...
    finishTime: number;
    /**
     * @generated from protobuf field: bool is_succ = 12;
     */
    isSucc: boolean;
}
...
class CharAmusementSettleNotify$Type extends MessageType<CharAmusementSettleNotify> {
    ...
    internalBinaryWrite(message: CharAmusementSettleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isSucc !== false)
            writer.tag(12, WireType.Varint).bool(message.isSucc);
