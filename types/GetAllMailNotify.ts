...
// @generated from protobuf file "GetAllMailNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetAllMailNotify
 */
export interface GetAllMailNotify {
    /**
     * @generated from protobuf field: bool is_collected = 5;
     */
    isCollected: boolean;
}
...
class GetAllMailNotify$Type extends MessageType<GetAllMailNotify> {
    ...
    internalBinaryWrite(message: GetAllMailNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isCollected !== false)
            writer.tag(5, WireType.Varint).bool(message.isCollected);
