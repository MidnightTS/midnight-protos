...
// @generated from protobuf file "HomeEditCustomFurnitureRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeEditCustomFurnitureRsp
 */
export interface HomeEditCustomFurnitureRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: HomeCustomFurnitureInfo custom_furniture_info = 2;
     */
...
class HomeEditCustomFurnitureRsp$Type extends MessageType<HomeEditCustomFurnitureRsp> {
    constructor() {
        super("HomeEditCustomFurnitureRsp", [
            ...
            { no: 2, name: "custom_furniture_info", kind: "message", T: () => HomeCustomFurnitureInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeEditCustomFurnitureRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customFurnitureInfo)
            HomeCustomFurnitureInfo.internalBinaryWrite(message.customFurnitureInfo, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
