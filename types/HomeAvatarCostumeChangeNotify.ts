...
// @generated from protobuf file "HomeAvatarCostumeChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeAvatarCostumeChangeNotify
 */
export interface HomeAvatarCostumeChangeNotify {
    ...
    avatarId: number;
    /**
     * @generated from protobuf field: uint32 costume_id = 14;
     */
    costumeId: number;
}
...
class HomeAvatarCostumeChangeNotify$Type extends MessageType<HomeAvatarCostumeChangeNotify> {
    ...
    internalBinaryWrite(message: HomeAvatarCostumeChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.costumeId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.costumeId);
