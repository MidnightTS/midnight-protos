...
exports.MuqadasPotionCaptureWeaknessReq = void 0;
...
class MuqadasPotionCaptureWeaknessReq$Type extends runtime_5.MessageType {
    constructor() {
        super("MuqadasPotionCaptureWeaknessReq", [
            { no: 7, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "capture_weakness_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { levelId: 0, captureWeaknessCount: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 level_id */ 7:
                    ...
                    break;
                case /* uint32 capture_weakness_count */ 10:
...
/**
 * @generated MessageType for protobuf message MuqadasPotionCaptureWeaknessReq
 */
