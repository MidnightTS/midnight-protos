...
class BossChestActivateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("BossChestActivateNotify", [
            { no: 15, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "qualify_uid_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { entityId: 0, qualifyUidList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 entity_id */ 15:
                    ...
                    break;
                case /* repeated uint32 qualify_uid_list */ 7:
...
/**
 * @generated MessageType for protobuf message BossChestActivateNotify
 */
