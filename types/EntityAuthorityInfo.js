...
const EntityClientExtraInfo_1 = require("./EntityClientExtraInfo");
...
class EntityAuthorityInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("EntityAuthorityInfo", [
            ...
            { no: 6, name: "client_extra_info", kind: "message", T: () => EntityClientExtraInfo_1.EntityClientExtraInfo }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* EntityClientExtraInfo client_extra_info */ 6:
                    message.clientExtraInfo = EntityClientExtraInfo_1.EntityClientExtraInfo.internalBinaryRead(reader, reader.uint32(), options, message.clientExtraInfo);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.clientExtraInfo)
            EntityClientExtraInfo_1.EntityClientExtraInfo.internalBinaryWrite(message.clientExtraInfo, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
