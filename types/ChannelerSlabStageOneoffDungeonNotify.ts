...
// @generated from protobuf file "ChannelerSlabStageOneoffDungeonNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChannelerSlabStageOneoffDungeonNotify
 */
export interface ChannelerSlabStageOneoffDungeonNotify {
    /**
     * @generated from protobuf field: bool is_done = 6;
     */
    isDone: boolean;
    /**
...
class ChannelerSlabStageOneoffDungeonNotify$Type extends MessageType<ChannelerSlabStageOneoffDungeonNotify> {
    ...
    internalBinaryWrite(message: ChannelerSlabStageOneoffDungeonNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isDone !== false)
            writer.tag(6, WireType.Varint).bool(message.isDone);
        /* uint32 stage_id = 13; */
