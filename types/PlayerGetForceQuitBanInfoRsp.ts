...
// @generated from protobuf file "PlayerGetForceQuitBanInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface PlayerGetForceQuitBanInfoRsp {
    /**
     * @generated from protobuf field: uint32 match_id = 13;
     */
    matchId: number;
    /**
     * @generated from protobuf field: uint32 expire_time = 2;
     */
    expireTime: number;
    /**
...
class PlayerGetForceQuitBanInfoRsp$Type extends MessageType<PlayerGetForceQuitBanInfoRsp> {
    ...
    internalBinaryWrite(message: PlayerGetForceQuitBanInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.matchId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.matchId);
        /* uint32 expire_time = 2; */
        if (message.expireTime !== 0)
            writer.tag(2, WireType.Varint).uint32(message.expireTime);
        /* int32 retcode = 4; */
