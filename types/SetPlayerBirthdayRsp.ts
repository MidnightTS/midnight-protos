...
// @generated from protobuf file "SetPlayerBirthdayRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface SetPlayerBirthdayRsp {
    /**
     * @generated from protobuf field: Birthday birthday = 1;
     */
    birthday?: Birthday;
    /**
...
class SetPlayerBirthdayRsp$Type extends MessageType<SetPlayerBirthdayRsp> {
    constructor() {
        super("SetPlayerBirthdayRsp", [
            { no: 1, name: "birthday", kind: "message", T: () => Birthday },
    ...
    internalBinaryWrite(message: SetPlayerBirthdayRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* Birthday birthday = 1; */
        if (message.birthday)
            Birthday.internalBinaryWrite(message.birthday, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 4; */
