...
export interface BattlePassMission {
    ...
    curProgress: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_MBOMOLFKPPO = 9 [json_name = "Unk3300MBOMOLFKPPO"];
     */
    unk3300MBOMOLFKPPO: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_DAHDCJNCALE = 14 [json_name = "Unk3300DAHDCJNCALE"];
     */
    unk3300DAHDCJNCALE: number;
    /**
...
class BattlePassMission$Type extends MessageType<BattlePassMission> {
    ...
    internalBinaryWrite(message: BattlePassMission, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300MBOMOLFKPPO !== 0)
            writer.tag(9, WireType.Varint).uint32(message.unk3300MBOMOLFKPPO);
        /* uint32 Unk3300_DAHDCJNCALE = 14 [json_name = "Unk3300DAHDCJNCALE"]; */
        if (message.unk3300DAHDCJNCALE !== 0)
            writer.tag(14, WireType.Varint).uint32(message.unk3300DAHDCJNCALE);
