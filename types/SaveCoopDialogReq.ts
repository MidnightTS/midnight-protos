...
// @generated from protobuf file "SaveCoopDialogReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SaveCoopDialogReq
 */
export interface SaveCoopDialogReq {
    /**
     * @generated from protobuf field: uint32 Unk3300_AMKDDJEPAKM = 10 [json_name = "Unk3300AMKDDJEPAKM"];
     */
    unk3300AMKDDJEPAKM: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_KMBGNIICNAF = 8 [json_name = "Unk3300KMBGNIICNAF"];
     */
...
class SaveCoopDialogReq$Type extends MessageType<SaveCoopDialogReq> {
    ...
    internalBinaryWrite(message: SaveCoopDialogReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300AMKDDJEPAKM !== 0)
            writer.tag(10, WireType.Varint).uint32(message.unk3300AMKDDJEPAKM);
        /* uint32 Unk3300_KMBGNIICNAF = 8 [json_name = "Unk3300KMBGNIICNAF"]; */
        if (message.unk3300KMBGNIICNAF !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300KMBGNIICNAF);
