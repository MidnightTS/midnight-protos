...
class TakeReunionFirstGiftRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeReunionFirstGiftRewardRsp", [
            { no: 4, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 1, name: "reward_id", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, rewardId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.rewardId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).int32(message.rewardId);
...
/**
 * @generated MessageType for protobuf message TakeReunionFirstGiftRewardRsp
 */
