...
exports.ActivityBannerClearRsp = void 0;
...
class ActivityBannerClearRsp$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { retcode: 0, scheduleId: 0, activityId: 0 };
...
/**
 * @generated MessageType for protobuf message ActivityBannerClearRsp
 */
