...
// @generated from protobuf file "MpPlayGuestReplyInviteRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MpPlayGuestReplyInviteRsp
 */
export interface MpPlayGuestReplyInviteRsp {
    /**
     * @generated from protobuf field: uint32 mp_play_id = 7;
     */
    mpPlayId: number;
    /**
...
class MpPlayGuestReplyInviteRsp$Type extends MessageType<MpPlayGuestReplyInviteRsp> {
    ...
    internalBinaryWrite(message: MpPlayGuestReplyInviteRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mpPlayId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.mpPlayId);
        /* int32 retcode = 2; */
