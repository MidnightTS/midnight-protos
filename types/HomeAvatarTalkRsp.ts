...
// @generated from protobuf file "HomeAvatarTalkRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeAvatarTalkRsp
 */
export interface HomeAvatarTalkRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: HomeAvatarTalkFinishInfo avatar_talk_info = 4;
     */
...
class HomeAvatarTalkRsp$Type extends MessageType<HomeAvatarTalkRsp> {
    constructor() {
        super("HomeAvatarTalkRsp", [
            ...
            { no: 4, name: "avatar_talk_info", kind: "message", T: () => HomeAvatarTalkFinishInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeAvatarTalkRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.avatarTalkInfo)
            HomeAvatarTalkFinishInfo.internalBinaryWrite(message.avatarTalkInfo, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
