...
// @generated from protobuf file "GivingRecordNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GivingRecordNotify
 */
export interface GivingRecordNotify {
    /**
     * @generated from protobuf field: repeated GivingRecord giving_record_list = 13;
     */
...
class GivingRecordNotify$Type extends MessageType<GivingRecordNotify> {
    constructor() {
        super("GivingRecordNotify", [
            { no: 13, name: "giving_record_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GivingRecord }
        ]);
    }
    ...
    internalBinaryWrite(message: GivingRecordNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.givingRecordList.length; i++)
            GivingRecord.internalBinaryWrite(message.givingRecordList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
