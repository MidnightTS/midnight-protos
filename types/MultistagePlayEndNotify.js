...
class MultistagePlayEndNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MultistagePlayEndNotify", [
            { no: 4, name: "group_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 15, name: "play_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 group_id */ 4:
                    message.groupId = reader.uint32();
                    break;
                case /* uint32 play_index */ 15:
...
/**
 * @generated MessageType for protobuf message MultistagePlayEndNotify
 */
