...
// @generated from protobuf file "FireworksReformParam.proto" (syntax proto3)
// tslint:disable
//
...
import { FireworksReformParamType } from "./FireworksReformParamType";
/**
 * @generated from protobuf message FireworksReformParam
 */
export interface FireworksReformParam {
    ...
    value: number;
    /**
     * @generated from protobuf field: FireworksReformParamType type = 5;
     */
...
class FireworksReformParam$Type extends MessageType<FireworksReformParam> {
    constructor() {
        super("FireworksReformParam", [
            ...
            { no: 5, name: "type", kind: "enum", T: () => ["FireworksReformParamType", FireworksReformParamType, "FIREWORKS_REFORM_PARAM_TYPE_"] }
        ]);
    }
