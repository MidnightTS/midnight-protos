...
export interface HomeResource {
    /**
     * @generated from protobuf field: uint32 store_limit = 6;
     */
    storeLimit: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 store_value = 1;
     */
    storeValue: number;
}
...
class HomeResource$Type extends MessageType<HomeResource> {
    ...
    internalBinaryWrite(message: HomeResource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.storeLimit !== 0)
            writer.tag(6, WireType.Varint).uint32(message.storeLimit);
        ...
        if (message.storeValue !== 0)
            writer.tag(1, WireType.Varint).uint32(message.storeValue);
