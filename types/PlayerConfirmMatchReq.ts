...
export class PlayerConfirmMatchReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get match_type() {
        return pb_1.Message.getFieldWithDefault(this, 12, dependency_1.MatchType.MATCH_TYPE_NONE) as dependency_1.MatchType;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PlayerConfirmMatchReq {
    ...
    static deserializeBinary(bytes: Uint8Array): PlayerConfirmMatchReq {
