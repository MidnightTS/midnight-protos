...
// @generated from protobuf file "PlayerConfirmMatchReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerConfirmMatchReq
 */
export interface PlayerConfirmMatchReq {
    /**
     * @generated from protobuf field: MatchType match_type = 3;
     */
    matchType: MatchType;
    /**
     * @generated from protobuf field: bool is_agreed = 14;
     */
    isAgreed: boolean;
}
...
class PlayerConfirmMatchReq$Type extends MessageType<PlayerConfirmMatchReq> {
    constructor() {
        super("PlayerConfirmMatchReq", [
            { no: 3, name: "match_type", kind: "enum", T: () => ["MatchType", MatchType, "MATCH_TYPE_"] },
    ...
    internalBinaryWrite(message: PlayerConfirmMatchReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAgreed !== false)
            writer.tag(14, WireType.Varint).bool(message.isAgreed);
