...
// @generated from protobuf file "cmd_hunting.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class GetCityHuntingOfferRsp$Type extends MessageType<GetCityHuntingOfferRsp> {
    constructor() {
        super("com.midnights.game.GetCityHuntingOfferRsp", [
            ...
            { no: 13, name: "hunting_offer_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HuntingOfferData },
