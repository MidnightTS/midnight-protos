...
// @generated from protobuf file "BargainStartNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BargainStartNotify
 */
export interface BargainStartNotify {
    /**
     * @generated from protobuf field: uint32 bargain_id = 11;
     */
    bargainId: number;
    /**
     * @generated from protobuf field: BargainSnapshot snapshot = 10;
     */
...
class BargainStartNotify$Type extends MessageType<BargainStartNotify> {
    constructor() {
        super("BargainStartNotify", [
            ...
            { no: 10, name: "snapshot", kind: "message", T: () => BargainSnapshot }
        ]);
    }
    ...
    internalBinaryWrite(message: BargainStartNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bargainId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.bargainId);
        /* BargainSnapshot snapshot = 10; */
        if (message.snapshot)
            BargainSnapshot.internalBinaryWrite(message.snapshot, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
