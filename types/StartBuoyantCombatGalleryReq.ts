...
// @generated from protobuf file "StartBuoyantCombatGalleryReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StartBuoyantCombatGalleryReq
 */
export interface StartBuoyantCombatGalleryReq {
    /**
     * @generated from protobuf field: uint32 gallery_level = 4;
     */
    galleryLevel: number;
    /**
...
class StartBuoyantCombatGalleryReq$Type extends MessageType<StartBuoyantCombatGalleryReq> {
    ...
    internalBinaryWrite(message: StartBuoyantCombatGalleryReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.galleryLevel !== 0)
            writer.tag(4, WireType.Varint).uint32(message.galleryLevel);
