...
class GetSignInRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GetSignInRewardReq", [
            { no: 4, name: "reward_day", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "schedule_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { rewardDay: 0, scheduleId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.rewardDay !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.rewardDay);
...
/**
 * @generated MessageType for protobuf message GetSignInRewardReq
 */
