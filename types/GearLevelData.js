...
class GearLevelData$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300DFGHKDBENED !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.unk3300DFGHKDBENED);
        /* bool is_finished = 3; */
        ...
        if (message.unk3300FIKPLGJIBGP !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.unk3300FIKPLGJIBGP);
