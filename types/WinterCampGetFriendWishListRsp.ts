...
// @generated from protobuf file "WinterCampGetFriendWishListRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { WinterCampFriendWishData } from "./WinterCampFriendWishData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message WinterCampGetFriendWishListRsp
 */
export interface WinterCampGetFriendWishListRsp {
    /**
     * @generated from protobuf field: repeated WinterCampFriendWishData wish_data_list = 3;
     */
...
class WinterCampGetFriendWishListRsp$Type extends MessageType<WinterCampGetFriendWishListRsp> {
    constructor() {
        super("WinterCampGetFriendWishListRsp", [
            { no: 3, name: "wish_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WinterCampFriendWishData },
    ...
    internalBinaryWrite(message: WinterCampGetFriendWishListRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.wishDataList.length; i++)
            WinterCampFriendWishData.internalBinaryWrite(message.wishDataList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 15; */
