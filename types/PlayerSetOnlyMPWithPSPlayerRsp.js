...
class PlayerSetOnlyMPWithPSPlayerRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerSetOnlyMPWithPSPlayerRsp", [
            { no: 4, name: "is_only", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 11, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { isOnly: false, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isOnly !== false)
            writer.tag(4, runtime_1.WireType.Varint).bool(message.isOnly);
        /* int32 retcode = 11; */
...
/**
 * @generated MessageType for protobuf message PlayerSetOnlyMPWithPSPlayerRsp
 */
