...
// @generated from protobuf file "HomeCreateBlueprintRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeCreateBlueprintRsp
 */
export interface HomeCreateBlueprintRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: HomeBlueprintSlotInfo slot_info = 6;
     */
...
class HomeCreateBlueprintRsp$Type extends MessageType<HomeCreateBlueprintRsp> {
    constructor() {
        super("HomeCreateBlueprintRsp", [
            ...
            { no: 6, name: "slot_info", kind: "message", T: () => HomeBlueprintSlotInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeCreateBlueprintRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.slotInfo)
            HomeBlueprintSlotInfo.internalBinaryWrite(message.slotInfo, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
