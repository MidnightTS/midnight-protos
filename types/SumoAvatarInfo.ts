...
// @generated from protobuf file "SumoAvatarInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SumoAvatarInfo
 */
export interface SumoAvatarInfo {
    /**
     * @generated from protobuf field: bool is_trial = 9;
     */
    isTrial: boolean;
    /**
     * @generated from protobuf field: uint64 avatar_id = 13;
     */
    avatarId: bigint;
}
...
class SumoAvatarInfo$Type extends MessageType<SumoAvatarInfo> {
    ...
    internalBinaryWrite(message: SumoAvatarInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isTrial !== false)
            writer.tag(9, WireType.Varint).bool(message.isTrial);
        /* uint64 avatar_id = 13; */
        if (message.avatarId !== 0n)
            writer.tag(13, WireType.Varint).uint64(message.avatarId);
