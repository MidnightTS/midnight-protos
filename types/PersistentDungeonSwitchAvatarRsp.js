...
exports.PersistentDungeonSwitchAvatarRsp = void 0;
...
class PersistentDungeonSwitchAvatarRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PersistentDungeonSwitchAvatarRsp", [
            ...
            { no: 15, name: "cur_avatar_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, avatarTeamGuidList: [], curAvatarGuid: 0n };
            ...
            switch (fieldNo) {
                ...
                case /* repeated uint64 avatar_team_guid_list */ 9:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        ...
                        message.avatarTeamGuidList.push(reader.uint64().toBigInt());
                    break;
                case /* uint64 cur_avatar_guid */ 15:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.curAvatarGuid !== 0n)
            writer.tag(15, runtime_2.WireType.Varint).uint64(message.curAvatarGuid);
...
/**
 * @generated MessageType for protobuf message PersistentDungeonSwitchAvatarRsp
 */
