...
// @generated from protobuf file "WorldAllRoutineTypeNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { WorldRoutineTypeInfo } from "./WorldRoutineTypeInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message WorldAllRoutineTypeNotify
 */
export interface WorldAllRoutineTypeNotify {
    /**
     * @generated from protobuf field: repeated WorldRoutineTypeInfo world_routine_type_list = 9;
     */
...
class WorldAllRoutineTypeNotify$Type extends MessageType<WorldAllRoutineTypeNotify> {
    constructor() {
        super("WorldAllRoutineTypeNotify", [
            { no: 9, name: "world_routine_type_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WorldRoutineTypeInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WorldAllRoutineTypeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.worldRoutineTypeList.length; i++)
            WorldRoutineTypeInfo.internalBinaryWrite(message.worldRoutineTypeList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
