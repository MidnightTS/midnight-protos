...
class ActivityInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300JAEALAIOOID !== 0)
            writer.tag(1870, runtime_2.WireType.Varint).uint32(message.unk3300JAEALAIOOID);
        ...
        if (message.unk3300GCEAKEMMJEA !== 0)
            writer.tag(697, runtime_2.WireType.Varint).uint32(message.unk3300GCEAKEMMJEA);
        ...
        if (message.unk3300DMILOONBELH !== 0)
            writer.tag(3, runtime_2.WireType.Varint).uint32(message.unk3300DMILOONBELH);
