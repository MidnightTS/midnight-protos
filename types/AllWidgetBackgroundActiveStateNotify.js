...
exports.AllWidgetBackgroundActiveStateNotify = void 0;
...
class AllWidgetBackgroundActiveStateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("AllWidgetBackgroundActiveStateNotify", [
            { no: 2, name: "background_active_widget_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 background_active_widget_list */ 2:
...
/**
 * @generated MessageType for protobuf message AllWidgetBackgroundActiveStateNotify
 */
