...
// @generated from protobuf file "HomeChangeModuleReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeChangeModuleReq
 */
export interface HomeChangeModuleReq {
    /**
     * @generated from protobuf field: uint32 target_module_id = 6;
     */
...
class HomeChangeModuleReq$Type extends MessageType<HomeChangeModuleReq> {
    ...
    internalBinaryWrite(message: HomeChangeModuleReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetModuleId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.targetModuleId);
