...
// @generated from protobuf file "AvatarSatiationDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { AvatarSatiationData } from "./AvatarSatiationData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message AvatarSatiationDataNotify
 */
export interface AvatarSatiationDataNotify {
    /**
     * @generated from protobuf field: repeated AvatarSatiationData satiation_data_list = 13;
     */
...
class AvatarSatiationDataNotify$Type extends MessageType<AvatarSatiationDataNotify> {
    constructor() {
        super("AvatarSatiationDataNotify", [
            { no: 13, name: "satiation_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AvatarSatiationData }
        ]);
    }
    ...
    internalBinaryWrite(message: AvatarSatiationDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.satiationDataList.length; i++)
            AvatarSatiationData.internalBinaryWrite(message.satiationDataList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
