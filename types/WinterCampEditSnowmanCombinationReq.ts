...
// @generated from protobuf file "WinterCampEditSnowmanCombinationReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message WinterCampEditSnowmanCombinationReq
 */
export interface WinterCampEditSnowmanCombinationReq {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: CustomGadgetTreeInfo combination_info = 5;
     */
...
class WinterCampEditSnowmanCombinationReq$Type extends MessageType<WinterCampEditSnowmanCombinationReq> {
    constructor() {
        super("WinterCampEditSnowmanCombinationReq", [
            ...
            { no: 5, name: "combination_info", kind: "message", T: () => CustomGadgetTreeInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WinterCampEditSnowmanCombinationReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.combinationInfo)
            CustomGadgetTreeInfo.internalBinaryWrite(message.combinationInfo, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
