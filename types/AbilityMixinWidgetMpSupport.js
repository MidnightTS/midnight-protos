...
exports.AbilityMixinWidgetMpSupport = void 0;
...
class AbilityMixinWidgetMpSupport$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityMixinWidgetMpSupport", [
            { no: 2, name: "target_entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 target_entity_id */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.targetEntityId !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.targetEntityId);
