...
exports.BreakoutSyncPing = void 0;
...
class BreakoutSyncPing$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.clientGameTime !== 0n)
            writer.tag(8, runtime_1.WireType.Varint).uint64(message.clientGameTime);
        /* uint64 server_game_time = 5; */
        if (message.serverGameTime !== 0n)
            writer.tag(5, runtime_1.WireType.Varint).uint64(message.serverGameTime);
 ...
 */
exports.BreakoutSyncPing = new BreakoutSyncPing$Type();
