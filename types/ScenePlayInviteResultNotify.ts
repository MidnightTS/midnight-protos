...
// @generated from protobuf file "ScenePlayInviteResultNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ScenePlayInviteResultNotify
 */
export interface ScenePlayInviteResultNotify {
    /**
     * @generated from protobuf field: uint32 play_id = 14;
     */
    playId: number;
    /**
     * @generated from protobuf field: bool is_all_agree = 11;
     */
    isAllAgree: boolean;
}
...
class ScenePlayInviteResultNotify$Type extends MessageType<ScenePlayInviteResultNotify> {
    ...
    internalBinaryWrite(message: ScenePlayInviteResultNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 play_id = 14; */
        if (message.playId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.playId);
        /* bool is_all_agree = 11; */
        if (message.isAllAgree !== false)
            writer.tag(11, WireType.Varint).bool(message.isAllAgree);
