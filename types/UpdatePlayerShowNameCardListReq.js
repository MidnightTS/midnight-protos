...
exports.UpdatePlayerShowNameCardListReq = void 0;
...
class UpdatePlayerShowNameCardListReq$Type extends runtime_5.MessageType {
    constructor() {
        super("UpdatePlayerShowNameCardListReq", [
            { no: 11, name: "show_name_card_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 show_name_card_id_list */ 11:
...
/**
 * @generated MessageType for protobuf message UpdatePlayerShowNameCardListReq
 */
