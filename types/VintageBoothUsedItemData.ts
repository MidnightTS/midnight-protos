...
// @generated from protobuf file "VintageBoothUsedItemData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message VintageBoothUsedItemData
 */
...
class VintageBoothUsedItemData$Type extends MessageType<VintageBoothUsedItemData> {
    ...
    internalBinaryWrite(message: VintageBoothUsedItemData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.gadgetId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.gadgetId);
