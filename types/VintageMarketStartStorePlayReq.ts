...
// @generated from protobuf file "VintageMarketStartStorePlayReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintageMarketStartStorePlayReq
 */
export interface VintageMarketStartStorePlayReq {
    /**
     * @generated from protobuf field: uint32 store_round = 14;
     */
    storeRound: number;
}
...
class VintageMarketStartStorePlayReq$Type extends MessageType<VintageMarketStartStorePlayReq> {
    ...
    internalBinaryWrite(message: VintageMarketStartStorePlayReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.storeRound !== 0)
            writer.tag(14, WireType.Varint).uint32(message.storeRound);
