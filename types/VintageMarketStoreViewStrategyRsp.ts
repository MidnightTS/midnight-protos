...
// @generated from protobuf file "VintageMarketStoreViewStrategyRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintageMarketStoreViewStrategyRsp
 */
export interface VintageMarketStoreViewStrategyRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated uint32 strategy_list = 6;
     */
    strategyList: number[];
    /**
     * @generated from protobuf field: uint32 strategy_id = 4;
     */
    strategyId: number;
}
...
class VintageMarketStoreViewStrategyRsp$Type extends MessageType<VintageMarketStoreViewStrategyRsp> {
    ...
    internalBinaryWrite(message: VintageMarketStoreViewStrategyRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.strategyId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.strategyId);
