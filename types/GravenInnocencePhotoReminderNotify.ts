...
// @generated from protobuf file "GravenInnocencePhotoReminderNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GravenInnocencePhotoReminderNotify
 */
export interface GravenInnocencePhotoReminderNotify {
    /**
     * @generated from protobuf field: uint32 reminder_id = 13;
     */
    reminderId: number;
    /**
     * @generated from protobuf field: uint32 group_bundle_id = 7;
     */
...
class GravenInnocencePhotoReminderNotify$Type extends MessageType<GravenInnocencePhotoReminderNotify> {
    ...
    internalBinaryWrite(message: GravenInnocencePhotoReminderNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reminderId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.reminderId);
        /* uint32 group_bundle_id = 7; */
        if (message.groupBundleId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.groupBundleId);
