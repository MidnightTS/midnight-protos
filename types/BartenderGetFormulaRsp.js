...
exports.BartenderGetFormulaRsp = void 0;
...
class BartenderGetFormulaRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.formulaId !== 0)
            writer.tag(15, runtime_2.WireType.Varint).uint32(message.formulaId);
        ...
        if (message.isNew !== false)
            writer.tag(10, runtime_2.WireType.Varint).bool(message.isNew);
