...
exports.ToTheMoonRemoveObstacleReq = exports.ToTheMoonRemoveObstacleReq_ObstacleType = void 0;
...
class ToTheMoonRemoveObstacleReq$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        /* int32 handle = 15; */
        if (message.handle !== 0)
            writer.tag(15, runtime_1.WireType.Varint).int32(message.handle);
        /* uint32 scene_id = 7; */
        if (message.sceneId !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.sceneId);
        /* int32 query_id = 6; */
        if (message.queryId !== 0)
            writer.tag(6, runtime_1.WireType.Varint).int32(message.queryId);
