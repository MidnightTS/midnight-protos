...
// @generated from protobuf file "PlayerNicknameAuditDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerNicknameAuditDataNotify
 */
export interface PlayerNicknameAuditDataNotify {
    /**
     * @generated from protobuf field: ContentAuditInfo info = 7;
     */
...
class PlayerNicknameAuditDataNotify$Type extends MessageType<PlayerNicknameAuditDataNotify> {
    constructor() {
        super("PlayerNicknameAuditDataNotify", [
            { no: 7, name: "info", kind: "message", T: () => ContentAuditInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerNicknameAuditDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            ContentAuditInfo.internalBinaryWrite(message.info, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
