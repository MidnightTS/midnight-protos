...
// @generated from protobuf file "WidgetQuickHitTreeReq.proto" (syntax proto3)
// tslint:disable
//
...
import { HitTreeInfo } from "./HitTreeInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message WidgetQuickHitTreeReq
 */
export interface WidgetQuickHitTreeReq {
    /**
     * @generated from protobuf field: repeated HitTreeInfo hit_tree_info_list = 4;
     */
...
class WidgetQuickHitTreeReq$Type extends MessageType<WidgetQuickHitTreeReq> {
    constructor() {
        super("WidgetQuickHitTreeReq", [
            { no: 4, name: "hit_tree_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HitTreeInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: WidgetQuickHitTreeReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.hitTreeInfoList.length; i++)
            HitTreeInfo.internalBinaryWrite(message.hitTreeInfoList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
