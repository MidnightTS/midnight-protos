...
export interface InvestigationMonster {
    ...
    groupId: number;
    /**
     * @generated from protobuf field: uint32 next_boss_chest_refresh_time = 1;
     */
    ...
    /**
     * @generated from protobuf field: uint32 boss_chest_num = 6;
     */
    bossChestNum: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 refresh_interval = 10;
     */
    ...
    level: number;
    /**
     * @generated from protobuf field: uint32 max_boss_chest_num = 11;
     */
...
class InvestigationMonster$Type extends MessageType<InvestigationMonster> {
    ...
    internalBinaryWrite(message: InvestigationMonster, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.nextBossChestRefreshTime !== 0)
            writer.tag(1, WireType.Varint).uint32(message.nextBossChestRefreshTime);
        ...
        if (message.bossChestNum !== 0)
            writer.tag(6, WireType.Varint).uint32(message.bossChestNum);
        /* uint32 id = 9; */
        if (message.id !== 0)
        ...
        if (message.refreshInterval !== 0)
            writer.tag(10, WireType.Varint).uint32(message.refreshInterval);
        ...
        if (message.maxBossChestNum !== 0)
            writer.tag(11, WireType.Varint).uint32(message.maxBossChestNum);
        /* uint32 resin = 15; */
        if (message.resin !== 0)
