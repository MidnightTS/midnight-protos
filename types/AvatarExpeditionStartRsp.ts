...
// @generated from protobuf file "AvatarExpeditionStartRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarExpeditionStartRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: map<uint64, AvatarExpeditionInfo> expedition_info_map = 8;
     */
    expeditionInfoMap: {
...
class AvatarExpeditionStartRsp$Type extends MessageType<AvatarExpeditionStartRsp> {
    constructor() {
        super("AvatarExpeditionStartRsp", [
            ...
            { no: 8, name: "expedition_info_map", kind: "map", K: 4 /*ScalarType.UINT64*/, V: { kind: "message", T: () => AvatarExpeditionInfo } }
        ]);
    }
    ...
    private binaryReadMap8(map: AvatarExpeditionStartRsp["expeditionInfoMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: AvatarExpeditionStartRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.expeditionInfoMap)) {
            writer.tag(8, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint64(k);
