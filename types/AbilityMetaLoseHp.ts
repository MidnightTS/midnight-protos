...
// @generated from protobuf file "AbilityMetaLoseHp.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityMetaLoseHp
 */
export interface AbilityMetaLoseHp {
    /**
     * @generated from protobuf field: uint32 lose_hp_config_idx = 15;
     */
...
class AbilityMetaLoseHp$Type extends MessageType<AbilityMetaLoseHp> {
    ...
    internalBinaryWrite(message: AbilityMetaLoseHp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.loseHpConfigIdx !== 0)
            writer.tag(15, WireType.Varint).uint32(message.loseHpConfigIdx);
