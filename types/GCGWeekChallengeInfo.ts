...
// @generated from protobuf file "GCGWeekChallengeInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGWeekChallengeInfo
 */
export interface GCGWeekChallengeInfo {
    /**
     * @generated from protobuf field: uint32 npc_id = 9;
     */
    npcId: number;
    /**
     * @generated from protobuf field: uint32 unlock_time = 8;
     */
    unlockTime: number;
    /**
...
class GCGWeekChallengeInfo$Type extends MessageType<GCGWeekChallengeInfo> {
    ...
    internalBinaryWrite(message: GCGWeekChallengeInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 npc_id = 9; */
        if (message.npcId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.npcId);
        /* uint32 unlock_time = 8; */
        if (message.unlockTime !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unlockTime);
        /* bool is_finished = 12; */
