...
// @generated from protobuf file "CrystalLinkTeamInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { CrystalLinkAvatarInfo } from "./CrystalLinkAvatarInfo";
/**
 * @generated from protobuf message CrystalLinkTeamInfo
 */
export interface CrystalLinkTeamInfo {
    /**
     * @generated from protobuf field: repeated CrystalLinkAvatarInfo avatar_info_list = 14;
     */
    avatarInfoList: CrystalLinkAvatarInfo[];
    /**
     * @generated from protobuf field: repeated CrystalLinkBuffInfo buff_info_list = 12;
     */
...
class CrystalLinkTeamInfo$Type extends MessageType<CrystalLinkTeamInfo> {
    constructor() {
        super("CrystalLinkTeamInfo", [
            { no: 14, name: "avatar_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CrystalLinkAvatarInfo },
            { no: 12, name: "buff_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CrystalLinkBuffInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: CrystalLinkTeamInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.avatarInfoList.length; i++)
            CrystalLinkAvatarInfo.internalBinaryWrite(message.avatarInfoList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        /* repeated CrystalLinkBuffInfo buff_info_list = 12; */
        for (let i = 0; i < message.buffInfoList.length; i++)
            CrystalLinkBuffInfo.internalBinaryWrite(message.buffInfoList[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
