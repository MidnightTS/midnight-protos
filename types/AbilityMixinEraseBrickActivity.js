...
exports.AbilityMixinEraseBrickActivity = void 0;
...
class AbilityMixinEraseBrickActivity$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityMixinEraseBrickActivity", [
            { no: 15, name: "data", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { data: [] };
...
/**
 * @generated MessageType for protobuf message AbilityMixinEraseBrickActivity
 */
