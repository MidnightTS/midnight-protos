...
const dependency_2 = require("./AvatarExcelInfo");
const dependency_3 = require("./AvatarExpeditionState");
const dependency_4 = require("./AvatarFetterInfo");
const dependency_5 = require("./AvatarSkillInfo");
const dependency_6 = require("./PropValue");
const dependency_7 = require("./TrialAvatarInfo");
const pb_1 = require("google-protobuf");
class AvatarInfo extends pb_1.Message {
    constructor(data) {
        super();
        _AvatarInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [5, 6, 14, 20, 22, 24], __classPrivateFieldGet(this, _AvatarInfo_one_of_decls, "f"));
    ...
    get trial_avatar_info() {
        return pb_1.Message.getWrapperField(this, dependency_7.TrialAvatarInfo, 9);
    }
    ...
    get fetter_info() {
        return pb_1.Message.getWrapperField(this, dependency_4.AvatarFetterInfo, 12);
    }
    ...
    get expedition_state() {
        return pb_1.Message.getFieldWithDefault(this, 16, dependency_3.AvatarExpeditionState.AVATAR_EXPEDITION_STATE_NONE);
    }
    set expedition_state(value) {
    ...
    get equip_affix_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.AvatarEquipAffixInfo, 22);
    }
    set equip_affix_list(value) {
    ...
    set pending_promote_reward_list(value) {
    ...
    get excel_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.AvatarExcelInfo, 26);
    }
    ...
    toObject() {
        ...
        if (this.equip_affix_list != null) {
            data.equip_affix_list = this.equip_affix_list.map((item) => item.toObject());
        }
    ...
    serialize(w) {
        ...
        if (this.equip_affix_list.length)
            writer.writeRepeatedMessage(22, this.equip_affix_list, (item) => item.serialize(writer));
        if (this.born_time != 0)
...
_AvatarInfo_one_of_decls = new WeakMap();
