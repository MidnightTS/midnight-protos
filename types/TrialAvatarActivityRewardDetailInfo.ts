...
export interface TrialAvatarActivityRewardDetailInfo {
    ...
    /**
     * @generated from protobuf field: bool received_reward = 14;
     */
    receivedReward: boolean;
    /**
     * @generated from protobuf field: bool passed_dungeon = 5;
     */
...
class TrialAvatarActivityRewardDetailInfo$Type extends MessageType<TrialAvatarActivityRewardDetailInfo> {
    ...
    internalBinaryWrite(message: TrialAvatarActivityRewardDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.receivedReward !== false)
            writer.tag(14, WireType.Varint).bool(message.receivedReward);
        /* bool passed_dungeon = 5; */
        if (message.passedDungeon !== false)
            writer.tag(5, WireType.Varint).bool(message.passedDungeon);
        /* uint32 reward_id = 11; */
