...
// @generated from protobuf file "TrialAvatarActivityRewardDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message TrialAvatarActivityRewardDetailInfo
 */
export interface TrialAvatarActivityRewardDetailInfo {
    /**
     * @generated from protobuf field: uint32 trial_avatar_index_id = 4;
     */
    trialAvatarIndexId: number;
    /**
     * @generated from protobuf field: bool Unk3300_IFEPGCKHODL = 14 [json_name = "Unk3300IFEPGCKHODL"];
     */
    unk3300IFEPGCKHODL: boolean;
    /**
     * @generated from protobuf field: bool Unk3300_NEJLGBBFDPH = 5 [json_name = "Unk3300NEJLGBBFDPH"];
     */
    unk3300NEJLGBBFDPH: boolean;
    /**
...
class TrialAvatarActivityRewardDetailInfo$Type extends MessageType<TrialAvatarActivityRewardDetailInfo> {
    ...
    internalBinaryWrite(message: TrialAvatarActivityRewardDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300IFEPGCKHODL !== false)
            writer.tag(14, WireType.Varint).bool(message.unk3300IFEPGCKHODL);
        /* bool Unk3300_NEJLGBBFDPH = 5 [json_name = "Unk3300NEJLGBBFDPH"]; */
        if (message.unk3300NEJLGBBFDPH !== false)
            writer.tag(5, WireType.Varint).bool(message.unk3300NEJLGBBFDPH);
        /* uint32 reward_id = 11; */
