...
import * as dependency_1 from "./ItemHint";
import * as dependency_2 from "./Vector";
import * as pb_1 from "google-protobuf";
export class ItemAddHintNotify extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        is_position_valid?: boolean;
        quest_id?: number;
        reason?: number;
        is_general_reward_hiden?: boolean;
        item_list?: dependency_1.ItemHint[];
        is_transfered_from_avatar_card?: boolean;
        position?: dependency_2.Vector;
        overflow_transformed_item_list?: dependency_1.ItemHint[];
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [10, 8], this.#one_of_decls);
    ...
    set is_position_valid(value: boolean) {
    ...
    set is_general_reward_hiden(value: boolean) {
        pb_1.Message.setField(this, 15, value);
    }
    get item_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.ItemHint, 10) as dependency_1.ItemHint[];
    }
    set item_list(value: dependency_1.ItemHint[]) {
        pb_1.Message.setRepeatedWrapperField(this, 10, value);
    }
    get is_transfered_from_avatar_card() {
        return pb_1.Message.getFieldWithDefault(this, 12, false) as boolean;
    }
    set is_transfered_from_avatar_card(value: boolean) {
    ...
    get overflow_transformed_item_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.ItemHint, 8) as dependency_1.ItemHint[];
    }
    set overflow_transformed_item_list(value: dependency_1.ItemHint[]) {
    ...
    static fromObject(data: {
        ...
        reason?: number;
        is_general_reward_hiden?: boolean;
        item_list?: ReturnType<typeof dependency_1.ItemHint.prototype.toObject>[];
        is_transfered_from_avatar_card?: boolean;
        position?: ReturnType<typeof dependency_2.Vector.prototype.toObject>;
        overflow_transformed_item_list?: ReturnType<typeof dependency_1.ItemHint.prototype.toObject>[];
    }): ItemAddHintNotify {
    ...
    toObject() {
        ...
        if (this.item_list != null) {
            data.item_list = this.item_list.map((item: dependency_1.ItemHint) => item.toObject());
        }
        ...
        if (this.overflow_transformed_item_list != null) {
            data.overflow_transformed_item_list = this.overflow_transformed_item_list.map((item: dependency_1.ItemHint) => item.toObject());
        }
        return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.item_list.length)
            writer.writeRepeatedMessage(10, this.item_list, (item: dependency_1.ItemHint) => item.serialize(writer));
        ...
        if (this.overflow_transformed_item_list.length)
            writer.writeRepeatedMessage(8, this.overflow_transformed_item_list, (item: dependency_1.ItemHint) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ItemAddHintNotify {
    ...
    static deserializeBinary(bytes: Uint8Array): ItemAddHintNotify {
