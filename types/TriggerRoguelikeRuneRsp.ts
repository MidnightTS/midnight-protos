...
// @generated from protobuf file "TriggerRoguelikeRuneRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TriggerRoguelikeRuneRsp
 */
export interface TriggerRoguelikeRuneRsp {
    /**
     * @generated from protobuf field: uint32 available_count = 15;
     */
...
class TriggerRoguelikeRuneRsp$Type extends MessageType<TriggerRoguelikeRuneRsp> {
    ...
    internalBinaryWrite(message: TriggerRoguelikeRuneRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.availableCount !== 0)
            writer.tag(15, WireType.Varint).uint32(message.availableCount);
        /* uint32 rune_id = 10; */
        if (message.runeId !== 0)
