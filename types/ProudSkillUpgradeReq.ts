...
// @generated from protobuf file "ProudSkillUpgradeReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ProudSkillUpgradeReq
 */
export interface ProudSkillUpgradeReq {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: uint32 old_proud_skill_level = 3;
     */
    oldProudSkillLevel: number;
    /**
     * @generated from protobuf field: uint32 proud_skill_id = 2;
     */
    proudSkillId: number;
}
...
class ProudSkillUpgradeReq$Type extends MessageType<ProudSkillUpgradeReq> {
    ...
    internalBinaryWrite(message: ProudSkillUpgradeReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.oldProudSkillLevel !== 0)
            writer.tag(3, WireType.Varint).uint32(message.oldProudSkillLevel);
        /* uint32 proud_skill_id = 2; */
        if (message.proudSkillId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.proudSkillId);
