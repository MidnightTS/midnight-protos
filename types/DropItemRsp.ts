...
// @generated from protobuf file "DropItemRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DropItemRsp
 */
export interface DropItemRsp {
    /**
     * @generated from protobuf field: uint64 guid = 6;
     */
    guid: bigint;
    /**
    ...
    retcode: number;
    /**
     * @generated from protobuf field: StoreType store_type = 2;
     */
    storeType: StoreType;
}
...
class DropItemRsp$Type extends MessageType<DropItemRsp> {
    constructor() {
        super("DropItemRsp", [
            ...
            { no: 2, name: "store_type", kind: "enum", T: () => ["StoreType", StoreType, "STORE_TYPE_"] }
        ]);
    }
