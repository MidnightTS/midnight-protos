...
exports.SeaLampCoinNotify = void 0;
...
class SeaLampCoinNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("SeaLampCoinNotify", [
            { no: 8, name: "sea_lamp_coin", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { seaLampCoin: 0 };
...
/**
 * @generated MessageType for protobuf message SeaLampCoinNotify
 */
