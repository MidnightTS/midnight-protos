...
// @generated from protobuf file "ActivityGiveFriendGiftReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ActivityGiveFriendGiftReq
 */
export interface ActivityGiveFriendGiftReq {
    /**
     * @generated from protobuf field: map<uint32, uint32> gift_num_map = 10;
     */
    giftNumMap: {
        [key: number]: number;
    };
...
class ActivityGiveFriendGiftReq$Type extends MessageType<ActivityGiveFriendGiftReq> {
    ...
    private binaryReadMap10(map: ActivityGiveFriendGiftReq["giftNumMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: ActivityGiveFriendGiftReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.giftNumMap))
            writer.tag(10, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.giftNumMap[k as any]).join();
