...
export interface PlayerMatchInfoNotify {
    ...
    dungeonId: number;
    /**
     * @generated from protobuf field: uint32 match_begin_time = 5;
     */
    matchBeginTime: number;
    /**
     * @generated from protobuf field: uint32 estimate_match_cost_time = 10;
     */
...
class PlayerMatchInfoNotify$Type extends MessageType<PlayerMatchInfoNotify> {
    ...
    internalBinaryWrite(message: PlayerMatchInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.matchBeginTime !== 0)
            writer.tag(5, WireType.Varint).uint32(message.matchBeginTime);
        /* uint32 estimate_match_cost_time = 10; */
        if (message.estimateMatchCostTime !== 0)
            writer.tag(10, WireType.Varint).uint32(message.estimateMatchCostTime);
        /* uint32 host_uid = 12; */
