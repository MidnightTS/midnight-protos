...
// @generated from protobuf file "HomeUpdateScenePointFishFarmingInfoReq.proto" (syntax proto3)
// tslint:disable
//
...
import { HomeScenePointFishFarmingInfo } from "./HomeScenePointFishFarmingInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message HomeUpdateScenePointFishFarmingInfoReq
 */
export interface HomeUpdateScenePointFishFarmingInfoReq {
    /**
     * @generated from protobuf field: HomeScenePointFishFarmingInfo fish_farming_info = 2;
     */
...
class HomeUpdateScenePointFishFarmingInfoReq$Type extends MessageType<HomeUpdateScenePointFishFarmingInfoReq> {
    constructor() {
        super("HomeUpdateScenePointFishFarmingInfoReq", [
            { no: 2, name: "fish_farming_info", kind: "message", T: () => HomeScenePointFishFarmingInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeUpdateScenePointFishFarmingInfoReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fishFarmingInfo)
            HomeScenePointFishFarmingInfo.internalBinaryWrite(message.fishFarmingInfo, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
