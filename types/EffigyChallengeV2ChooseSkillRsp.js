...
exports.EffigyChallengeV2ChooseSkillRsp = void 0;
...
class EffigyChallengeV2ChooseSkillRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("EffigyChallengeV2ChooseSkillRsp", [
            { no: 12, name: "challenge_mode_skill_no", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 10, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { challengeModeSkillNo: 0, retcode: 0, levelId: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 challenge_mode_skill_no */ 12:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.challengeModeSkillNo !== 0)
            writer.tag(12, runtime_1.WireType.Varint).uint32(message.challengeModeSkillNo);
        /* int32 retcode = 1; */
...
/**
 * @generated MessageType for protobuf message EffigyChallengeV2ChooseSkillRsp
 */
