...
// @generated from protobuf file "ChessMonsterInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message ChessMonsterInfo
 */
export interface ChessMonsterInfo {
    /**
     * @generated from protobuf field: uint32 monster_id = 9;
     */
    monsterId: number;
    /**
...
class ChessMonsterInfo$Type extends MessageType<ChessMonsterInfo> {
    ...
    internalBinaryWrite(message: ChessMonsterInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.monsterId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.monsterId);
        /* uint32 level = 15; */
        if (message.level !== 0)
