...
class DoRoguelikeDungeonCardGachaReq$Type extends runtime_5.MessageType {
    constructor() {
        super("DoRoguelikeDungeonCardGachaReq", [
            { no: 5, name: "cell_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        /* uint32 cell_id = 5; */
        if (message.cellId !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.cellId);
        /* uint32 dungeon_id = 8; */
...
/**
 * @generated MessageType for protobuf message DoRoguelikeDungeonCardGachaReq
 */
