...
var _GetInvestigationMonsterReq_one_of_decls;
...
class GetInvestigationMonsterReq extends pb_1.Message {
    constructor(data) {
        super();
        _GetInvestigationMonsterReq_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _GetInvestigationMonsterReq_one_of_decls, "f"));
...
exports.GetInvestigationMonsterReq = GetInvestigationMonsterReq;
_GetInvestigationMonsterReq_one_of_decls = new WeakMap();
