...
// @generated from protobuf file "ExpeditionTakeRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ExpeditionTakeRewardReq
 */
export interface ExpeditionTakeRewardReq {
    /**
     * @generated from protobuf field: uint32 path_id = 5;
     */
    pathId: number;
}
...
class ExpeditionTakeRewardReq$Type extends MessageType<ExpeditionTakeRewardReq> {
    ...
    internalBinaryWrite(message: ExpeditionTakeRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 path_id = 5; */
        if (message.pathId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.pathId);
