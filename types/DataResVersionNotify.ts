...
export interface DataResVersionNotify {
    ...
    /**
     * @generated from protobuf field: string Unk3300_HMGCPAGLDHB = 12 [json_name = "Unk3300HMGCPAGLDHB"];
     */
    ...
    /**
     * @generated from protobuf field: string Unk3300_OPGDBOLKLJA = 2 [json_name = "Unk3300OPGDBOLKLJA"];
     */
...
class DataResVersionNotify$Type extends MessageType<DataResVersionNotify> {
    ...
    internalBinaryWrite(message: DataResVersionNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300HMGCPAGLDHB !== "")
            writer.tag(12, WireType.LengthDelimited).string(message.unk3300HMGCPAGLDHB);
        ...
        if (message.unk3300OPGDBOLKLJA !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.unk3300OPGDBOLKLJA);
