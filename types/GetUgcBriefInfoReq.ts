...
// @generated from protobuf file "GetUgcBriefInfoReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetUgcBriefInfoReq
 */
export interface GetUgcBriefInfoReq {
    ...
    ugcGuid: bigint;
    /**
     * @generated from protobuf field: UgcType ugc_type = 1;
     */
    ugcType: UgcType;
}
...
class GetUgcBriefInfoReq$Type extends MessageType<GetUgcBriefInfoReq> {
    constructor() {
        super("GetUgcBriefInfoReq", [
            ...
            { no: 1, name: "ugc_type", kind: "enum", T: () => ["UgcType", UgcType, "UGC_TYPE_"] }
        ]);
    }
