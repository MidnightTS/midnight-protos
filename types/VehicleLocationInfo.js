...
class VehicleLocationInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("VehicleLocationInfo", [
            ...
            { no: 2, name: "Unk3300_MLICEAKLOIH", kind: "scalar", jsonName: "Unk3300MLICEAKLOIH", T: 2 /*ScalarType.FLOAT*/ },
            ...
            { no: 15, name: "Unk3300_MNNMOCIIEAJ", kind: "scalar", jsonName: "Unk3300MNNMOCIIEAJ", T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    create(value) {
        const message = { ownerUid: 0, uidList: [], unk3300MLICEAKLOIH: 0, gadgetId: 0, entityId: 0, unk3300MNNMOCIIEAJ: 0 };
            ...
            switch (fieldNo) {
                ...
                case /* repeated uint32 uid_list */ 4:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        ...
                        message.uidList.push(reader.uint32());
                    break;
                case /* float Unk3300_MLICEAKLOIH = 2 [json_name = "Unk3300MLICEAKLOIH"];*/ 2:
                    message.unk3300MLICEAKLOIH = reader.float();
                    break;
                case /* Vector pos */ 9:
                ...
                case /* uint32 entity_id */ 14:
                    ...
                    break;
                case /* float Unk3300_MNNMOCIIEAJ = 15 [json_name = "Unk3300MNNMOCIIEAJ"];*/ 15:
                    message.unk3300MNNMOCIIEAJ = reader.float();
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* float Unk3300_MLICEAKLOIH = 2 [json_name = "Unk3300MLICEAKLOIH"]; */
        if (message.unk3300MLICEAKLOIH !== 0)
            writer.tag(2, runtime_2.WireType.Bit32).float(message.unk3300MLICEAKLOIH);
        /* Vector pos = 9; */
        if (message.pos)
        ...
        /* float Unk3300_MNNMOCIIEAJ = 15 [json_name = "Unk3300MNNMOCIIEAJ"]; */
        if (message.unk3300MNNMOCIIEAJ !== 0)
            writer.tag(15, runtime_2.WireType.Bit32).float(message.unk3300MNNMOCIIEAJ);
