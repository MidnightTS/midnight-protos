...
// @generated from protobuf file "DeshretObeliskChestInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { DeshretObeliskChestInfo } from "./DeshretObeliskChestInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message DeshretObeliskChestInfoNotify
 */
export interface DeshretObeliskChestInfoNotify {
    /**
     * @generated from protobuf field: repeated DeshretObeliskChestInfo chest_info_list = 6;
     */
...
class DeshretObeliskChestInfoNotify$Type extends MessageType<DeshretObeliskChestInfoNotify> {
    constructor() {
        super("DeshretObeliskChestInfoNotify", [
            { no: 6, name: "chest_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DeshretObeliskChestInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: DeshretObeliskChestInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.chestInfoList.length; i++)
            DeshretObeliskChestInfo.internalBinaryWrite(message.chestInfoList[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
