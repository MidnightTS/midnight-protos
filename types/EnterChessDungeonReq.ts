...
// @generated from protobuf file "EnterChessDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EnterChessDungeonReq
 */
export interface EnterChessDungeonReq {
    /**
     * @generated from protobuf field: uint32 map_id = 14;
     */
    mapId: number;
}
...
class EnterChessDungeonReq$Type extends MessageType<EnterChessDungeonReq> {
    ...
    internalBinaryWrite(message: EnterChessDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 map_id = 14; */
        if (message.mapId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.mapId);
