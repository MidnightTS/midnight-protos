...
// @generated from protobuf file "AchievementAllDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AchievementAllDataNotify
 */
export interface AchievementAllDataNotify {
    /**
     * @generated from protobuf field: repeated uint32 reward_taken_goal_id_list = 13;
     */
    rewardTakenGoalIdList: number[];
    /**
     * @generated from protobuf field: repeated Achievement achievement_list = 8;
     */
...
class AchievementAllDataNotify$Type extends MessageType<AchievementAllDataNotify> {
    constructor() {
        super("AchievementAllDataNotify", [
            ...
            { no: 8, name: "achievement_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Achievement }
        ]);
    }
    ...
    internalBinaryWrite(message: AchievementAllDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.achievementList.length; i++)
            Achievement.internalBinaryWrite(message.achievementList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
