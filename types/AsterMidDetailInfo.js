...
class AsterMidDetailInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("AsterMidDetailInfo", [
            ...
            { no: 7, name: "collect_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isOpen: false, campList: [], beginTime: 0, collectCount: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.collectCount !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.collectCount);
...
/**
 * @generated MessageType for protobuf message AsterMidDetailInfo
 */
