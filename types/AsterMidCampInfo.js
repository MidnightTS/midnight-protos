...
class AsterMidCampInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("AsterMidCampInfo", [
            { no: 3, name: "pos", kind: "message", T: () => Vector_1.Vector },
            { no: 15, name: "camp_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { campId: 0 };
...
/**
 * @generated MessageType for protobuf message AsterMidCampInfo
 */
