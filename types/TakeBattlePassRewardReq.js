...
exports.TakeBattlePassRewardReq = void 0;
...
class TakeBattlePassRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeBattlePassRewardReq", [
            { no: 9, name: "take_option_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BattlePassRewardTakeOption_1.BattlePassRewardTakeOption }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.takeOptionList.length; i++)
            BattlePassRewardTakeOption_1.BattlePassRewardTakeOption.internalBinaryWrite(message.takeOptionList[i], writer.tag(9, runtime_1.WireType.LengthDelimited).fork(), options).join();
