...
exports.CheckGroupReplacedRsp = void 0;
...
class CheckGroupReplacedRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("CheckGroupReplacedRsp", [
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 10, name: "replaced_group_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, replacedGroupIdList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 14:
                    ...
                    break;
                case /* repeated uint32 replaced_group_id_list */ 10:
...
/**
 * @generated MessageType for protobuf message CheckGroupReplacedRsp
 */
