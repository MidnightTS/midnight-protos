...
// @generated from protobuf file "EntityAuthorityChangeNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { AuthorityChange } from "./AuthorityChange";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message EntityAuthorityChangeNotify
 */
export interface EntityAuthorityChangeNotify {
    /**
     * @generated from protobuf field: repeated AuthorityChange authority_change_list = 8;
     */
...
class EntityAuthorityChangeNotify$Type extends MessageType<EntityAuthorityChangeNotify> {
    constructor() {
        super("EntityAuthorityChangeNotify", [
            { no: 8, name: "authority_change_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AuthorityChange }
        ]);
    }
    ...
    internalBinaryWrite(message: EntityAuthorityChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.authorityChangeList.length; i++)
            AuthorityChange.internalBinaryWrite(message.authorityChangeList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
