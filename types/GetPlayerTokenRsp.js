...
class GetPlayerTokenRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300PIPLDEAPMMN !== 0)
            writer.tag(7, runtime_2.WireType.Varint).uint32(message.unk3300PIPLDEAPMMN);
        /* bool is_guest = 11; */
        ...
        if (message.unk3300DILMOPPLPEM !== 0)
            writer.tag(1670, runtime_2.WireType.Varint).uint32(message.unk3300DILMOPPLPEM);
        ...
        if (message.unk3300IADFJHNFKIB !== 0)
            writer.tag(1038, runtime_2.WireType.Varint).uint32(message.unk3300IADFJHNFKIB);
        /* int32 retcode = 2; */
        ...
        if (message.unk3300PPGJMLBGJED !== false)
            writer.tag(9, runtime_2.WireType.Varint).bool(message.unk3300PPGJMLBGJED);
        ...
        if (message.unk3300FHPCJMIILPA !== 0)
            writer.tag(12, runtime_2.WireType.Varint).uint32(message.unk3300FHPCJMIILPA);
