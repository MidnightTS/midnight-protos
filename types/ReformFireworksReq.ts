...
// @generated from protobuf file "ReformFireworksReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ReformFireworksReq
 */
export interface ReformFireworksReq {
    /**
     * @generated from protobuf field: FireworksReformData fireworks_reform_data = 1;
     */
...
class ReformFireworksReq$Type extends MessageType<ReformFireworksReq> {
    constructor() {
        super("ReformFireworksReq", [
            { no: 1, name: "fireworks_reform_data", kind: "message", T: () => FireworksReformData }
        ]);
    }
    ...
    internalBinaryWrite(message: ReformFireworksReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fireworksReformData)
            FireworksReformData.internalBinaryWrite(message.fireworksReformData, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
