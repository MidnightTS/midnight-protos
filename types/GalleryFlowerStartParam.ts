...
// @generated from protobuf file "GalleryFlowerStartParam.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GalleryFlowerStartParam
 */
export interface GalleryFlowerStartParam {
    /**
     * @generated from protobuf field: uint32 target_score = 9;
     */
    targetScore: number;
}
...
class GalleryFlowerStartParam$Type extends MessageType<GalleryFlowerStartParam> {
    ...
    internalBinaryWrite(message: GalleryFlowerStartParam, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetScore !== 0)
            writer.tag(9, WireType.Varint).uint32(message.targetScore);
