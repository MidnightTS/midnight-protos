...
exports.TowerGetFloorStarRewardRsp = void 0;
...
class TowerGetFloorStarRewardRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.floorId !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.floorId);
...
/**
 * @generated MessageType for protobuf message TowerGetFloorStarRewardRsp
 */
