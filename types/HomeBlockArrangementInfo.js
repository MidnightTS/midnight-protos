...
class HomeBlockArrangementInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeBlockArrangementInfo", [
            { no: 10, name: "Unk3300_GMMAIDIJOJM", kind: "message", jsonName: "Unk3300GMMAIDIJOJM", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeFurnitureData_1.HomeFurnitureData },
            ...
            { no: 12, name: "Unk3300_DEIECJCAFLN", kind: "message", jsonName: "Unk3300DEIECJCAFLN", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeFurnitureData_1.HomeFurnitureData },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated HomeFurnitureData Unk3300_GMMAIDIJOJM = 10 [json_name = "Unk3300GMMAIDIJOJM"];*/ 10:
                    message.unk3300GMMAIDIJOJM.push(HomeFurnitureData_1.HomeFurnitureData.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                ...
                case /* repeated HomeFurnitureData Unk3300_DEIECJCAFLN = 12 [json_name = "Unk3300DEIECJCAFLN"];*/ 12:
                    message.unk3300DEIECJCAFLN.push(HomeFurnitureData_1.HomeFurnitureData.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.unk3300GMMAIDIJOJM.length; i++)
            HomeFurnitureData_1.HomeFurnitureData.internalBinaryWrite(message.unk3300GMMAIDIJOJM[i], writer.tag(10, runtime_1.WireType.LengthDelimited).fork(), options).join();
        ...
        for (let i = 0; i < message.unk3300DEIECJCAFLN.length; i++)
            HomeFurnitureData_1.HomeFurnitureData.internalBinaryWrite(message.unk3300DEIECJCAFLN[i], writer.tag(12, runtime_1.WireType.LengthDelimited).fork(), options).join();
