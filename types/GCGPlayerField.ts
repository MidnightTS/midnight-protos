...
export interface GCGPlayerField {
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_FJNPFBIHFGD = 3 [json_name = "Unk3300FJNPFBIHFGD"];
     */
    unk3300FJNPFBIHFGD: number;
    /**
...
class GCGPlayerField$Type extends MessageType<GCGPlayerField> {
    ...
    internalBinaryWrite(message: GCGPlayerField, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300FJNPFBIHFGD !== 0)
            writer.tag(3, WireType.Varint).uint32(message.unk3300FJNPFBIHFGD);
