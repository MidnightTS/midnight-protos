...
var _PlayerPropNotify_one_of_decls;
...
class PlayerPropNotify extends pb_1.Message {
    constructor(data) {
        super();
        _PlayerPropNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PlayerPropNotify_one_of_decls, "f"));
...
exports.PlayerPropNotify = PlayerPropNotify;
_PlayerPropNotify_one_of_decls = new WeakMap();
