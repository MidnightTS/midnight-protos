...
// @generated from protobuf file "TakeReunionSignInRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeReunionSignInRewardReq
 */
export interface TakeReunionSignInRewardReq {
    /**
     * @generated from protobuf field: uint32 reward_day = 1;
     */
    rewardDay: number;
    /**
...
class TakeReunionSignInRewardReq$Type extends MessageType<TakeReunionSignInRewardReq> {
    ...
    internalBinaryWrite(message: TakeReunionSignInRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardDay !== 0)
            writer.tag(1, WireType.Varint).uint32(message.rewardDay);
        /* uint32 config_id = 11; */
