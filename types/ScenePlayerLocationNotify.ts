...
// @generated from protobuf file "ScenePlayerLocationNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { VehicleLocationInfo } from "./VehicleLocationInfo";
/**
 * enum CmdId {
...
export interface ScenePlayerLocationNotify {
    ...
    sceneId: number;
    /**
     * @generated from protobuf field: repeated VehicleLocationInfo vehicle_loc_list = 6;
     */
    vehicleLocList: VehicleLocationInfo[];
    /**
     * @generated from protobuf field: repeated PlayerLocationInfo player_loc_list = 4;
     */
...
class ScenePlayerLocationNotify$Type extends MessageType<ScenePlayerLocationNotify> {
    constructor() {
        super("ScenePlayerLocationNotify", [
            ...
            { no: 6, name: "vehicle_loc_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => VehicleLocationInfo },
            { no: 4, name: "player_loc_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlayerLocationInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: ScenePlayerLocationNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.vehicleLocList.length; i++)
            VehicleLocationInfo.internalBinaryWrite(message.vehicleLocList[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* repeated PlayerLocationInfo player_loc_list = 4; */
        for (let i = 0; i < message.playerLocList.length; i++)
            PlayerLocationInfo.internalBinaryWrite(message.playerLocList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
