...
exports.SetCodexPushtipsReadRsp = void 0;
...
class SetCodexPushtipsReadRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 type_id = 4; */
        if (message.typeId !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.typeId);
        /* uint32 codex_id = 14; */
        if (message.codexId !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.codexId);
