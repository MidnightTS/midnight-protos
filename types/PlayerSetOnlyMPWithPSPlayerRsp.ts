...
// @generated from protobuf file "PlayerSetOnlyMPWithPSPlayerRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerSetOnlyMPWithPSPlayerRsp
 */
export interface PlayerSetOnlyMPWithPSPlayerRsp {
    /**
     * @generated from protobuf field: bool is_only = 4;
     */
    isOnly: boolean;
    /**
...
class PlayerSetOnlyMPWithPSPlayerRsp$Type extends MessageType<PlayerSetOnlyMPWithPSPlayerRsp> {
    ...
    internalBinaryWrite(message: PlayerSetOnlyMPWithPSPlayerRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isOnly !== false)
            writer.tag(4, WireType.Varint).bool(message.isOnly);
        /* int32 retcode = 11; */
