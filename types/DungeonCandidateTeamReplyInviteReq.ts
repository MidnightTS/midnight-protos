...
// @generated from protobuf file "DungeonCandidateTeamReplyInviteReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonCandidateTeamReplyInviteReq
 */
export interface DungeonCandidateTeamReplyInviteReq {
    /**
     * @generated from protobuf field: bool is_accept = 1;
     */
    isAccept: boolean;
}
...
class DungeonCandidateTeamReplyInviteReq$Type extends MessageType<DungeonCandidateTeamReplyInviteReq> {
    ...
    internalBinaryWrite(message: DungeonCandidateTeamReplyInviteReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAccept !== false)
            writer.tag(1, WireType.Varint).bool(message.isAccept);
