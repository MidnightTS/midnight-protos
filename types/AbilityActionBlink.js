...
exports.AbilityActionBlink = void 0;
...
class AbilityActionBlink$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityActionBlink", [
            { no: 8, name: "rot", kind: "message", T: () => Vector_1.Vector },
    ...
    internalBinaryWrite(message, writer, options) {
        /* Vector rot = 8; */
        if (message.rot)
            Vector_1.Vector.internalBinaryWrite(message.rot, writer.tag(8, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* Vector pos = 3; */
        if (message.pos)
...
/**
 * @generated MessageType for protobuf message AbilityActionBlink
 */
