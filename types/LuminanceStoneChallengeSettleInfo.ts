...
// @generated from protobuf file "LuminanceStoneChallengeSettleInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { LuminanceStoneChallengeGallerySettleInfo } from "./LuminanceStoneChallengeGallerySettleInfo";
/**
 * @generated from protobuf message LuminanceStoneChallengeSettleInfo
 */
export interface LuminanceStoneChallengeSettleInfo {
    ...
    isNewRecord: boolean;
    /**
     * @generated from protobuf field: LuminanceStoneChallengeGallerySettleInfo settle_info = 10;
     */
...
class LuminanceStoneChallengeSettleInfo$Type extends MessageType<LuminanceStoneChallengeSettleInfo> {
    constructor() {
        super("LuminanceStoneChallengeSettleInfo", [
            ...
            { no: 10, name: "settle_info", kind: "message", T: () => LuminanceStoneChallengeGallerySettleInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: LuminanceStoneChallengeSettleInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.settleInfo)
            LuminanceStoneChallengeGallerySettleInfo.internalBinaryWrite(message.settleInfo, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
