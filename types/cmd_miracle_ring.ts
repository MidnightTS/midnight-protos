...
// @generated from protobuf file "cmd_miracle_ring.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class MiracleRingDeliverItemReq$Type extends MessageType<MiracleRingDeliverItemReq> {
    constructor() {
        super("com.midnights.game.MiracleRingDeliverItemReq", [
            ...
            { no: 1, name: "item_param_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
