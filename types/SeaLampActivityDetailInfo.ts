...
export interface SeaLampActivityDetailInfo {
    ...
    days: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_DGMGNJLHFMB = 8 [json_name = "Unk3300DGMGNJLHFMB"];
     */
    unk3300DGMGNJLHFMB: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_GBCCJMBPBBI = 11 [json_name = "Unk3300GBCCJMBPBBI"];
     */
    unk3300GBCCJMBPBBI: number;
    /**
...
class SeaLampActivityDetailInfo$Type extends MessageType<SeaLampActivityDetailInfo> {
    ...
    internalBinaryWrite(message: SeaLampActivityDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300DGMGNJLHFMB !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300DGMGNJLHFMB);
        /* uint32 progress = 5; */
        ...
        if (message.unk3300GBCCJMBPBBI !== 0)
            writer.tag(11, WireType.Varint).uint32(message.unk3300GBCCJMBPBBI);
        /* uint32 phase_id = 3; */
