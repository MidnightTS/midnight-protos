...
class GetAllUnlockNameCardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GetAllUnlockNameCardRsp", [
            { no: 11, name: "name_card_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { nameCardList: [], retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 name_card_list */ 11:
