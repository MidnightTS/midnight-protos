...
// @generated from protobuf file "BonusActivityInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message BonusActivityInfoRsp
 */
export interface BonusActivityInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated BonusActivityInfo bonus_activity_info_list = 15;
     */
...
class BonusActivityInfoRsp$Type extends MessageType<BonusActivityInfoRsp> {
    constructor() {
        super("BonusActivityInfoRsp", [
            ...
            { no: 15, name: "bonus_activity_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BonusActivityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: BonusActivityInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.bonusActivityInfoList.length; i++)
            BonusActivityInfo.internalBinaryWrite(message.bonusActivityInfoList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
