...
// @generated from protobuf file "PullRecentChatReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PullRecentChatReq
 */
export interface PullRecentChatReq {
    /**
     * @generated from protobuf field: uint32 pull_num = 3;
     */
    pullNum: number;
    /**
     * @generated from protobuf field: uint32 begin_sequence = 15;
     */
...
class PullRecentChatReq$Type extends MessageType<PullRecentChatReq> {
    ...
    internalBinaryWrite(message: PullRecentChatReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.pullNum !== 0)
            writer.tag(3, WireType.Varint).uint32(message.pullNum);
