...
// @generated from protobuf file "SceneGalleryFungusFighterTrainingInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SceneGalleryFungusFighterTrainingInfo
 */
export interface SceneGalleryFungusFighterTrainingInfo {
    /**
     * @generated from protobuf field: uint32 Unk3300_GMLIPFDMDOG = 15 [json_name = "Unk3300GMLIPFDMDOG"];
     */
    unk3300GMLIPFDMDOG: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_IOEELCAMDCK = 8 [json_name = "Unk3300IOEELCAMDCK"];
     */
    unk3300IOEELCAMDCK: number;
    /**
     * @generated from protobuf field: uint32 max_monster_count = 10;
     */
    maxMonsterCount: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_EDHANEGNMJM = 2 [json_name = "Unk3300EDHANEGNMJM"];
     */
    unk3300EDHANEGNMJM: number;
    /**
     * @generated from protobuf field: uint32 buff_id = 13;
     */
    buffId: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_HGPGNCMNDJN = 14 [json_name = "Unk3300HGPGNCMNDJN"];
     */
    unk3300HGPGNCMNDJN: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_EKAMCPNGCGH = 5 [json_name = "Unk3300EKAMCPNGCGH"];
     */
...
class SceneGalleryFungusFighterTrainingInfo$Type extends MessageType<SceneGalleryFungusFighterTrainingInfo> {
    ...
    internalBinaryWrite(message: SceneGalleryFungusFighterTrainingInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300GMLIPFDMDOG !== 0)
            writer.tag(15, WireType.Varint).uint32(message.unk3300GMLIPFDMDOG);
        /* uint32 Unk3300_IOEELCAMDCK = 8 [json_name = "Unk3300IOEELCAMDCK"]; */
        if (message.unk3300IOEELCAMDCK !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300IOEELCAMDCK);
        /* uint32 max_monster_count = 10; */
        if (message.maxMonsterCount !== 0)
            writer.tag(10, WireType.Varint).uint32(message.maxMonsterCount);
        /* uint32 Unk3300_EDHANEGNMJM = 2 [json_name = "Unk3300EDHANEGNMJM"]; */
        if (message.unk3300EDHANEGNMJM !== 0)
            writer.tag(2, WireType.Varint).uint32(message.unk3300EDHANEGNMJM);
        /* uint32 buff_id = 13; */
        if (message.buffId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.buffId);
        /* uint32 Unk3300_HGPGNCMNDJN = 14 [json_name = "Unk3300HGPGNCMNDJN"]; */
        if (message.unk3300HGPGNCMNDJN !== 0)
            writer.tag(14, WireType.Varint).uint32(message.unk3300HGPGNCMNDJN);
        /* uint32 Unk3300_EKAMCPNGCGH = 5 [json_name = "Unk3300EKAMCPNGCGH"]; */
        if (message.unk3300EKAMCPNGCGH !== 0)
            writer.tag(5, WireType.Varint).uint32(message.unk3300EKAMCPNGCGH);
