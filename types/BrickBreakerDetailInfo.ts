...
export interface BrickBreakerDetailInfo {
    ...
    /**
     * @generated from protobuf field: repeated BrickBreakerLevelInfo dungeon_level_info_list = 9;
     */
    dungeonLevelInfoList: BrickBreakerLevelInfo[];
    /**
     * @generated from protobuf field: repeated BrickBreakerLevelInfo world_level_info_list = 11;
     */
    worldLevelInfoList: BrickBreakerLevelInfo[];
    /**
...
class BrickBreakerDetailInfo$Type extends MessageType<BrickBreakerDetailInfo> {
    constructor() {
        super("BrickBreakerDetailInfo", [
            ...
            { no: 9, name: "dungeon_level_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BrickBreakerLevelInfo },
            { no: 11, name: "world_level_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BrickBreakerLevelInfo },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated BrickBreakerLevelInfo dungeon_level_info_list */ 9:
                    message.dungeonLevelInfoList.push(BrickBreakerLevelInfo.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated BrickBreakerLevelInfo world_level_info_list */ 11:
                    message.worldLevelInfoList.push(BrickBreakerLevelInfo.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: BrickBreakerDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.dungeonLevelInfoList.length; i++)
            BrickBreakerLevelInfo.internalBinaryWrite(message.dungeonLevelInfoList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* repeated BrickBreakerLevelInfo world_level_info_list = 11; */
        for (let i = 0; i < message.worldLevelInfoList.length; i++)
            BrickBreakerLevelInfo.internalBinaryWrite(message.worldLevelInfoList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
