...
class SceneGalleryWindFieldInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300MMONPDMIEBN !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.unk3300MMONPDMIEBN);
        /* uint32 Unk3300_OJHJPBCAONA = 2 [json_name = "Unk3300OJHJPBCAONA"]; */
        if (message.unk3300OJHJPBCAONA !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.unk3300OJHJPBCAONA);
        ...
        if (message.unk3300EKMHMHJDHIL !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.unk3300EKMHMHJDHIL);
        /* uint32 Unk3300_GNJKOCLJFNM = 7 [json_name = "Unk3300GNJKOCLJFNM"]; */
        if (message.unk3300GNJKOCLJFNM !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.unk3300GNJKOCLJFNM);
        /* uint32 Unk3300_GNKCFHMDOHJ = 3 [json_name = "Unk3300GNKCFHMDOHJ"]; */
        if (message.unk3300GNKCFHMDOHJ !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.unk3300GNKCFHMDOHJ);
        /* uint32 Unk3300_FFODAKMKGEK = 4 [json_name = "Unk3300FFODAKMKGEK"]; */
        if (message.unk3300FFODAKMKGEK !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.unk3300FFODAKMKGEK);
        /* uint32 Unk3300_GLNHBJJJINK = 14 [json_name = "Unk3300GLNHBJJJINK"]; */
        if (message.unk3300GLNHBJJJINK !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.unk3300GLNHBJJJINK);
