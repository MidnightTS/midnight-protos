...
exports.GCGMsgSelectOnStage = void 0;
...
class GCGMsgSelectOnStage$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGMsgSelectOnStage", [
            { no: 11, name: "reason", kind: "enum", T: () => ["GCGReason", GCGReason_1.GCGReason] },
            { no: 12, name: "controller_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "card_guid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { reason: 0, controllerId: 0, cardGuid: 0 };
...
/**
 * @generated MessageType for protobuf message GCGMsgSelectOnStage
 */
