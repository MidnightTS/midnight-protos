...
var _PlatformChangeRouteNotify_one_of_decls;
...
class PlatformChangeRouteNotify extends pb_1.Message {
    constructor(data) {
        super();
        _PlatformChangeRouteNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PlatformChangeRouteNotify_one_of_decls, "f"));
    ...
    get platform() {
        return pb_1.Message.getWrapperField(this, dependency_1.PlatformInfo, 1);
    }
    set platform(value) {
...
exports.PlatformChangeRouteNotify = PlatformChangeRouteNotify;
_PlatformChangeRouteNotify_one_of_decls = new WeakMap();
