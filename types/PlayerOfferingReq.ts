...
// @generated from protobuf file "PlayerOfferingReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerOfferingReq
 */
export interface PlayerOfferingReq {
    /**
     * @generated from protobuf field: uint32 offering_id = 15;
     */
    offeringId: number;
}
...
class PlayerOfferingReq$Type extends MessageType<PlayerOfferingReq> {
    ...
    internalBinaryWrite(message: PlayerOfferingReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.offeringId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.offeringId);
