...
class GalleryPreStartNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GalleryPreStartNotify", [
            { no: 4, name: "gallery_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "pre_start_end_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { galleryId: 0, preStartEndTime: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 gallery_id */ 4:
                    ...
                    break;
                case /* uint32 pre_start_end_time */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.preStartEndTime !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.preStartEndTime);
...
/**
 * @generated MessageType for protobuf message GalleryPreStartNotify
 */
