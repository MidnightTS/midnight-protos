...
// @generated from protobuf file "OpActivityDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message OpActivityDataNotify
 */
export interface OpActivityDataNotify {
    /**
     * @generated from protobuf field: repeated OpActivityInfo op_activity_info_list = 4;
     */
...
class OpActivityDataNotify$Type extends MessageType<OpActivityDataNotify> {
    constructor() {
        super("OpActivityDataNotify", [
            { no: 4, name: "op_activity_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => OpActivityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: OpActivityDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.opActivityInfoList.length; i++)
            OpActivityInfo.internalBinaryWrite(message.opActivityInfoList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
