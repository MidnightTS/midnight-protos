...
// @generated from protobuf file "CustomDungeonBattleRecordNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CustomDungeonBattleRecordNotify
 */
export interface CustomDungeonBattleRecordNotify {
    ...
    dungeonGuid: bigint;
    /**
     * @generated from protobuf field: uint32 min_cost_time = 12;
     */
    minCostTime: number;
}
...
class CustomDungeonBattleRecordNotify$Type extends MessageType<CustomDungeonBattleRecordNotify> {
    ...
    internalBinaryWrite(message: CustomDungeonBattleRecordNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.minCostTime !== 0)
            writer.tag(12, WireType.Varint).uint32(message.minCostTime);
