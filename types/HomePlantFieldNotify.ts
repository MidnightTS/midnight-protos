...
// @generated from protobuf file "HomePlantFieldNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomePlantFieldNotify
 */
export interface HomePlantFieldNotify {
    /**
     * @generated from protobuf field: HomePlantFieldData field = 7;
     */
...
class HomePlantFieldNotify$Type extends MessageType<HomePlantFieldNotify> {
    constructor() {
        super("HomePlantFieldNotify", [
            { no: 7, name: "field", kind: "message", T: () => HomePlantFieldData }
        ]);
    }
    ...
    internalBinaryWrite(message: HomePlantFieldNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.field)
            HomePlantFieldData.internalBinaryWrite(message.field, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
