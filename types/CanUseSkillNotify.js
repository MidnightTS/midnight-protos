...
class CanUseSkillNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CanUseSkillNotify", [
            { no: 12, name: "is_can_use_skill", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isCanUseSkill !== false)
            writer.tag(12, runtime_1.WireType.Varint).bool(message.isCanUseSkill);
