...
var _InBattleMechanicusSettleNotify_one_of_decls;
...
class InBattleMechanicusSettleNotify extends pb_1.Message {
    constructor(data) {
        super();
        _InBattleMechanicusSettleNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _InBattleMechanicusSettleNotify_one_of_decls, "f"));
    ...
    get watcher_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.MultistageSettleWatcherInfo, 3);
    }
    ...
    serialize(w) {
        ...
        if (this.watcher_list.length)
            writer.writeRepeatedMessage(3, this.watcher_list, (item) => item.serialize(writer));
...
exports.InBattleMechanicusSettleNotify = InBattleMechanicusSettleNotify;
_InBattleMechanicusSettleNotify_one_of_decls = new WeakMap();
