...
exports.QuestListNotify = void 0;
...
class QuestListNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("QuestListNotify", [
            { no: 13, name: "quest_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Quest_1.Quest }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.questList.length; i++)
            Quest_1.Quest.internalBinaryWrite(message.questList[i], writer.tag(13, runtime_1.WireType.LengthDelimited).fork(), options).join();
