...
// @generated from protobuf file "DestroyMaterialReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface DestroyMaterialReq {
    /**
     * @generated from protobuf field: repeated MaterialInfo material_list = 1;
     */
...
class DestroyMaterialReq$Type extends MessageType<DestroyMaterialReq> {
    constructor() {
        super("DestroyMaterialReq", [
            { no: 1, name: "material_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MaterialInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: DestroyMaterialReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.materialList.length; i++)
            MaterialInfo.internalBinaryWrite(message.materialList[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
