...
// @generated from protobuf file "RogueFinishRepairReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RogueFinishRepairReq
 */
export interface RogueFinishRepairReq {
    /**
     * @generated from protobuf field: repeated RogueDiaryAvatar chosen_avatar_list = 14;
     */
...
class RogueFinishRepairReq$Type extends MessageType<RogueFinishRepairReq> {
    constructor() {
        super("RogueFinishRepairReq", [
            { no: 14, name: "chosen_avatar_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RogueDiaryAvatar },
    ...
    internalBinaryWrite(message: RogueFinishRepairReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.chosenAvatarList.length; i++)
            RogueDiaryAvatar.internalBinaryWrite(message.chosenAvatarList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
