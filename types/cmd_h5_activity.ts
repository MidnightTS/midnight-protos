...
// @generated from protobuf file "cmd_h5_activity.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class GetAllH5ActivityInfoRsp$Type extends MessageType<GetAllH5ActivityInfoRsp> {
    constructor() {
        super("com.midnights.game.GetAllH5ActivityInfoRsp", [
            { no: 15, name: "h5_activity_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => H5ActivityInfo },
