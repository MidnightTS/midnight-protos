...
class ReliquaryUpgradeRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ReliquaryUpgradeRsp", [
            ...
            { no: 10, name: "old_append_prop_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "power_up_rate", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { curAppendPropList: [], retcode: 0, targetReliquaryGuid: 0n, curLevel: 0, oldLevel: 0, oldAppendPropList: [], powerUpRate: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 old_level */ 6:
                    ...
                    break;
                case /* repeated uint32 old_append_prop_list */ 10:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
