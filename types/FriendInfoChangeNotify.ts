...
// @generated from protobuf file "FriendInfoChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FriendInfoChangeNotify
 */
export interface FriendInfoChangeNotify {
    ...
    uid: number;
    /**
     * @generated from protobuf field: string online_id = 3;
     */
    onlineId: string;
}
...
class FriendInfoChangeNotify$Type extends MessageType<FriendInfoChangeNotify> {
    ...
    internalBinaryWrite(message: FriendInfoChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string online_id = 3; */
        if (message.onlineId !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.onlineId);
