...
// @generated from protobuf file "DraftOwnerTwiceConfirmNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DraftOwnerTwiceConfirmNotify
 */
export interface DraftOwnerTwiceConfirmNotify {
    /**
     * @generated from protobuf field: uint32 draft_id = 6;
     */
    draftId: number;
    /**
     * @generated from protobuf field: uint32 twice_confirm_deadline_time = 5;
     */
...
class DraftOwnerTwiceConfirmNotify$Type extends MessageType<DraftOwnerTwiceConfirmNotify> {
    ...
    internalBinaryWrite(message: DraftOwnerTwiceConfirmNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.draftId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.draftId);
        /* uint32 twice_confirm_deadline_time = 5; */
        if (message.twiceConfirmDeadlineTime !== 0)
            writer.tag(5, WireType.Varint).uint32(message.twiceConfirmDeadlineTime);
