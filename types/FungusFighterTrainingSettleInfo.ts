...
// @generated from protobuf file "FungusFighterTrainingSettleInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message FungusFighterTrainingSettleInfo
 */
export interface FungusFighterTrainingSettleInfo {
    /**
     * @generated from protobuf field: uint32 used_time = 13;
     */
    usedTime: number;
    /**
     * @generated from protobuf field: GalleryStopReason reason = 4;
     */
...
class FungusFighterTrainingSettleInfo$Type extends MessageType<FungusFighterTrainingSettleInfo> {
    constructor() {
        super("FungusFighterTrainingSettleInfo", [
            ...
            { no: 4, name: "reason", kind: "enum", T: () => ["GalleryStopReason", GalleryStopReason, "GALLERY_STOP_REASON_"] },
    ...
    internalBinaryWrite(message: FungusFighterTrainingSettleInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.usedTime !== 0)
            writer.tag(13, WireType.Varint).uint32(message.usedTime);
