...
class GCGMsgDiceRoll$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGMsgDiceRoll", [
            { no: 9, name: "controller_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "dice_num", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "dice_side_list", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["GCGDiceSideType", GCGDiceSideType_1.GCGDiceSideType] }
        ]);
    }
    create(value) {
        const message = { controllerId: 0, diceNum: 0, diceSideList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 controller_id */ 9:
                    ...
                    break;
                case /* uint32 dice_num */ 3:
                    message.diceNum = reader.uint32();
                    break;
                case /* repeated GCGDiceSideType dice_side_list */ 14:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 dice_num = 3; */
        if (message.diceNum !== 0)
            writer.tag(3, runtime_2.WireType.Varint).uint32(message.diceNum);
...
/**
 * @generated MessageType for protobuf message GCGMsgDiceRoll
 */
