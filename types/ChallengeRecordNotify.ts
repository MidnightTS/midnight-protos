...
// @generated from protobuf file "ChallengeRecordNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChallengeRecordNotify
 */
export interface ChallengeRecordNotify {
    ...
    groupId: number;
    /**
     * @generated from protobuf field: repeated ChallengeRecord challenge_record_list = 9;
     */
...
class ChallengeRecordNotify$Type extends MessageType<ChallengeRecordNotify> {
    constructor() {
        super("ChallengeRecordNotify", [
            ...
            { no: 9, name: "challenge_record_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ChallengeRecord }
        ]);
    }
    ...
    internalBinaryWrite(message: ChallengeRecordNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.challengeRecordList.length; i++)
            ChallengeRecord.internalBinaryWrite(message.challengeRecordList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
