...
var _MichiaeMatsuriStage_one_of_decls;
...
class MichiaeMatsuriStage extends pb_1.Message {
    constructor(data) {
        super();
        _MichiaeMatsuriStage_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MichiaeMatsuriStage_one_of_decls, "f"));
    ...
    static fromObject(data) {
        const message = new MichiaeMatsuriStage({});
    ...
    static deserialize(bytes) {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MichiaeMatsuriStage();
    ...
    static deserializeBinary(bytes) {
        return MichiaeMatsuriStage.deserialize(bytes);
    }
}
exports.MichiaeMatsuriStage = MichiaeMatsuriStage;
_MichiaeMatsuriStage_one_of_decls = new WeakMap();
