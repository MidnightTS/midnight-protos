...
// @generated from protobuf file "SeaLampTakePhaseRewardRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SeaLampTakePhaseRewardRsp
 */
export interface SeaLampTakePhaseRewardRsp {
    /**
     * @generated from protobuf field: uint32 phase_id = 13;
     */
    phaseId: number;
    /**
...
class SeaLampTakePhaseRewardRsp$Type extends MessageType<SeaLampTakePhaseRewardRsp> {
    ...
    internalBinaryWrite(message: SeaLampTakePhaseRewardRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.phaseId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.phaseId);
        /* int32 retcode = 6; */
