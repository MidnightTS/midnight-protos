...
// @generated from protobuf file "PotionActivityDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message PotionActivityDetailInfo
 */
export interface PotionActivityDetailInfo {
    /**
     * @generated from protobuf field: repeated PotionStageData stage_list = 4;
     */
...
class PotionActivityDetailInfo$Type extends MessageType<PotionActivityDetailInfo> {
    constructor() {
        super("PotionActivityDetailInfo", [
            { no: 4, name: "stage_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PotionStageData }
        ]);
    }
    ...
    internalBinaryWrite(message: PotionActivityDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.stageList.length; i++)
            PotionStageData.internalBinaryWrite(message.stageList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
