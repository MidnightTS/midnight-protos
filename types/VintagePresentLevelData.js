...
exports.VintagePresentLevelData = void 0;
...
class VintagePresentLevelData$Type extends runtime_5.MessageType {
    constructor() {
        super("VintagePresentLevelData", [
            { no: 6, name: "is_finish", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "is_open", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 9, name: "stage_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "present_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isFinish: false, isOpen: false, stageId: 0, presentId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.presentId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.presentId);
...
/**
 * @generated MessageType for protobuf message VintagePresentLevelData
 */
