...
// @generated from protobuf file "GalleryPreStartNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GalleryPreStartNotify
 */
export interface GalleryPreStartNotify {
    ...
    galleryId: number;
    /**
     * @generated from protobuf field: uint32 pre_start_end_time = 1;
     */
...
class GalleryPreStartNotify$Type extends MessageType<GalleryPreStartNotify> {
    ...
    internalBinaryWrite(message: GalleryPreStartNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.preStartEndTime !== 0)
            writer.tag(1, WireType.Varint).uint32(message.preStartEndTime);
