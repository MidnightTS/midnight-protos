...
// @generated from protobuf file "GetBonusActivityRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetBonusActivityRewardReq
 */
export interface GetBonusActivityRewardReq {
    /**
     * @generated from protobuf field: uint32 bonus_activity_id = 5;
     */
...
class GetBonusActivityRewardReq$Type extends MessageType<GetBonusActivityRewardReq> {
    ...
    internalBinaryWrite(message: GetBonusActivityRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bonusActivityId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.bonusActivityId);
