...
class ChessLeftMonstersNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.leftMonsters !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.leftMonsters);
...
/**
 * @generated MessageType for protobuf message ChessLeftMonstersNotify
 */
