...
// @generated from protobuf file "OpActivityUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message OpActivityUpdateNotify
 */
export interface OpActivityUpdateNotify {
    /**
     * @generated from protobuf field: OpActivityInfo op_activity_info = 9;
     */
...
class OpActivityUpdateNotify$Type extends MessageType<OpActivityUpdateNotify> {
    constructor() {
        super("OpActivityUpdateNotify", [
            { no: 9, name: "op_activity_info", kind: "message", T: () => OpActivityInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: OpActivityUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.opActivityInfo)
            OpActivityInfo.internalBinaryWrite(message.opActivityInfo, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
