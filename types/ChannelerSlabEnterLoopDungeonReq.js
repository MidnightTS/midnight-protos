...
var _ChannelerSlabEnterLoopDungeonReq_one_of_decls;
...
class ChannelerSlabEnterLoopDungeonReq extends pb_1.Message {
    constructor(data) {
        super();
        _ChannelerSlabEnterLoopDungeonReq_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [5], __classPrivateFieldGet(this, _ChannelerSlabEnterLoopDungeonReq_one_of_decls, "f"));
...
exports.ChannelerSlabEnterLoopDungeonReq = ChannelerSlabEnterLoopDungeonReq;
_ChannelerSlabEnterLoopDungeonReq_one_of_decls = new WeakMap();
