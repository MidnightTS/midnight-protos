...
// @generated from protobuf file "IrodoriChessUnequipCardRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriChessUnequipCardRsp
 */
export interface IrodoriChessUnequipCardRsp {
    /**
     * @generated from protobuf field: uint32 card_id = 10;
     */
    cardId: number;
    /**
    ...
    levelId: number;
    /**
     * @generated from protobuf field: bool is_hard_map = 6;
     */
    isHardMap: boolean;
}
...
class IrodoriChessUnequipCardRsp$Type extends MessageType<IrodoriChessUnequipCardRsp> {
    ...
    internalBinaryWrite(message: IrodoriChessUnequipCardRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isHardMap !== false)
            writer.tag(6, WireType.Varint).bool(message.isHardMap);
