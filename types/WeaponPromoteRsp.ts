...
export interface WeaponPromoteRsp {
    /**
     * @generated from protobuf field: uint32 Unk3300_GGFCIPAKKDP = 4 [json_name = "Unk3300GGFCIPAKKDP"];
     */
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_MBEBIACJNBB = 5 [json_name = "Unk3300MBEBIACJNBB"];
     */
...
class WeaponPromoteRsp$Type extends MessageType<WeaponPromoteRsp> {
    ...
    internalBinaryWrite(message: WeaponPromoteRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300GGFCIPAKKDP !== 0)
            writer.tag(4, WireType.Varint).uint32(message.unk3300GGFCIPAKKDP);
        ...
        if (message.unk3300MBEBIACJNBB !== 0)
            writer.tag(5, WireType.Varint).uint32(message.unk3300MBEBIACJNBB);
        /* int32 retcode = 8; */
