...
// @generated from protobuf file "GCGMsgDiceReroll.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGMsgDiceReroll
 */
export interface GCGMsgDiceReroll {
    ...
    controllerId: number;
    /**
     * @generated from protobuf field: repeated GCGDiceSideType dice_side_list = 8;
     */
...
class GCGMsgDiceReroll$Type extends MessageType<GCGMsgDiceReroll> {
    constructor() {
        super("GCGMsgDiceReroll", [
            ...
            { no: 8, name: "dice_side_list", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["GCGDiceSideType", GCGDiceSideType] },
