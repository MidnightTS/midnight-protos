...
// @generated from protobuf file "LikeCustomDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LikeCustomDungeonReq
 */
export interface LikeCustomDungeonReq {
    /**
     * @generated from protobuf field: bool is_cancel_like = 2;
     */
...
class LikeCustomDungeonReq$Type extends MessageType<LikeCustomDungeonReq> {
    ...
    internalBinaryWrite(message: LikeCustomDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isCancelLike !== false)
            writer.tag(2, WireType.Varint).bool(message.isCancelLike);
