...
// @generated from protobuf file "HomeBalloonGalleryScoreNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeBalloonGalleryScoreNotify
 */
export interface HomeBalloonGalleryScoreNotify {
    ...
    galleryId: number;
    /**
     * @generated from protobuf field: uint32 trigger_entity_id = 3;
     */
    triggerEntityId: number;
    /**
     * @generated from protobuf field: uint32 add_score = 4;
     */
    addScore: number;
    /**
     * @generated from protobuf field: uint32 cur_score = 14;
     */
    curScore: number;
}
...
class HomeBalloonGalleryScoreNotify$Type extends MessageType<HomeBalloonGalleryScoreNotify> {
    ...
    internalBinaryWrite(message: HomeBalloonGalleryScoreNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.triggerEntityId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.triggerEntityId);
        /* uint32 add_score = 4; */
        if (message.addScore !== 0)
            writer.tag(4, WireType.Varint).uint32(message.addScore);
        /* uint32 cur_score = 14; */
