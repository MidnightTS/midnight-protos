...
// @generated from protobuf file "HomeFurnitureCustomSuiteData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message HomeFurnitureCustomSuiteData
 */
export interface HomeFurnitureCustomSuiteData {
    /**
     * @generated from protobuf field: repeated int32 included_furniture_index_list = 14;
     */
    includedFurnitureIndexList: number[];
    /**
     * @generated from protobuf field: Vector spawn_pos = 5;
     */
    spawnPos?: Vector;
    /**
...
class HomeFurnitureCustomSuiteData$Type extends MessageType<HomeFurnitureCustomSuiteData> {
    constructor() {
        super("HomeFurnitureCustomSuiteData", [
            ...
            { no: 5, name: "spawn_pos", kind: "message", T: () => Vector },
    ...
    internalBinaryWrite(message: HomeFurnitureCustomSuiteData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* Vector spawn_pos = 5; */
        if (message.spawnPos)
            Vector.internalBinaryWrite(message.spawnPos, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* uint32 guid = 12; */
        if (message.guid !== 0)
