...
// @generated from protobuf file "EffigyChallengeInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EffigyChallengeInfoNotify
 */
export interface EffigyChallengeInfoNotify {
    ...
    difficultyId: number;
    /**
     * @generated from protobuf field: uint32 challenge_score = 11;
     */
...
class EffigyChallengeInfoNotify$Type extends MessageType<EffigyChallengeInfoNotify> {
    ...
    internalBinaryWrite(message: EffigyChallengeInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.challengeScore !== 0)
            writer.tag(11, WireType.Varint).uint32(message.challengeScore);
