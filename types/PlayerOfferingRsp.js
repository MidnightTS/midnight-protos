...
class PlayerOfferingRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerOfferingRsp", [
            ...
            { no: 10, name: "offering_data", kind: "message", T: () => PlayerOfferingData_1.PlayerOfferingData }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated ItemParam item_list */ 3:
                    ...
                    break;
                case /* PlayerOfferingData offering_data */ 10:
                    message.offeringData = PlayerOfferingData_1.PlayerOfferingData.internalBinaryRead(reader, reader.uint32(), options, message.offeringData);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.offeringData)
            PlayerOfferingData_1.PlayerOfferingData.internalBinaryWrite(message.offeringData, writer.tag(10, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message PlayerOfferingRsp
 */
