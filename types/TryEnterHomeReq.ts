...
// @generated from protobuf file "TryEnterHomeReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface TryEnterHomeReq {
    /**
     * @generated from protobuf field: bool is_transfer_to_safe_point = 13;
     */
    isTransferToSafePoint: boolean;
    /**
     * @generated from protobuf field: uint32 target_point = 10;
     */
    targetPoint: number;
    /**
...
class TryEnterHomeReq$Type extends MessageType<TryEnterHomeReq> {
    ...
    internalBinaryWrite(message: TryEnterHomeReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isTransferToSafePoint !== false)
            writer.tag(13, WireType.Varint).bool(message.isTransferToSafePoint);
        /* uint32 target_point = 10; */
        if (message.targetPoint !== 0)
            writer.tag(10, WireType.Varint).uint32(message.targetPoint);
        /* uint32 target_uid = 1; */
