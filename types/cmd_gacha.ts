...
class GachaInfo$Type extends MessageType<GachaInfo> {
    constructor() {
        super("com.midnights.game.GachaInfo", [
            ...
            { no: 1233, name: "gacha_up_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GachaUpInfo },
    ...
    internalBinaryWrite(message: GachaInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.displayUp4ItemList.length) {
            writer.tag(1875, WireType.LengthDelimited).fork();
...
class GetGachaInfoRsp$Type extends MessageType<GetGachaInfoRsp> {
    constructor() {
        super("com.midnights.game.GetGachaInfoRsp", [
            ...
            { no: 13, name: "gacha_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GachaInfo }
        ]);
    }
...
class GachaItem$Type extends MessageType<GachaItem> {
    constructor() {
        super("com.midnights.game.GachaItem", [
            ...
            { no: 9, name: "token_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
            { no: 12, name: "transfer_items", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GachaTransferItem }
        ]);
    }
...
class DoGachaRsp$Type extends MessageType<DoGachaRsp> {
    constructor() {
        super("com.midnights.game.DoGachaRsp", [
            ...
            { no: 15, name: "gacha_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GachaItem },
