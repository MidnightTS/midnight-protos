...
exports.HomeSetBlueprintFriendOptionRsp = void 0;
...
class HomeSetBlueprintFriendOptionRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeSetBlueprintFriendOptionRsp", [
            { no: 14, name: "is_allow_friend_copy", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 13, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { isAllowFriendCopy: false, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool is_allow_friend_copy */ 14:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isAllowFriendCopy !== false)
            writer.tag(14, runtime_1.WireType.Varint).bool(message.isAllowFriendCopy);
        /* int32 retcode = 13; */
...
/**
 * @generated MessageType for protobuf message HomeSetBlueprintFriendOptionRsp
 */
