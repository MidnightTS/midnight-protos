...
// @generated from protobuf file "GetPlayerFriendListRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface GetPlayerFriendListRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated FriendBrief friend_list = 15;
     */
...
class GetPlayerFriendListRsp$Type extends MessageType<GetPlayerFriendListRsp> {
    constructor() {
        super("GetPlayerFriendListRsp", [
            ...
            { no: 15, name: "friend_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FriendBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: GetPlayerFriendListRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.friendList.length; i++)
            FriendBrief.internalBinaryWrite(message.friendList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
