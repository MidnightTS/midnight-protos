...
exports.FungusFighterTrainingInfoNotify = void 0;
...
class FungusFighterTrainingInfoNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300IOEELCAMDCK !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.unk3300IOEELCAMDCK);
        /* uint32 Unk3300_HGPGNCMNDJN = 4 [json_name = "Unk3300HGPGNCMNDJN"]; */
        if (message.unk3300HGPGNCMNDJN !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.unk3300HGPGNCMNDJN);
        /* uint32 Unk3300_EDHANEGNMJM = 3 [json_name = "Unk3300EDHANEGNMJM"]; */
        if (message.unk3300EDHANEGNMJM !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.unk3300EDHANEGNMJM);
        /* uint32 Unk3300_GMLIPFDMDOG = 6 [json_name = "Unk3300GMLIPFDMDOG"]; */
        if (message.unk3300GMLIPFDMDOG !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.unk3300GMLIPFDMDOG);
        /* uint32 Unk3300_EKAMCPNGCGH = 13 [json_name = "Unk3300EKAMCPNGCGH"]; */
        if (message.unk3300EKAMCPNGCGH !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.unk3300EKAMCPNGCGH);
        /* uint32 max_monster_count = 9; */
        if (message.maxMonsterCount !== 0)
            writer.tag(9, runtime_1.WireType.Varint).uint32(message.maxMonsterCount);
