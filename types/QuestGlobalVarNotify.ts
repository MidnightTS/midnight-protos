...
// @generated from protobuf file "QuestGlobalVarNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { QuestGlobalVar } from "./QuestGlobalVar";
/**
 * enum CmdId {
...
export interface QuestGlobalVarNotify {
    /**
     * @generated from protobuf field: repeated QuestGlobalVar var_list = 8;
     */
...
class QuestGlobalVarNotify$Type extends MessageType<QuestGlobalVarNotify> {
    constructor() {
        super("QuestGlobalVarNotify", [
            { no: 8, name: "var_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => QuestGlobalVar }
        ]);
    }
    ...
    internalBinaryWrite(message: QuestGlobalVarNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.varList.length; i++)
            QuestGlobalVar.internalBinaryWrite(message.varList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
