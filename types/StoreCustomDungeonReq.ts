...
// @generated from protobuf file "StoreCustomDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StoreCustomDungeonReq
 */
export interface StoreCustomDungeonReq {
    /**
     * @generated from protobuf field: uint64 dungeon_guid = 12;
     */
    dungeonGuid: bigint;
    /**
     * @generated from protobuf field: bool is_cancel_store = 11;
     */
...
class StoreCustomDungeonReq$Type extends MessageType<StoreCustomDungeonReq> {
    ...
    internalBinaryWrite(message: StoreCustomDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isCancelStore !== false)
            writer.tag(11, WireType.Varint).bool(message.isCancelStore);
