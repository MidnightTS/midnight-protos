...
// @generated from protobuf file "OneoffGatherPointDetectorDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface OneoffGatherPointDetectorDataNotify {
    /**
     * @generated from protobuf field: repeated OneoffGatherPointDetectorData oneoff_gather_point_detector_data_list = 2;
     */
...
class OneoffGatherPointDetectorDataNotify$Type extends MessageType<OneoffGatherPointDetectorDataNotify> {
    constructor() {
        super("OneoffGatherPointDetectorDataNotify", [
            { no: 2, name: "oneoff_gather_point_detector_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => OneoffGatherPointDetectorData }
        ]);
    }
    ...
    internalBinaryWrite(message: OneoffGatherPointDetectorDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.oneoffGatherPointDetectorDataList.length; i++)
            OneoffGatherPointDetectorData.internalBinaryWrite(message.oneoffGatherPointDetectorDataList[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
