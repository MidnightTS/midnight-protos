...
// @generated from protobuf file "cmd_mechanicus.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class MechanicusInfo$Type extends MessageType<MechanicusInfo> {
    constructor() {
        super("com.midnights.game.MechanicusInfo", [
            { no: 14, name: "gear_level_pair_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Uint32Pair },
