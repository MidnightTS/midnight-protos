...
// @generated from protobuf file "GetInvestigationMonsterRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface GetInvestigationMonsterRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: bool is_for_mark = 11;
     */
    isForMark: boolean;
    /**
     * @generated from protobuf field: repeated InvestigationMonster monster_list = 14;
     */
...
class GetInvestigationMonsterRsp$Type extends MessageType<GetInvestigationMonsterRsp> {
    constructor() {
        super("GetInvestigationMonsterRsp", [
            ...
            { no: 14, name: "monster_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => InvestigationMonster }
        ]);
    }
    ...
    internalBinaryWrite(message: GetInvestigationMonsterRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isForMark !== false)
            writer.tag(11, WireType.Varint).bool(message.isForMark);
        /* repeated InvestigationMonster monster_list = 14; */
        for (let i = 0; i < message.monsterList.length; i++)
            InvestigationMonster.internalBinaryWrite(message.monsterList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
