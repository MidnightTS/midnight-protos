...
var _BalloonPlayerInfo_one_of_decls;
...
class BalloonPlayerInfo extends pb_1.Message {
    constructor(data) {
        super();
        _BalloonPlayerInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BalloonPlayerInfo_one_of_decls, "f"));
...
exports.BalloonPlayerInfo = BalloonPlayerInfo;
_BalloonPlayerInfo_one_of_decls = new WeakMap();
