...
// @generated from protobuf file "InstableSprayRestartDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message InstableSprayRestartDungeonReq
 */
export interface InstableSprayRestartDungeonReq {
    /**
     * @generated from protobuf field: repeated InstableSprayAvatarInfo avatar_info_list = 15;
     */
...
class InstableSprayRestartDungeonReq$Type extends MessageType<InstableSprayRestartDungeonReq> {
    constructor() {
        super("InstableSprayRestartDungeonReq", [
            { no: 15, name: "avatar_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => InstableSprayAvatarInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: InstableSprayRestartDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.avatarInfoList.length; i++)
            InstableSprayAvatarInfo.internalBinaryWrite(message.avatarInfoList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
