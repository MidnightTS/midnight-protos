...
// @generated from protobuf file "CrystalLinkEnterDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CrystalLinkEnterDungeonReq
 */
export interface CrystalLinkEnterDungeonReq {
    /**
     * @generated from protobuf field: repeated CrystalLinkTeamInfo team_info_list = 13;
     */
...
class CrystalLinkEnterDungeonReq$Type extends MessageType<CrystalLinkEnterDungeonReq> {
    constructor() {
        super("CrystalLinkEnterDungeonReq", [
            { no: 13, name: "team_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CrystalLinkTeamInfo },
