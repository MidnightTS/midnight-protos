...
class CutSceneEndNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CutSceneEndNotify", [
            { no: 4, name: "cutscene_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { cutsceneId: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.cutsceneId !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.cutsceneId);
        /* int32 retcode = 11; */
