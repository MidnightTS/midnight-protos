...
// @generated from protobuf file "PlayerRTTInfo.proto" (syntax proto3)
// tslint:disable
//
...
export interface PlayerRTTInfo {
    /**
     * @generated from protobuf field: uint32 rtt = 12;
     */
    rtt: number;
    /**
...
class PlayerRTTInfo$Type extends MessageType<PlayerRTTInfo> {
    ...
    internalBinaryWrite(message: PlayerRTTInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 rtt = 12; */
        if (message.rtt !== 0)
            writer.tag(12, WireType.Varint).uint32(message.rtt);
        /* uint32 uid = 14; */
        if (message.uid !== 0)
