...
// @generated from protobuf file "GachaUpInfo.proto" (syntax proto3)
// tslint:disable
//
...
export interface GachaUpInfo {
    /**
     * @generated from protobuf field: uint32 item_parent_type = 15;
     */
    itemParentType: number;
    /**
     * @generated from protobuf field: repeated uint32 item_id_list = 6;
     */
    itemIdList: number[];
}
...
class GachaUpInfo$Type extends MessageType<GachaUpInfo> {
    ...
    internalBinaryWrite(message: GachaUpInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.itemParentType !== 0)
            writer.tag(15, WireType.Varint).uint32(message.itemParentType);
