...
// @generated from protobuf file "GetMechanicusInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { MechanicusInfo } from "./MechanicusInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetMechanicusInfoRsp
 */
export interface GetMechanicusInfoRsp {
    /**
     * @generated from protobuf field: MechanicusInfo mechanicus_info = 5;
     */
...
class GetMechanicusInfoRsp$Type extends MessageType<GetMechanicusInfoRsp> {
    constructor() {
        super("GetMechanicusInfoRsp", [
            { no: 5, name: "mechanicus_info", kind: "message", T: () => MechanicusInfo },
    ...
    internalBinaryWrite(message: GetMechanicusInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mechanicusInfo)
            MechanicusInfo.internalBinaryWrite(message.mechanicusInfo, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 12; */
