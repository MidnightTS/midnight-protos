...
// @generated from protobuf file "RogueShowAvatarTeamInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { RogueAvatarInfo } from "./RogueAvatarInfo";
/**
 * @generated from protobuf message RogueShowAvatarTeamInfo
 */
export interface RogueShowAvatarTeamInfo {
    /**
     * @generated from protobuf field: repeated RogueAvatarInfo avatar_list = 13;
     */
...
class RogueShowAvatarTeamInfo$Type extends MessageType<RogueShowAvatarTeamInfo> {
    constructor() {
        super("RogueShowAvatarTeamInfo", [
            { no: 13, name: "avatar_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RogueAvatarInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: RogueShowAvatarTeamInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.avatarList.length; i++)
            RogueAvatarInfo.internalBinaryWrite(message.avatarList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
