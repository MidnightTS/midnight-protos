...
// @generated from protobuf file "MechanicusCoinNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MechanicusCoinNotify
 */
export interface MechanicusCoinNotify {
    ...
    coin: number;
    /**
     * @generated from protobuf field: uint32 mechanicus_id = 5;
     */
    mechanicusId: number;
}
...
class MechanicusCoinNotify$Type extends MessageType<MechanicusCoinNotify> {
    ...
    internalBinaryWrite(message: MechanicusCoinNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mechanicusId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.mechanicusId);
