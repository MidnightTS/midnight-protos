...
// @generated from protobuf file "CharAmusementAvatarInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message CharAmusementAvatarInfo
 */
export interface CharAmusementAvatarInfo {
    ...
    avatarIdList: number[];
    /**
     * @generated from protobuf field: uint32 punish_time = 5;
     */
    punishTime: number;
}
...
class CharAmusementAvatarInfo$Type extends MessageType<CharAmusementAvatarInfo> {
    ...
    internalBinaryWrite(message: CharAmusementAvatarInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.punishTime !== 0)
            writer.tag(5, WireType.Varint).uint32(message.punishTime);
