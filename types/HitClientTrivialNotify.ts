...
// @generated from protobuf file "HitClientTrivialNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HitClientTrivialNotify
 */
export interface HitClientTrivialNotify {
    /**
     * @generated from protobuf field: uint32 owner_entity_id = 14;
     */
...
class HitClientTrivialNotify$Type extends MessageType<HitClientTrivialNotify> {
    ...
    internalBinaryWrite(message: HitClientTrivialNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.ownerEntityId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.ownerEntityId);
        /* Vector position = 1; */
        if (message.position)
