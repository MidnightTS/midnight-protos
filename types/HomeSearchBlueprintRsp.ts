...
// @generated from protobuf file "HomeSearchBlueprintRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { HomeBlueprintSearchInfo } from "./HomeBlueprintSearchInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message HomeSearchBlueprintRsp
 */
export interface HomeSearchBlueprintRsp {
    /**
     * @generated from protobuf field: HomeBlueprintSearchInfo search_info = 4;
     */
...
class HomeSearchBlueprintRsp$Type extends MessageType<HomeSearchBlueprintRsp> {
    constructor() {
        super("HomeSearchBlueprintRsp", [
            { no: 4, name: "search_info", kind: "message", T: () => HomeBlueprintSearchInfo },
    ...
    internalBinaryWrite(message: HomeSearchBlueprintRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.searchInfo)
            HomeBlueprintSearchInfo.internalBinaryWrite(message.searchInfo, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 8; */
