...
exports.EnterIrodoriChessDungeonReq = void 0;
...
class EnterIrodoriChessDungeonReq$Type extends runtime_5.MessageType {
    constructor() {
        super("EnterIrodoriChessDungeonReq", [
            { no: 12, name: "is_hard_map", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 10, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isHardMap: false, levelId: 0 };
...
/**
 * @generated MessageType for protobuf message EnterIrodoriChessDungeonReq
 */
