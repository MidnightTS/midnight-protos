...
class ActivityCondStateChangeNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ActivityCondStateChangeNotify", [
            ...
            { no: 4, name: "meet_cond_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { activityId: 0, scheduleId: 0, expireCondList: [], meetCondList: [], activatedSaleIdList: [], disableTransferPointInteractionList: [] };
            ...
            switch (fieldNo) {
                ...
                case /* repeated uint32 expire_cond_list */ 1:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        ...
                        message.expireCondList.push(reader.uint32());
                    break;
                case /* repeated uint32 meet_cond_list */ 4:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
