...
exports.LevelTagDataNotify = void 0;
...
class LevelTagDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("LevelTagDataNotify", [
            { no: 15, name: "level_tag_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 level_tag_id_list */ 15:
...
/**
 * @generated MessageType for protobuf message LevelTagDataNotify
 */
