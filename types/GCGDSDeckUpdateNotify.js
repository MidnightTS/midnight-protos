...
exports.GCGDSDeckUpdateNotify = void 0;
...
class GCGDSDeckUpdateNotify$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isValid !== false)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.isValid);
        /* uint32 deck_id = 15; */
        if (message.deckId !== 0)
 ...
 */
exports.GCGDSDeckUpdateNotify = new GCGDSDeckUpdateNotify$Type();
