...
// @generated from protobuf file "AsterLittleInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AsterLittleInfoNotify
 */
export interface AsterLittleInfoNotify {
    /**
     * @generated from protobuf field: AsterLittleDetailInfo info = 10;
     */
...
class AsterLittleInfoNotify$Type extends MessageType<AsterLittleInfoNotify> {
    constructor() {
        super("AsterLittleInfoNotify", [
            { no: 10, name: "info", kind: "message", T: () => AsterLittleDetailInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: AsterLittleInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            AsterLittleDetailInfo.internalBinaryWrite(message.info, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
