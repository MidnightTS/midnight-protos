...
// @generated from protobuf file "PlantFlowerAcceptAllGiveFlowerRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlantFlowerAcceptAllGiveFlowerRsp
 */
export interface PlantFlowerAcceptAllGiveFlowerRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated PlantFlowerAcceptFlowerResultInfo accept_flower_result_info_list = 13;
     */
...
class PlantFlowerAcceptAllGiveFlowerRsp$Type extends MessageType<PlantFlowerAcceptAllGiveFlowerRsp> {
    constructor() {
        super("PlantFlowerAcceptAllGiveFlowerRsp", [
            ...
            { no: 13, name: "accept_flower_result_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlantFlowerAcceptFlowerResultInfo }
        ]);
    }
