...
class ForgeStartReq$Type extends runtime_5.MessageType {
    constructor() {
        super("ForgeStartReq", [
            { no: 8, name: "forge_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "avatar_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "forge_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { forgeId: 0, avatarId: 0, forgeCount: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.forgeId !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.forgeId);
        /* uint32 avatar_id = 1; */
        ...
        if (message.forgeCount !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.forgeCount);
