...
export interface ResinChangeNotify {
    /**
     * @generated from protobuf field: uint32 cur_buy_count = 11;
     */
    curBuyCount: number;
    /**
     * @generated from protobuf field: uint32 next_add_timestamp = 13;
     */
...
class ResinChangeNotify$Type extends MessageType<ResinChangeNotify> {
    ...
    internalBinaryWrite(message: ResinChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curBuyCount !== 0)
            writer.tag(11, WireType.Varint).uint32(message.curBuyCount);
        /* uint32 next_add_timestamp = 13; */
        if (message.nextAddTimestamp !== 0)
            writer.tag(13, WireType.Varint).uint32(message.nextAddTimestamp);
        /* uint32 cur_value = 10; */
