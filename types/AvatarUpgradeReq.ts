...
// @generated from protobuf file "AvatarUpgradeReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarUpgradeReq {
    /**
     * @generated from protobuf field: uint32 item_id = 12;
     */
    itemId: number;
    /**
...
class AvatarUpgradeReq$Type extends MessageType<AvatarUpgradeReq> {
    ...
    internalBinaryWrite(message: AvatarUpgradeReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 item_id = 12; */
        if (message.itemId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.itemId);
        /* uint32 count = 7; */
        if (message.count !== 0)
