...
// @generated from protobuf file "SceneGadgetInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { CoinCollectOperatorInfo } from "./CoinCollectOperatorInfo";
import { DeshretObeliskGadgetInfo } from "./DeshretObeliskGadgetInfo";
import { NightCrowGadgetInfo } from "./NightCrowGadgetInfo";
...
export interface SceneGadgetInfo {
    ...
    content: {
        ...
        /**
         * @generated from protobuf field: NightCrowGadgetInfo night_crow_gadget_info = 62;
         */
        nightCrowGadgetInfo: NightCrowGadgetInfo;
    } | {
        oneofKind: "deshretObeliskGadgetInfo";
        /**
         * @generated from protobuf field: DeshretObeliskGadgetInfo deshret_obelisk_gadget_info = 63;
         */
        deshretObeliskGadgetInfo: DeshretObeliskGadgetInfo;
    } | {
        oneofKind: "coinCollectOperatorInfo";
        /**
         * @generated from protobuf field: CoinCollectOperatorInfo coin_collect_operator_info = 64;
         */
...
class SceneGadgetInfo$Type extends MessageType<SceneGadgetInfo> {
    constructor() {
        super("SceneGadgetInfo", [
            ...
            { no: 64, name: "coin_collect_operator_info", kind: "message", oneof: "content", T: () => CoinCollectOperatorInfo }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* CoinCollectOperatorInfo coin_collect_operator_info */ 64:
                    message.content = {
                        oneofKind: "coinCollectOperatorInfo",
                        coinCollectOperatorInfo: CoinCollectOperatorInfo.internalBinaryRead(reader, reader.uint32(), options, (message.content as any).coinCollectOperatorInfo)
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message: SceneGadgetInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.content.oneofKind === "coinCollectOperatorInfo")
            CoinCollectOperatorInfo.internalBinaryWrite(message.content.coinCollectOperatorInfo, writer.tag(64, WireType.LengthDelimited).fork(), options).join();
