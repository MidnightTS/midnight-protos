...
// @generated from protobuf file "WidgetGadgetAllDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface WidgetGadgetAllDataNotify {
    /**
     * @generated from protobuf field: repeated WidgetGadgetData widget_gadget_data = 1;
     */
...
class WidgetGadgetAllDataNotify$Type extends MessageType<WidgetGadgetAllDataNotify> {
    constructor() {
        super("WidgetGadgetAllDataNotify", [
            { no: 1, name: "widget_gadget_data", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WidgetGadgetData }
        ]);
    }
    ...
    internalBinaryWrite(message: WidgetGadgetAllDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.widgetGadgetData.length; i++)
            WidgetGadgetData.internalBinaryWrite(message.widgetGadgetData[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
