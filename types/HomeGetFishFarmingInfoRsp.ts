...
// @generated from protobuf file "HomeGetFishFarmingInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeGetFishFarmingInfoRsp
 */
export interface HomeGetFishFarmingInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated HomeFishFarmingInfo fish_farming_info_list = 12;
     */
...
class HomeGetFishFarmingInfoRsp$Type extends MessageType<HomeGetFishFarmingInfoRsp> {
    constructor() {
        super("HomeGetFishFarmingInfoRsp", [
            ...
            { no: 12, name: "fish_farming_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeFishFarmingInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeGetFishFarmingInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fishFarmingInfoList.length; i++)
            HomeFishFarmingInfo.internalBinaryWrite(message.fishFarmingInfoList[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
