...
class DungeonDieOptionReq$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonDieOptionReq", [
            { no: 5, name: "die_option", kind: "enum", T: () => ["PlayerDieOption", PlayerDieOption_1.PlayerDieOption, "PLAYER_DIE_OPTION_"] },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.dieOption !== 0)
            writer.tag(5, runtime_1.WireType.Varint).int32(message.dieOption);
