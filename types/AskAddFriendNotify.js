...
class AskAddFriendNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("AskAddFriendNotify", [
            ...
            { no: 1, name: "target_friend_brief", kind: "message", T: () => FriendBrief_1.FriendBrief }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 target_uid */ 5:
                    ...
                    break;
                case /* FriendBrief target_friend_brief */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.targetFriendBrief)
            FriendBrief_1.FriendBrief.internalBinaryWrite(message.targetFriendBrief, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
