...
// @generated from protobuf file "WorldPlayerLocationNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { PlayerWorldLocationInfo } from "./PlayerWorldLocationInfo";
/**
 * enum CmdId {
...
export interface WorldPlayerLocationNotify {
    /**
     * @generated from protobuf field: repeated PlayerWorldLocationInfo player_world_loc_list = 5;
     */
    playerWorldLocList: PlayerWorldLocationInfo[];
    /**
     * @generated from protobuf field: repeated PlayerLocationInfo player_loc_list = 14;
     */
...
class WorldPlayerLocationNotify$Type extends MessageType<WorldPlayerLocationNotify> {
    constructor() {
        super("WorldPlayerLocationNotify", [
            { no: 5, name: "player_world_loc_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlayerWorldLocationInfo },
    ...
    internalBinaryWrite(message: WorldPlayerLocationNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.playerWorldLocList.length; i++)
            PlayerWorldLocationInfo.internalBinaryWrite(message.playerWorldLocList[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
