...
// @generated from protobuf file "TreasureMapCurrencyNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TreasureMapCurrencyNotify
 */
export interface TreasureMapCurrencyNotify {
    /**
     * @generated from protobuf field: uint32 currency_num = 3;
     */
    currencyNum: number;
}
...
class TreasureMapCurrencyNotify$Type extends MessageType<TreasureMapCurrencyNotify> {
    ...
    internalBinaryWrite(message: TreasureMapCurrencyNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.currencyNum !== 0)
            writer.tag(3, WireType.Varint).uint32(message.currencyNum);
