...
// @generated from protobuf file "CustomDungeonUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CustomDungeonUpdateNotify
 */
export interface CustomDungeonUpdateNotify {
    /**
     * @generated from protobuf field: CustomDungeonBrief dungeon_brief = 15;
     */
...
class CustomDungeonUpdateNotify$Type extends MessageType<CustomDungeonUpdateNotify> {
    constructor() {
        super("CustomDungeonUpdateNotify", [
            { no: 15, name: "dungeon_brief", kind: "message", T: () => CustomDungeonBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: CustomDungeonUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dungeonBrief)
            CustomDungeonBrief.internalBinaryWrite(message.dungeonBrief, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
