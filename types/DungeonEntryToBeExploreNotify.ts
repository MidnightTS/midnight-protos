...
// @generated from protobuf file "DungeonEntryToBeExploreNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonEntryToBeExploreNotify
 */
export interface DungeonEntryToBeExploreNotify {
    ...
    sceneId: number;
    /**
     * @generated from protobuf field: uint32 dungeon_entry_scene_point_id = 3;
     */
...
class DungeonEntryToBeExploreNotify$Type extends MessageType<DungeonEntryToBeExploreNotify> {
    ...
    internalBinaryWrite(message: DungeonEntryToBeExploreNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dungeonEntryScenePointId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.dungeonEntryScenePointId);
