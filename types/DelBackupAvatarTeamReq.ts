...
// @generated from protobuf file "DelBackupAvatarTeamReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DelBackupAvatarTeamReq
 */
export interface DelBackupAvatarTeamReq {
    /**
     * @generated from protobuf field: uint32 backup_avatar_team_id = 10;
     */
...
class DelBackupAvatarTeamReq$Type extends MessageType<DelBackupAvatarTeamReq> {
    ...
    internalBinaryWrite(message: DelBackupAvatarTeamReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.backupAvatarTeamId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.backupAvatarTeamId);
