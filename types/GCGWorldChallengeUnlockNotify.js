...
exports.GCGWorldChallengeUnlockNotify = void 0;
...
class GCGWorldChallengeUnlockNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGWorldChallengeUnlockNotify", [
            { no: 6, name: "unlock_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 unlock_id_list */ 6:
...
/**
 * @generated MessageType for protobuf message GCGWorldChallengeUnlockNotify
 */
