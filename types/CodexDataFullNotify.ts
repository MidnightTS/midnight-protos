...
export interface CodexDataFullNotify {
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_ODPDLGEKIEM = 4 [json_name = "Unk3300ODPDLGEKIEM"];
     */
    unk3300ODPDLGEKIEM: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_DCMJLCIFCEH = 13 [json_name = "Unk3300DCMJLCIFCEH"];
     */
    unk3300DCMJLCIFCEH: number;
    /**
...
class CodexDataFullNotify$Type extends MessageType<CodexDataFullNotify> {
    ...
    internalBinaryWrite(message: CodexDataFullNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300ODPDLGEKIEM !== 0)
            writer.tag(4, WireType.Varint).uint32(message.unk3300ODPDLGEKIEM);
        /* uint32 Unk3300_DCMJLCIFCEH = 13 [json_name = "Unk3300DCMJLCIFCEH"]; */
        if (message.unk3300DCMJLCIFCEH !== 0)
            writer.tag(13, WireType.Varint).uint32(message.unk3300DCMJLCIFCEH);
