...
exports.PlayerNicknameNotify = void 0;
...
class PlayerNicknameNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        /* string nickname = 4; */
        if (message.nickname !== "")
            writer.tag(4, runtime_1.WireType.LengthDelimited).string(message.nickname);
...
/**
 * @generated MessageType for protobuf message PlayerNicknameNotify
 */
