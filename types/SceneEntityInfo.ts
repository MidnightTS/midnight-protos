...
import * as dependency_1 from "./AnimatorParameterValueInfoPair";
import * as dependency_2 from "./EntityAuthorityInfo";
import * as dependency_3 from "./EntityClientData";
import * as dependency_4 from "./EntityEnvironmentInfo";
import * as dependency_5 from "./FightPropPair";
import * as dependency_6 from "./MotionInfo";
import * as dependency_7 from "./PropPair";
import * as dependency_8 from "./ProtEntityType";
import * as dependency_9 from "./SceneAvatarInfo";
import * as dependency_10 from "./SceneGadgetInfo";
import * as dependency_11 from "./SceneMonsterInfo";
import * as dependency_12 from "./SceneNpcInfo";
import * as dependency_13 from "./ServerBuff";
import * as pb_1 from "google-protobuf";
export class SceneEntityInfo extends pb_1.Message {
    #one_of_decls: number[][] = [[10, 11, 12, 13]];
    constructor(data?: any[] | ({
        entity_type?: dependency_8.ProtEntityType;
        entity_id?: number;
        name?: string;
        motion_info?: dependency_6.MotionInfo;
        prop_list?: dependency_7.PropPair[];
        fight_prop_list?: dependency_5.FightPropPair[];
        life_state?: number;
        animator_para_list?: dependency_1.AnimatorParameterValueInfoPair[];
        last_move_scene_time_ms?: number;
        last_move_reliable_seq?: number;
        entity_client_data?: dependency_3.EntityClientData;
        entity_environment_info_list?: dependency_4.EntityEnvironmentInfo[];
        entity_authority_info?: dependency_2.EntityAuthorityInfo;
        tag_list?: string[];
        server_buff_list?: dependency_13.ServerBuff[];
    } & (({
        avatar?: dependency_9.SceneAvatarInfo;
        monster?: never;
        npc?: never;
        gadget?: never;
    } | {
        avatar?: never;
        monster?: dependency_11.SceneMonsterInfo;
        npc?: never;
        gadget?: never;
    } | {
        avatar?: never;
        monster?: never;
        npc?: dependency_12.SceneNpcInfo;
        gadget?: never;
    } | {
        avatar?: never;
        monster?: never;
        npc?: never;
        gadget?: dependency_10.SceneGadgetInfo;
    })))) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [5, 6, 9, 20, 22, 23], this.#one_of_decls);
    ...
    get entity_type() {
        return pb_1.Message.getFieldWithDefault(this, 1, dependency_8.ProtEntityType.PROT_ENTITY_TYPE_NONE) as dependency_8.ProtEntityType;
    }
    set entity_type(value: dependency_8.ProtEntityType) {
    ...
    get motion_info() {
        return pb_1.Message.getWrapperField(this, dependency_6.MotionInfo, 4) as dependency_6.MotionInfo;
    }
    set motion_info(value: dependency_6.MotionInfo) {
    ...
    get prop_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_7.PropPair, 5) as dependency_7.PropPair[];
    }
    set prop_list(value: dependency_7.PropPair[]) {
        pb_1.Message.setRepeatedWrapperField(this, 5, value);
    }
    get fight_prop_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_5.FightPropPair, 6) as dependency_5.FightPropPair[];
    }
    set fight_prop_list(value: dependency_5.FightPropPair[]) {
    ...
    get animator_para_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.AnimatorParameterValueInfoPair, 9) as dependency_1.AnimatorParameterValueInfoPair[];
    }
    set animator_para_list(value: dependency_1.AnimatorParameterValueInfoPair[]) {
        pb_1.Message.setRepeatedWrapperField(this, 9, value);
    }
    get last_move_scene_time_ms() {
        return pb_1.Message.getFieldWithDefault(this, 17, 0) as number;
    }
    set last_move_scene_time_ms(value: number) {
        pb_1.Message.setField(this, 17, value);
    }
    get last_move_reliable_seq() {
        return pb_1.Message.getFieldWithDefault(this, 18, 0) as number;
    }
    set last_move_reliable_seq(value: number) {
        pb_1.Message.setField(this, 18, value);
    }
    get entity_client_data() {
        return pb_1.Message.getWrapperField(this, dependency_3.EntityClientData, 19) as dependency_3.EntityClientData;
    }
    set entity_client_data(value: dependency_3.EntityClientData) {
    ...
    get entity_environment_info_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_4.EntityEnvironmentInfo, 20) as dependency_4.EntityEnvironmentInfo[];
    }
    set entity_environment_info_list(value: dependency_4.EntityEnvironmentInfo[]) {
        pb_1.Message.setRepeatedWrapperField(this, 20, value);
    }
    get entity_authority_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.EntityAuthorityInfo, 21) as dependency_2.EntityAuthorityInfo;
    }
    set entity_authority_info(value: dependency_2.EntityAuthorityInfo) {
    ...
    set tag_list(value: string[]) {
        pb_1.Message.setField(this, 22, value);
    }
    get server_buff_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_13.ServerBuff, 23) as dependency_13.ServerBuff[];
    }
    set server_buff_list(value: dependency_13.ServerBuff[]) {
        pb_1.Message.setRepeatedWrapperField(this, 23, value);
    }
    get avatar() {
        return pb_1.Message.getWrapperField(this, dependency_9.SceneAvatarInfo, 10) as dependency_9.SceneAvatarInfo;
    }
    set avatar(value: dependency_9.SceneAvatarInfo) {
    ...
    get monster() {
        return pb_1.Message.getWrapperField(this, dependency_11.SceneMonsterInfo, 11) as dependency_11.SceneMonsterInfo;
    }
    set monster(value: dependency_11.SceneMonsterInfo) {
    ...
    get npc() {
        return pb_1.Message.getWrapperField(this, dependency_12.SceneNpcInfo, 12) as dependency_12.SceneNpcInfo;
    }
    set npc(value: dependency_12.SceneNpcInfo) {
    ...
    get gadget() {
        return pb_1.Message.getWrapperField(this, dependency_10.SceneGadgetInfo, 13) as dependency_10.SceneGadgetInfo;
    }
    set gadget(value: dependency_10.SceneGadgetInfo) {
    ...
    get entity() {
        const cases: {
            [index: number]: "none" | "avatar" | "monster" | "npc" | "gadget";
        } = {
            0: "none",
            10: "avatar",
            11: "monster",
    ...
    static fromObject(data: {
        ...
        entity_id?: number;
        name?: string;
        motion_info?: ReturnType<typeof dependency_6.MotionInfo.prototype.toObject>;
        prop_list?: ReturnType<typeof dependency_7.PropPair.prototype.toObject>[];
        fight_prop_list?: ReturnType<typeof dependency_5.FightPropPair.prototype.toObject>[];
        life_state?: number;
        animator_para_list?: ReturnType<typeof dependency_1.AnimatorParameterValueInfoPair.prototype.toObject>[];
        last_move_scene_time_ms?: number;
        last_move_reliable_seq?: number;
        entity_client_data?: ReturnType<typeof dependency_3.EntityClientData.prototype.toObject>;
        entity_environment_info_list?: ReturnType<typeof dependency_4.EntityEnvironmentInfo.prototype.toObject>[];
        entity_authority_info?: ReturnType<typeof dependency_2.EntityAuthorityInfo.prototype.toObject>;
        tag_list?: string[];
        server_buff_list?: ReturnType<typeof dependency_13.ServerBuff.prototype.toObject>[];
        avatar?: ReturnType<typeof dependency_9.SceneAvatarInfo.prototype.toObject>;
        monster?: ReturnType<typeof dependency_11.SceneMonsterInfo.prototype.toObject>;
        npc?: ReturnType<typeof dependency_12.SceneNpcInfo.prototype.toObject>;
        gadget?: ReturnType<typeof dependency_10.SceneGadgetInfo.prototype.toObject>;
    }): SceneEntityInfo {
    ...
    toObject() {
        ...
        if (this.prop_list != null) {
            data.prop_list = this.prop_list.map((item: dependency_7.PropPair) => item.toObject());
        }
        if (this.fight_prop_list != null) {
            data.fight_prop_list = this.fight_prop_list.map((item: dependency_5.FightPropPair) => item.toObject());
        }
        if (this.life_state != null) {
            data.life_state = this.life_state;
        }
        if (this.animator_para_list != null) {
            data.animator_para_list = this.animator_para_list.map((item: dependency_1.AnimatorParameterValueInfoPair) => item.toObject());
        }
        ...
        if (this.entity_environment_info_list != null) {
            data.entity_environment_info_list = this.entity_environment_info_list.map((item: dependency_4.EntityEnvironmentInfo) => item.toObject());
        }
        ...
        if (this.server_buff_list != null) {
            data.server_buff_list = this.server_buff_list.map((item: dependency_13.ServerBuff) => item.toObject());
        }
        if (this.avatar != null) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.prop_list.length)
            writer.writeRepeatedMessage(5, this.prop_list, (item: dependency_7.PropPair) => item.serialize(writer));
        if (this.fight_prop_list.length)
            writer.writeRepeatedMessage(6, this.fight_prop_list, (item: dependency_5.FightPropPair) => item.serialize(writer));
        if (this.life_state != 0)
            writer.writeUint32(7, this.life_state);
        if (this.animator_para_list.length)
            writer.writeRepeatedMessage(9, this.animator_para_list, (item: dependency_1.AnimatorParameterValueInfoPair) => item.serialize(writer));
        ...
        if (this.entity_environment_info_list.length)
            writer.writeRepeatedMessage(20, this.entity_environment_info_list, (item: dependency_4.EntityEnvironmentInfo) => item.serialize(writer));
        ...
        if (this.server_buff_list.length)
            writer.writeRepeatedMessage(23, this.server_buff_list, (item: dependency_13.ServerBuff) => item.serialize(writer));
        if (this.has_avatar)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SceneEntityInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): SceneEntityInfo {
