...
// @generated from protobuf file "FindHilichurlFinishSecondQuestNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FindHilichurlFinishSecondQuestNotify
 */
export interface FindHilichurlFinishSecondQuestNotify {
    /**
     * @generated from protobuf field: uint32 day_index = 4;
     */
    dayIndex: number;
}
...
class FindHilichurlFinishSecondQuestNotify$Type extends MessageType<FindHilichurlFinishSecondQuestNotify> {
    ...
    internalBinaryWrite(message: FindHilichurlFinishSecondQuestNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dayIndex !== 0)
            writer.tag(4, WireType.Varint).uint32(message.dayIndex);
