...
// @generated from protobuf file "RogueDiaryDungeonSettleNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RogueDiaryDungeonSettleNotify
 */
export interface RogueDiaryDungeonSettleNotify {
    ...
    isFinish: boolean;
    /**
     * @generated from protobuf field: uint32 cur_round = 11;
     */
    curRound: number;
    /**
     * @generated from protobuf field: uint32 explore_time = 4;
     */
    exploreTime: number;
}
...
class RogueDiaryDungeonSettleNotify$Type extends MessageType<RogueDiaryDungeonSettleNotify> {
    ...
    internalBinaryWrite(message: RogueDiaryDungeonSettleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curRound !== 0)
            writer.tag(11, WireType.Varint).uint32(message.curRound);
        /* uint32 explore_time = 4; */
        if (message.exploreTime !== 0)
            writer.tag(4, WireType.Varint).uint32(message.exploreTime);
