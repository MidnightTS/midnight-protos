...
// @generated from protobuf file "LevelupCityRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LevelupCityRsp
 */
export interface LevelupCityRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: CityInfo city_info = 14;
     */
    cityInfo?: CityInfo;
    /**
...
class LevelupCityRsp$Type extends MessageType<LevelupCityRsp> {
    constructor() {
        super("LevelupCityRsp", [
            ...
            { no: 14, name: "city_info", kind: "message", T: () => CityInfo },
    ...
    internalBinaryWrite(message: LevelupCityRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cityInfo)
            CityInfo.internalBinaryWrite(message.cityInfo, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
        /* uint32 scene_id = 11; */
