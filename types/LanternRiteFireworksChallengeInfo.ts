...
// @generated from protobuf file "LanternRiteFireworksChallengeInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message LanternRiteFireworksChallengeInfo
 */
export interface LanternRiteFireworksChallengeInfo {
    /**
     * @generated from protobuf field: uint32 best_score = 2;
     */
    bestScore: number;
    /**
     * @generated from protobuf field: bool is_full_score = 3;
     */
    isFullScore: boolean;
    /**
     * @generated from protobuf field: uint32 challenge_id = 12;
     */
    challengeId: number;
}
...
class LanternRiteFireworksChallengeInfo$Type extends MessageType<LanternRiteFireworksChallengeInfo> {
    ...
    internalBinaryWrite(message: LanternRiteFireworksChallengeInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bestScore !== 0)
            writer.tag(2, WireType.Varint).uint32(message.bestScore);
        /* bool is_full_score = 3; */
        if (message.isFullScore !== false)
            writer.tag(3, WireType.Varint).bool(message.isFullScore);
