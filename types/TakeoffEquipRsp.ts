...
// @generated from protobuf file "TakeoffEquipRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface TakeoffEquipRsp {
    /**
     * @generated from protobuf field: uint32 slot = 3;
     */
    slot: number;
    /**
...
class TakeoffEquipRsp$Type extends MessageType<TakeoffEquipRsp> {
    ...
    internalBinaryWrite(message: TakeoffEquipRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 slot = 3; */
        if (message.slot !== 0)
            writer.tag(3, WireType.Varint).uint32(message.slot);
        /* int32 retcode = 10; */
