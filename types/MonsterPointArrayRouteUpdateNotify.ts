...
// @generated from protobuf file "MonsterPointArrayRouteUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MonsterPointArrayRouteUpdateNotify
 */
export interface MonsterPointArrayRouteUpdateNotify {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: MonsterRoute monster_route = 11;
     */
...
class MonsterPointArrayRouteUpdateNotify$Type extends MessageType<MonsterPointArrayRouteUpdateNotify> {
    constructor() {
        super("MonsterPointArrayRouteUpdateNotify", [
            ...
            { no: 11, name: "monster_route", kind: "message", T: () => MonsterRoute }
        ]);
    }
    ...
    internalBinaryWrite(message: MonsterPointArrayRouteUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.monsterRoute)
            MonsterRoute.internalBinaryWrite(message.monsterRoute, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
