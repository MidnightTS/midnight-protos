...
class ClientAIStateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ClientAIStateNotify", [
            { no: 13, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "cur_tactic", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { entityId: 0, curTactic: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.curTactic !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.curTactic);
...
/**
 * @generated MessageType for protobuf message ClientAIStateNotify
 */
