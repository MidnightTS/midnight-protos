...
var _PlantFlowerRecvFlowerData_one_of_decls;
...
class PlantFlowerRecvFlowerData extends pb_1.Message {
    constructor(data) {
        super();
        _PlantFlowerRecvFlowerData_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PlantFlowerRecvFlowerData_one_of_decls, "f"));
    ...
    get profile_picture() {
        return pb_1.Message.getWrapperField(this, dependency_1.ProfilePicture, 13);
    }
...
exports.PlantFlowerRecvFlowerData = PlantFlowerRecvFlowerData;
_PlantFlowerRecvFlowerData_one_of_decls = new WeakMap();
