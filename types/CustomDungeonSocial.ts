...
// @generated from protobuf file "CustomDungeonSocial.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message CustomDungeonSocial
 */
export interface CustomDungeonSocial {
    /**
     * @generated from protobuf field: uint32 win_num = 3;
     */
    winNum: number;
    /**
     * @generated from protobuf field: uint32 play_num = 11;
     */
    playNum: number;
    /**
     * @generated from protobuf field: uint32 like_num = 15;
     */
    likeNum: number;
    /**
     * @generated from protobuf field: uint32 store_num = 14;
     */
    storeNum: number;
}
...
class CustomDungeonSocial$Type extends MessageType<CustomDungeonSocial> {
    ...
    internalBinaryWrite(message: CustomDungeonSocial, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 win_num = 3; */
        if (message.winNum !== 0)
            writer.tag(3, WireType.Varint).uint32(message.winNum);
        /* uint32 play_num = 11; */
        if (message.playNum !== 0)
            writer.tag(11, WireType.Varint).uint32(message.playNum);
        /* uint32 like_num = 15; */
        if (message.likeNum !== 0)
            writer.tag(15, WireType.Varint).uint32(message.likeNum);
        /* uint32 store_num = 14; */
        if (message.storeNum !== 0)
            writer.tag(14, WireType.Varint).uint32(message.storeNum);
