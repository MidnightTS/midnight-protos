...
// @generated from protobuf file "DungeonDieOptionRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonDieOptionRsp
 */
export interface DungeonDieOptionRsp {
    /**
     * @generated from protobuf field: uint32 revive_count = 2;
     */
    reviveCount: number;
    /**
     * @generated from protobuf field: PlayerDieOption die_option = 7;
     */
...
class DungeonDieOptionRsp$Type extends MessageType<DungeonDieOptionRsp> {
    constructor() {
        super("DungeonDieOptionRsp", [
            ...
            { no: 7, name: "die_option", kind: "enum", T: () => ["PlayerDieOption", PlayerDieOption, "PLAYER_DIE_OPTION_"] },
    ...
    internalBinaryWrite(message: DungeonDieOptionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reviveCount !== 0)
            writer.tag(2, WireType.Varint).uint32(message.reviveCount);
        /* PlayerDieOption die_option = 7; */
        if (message.dieOption !== 0)
            writer.tag(7, WireType.Varint).int32(message.dieOption);
        /* int32 retcode = 13; */
