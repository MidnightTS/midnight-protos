...
// @generated from protobuf file "DungeonRestartInviteNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonRestartInviteNotify
 */
export interface DungeonRestartInviteNotify {
    ...
    dungeonId: number;
    /**
     * @generated from protobuf field: uint32 cd = 5;
     */
    cd: number;
    /**
...
class DungeonRestartInviteNotify$Type extends MessageType<DungeonRestartInviteNotify> {
    ...
    internalBinaryWrite(message: DungeonRestartInviteNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 cd = 5; */
        if (message.cd !== 0)
            writer.tag(5, WireType.Varint).uint32(message.cd);
        /* uint32 player_uid = 6; */
