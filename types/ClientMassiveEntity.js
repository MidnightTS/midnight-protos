...
var _ClientMassiveEntity_one_of_decls;
...
class ClientMassiveEntity extends pb_1.Message {
    constructor(data) {
        super();
        _ClientMassiveEntity_one_of_decls.set(this, [[4, 5, 6]]);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ClientMassiveEntity_one_of_decls, "f"));
    ...
    get water_info() {
        return pb_1.Message.getWrapperField(this, dependency_3.MassiveWaterInfo, 4);
    }
    set water_info(value) {
        pb_1.Message.setOneofWrapperField(this, 4, __classPrivateFieldGet(this, _ClientMassiveEntity_one_of_decls, "f")[0], value);
    }
    get has_water_info() {
        return pb_1.Message.getField(this, 4) != null;
    }
    get grass_info() {
        return pb_1.Message.getWrapperField(this, dependency_2.MassiveGrassInfo, 5);
    }
    set grass_info(value) {
        pb_1.Message.setOneofWrapperField(this, 5, __classPrivateFieldGet(this, _ClientMassiveEntity_one_of_decls, "f")[0], value);
    }
    get has_grass_info() {
        return pb_1.Message.getField(this, 5) != null;
    }
    get box_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.MassiveBoxInfo, 6);
    }
    set box_info(value) {
        pb_1.Message.setOneofWrapperField(this, 6, __classPrivateFieldGet(this, _ClientMassiveEntity_one_of_decls, "f")[0], value);
    }
    get has_box_info() {
...
exports.ClientMassiveEntity = ClientMassiveEntity;
_ClientMassiveEntity_one_of_decls = new WeakMap();
