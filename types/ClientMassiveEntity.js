...
exports.ClientMassiveEntity = void 0;
...
class ClientMassiveEntity$Type extends runtime_5.MessageType {
    constructor() {
        super("ClientMassiveEntity", [
            ...
            { no: 4, name: "water_info", kind: "message", oneof: "entityInfo", T: () => MassiveWaterInfo_1.MassiveWaterInfo },
            { no: 5, name: "grass_info", kind: "message", oneof: "entityInfo", T: () => MassiveGrassInfo_1.MassiveGrassInfo },
            { no: 6, name: "box_info", kind: "message", oneof: "entityInfo", T: () => MassiveBoxInfo_1.MassiveBoxInfo }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* int64 obj_id = 3; */
        if (message.objId !== 0n)
            writer.tag(3, runtime_1.WireType.Varint).int64(message.objId);
        /* MassiveWaterInfo water_info = 4; */
        if (message.entityInfo.oneofKind === "waterInfo")
            MassiveWaterInfo_1.MassiveWaterInfo.internalBinaryWrite(message.entityInfo.waterInfo, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* MassiveGrassInfo grass_info = 5; */
        if (message.entityInfo.oneofKind === "grassInfo")
            MassiveGrassInfo_1.MassiveGrassInfo.internalBinaryWrite(message.entityInfo.grassInfo, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* MassiveBoxInfo box_info = 6; */
        if (message.entityInfo.oneofKind === "boxInfo")
            MassiveBoxInfo_1.MassiveBoxInfo.internalBinaryWrite(message.entityInfo.boxInfo, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
