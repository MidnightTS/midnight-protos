...
class RefreshRoguelikeDungeonCardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("RefreshRoguelikeDungeonCardRsp", [
            { no: 14, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "res_card_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, resCardList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 14:
                    ...
                    break;
                case /* repeated uint32 res_card_list */ 2:
...
/**
 * @generated MessageType for protobuf message RefreshRoguelikeDungeonCardRsp
 */
