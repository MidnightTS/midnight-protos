...
// @generated from protobuf file "PlayerCompoundMaterialRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerCompoundMaterialRsp
 */
export interface PlayerCompoundMaterialRsp {
    /**
     * @generated from protobuf field: CompoundQueueData compound_queue_data = 9;
     */
...
class PlayerCompoundMaterialRsp$Type extends MessageType<PlayerCompoundMaterialRsp> {
    constructor() {
        super("PlayerCompoundMaterialRsp", [
            { no: 9, name: "compound_queue_data", kind: "message", T: () => CompoundQueueData },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* CompoundQueueData compound_queue_data */ 9:
                    message.compoundQueueData = CompoundQueueData.internalBinaryRead(reader, reader.uint32(), options, message.compoundQueueData);
                    break;
    ...
    internalBinaryWrite(message: PlayerCompoundMaterialRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.compoundQueueData)
            CompoundQueueData.internalBinaryWrite(message.compoundQueueData, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 5; */
