...
class MainCoop$Type extends runtime_5.MessageType {
    constructor() {
        super("MainCoop", [
            ...
            { no: 5, name: "Unk3300_JFPLEDLNJPF", kind: "map", jsonName: "Unk3300JFPLEDLNJPF", K: 13 /*ScalarType.UINT32*/, V: { kind: "scalar", T: 5 /*ScalarType.INT32*/ } },
            { no: 7, name: "Unk3300_OMEEMFJFKBH", kind: "map", jsonName: "Unk3300OMEEMFJFKBH", K: 13 /*ScalarType.UINT32*/, V: { kind: "scalar", T: 5 /*ScalarType.INT32*/ } },
    ...
    create(value) {
        const message = { status: 0, unk3300JFPLEDLNJPF: {}, unk3300OMEEMFJFKBH: {}, selfConfidence: 0, id: 0, savePointIdList: [], seenEndingMap: {} };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* MainCoop.Status status */ 6:
                    ...
                    break;
                case /* map<uint32, int32> Unk3300_JFPLEDLNJPF = 5 [json_name = "Unk3300JFPLEDLNJPF"];*/ 5:
                    this.binaryReadMap5(message.unk3300JFPLEDLNJPF, reader, options);
                    break;
                case /* map<uint32, int32> Unk3300_OMEEMFJFKBH = 7 [json_name = "Unk3300OMEEMFJFKBH"];*/ 7:
                    this.binaryReadMap7(message.unk3300OMEEMFJFKBH, reader, options);
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field MainCoop.Unk3300_JFPLEDLNJPF");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field MainCoop.Unk3300_OMEEMFJFKBH");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* map<uint32, int32> Unk3300_JFPLEDLNJPF = 5 [json_name = "Unk3300JFPLEDLNJPF"]; */
        for (let k of Object.keys(message.unk3300JFPLEDLNJPF))
            writer.tag(5, runtime_2.WireType.LengthDelimited).fork().tag(1, runtime_2.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_2.WireType.Varint).int32(message.unk3300JFPLEDLNJPF[k]).join();
        /* map<uint32, int32> Unk3300_OMEEMFJFKBH = 7 [json_name = "Unk3300OMEEMFJFKBH"]; */
        for (let k of Object.keys(message.unk3300OMEEMFJFKBH))
            writer.tag(7, runtime_2.WireType.LengthDelimited).fork().tag(1, runtime_2.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_2.WireType.Varint).int32(message.unk3300OMEEMFJFKBH[k]).join();
