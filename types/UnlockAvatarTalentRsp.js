...
exports.UnlockAvatarTalentRsp = void 0;
...
class UnlockAvatarTalentRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("UnlockAvatarTalentRsp", [
            { no: 14, name: "talent_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { talentId: 0, avatarGuid: 0n, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.talentId !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.talentId);
