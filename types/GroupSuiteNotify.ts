...
// @generated from protobuf file "GroupSuiteNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface GroupSuiteNotify {
    /**
     * @generated from protobuf field: map<uint32, uint32> group_map = 4;
     */
    groupMap: {
        [key: number]: number;
    };
...
class GroupSuiteNotify$Type extends MessageType<GroupSuiteNotify> {
    ...
    private binaryReadMap4(map: GroupSuiteNotify["groupMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: GroupSuiteNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.groupMap))
            writer.tag(4, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.groupMap[k as any]).join();
