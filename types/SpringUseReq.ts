...
// @generated from protobuf file "SpringUseReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SpringUseReq
 */
export interface SpringUseReq {
    /**
     * @generated from protobuf field: uint64 guid = 12;
     */
    guid: bigint;
}
...
class SpringUseReq$Type extends MessageType<SpringUseReq> {
    ...
    internalBinaryWrite(message: SpringUseReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 guid = 12; */
        if (message.guid !== 0n)
            writer.tag(12, WireType.Varint).uint64(message.guid);
