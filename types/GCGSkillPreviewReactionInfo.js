...
exports.GCGSkillPreviewReactionInfo = void 0;
...
class GCGSkillPreviewReactionInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300AENPLEDPMJH !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.unk3300AENPLEDPMJH);
        /* uint32 Unk3300_PDEHPHJFAKD = 2 [json_name = "Unk3300PDEHPHJFAKD"]; */
        if (message.unk3300PDEHPHJFAKD !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.unk3300PDEHPHJFAKD);
