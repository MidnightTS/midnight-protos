...
exports.LunaRiteAreaFinishNotify = void 0;
...
class LunaRiteAreaFinishNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("LunaRiteAreaFinishNotify", [
    ...
    internalBinaryWrite(message, writer, options) {
        /* uint32 area_id = 14; */
        if (message.areaId !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.areaId);
...
/**
 * @generated MessageType for protobuf message LunaRiteAreaFinishNotify
 */
