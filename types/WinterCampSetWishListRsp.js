...
exports.WinterCampSetWishListRsp = void 0;
...
class WinterCampSetWishListRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("WinterCampSetWishListRsp", [
            { no: 10, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "item_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, itemIdList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 10:
                    ...
                    break;
                case /* repeated uint32 item_id_list */ 3:
...
/**
 * @generated MessageType for protobuf message WinterCampSetWishListRsp
 */
