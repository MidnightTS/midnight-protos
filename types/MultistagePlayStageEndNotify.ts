...
// @generated from protobuf file "MultistagePlayStageEndNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MultistagePlayStageEndNotify
 */
export interface MultistagePlayStageEndNotify {
    ...
    groupId: number;
    /**
     * @generated from protobuf field: uint32 play_index = 1;
     */
    playIndex: number;
}
...
class MultistagePlayStageEndNotify$Type extends MessageType<MultistagePlayStageEndNotify> {
    ...
    internalBinaryWrite(message: MultistagePlayStageEndNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.playIndex !== 0)
            writer.tag(1, WireType.Varint).uint32(message.playIndex);
