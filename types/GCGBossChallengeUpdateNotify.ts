...
// @generated from protobuf file "GCGBossChallengeUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGBossChallengeUpdateNotify
 */
export interface GCGBossChallengeUpdateNotify {
    /**
     * @generated from protobuf field: GCGBossChallengeData boss_challenge = 7;
     */
...
class GCGBossChallengeUpdateNotify$Type extends MessageType<GCGBossChallengeUpdateNotify> {
    constructor() {
        super("GCGBossChallengeUpdateNotify", [
            { no: 7, name: "boss_challenge", kind: "message", T: () => GCGBossChallengeData }
        ]);
    }
    ...
    internalBinaryWrite(message: GCGBossChallengeUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.bossChallenge)
            GCGBossChallengeData.internalBinaryWrite(message.bossChallenge, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
