...
// @generated from protobuf file "HomeLimitedShopInfoChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeLimitedShopInfoChangeNotify
 */
export interface HomeLimitedShopInfoChangeNotify {
    /**
     * @generated from protobuf field: repeated HomeLimitedShopGoods goods_list = 2;
     */
...
class HomeLimitedShopInfoChangeNotify$Type extends MessageType<HomeLimitedShopInfoChangeNotify> {
    constructor() {
        super("HomeLimitedShopInfoChangeNotify", [
            { no: 2, name: "goods_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeLimitedShopGoods }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeLimitedShopInfoChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.goodsList.length; i++)
            HomeLimitedShopGoods.internalBinaryWrite(message.goodsList[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
