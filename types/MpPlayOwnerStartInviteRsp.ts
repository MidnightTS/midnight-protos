...
// @generated from protobuf file "MpPlayOwnerStartInviteRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MpPlayOwnerStartInviteRsp
 */
export interface MpPlayOwnerStartInviteRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 mp_play_id = 4;
     */
    mpPlayId: number;
}
...
class MpPlayOwnerStartInviteRsp$Type extends MessageType<MpPlayOwnerStartInviteRsp> {
    ...
    internalBinaryWrite(message: MpPlayOwnerStartInviteRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mpPlayId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.mpPlayId);
