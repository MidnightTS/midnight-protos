...
// @generated from protobuf file "PotionDungeonResultInfo.proto" (syntax proto3)
// tslint:disable
//
...
export interface PotionDungeonResultInfo {
    /**
     * @generated from protobuf field: uint32 left_time = 7;
     */
    leftTime: number;
    /**
     * @generated from protobuf field: uint32 mode_id = 13;
     */
    modeId: number;
    /**
    ...
    finalScore: number;
    /**
     * @generated from protobuf field: uint32 difficulty_level = 8;
     */
...
class PotionDungeonResultInfo$Type extends MessageType<PotionDungeonResultInfo> {
    ...
    internalBinaryWrite(message: PotionDungeonResultInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.leftTime !== 0)
            writer.tag(7, WireType.Varint).uint32(message.leftTime);
        /* uint32 mode_id = 13; */
        if (message.modeId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.modeId);
        /* uint32 stage_id = 1; */
        ...
        if (message.difficultyLevel !== 0)
            writer.tag(8, WireType.Varint).uint32(message.difficultyLevel);
