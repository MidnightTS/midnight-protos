...
class MechanicusCandidateTeamCreateRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("MechanicusCandidateTeamCreateRsp", [
            { no: 11, name: "difficult_level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "dungeon_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { difficultLevel: 0, dungeonId: 0, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 difficult_level */ 11:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.difficultLevel !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.difficultLevel);
        /* uint32 dungeon_id = 5; */
...
/**
 * @generated MessageType for protobuf message MechanicusCandidateTeamCreateRsp
 */
