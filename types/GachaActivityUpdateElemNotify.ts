...
// @generated from protobuf file "GachaActivityUpdateElemNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GachaActivityUpdateElemNotify
 */
export interface GachaActivityUpdateElemNotify {
    /**
     * @generated from protobuf field: uint32 elem_type = 9;
     */
    elemType: number;
}
...
class GachaActivityUpdateElemNotify$Type extends MessageType<GachaActivityUpdateElemNotify> {
    ...
    internalBinaryWrite(message: GachaActivityUpdateElemNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.elemType !== 0)
            writer.tag(9, WireType.Varint).uint32(message.elemType);
