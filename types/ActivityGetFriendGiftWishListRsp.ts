...
// @generated from protobuf file "ActivityGetFriendGiftWishListRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { ActivityFriendGiftWishData } from "./ActivityFriendGiftWishData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message ActivityGetFriendGiftWishListRsp
 */
export interface ActivityGetFriendGiftWishListRsp {
    /**
     * @generated from protobuf field: repeated ActivityFriendGiftWishData friend_gift_wish_list = 12;
     */
...
class ActivityGetFriendGiftWishListRsp$Type extends MessageType<ActivityGetFriendGiftWishListRsp> {
    constructor() {
        super("ActivityGetFriendGiftWishListRsp", [
            { no: 12, name: "friend_gift_wish_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ActivityFriendGiftWishData },
    ...
    internalBinaryWrite(message: ActivityGetFriendGiftWishListRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.friendGiftWishList.length; i++)
            ActivityFriendGiftWishData.internalBinaryWrite(message.friendGiftWishList[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
