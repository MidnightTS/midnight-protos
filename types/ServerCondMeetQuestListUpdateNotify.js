...
class ServerCondMeetQuestListUpdateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("ServerCondMeetQuestListUpdateNotify", [
            { no: 10, name: "add_quest_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "del_quest_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 add_quest_id_list */ 10:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        ...
                        message.addQuestIdList.push(reader.uint32());
                    break;
                case /* repeated uint32 del_quest_id_list */ 4:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
