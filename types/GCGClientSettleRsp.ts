...
// @generated from protobuf file "GCGClientSettleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGClientSettleRsp
 */
export interface GCGClientSettleRsp {
    /**
     * @generated from protobuf field: uint32 close_time = 5;
     */
    closeTime: number;
    /**
...
class GCGClientSettleRsp$Type extends MessageType<GCGClientSettleRsp> {
    ...
    internalBinaryWrite(message: GCGClientSettleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.closeTime !== 0)
            writer.tag(5, WireType.Varint).uint32(message.closeTime);
        /* int32 retcode = 9; */
