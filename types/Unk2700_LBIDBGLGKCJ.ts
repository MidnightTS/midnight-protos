...
export class Unk2700_LBIDBGLGKCJ extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Unk2700_LBIDBGLGKCJ {
    ...
    static deserializeBinary(bytes: Uint8Array): Unk2700_LBIDBGLGKCJ {
