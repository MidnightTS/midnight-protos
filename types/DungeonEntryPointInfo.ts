...
// @generated from protobuf file "DungeonEntryPointInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message DungeonEntryPointInfo
 */
export interface DungeonEntryPointInfo {
    ...
    sceneId: number;
    /**
     * @generated from protobuf field: repeated DungeonEntryInfo dungeon_entry_list = 14;
     */
...
class DungeonEntryPointInfo$Type extends MessageType<DungeonEntryPointInfo> {
    constructor() {
        super("DungeonEntryPointInfo", [
            ...
            { no: 14, name: "dungeon_entry_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DungeonEntryInfo },
    ...
    internalBinaryWrite(message: DungeonEntryPointInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.dungeonEntryList.length; i++)
            DungeonEntryInfo.internalBinaryWrite(message.dungeonEntryList[i], writer.tag(14, WireType.LengthDelimited).fork(), options).join();
