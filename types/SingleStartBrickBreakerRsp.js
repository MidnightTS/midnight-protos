...
exports.SingleStartBrickBreakerRsp = void 0;
...
class SingleStartBrickBreakerRsp$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isDungeon !== false)
            writer.tag(9, runtime_1.WireType.Varint).bool(message.isDungeon);
        /* int32 retcode = 8; */
 ...
 */
exports.SingleStartBrickBreakerRsp = new SingleStartBrickBreakerRsp$Type();
