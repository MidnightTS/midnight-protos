...
// @generated from protobuf file "SocialDataNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SocialDataNotify
 */
export interface SocialDataNotify {
    /**
     * @generated from protobuf field: bool is_have_first_share = 13;
     */
...
class SocialDataNotify$Type extends MessageType<SocialDataNotify> {
    ...
    internalBinaryWrite(message: SocialDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isHaveFirstShare !== false)
            writer.tag(13, WireType.Varint).bool(message.isHaveFirstShare);
