...
// @generated from protobuf file "MistTrialGetChallengeMissionRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { MistTrialMissionInfo } from "./MistTrialMissionInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message MistTrialGetChallengeMissionRsp
 */
export interface MistTrialGetChallengeMissionRsp {
    /**
     * @generated from protobuf field: uint32 trial_id = 6;
     */
    trialId: number;
    /**
     * @generated from protobuf field: repeated MistTrialMissionInfo mission_info_list = 3;
     */
...
class MistTrialGetChallengeMissionRsp$Type extends MessageType<MistTrialGetChallengeMissionRsp> {
    constructor() {
        super("MistTrialGetChallengeMissionRsp", [
            ...
            { no: 3, name: "mission_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MistTrialMissionInfo },
    ...
    internalBinaryWrite(message: MistTrialGetChallengeMissionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.trialId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.trialId);
        /* repeated MistTrialMissionInfo mission_info_list = 3; */
        for (let i = 0; i < message.missionInfoList.length; i++)
            MistTrialMissionInfo.internalBinaryWrite(message.missionInfoList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 7; */
