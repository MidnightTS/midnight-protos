...
// @generated from protobuf file "MechanicusSequenceOpenNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MechanicusSequenceOpenNotify
 */
export interface MechanicusSequenceOpenNotify {
    /**
     * @generated from protobuf field: uint32 mechanicus_id = 12;
     */
    mechanicusId: number;
    /**
     * @generated from protobuf field: uint32 sequence_id = 9;
     */
    sequenceId: number;
}
...
class MechanicusSequenceOpenNotify$Type extends MessageType<MechanicusSequenceOpenNotify> {
    ...
    internalBinaryWrite(message: MechanicusSequenceOpenNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sequenceId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.sequenceId);
