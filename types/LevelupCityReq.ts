...
// @generated from protobuf file "LevelupCityReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LevelupCityReq
 */
export interface LevelupCityReq {
    ...
    sceneId: number;
    /**
     * @generated from protobuf field: uint32 item_num = 13;
     */
    itemNum: number;
    /**
     * @generated from protobuf field: uint32 area_id = 7;
     */
    areaId: number;
}
...
class LevelupCityReq$Type extends MessageType<LevelupCityReq> {
    ...
    internalBinaryWrite(message: LevelupCityReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.itemNum !== 0)
            writer.tag(13, WireType.Varint).uint32(message.itemNum);
        /* uint32 area_id = 7; */
        if (message.areaId !== 0)
