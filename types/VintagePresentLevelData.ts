...
// @generated from protobuf file "VintagePresentLevelData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message VintagePresentLevelData
 */
export interface VintagePresentLevelData {
    /**
     * @generated from protobuf field: bool is_finish = 6;
     */
    isFinish: boolean;
    /**
    ...
    stageId: number;
    /**
     * @generated from protobuf field: uint32 present_id = 1;
     */
    presentId: number;
}
...
class VintagePresentLevelData$Type extends MessageType<VintagePresentLevelData> {
    ...
    internalBinaryWrite(message: VintagePresentLevelData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.presentId !== 0)
            writer.tag(1, WireType.Varint).uint32(message.presentId);
