...
class DataResVersionNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DataResVersionNotify", [
            ...
            { no: 12, name: "Unk3300_HMGCPAGLDHB", kind: "scalar", jsonName: "Unk3300HMGCPAGLDHB", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "client_data_version", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "Unk3300_OPGDBOLKLJA", kind: "scalar", jsonName: "Unk3300OPGDBOLKLJA", T: 9 /*ScalarType.STRING*/ },
            { no: 7, name: "res_version_config", kind: "message", T: () => ResVersionConfig_1.ResVersionConfig }
        ]);
    }
    create(value) {
        const message = { clientSilenceDataVersion: 0, opType: 0, clientSilenceVersionSuffix: "", clientVersionSuffix: "", isDataNeedRelogin: false, unk3300HMGCPAGLDHB: "", clientDataVersion: 0, unk3300OPGDBOLKLJA: "" };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool is_data_need_relogin */ 15:
                    ...
                    break;
                case /* string Unk3300_HMGCPAGLDHB = 12 [json_name = "Unk3300HMGCPAGLDHB"];*/ 12:
                    message.unk3300HMGCPAGLDHB = reader.string();
                    break;
                case /* uint32 client_data_version */ 5:
                    message.clientDataVersion = reader.uint32();
                    break;
                case /* string Unk3300_OPGDBOLKLJA = 2 [json_name = "Unk3300OPGDBOLKLJA"];*/ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string Unk3300_HMGCPAGLDHB = 12 [json_name = "Unk3300HMGCPAGLDHB"]; */
        if (message.unk3300HMGCPAGLDHB !== "")
            writer.tag(12, runtime_1.WireType.LengthDelimited).string(message.unk3300HMGCPAGLDHB);
        ...
        /* string Unk3300_OPGDBOLKLJA = 2 [json_name = "Unk3300OPGDBOLKLJA"]; */
        if (message.unk3300OPGDBOLKLJA !== "")
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.unk3300OPGDBOLKLJA);
