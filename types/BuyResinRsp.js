...
class BuyResinRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("BuyResinRsp", [
            { no: 7, name: "cur_value", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { curValue: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.curValue !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.curValue);
        /* int32 retcode = 13; */
...
/**
 * @generated MessageType for protobuf message BuyResinRsp
 */
