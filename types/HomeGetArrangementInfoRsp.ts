...
// @generated from protobuf file "HomeGetArrangementInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface HomeGetArrangementInfoRsp {
    /**
     * @generated from protobuf field: repeated HomeSceneArrangementInfo scene_arrangement_info_list = 13;
     */
...
class HomeGetArrangementInfoRsp$Type extends MessageType<HomeGetArrangementInfoRsp> {
    constructor() {
        super("HomeGetArrangementInfoRsp", [
            { no: 13, name: "scene_arrangement_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeSceneArrangementInfo },
    ...
    internalBinaryWrite(message: HomeGetArrangementInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.sceneArrangementInfoList.length; i++)
            HomeSceneArrangementInfo.internalBinaryWrite(message.sceneArrangementInfoList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 11; */
