...
// @generated from protobuf file "GCGToken.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGToken
 */
export interface GCGToken {
    /**
     * @generated from protobuf field: uint32 value = 14;
     */
    value: number;
    /**
     * @generated from protobuf field: uint32 key = 4;
     */
    key: number;
}
...
class GCGToken$Type extends MessageType<GCGToken> {
    ...
    internalBinaryWrite(message: GCGToken, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 value = 14; */
        if (message.value !== 0)
            writer.tag(14, WireType.Varint).uint32(message.value);
        /* uint32 key = 4; */
        if (message.key !== 0)
