...
// @generated from protobuf file "ActivitySetGiftWishReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ActivitySetGiftWishReq
 */
export interface ActivitySetGiftWishReq {
    ...
    scheduleId: number;
    /**
     * @generated from protobuf field: map<uint32, uint32> gift_num_map = 13;
     */
    giftNumMap: {
        [key: number]: number;
    };
...
class ActivitySetGiftWishReq$Type extends MessageType<ActivitySetGiftWishReq> {
    ...
    private binaryReadMap13(map: ActivitySetGiftWishReq["giftNumMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: ActivitySetGiftWishReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.giftNumMap))
            writer.tag(13, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.giftNumMap[k as any]).join();
