...
// @generated from protobuf file "ChessPickCardNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChessPickCardNotify
 */
export interface ChessPickCardNotify {
    /**
     * @generated from protobuf field: ChessNormalCardInfo normal_card_info = 8;
     */
    normalCardInfo?: ChessNormalCardInfo;
    /**
     * @generated from protobuf field: uint32 curse_card_id = 6;
     */
    curseCardId: number;
}
...
class ChessPickCardNotify$Type extends MessageType<ChessPickCardNotify> {
    constructor() {
        super("ChessPickCardNotify", [
            { no: 8, name: "normal_card_info", kind: "message", T: () => ChessNormalCardInfo },
    ...
    internalBinaryWrite(message: ChessPickCardNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.normalCardInfo)
            ChessNormalCardInfo.internalBinaryWrite(message.normalCardInfo, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* uint32 curse_card_id = 6; */
        if (message.curseCardId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.curseCardId);
