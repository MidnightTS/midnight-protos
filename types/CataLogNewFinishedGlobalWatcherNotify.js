...
exports.CataLogNewFinishedGlobalWatcherNotify = void 0;
...
class CataLogNewFinishedGlobalWatcherNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("CataLogNewFinishedGlobalWatcherNotify", [
            { no: 11, name: "new_finished_global_watcher_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CataLogGlobalWatcherFinishedData_1.CataLogGlobalWatcherFinishedData }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated CataLogGlobalWatcherFinishedData new_finished_global_watcher_data_list */ 11:
                    message.newFinishedGlobalWatcherDataList.push(CataLogGlobalWatcherFinishedData_1.CataLogGlobalWatcherFinishedData.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.newFinishedGlobalWatcherDataList.length; i++)
            CataLogGlobalWatcherFinishedData_1.CataLogGlobalWatcherFinishedData.internalBinaryWrite(message.newFinishedGlobalWatcherDataList[i], writer.tag(11, runtime_1.WireType.LengthDelimited).fork(), options).join();
