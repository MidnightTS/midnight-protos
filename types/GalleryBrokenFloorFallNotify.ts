...
// @generated from protobuf file "GalleryBrokenFloorFallNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GalleryBrokenFloorFallNotify
 */
export interface GalleryBrokenFloorFallNotify {
    /**
     * @generated from protobuf field: uint32 fall_count = 10;
     */
    fallCount: number;
    /**
...
class GalleryBrokenFloorFallNotify$Type extends MessageType<GalleryBrokenFloorFallNotify> {
    ...
    internalBinaryWrite(message: GalleryBrokenFloorFallNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fallCount !== 0)
            writer.tag(10, WireType.Varint).uint32(message.fallCount);
        /* uint32 gallery_id = 7; */
