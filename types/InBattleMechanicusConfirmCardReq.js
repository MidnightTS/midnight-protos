...
class InBattleMechanicusConfirmCardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("InBattleMechanicusConfirmCardReq", [
    ...
    create(value) {
        const message = { cardId: 0, playIndex: 0, groupId: 0 };
...
/**
 * @generated MessageType for protobuf message InBattleMechanicusConfirmCardReq
 */
