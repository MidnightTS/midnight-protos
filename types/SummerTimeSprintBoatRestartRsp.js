...
exports.SummerTimeSprintBoatRestartRsp = void 0;
...
class SummerTimeSprintBoatRestartRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SummerTimeSprintBoatRestartRsp", [
    ...
    create(value) {
        const message = { scheduleId: 0, groupId: 0, retcode: 0 };
...
/**
 * @generated MessageType for protobuf message SummerTimeSprintBoatRestartRsp
 */
