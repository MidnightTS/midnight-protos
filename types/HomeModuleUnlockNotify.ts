...
// @generated from protobuf file "HomeModuleUnlockNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeModuleUnlockNotify
 */
export interface HomeModuleUnlockNotify {
    /**
     * @generated from protobuf field: uint32 module_id = 4;
     */
    moduleId: number;
}
...
class HomeModuleUnlockNotify$Type extends MessageType<HomeModuleUnlockNotify> {
    ...
    internalBinaryWrite(message: HomeModuleUnlockNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.moduleId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.moduleId);
