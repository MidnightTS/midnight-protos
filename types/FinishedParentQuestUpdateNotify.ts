...
// @generated from protobuf file "FinishedParentQuestUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { ParentQuest } from "./ParentQuest";
/**
 * enum CmdId {
...
export interface FinishedParentQuestUpdateNotify {
    /**
     * @generated from protobuf field: repeated ParentQuest parent_quest_list = 3;
     */
...
class FinishedParentQuestUpdateNotify$Type extends MessageType<FinishedParentQuestUpdateNotify> {
    constructor() {
        super("FinishedParentQuestUpdateNotify", [
            { no: 3, name: "parent_quest_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ParentQuest }
        ]);
    }
    ...
    internalBinaryWrite(message: FinishedParentQuestUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.parentQuestList.length; i++)
            ParentQuest.internalBinaryWrite(message.parentQuestList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
