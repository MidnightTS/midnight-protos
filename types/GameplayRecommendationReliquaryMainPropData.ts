...
// @generated from protobuf file "GameplayRecommendationReliquaryMainPropData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GameplayRecommendationReliquaryMainPropData
 */
export interface GameplayRecommendationReliquaryMainPropData {
    /**
     * @generated from protobuf field: uint32 permillage = 5;
     */
    permillage: number;
    /**
     * @generated from protobuf field: uint32 main_prop_id = 10;
     */
    mainPropId: number;
}
...
class GameplayRecommendationReliquaryMainPropData$Type extends MessageType<GameplayRecommendationReliquaryMainPropData> {
    ...
    internalBinaryWrite(message: GameplayRecommendationReliquaryMainPropData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.permillage !== 0)
            writer.tag(5, WireType.Varint).uint32(message.permillage);
        /* uint32 main_prop_id = 10; */
        if (message.mainPropId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.mainPropId);
