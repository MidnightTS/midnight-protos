...
// @generated from protobuf file "LaunchFireworksReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LaunchFireworksReq
 */
export interface LaunchFireworksReq {
    /**
     * @generated from protobuf field: FireworksLaunchSchemeData scheme_data = 8;
     */
...
class LaunchFireworksReq$Type extends MessageType<LaunchFireworksReq> {
    constructor() {
        super("LaunchFireworksReq", [
            { no: 8, name: "scheme_data", kind: "message", T: () => FireworksLaunchSchemeData }
        ]);
    }
    ...
    internalBinaryWrite(message: LaunchFireworksReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.schemeData)
            FireworksLaunchSchemeData.internalBinaryWrite(message.schemeData, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
