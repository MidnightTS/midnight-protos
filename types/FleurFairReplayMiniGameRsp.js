...
exports.FleurFairReplayMiniGameRsp = void 0;
...
class FleurFairReplayMiniGameRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("FleurFairReplayMiniGameRsp", [
            { no: 6, name: "minigame_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { minigameId: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.minigameId !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.minigameId);
        /* int32 retcode = 5; */
...
/**
 * @generated MessageType for protobuf message FleurFairReplayMiniGameRsp
 */
