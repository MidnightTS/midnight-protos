...
// @generated from protobuf file "SalvageEscortSettleNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { SalvageEscortSettleInfo } from "./SalvageEscortSettleInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message SalvageEscortSettleNotify
 */
export interface SalvageEscortSettleNotify {
    /**
     * @generated from protobuf field: SalvageEscortSettleInfo settle_info = 1;
     */
...
class SalvageEscortSettleNotify$Type extends MessageType<SalvageEscortSettleNotify> {
    constructor() {
        super("SalvageEscortSettleNotify", [
            { no: 1, name: "settle_info", kind: "message", T: () => SalvageEscortSettleInfo },
    ...
    internalBinaryWrite(message: SalvageEscortSettleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.settleInfo)
            SalvageEscortSettleInfo.internalBinaryWrite(message.settleInfo, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* uint32 gallery_id = 6; */
