...
class GetBlossomBriefInfoListRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GetBlossomBriefInfoListRsp", [
            ...
            { no: 1, name: "brief_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BlossomBriefInfo_1.BlossomBriefInfo }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.briefInfoList.length; i++)
            BlossomBriefInfo_1.BlossomBriefInfo.internalBinaryWrite(message.briefInfoList[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
