...
// @generated from protobuf file "GCGDSFieldUnlockNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSFieldUnlockNotify
 */
export interface GCGDSFieldUnlockNotify {
    /**
     * @generated from protobuf field: uint32 field_id = 12;
     */
    fieldId: number;
}
...
class GCGDSFieldUnlockNotify$Type extends MessageType<GCGDSFieldUnlockNotify> {
    ...
    internalBinaryWrite(message: GCGDSFieldUnlockNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.fieldId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.fieldId);
