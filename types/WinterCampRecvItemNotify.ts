...
// @generated from protobuf file "WinterCampRecvItemNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { WinterCampRecvItemData } from "./WinterCampRecvItemData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message WinterCampRecvItemNotify
 */
export interface WinterCampRecvItemNotify {
    /**
     * @generated from protobuf field: WinterCampRecvItemData recv_item_data = 11;
     */
...
class WinterCampRecvItemNotify$Type extends MessageType<WinterCampRecvItemNotify> {
    constructor() {
        super("WinterCampRecvItemNotify", [
            { no: 11, name: "recv_item_data", kind: "message", T: () => WinterCampRecvItemData }
        ]);
    }
    ...
    internalBinaryWrite(message: WinterCampRecvItemNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.recvItemData)
            WinterCampRecvItemData.internalBinaryWrite(message.recvItemData, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
