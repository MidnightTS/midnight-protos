...
// @generated from protobuf file "AvatarFightPropUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface AvatarFightPropUpdateNotify {
    ...
    avatarGuid: bigint;
    /**
     * @generated from protobuf field: map<uint32, float> fight_prop_map = 10;
     */
    fightPropMap: {
        [key: number]: number;
    };
...
class AvatarFightPropUpdateNotify$Type extends MessageType<AvatarFightPropUpdateNotify> {
    ...
    private binaryReadMap10(map: AvatarFightPropUpdateNotify["fightPropMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: AvatarFightPropUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.fightPropMap))
            writer.tag(10, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Bit32).float(message.fightPropMap[k as any]).join();
