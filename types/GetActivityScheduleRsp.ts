...
// @generated from protobuf file "GetActivityScheduleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetActivityScheduleRsp
 */
export interface GetActivityScheduleRsp {
    /**
     * @generated from protobuf field: repeated ActivityScheduleInfo activity_schedule_list = 15;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 remain_fly_sea_lamp_num = 7;
     */
...
class GetActivityScheduleRsp$Type extends MessageType<GetActivityScheduleRsp> {
    constructor() {
        super("GetActivityScheduleRsp", [
            { no: 15, name: "activity_schedule_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ActivityScheduleInfo },
    ...
    internalBinaryWrite(message: GetActivityScheduleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.activityScheduleList.length; i++)
            ActivityScheduleInfo.internalBinaryWrite(message.activityScheduleList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 8; */
        if (message.retcode !== 0)
            writer.tag(8, WireType.Varint).int32(message.retcode);
        /* uint32 remain_fly_sea_lamp_num = 7; */
        if (message.remainFlySeaLampNum !== 0)
            writer.tag(7, WireType.Varint).uint32(message.remainFlySeaLampNum);
