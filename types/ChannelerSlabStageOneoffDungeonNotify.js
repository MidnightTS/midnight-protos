...
exports.ChannelerSlabStageOneoffDungeonNotify = void 0;
...
class ChannelerSlabStageOneoffDungeonNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isDone !== false)
            writer.tag(6, runtime_1.WireType.Varint).bool(message.isDone);
        /* uint32 stage_id = 13; */
...
/**
 * @generated MessageType for protobuf message ChannelerSlabStageOneoffDungeonNotify
 */
