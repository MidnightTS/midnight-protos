...
exports.GachaActivityTakeRewardRsp = void 0;
...
class GachaActivityTakeRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GachaActivityTakeRewardRsp", [
    ...
    create(value) {
        const message = { robotNumMap: {}, retcode: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.uint32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field GachaActivityTakeRewardRsp.robot_num_map");
            }
        }
        map[key ?? 0] = val ?? 0;
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.robotNumMap))
            writer.tag(10, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.Varint).uint32(parseInt(k)).tag(2, runtime_1.WireType.Varint).uint32(message.robotNumMap[k]).join();
        /* int32 retcode = 8; */
...
/**
 * @generated MessageType for protobuf message GachaActivityTakeRewardRsp
 */
