...
// @generated from protobuf file "cmd_routine.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class PlayerRoutineDataNotify$Type extends MessageType<PlayerRoutineDataNotify> {
    constructor() {
        super("com.midnights.game.PlayerRoutineDataNotify", [
            { no: 11, name: "routine_info_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PlayerRoutineInfo }
        ]);
    }
...
class WorldRoutineTypeInfo$Type extends MessageType<WorldRoutineTypeInfo> {
    constructor() {
        super("com.midnights.game.WorldRoutineTypeInfo", [
            ...
            { no: 3, name: "world_routine_info_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => WorldRoutineInfo }
        ]);
    }
...
class WorldAllRoutineTypeNotify$Type extends MessageType<WorldAllRoutineTypeNotify> {
    constructor() {
        super("com.midnights.game.WorldAllRoutineTypeNotify", [
            { no: 12, name: "world_routine_type_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => WorldRoutineTypeInfo }
        ]);
    }
