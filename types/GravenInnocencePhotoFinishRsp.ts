...
// @generated from protobuf file "GravenInnocencePhotoFinishRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GravenInnocencePhotoFinishRsp
 */
export interface GravenInnocencePhotoFinishRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 object_id = 3;
     */
    objectId: number;
    /**
...
class GravenInnocencePhotoFinishRsp$Type extends MessageType<GravenInnocencePhotoFinishRsp> {
    ...
    internalBinaryWrite(message: GravenInnocencePhotoFinishRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.objectId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.objectId);
        /* uint32 param = 10; */
        if (message.param !== 0)
