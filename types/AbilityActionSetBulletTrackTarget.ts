...
// @generated from protobuf file "AbilityActionSetBulletTrackTarget.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message AbilityActionSetBulletTrackTarget
 */
export interface AbilityActionSetBulletTrackTarget {
    /**
     * @generated from protobuf field: uint32 Unk3300_GKACKBIEOHK = 10 [json_name = "Unk3300GKACKBIEOHK"];
     */
    unk3300GKACKBIEOHK: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_HGBOFFKEPDJ = 4 [json_name = "Unk3300HGBOFFKEPDJ"];
     */
    unk3300HGBOFFKEPDJ: number;
}
...
class AbilityActionSetBulletTrackTarget$Type extends MessageType<AbilityActionSetBulletTrackTarget> {
    ...
    internalBinaryWrite(message: AbilityActionSetBulletTrackTarget, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300GKACKBIEOHK !== 0)
            writer.tag(10, WireType.Varint).uint32(message.unk3300GKACKBIEOHK);
        /* uint32 Unk3300_HGBOFFKEPDJ = 4 [json_name = "Unk3300HGBOFFKEPDJ"]; */
        if (message.unk3300HGBOFFKEPDJ !== 0)
            writer.tag(4, WireType.Varint).uint32(message.unk3300HGBOFFKEPDJ);
