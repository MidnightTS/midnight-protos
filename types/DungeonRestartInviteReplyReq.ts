...
// @generated from protobuf file "DungeonRestartInviteReplyReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DungeonRestartInviteReplyReq
 */
export interface DungeonRestartInviteReplyReq {
    /**
     * @generated from protobuf field: bool is_accept = 2;
     */
    isAccept: boolean;
}
...
class DungeonRestartInviteReplyReq$Type extends MessageType<DungeonRestartInviteReplyReq> {
    ...
    internalBinaryWrite(message: DungeonRestartInviteReplyReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAccept !== false)
            writer.tag(2, WireType.Varint).bool(message.isAccept);
