...
export interface ForgeQueueManipulateRsp {
    ...
    /**
     * @generated from protobuf field: repeated ItemParam return_item_list = 4;
     */
    returnItemList: ItemParam[];
    /**
     * @generated from protobuf field: repeated ItemParam output_item_list = 14;
     */
...
class ForgeQueueManipulateRsp$Type extends MessageType<ForgeQueueManipulateRsp> {
    constructor() {
        super("ForgeQueueManipulateRsp", [
            ...
            { no: 4, name: "return_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam },
    ...
    internalBinaryWrite(message: ForgeQueueManipulateRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.returnItemList.length; i++)
            ItemParam.internalBinaryWrite(message.returnItemList[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
