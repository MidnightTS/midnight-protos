...
// @generated from protobuf file "ActivitySaleChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ActivitySaleChangeNotify
 */
export interface ActivitySaleChangeNotify {
    /**
     * @generated from protobuf field: bool is_close = 14;
     */
    isClose: boolean;
    /**
     * @generated from protobuf field: uint32 sale_id = 8;
     */
    saleId: number;
}
...
class ActivitySaleChangeNotify$Type extends MessageType<ActivitySaleChangeNotify> {
    ...
    internalBinaryWrite(message: ActivitySaleChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isClose !== false)
            writer.tag(14, WireType.Varint).bool(message.isClose);
        /* uint32 sale_id = 8; */
        if (message.saleId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.saleId);
