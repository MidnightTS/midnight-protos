...
class AbilityMixinRecoverInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityMixinRecoverInfo", [
            ...
            { no: 7, name: "breakout_snap_shot", kind: "message", T: () => BreakoutSnapShot_1.BreakoutSnapShot },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* BreakoutSnapShot breakout_snap_shot */ 7:
                    message.breakoutSnapShot = BreakoutSnapShot_1.BreakoutSnapShot.internalBinaryRead(reader, reader.uint32(), options, message.breakoutSnapShot);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.breakoutSnapShot)
            BreakoutSnapShot_1.BreakoutSnapShot.internalBinaryWrite(message.breakoutSnapShot, writer.tag(7, runtime_2.WireType.LengthDelimited).fork(), options).join();
