...
exports.HomeTransferData = void 0;
...
class HomeTransferData$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeTransferData", [
            { no: 1, name: "spawn_pos", kind: "message", T: () => Vector_1.Vector },
    ...
    internalBinaryWrite(message, writer, options) {
        /* Vector spawn_pos = 1; */
        if (message.spawnPos)
            Vector_1.Vector.internalBinaryWrite(message.spawnPos, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 guid = 5; */
        if (message.guid !== 0)
