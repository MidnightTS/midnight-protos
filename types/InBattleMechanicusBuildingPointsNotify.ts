...
// @generated from protobuf file "InBattleMechanicusBuildingPointsNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message InBattleMechanicusBuildingPointsNotify
 */
export interface InBattleMechanicusBuildingPointsNotify {
    /**
     * @generated from protobuf field: map<uint32, uint32> player_building_points_map = 12;
     */
...
class InBattleMechanicusBuildingPointsNotify$Type extends MessageType<InBattleMechanicusBuildingPointsNotify> {
    ...
    private binaryReadMap12(map: InBattleMechanicusBuildingPointsNotify["playerBuildingPointsMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: InBattleMechanicusBuildingPointsNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.playerBuildingPointsMap))
            writer.tag(12, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.playerBuildingPointsMap[k as any]).join();
