...
// @generated from protobuf file "SkyCrystalDetectorData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SkyCrystalDetectorData
 */
export interface SkyCrystalDetectorData {
    /**
     * @generated from protobuf field: bool is_hint_valid = 1;
     */
    isHintValid: boolean;
    /**
...
class SkyCrystalDetectorData$Type extends MessageType<SkyCrystalDetectorData> {
    ...
    internalBinaryWrite(message: SkyCrystalDetectorData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isHintValid !== false)
            writer.tag(1, WireType.Varint).bool(message.isHintValid);
        /* uint32 group_id = 5; */
