...
// @generated from protobuf file "FinishDeliveryNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FinishDeliveryNotify
 */
export interface FinishDeliveryNotify {
    /**
     * @generated from protobuf field: uint32 finished_quest_index = 12;
     */
    finishedQuestIndex: number;
    /**
     * @generated from protobuf field: uint32 day_index = 7;
     */
    dayIndex: number;
    /**
...
class FinishDeliveryNotify$Type extends MessageType<FinishDeliveryNotify> {
    ...
    internalBinaryWrite(message: FinishDeliveryNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.finishedQuestIndex !== 0)
            writer.tag(12, WireType.Varint).uint32(message.finishedQuestIndex);
        /* uint32 day_index = 7; */
        if (message.dayIndex !== 0)
            writer.tag(7, WireType.Varint).uint32(message.dayIndex);
