...
class GetPlayerSocialDetailRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GetPlayerSocialDetailRsp", [
            { no: 6, name: "detail_data", kind: "message", T: () => SocialDetail_1.SocialDetail },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.detailData)
            SocialDetail_1.SocialDetail.internalBinaryWrite(message.detailData, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 14; */
