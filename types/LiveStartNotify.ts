...
// @generated from protobuf file "LiveStartNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message LiveStartNotify
 */
export interface LiveStartNotify {
    /**
     * @generated from protobuf field: uint32 live_id = 7;
     */
    liveId: number;
}
...
class LiveStartNotify$Type extends MessageType<LiveStartNotify> {
    ...
    internalBinaryWrite(message: LiveStartNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 live_id = 7; */
        if (message.liveId !== 0)
            writer.tag(7, WireType.Varint).uint32(message.liveId);
