...
// @generated from protobuf file "PlayerInvestigationNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerInvestigationNotify
 */
export interface PlayerInvestigationNotify {
    /**
     * @generated from protobuf field: repeated Investigation investigation_list = 12;
     */
...
class PlayerInvestigationNotify$Type extends MessageType<PlayerInvestigationNotify> {
    constructor() {
        super("PlayerInvestigationNotify", [
            { no: 12, name: "investigation_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Investigation }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerInvestigationNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.investigationList.length; i++)
            Investigation.internalBinaryWrite(message.investigationList[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
