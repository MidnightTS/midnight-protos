...
// @generated from protobuf file "SetIsAutoUnlockSpecificEquipReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SetIsAutoUnlockSpecificEquipReq
 */
export interface SetIsAutoUnlockSpecificEquipReq {
    /**
     * @generated from protobuf field: bool is_auto_unlock_specific_equip = 8;
     */
...
class SetIsAutoUnlockSpecificEquipReq$Type extends MessageType<SetIsAutoUnlockSpecificEquipReq> {
    ...
    internalBinaryWrite(message: SetIsAutoUnlockSpecificEquipReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isAutoUnlockSpecificEquip !== false)
            writer.tag(8, WireType.Varint).bool(message.isAutoUnlockSpecificEquip);
