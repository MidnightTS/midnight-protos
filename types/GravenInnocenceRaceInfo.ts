...
// @generated from protobuf file "GravenInnocenceRaceInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { GravenInnocenceRaceLevelInfo } from "./GravenInnocenceRaceLevelInfo";
/**
 * @generated from protobuf message GravenInnocenceRaceInfo
 */
export interface GravenInnocenceRaceInfo {
    /**
     * @generated from protobuf field: repeated GravenInnocenceRaceLevelInfo level_info_list = 9;
     */
...
class GravenInnocenceRaceInfo$Type extends MessageType<GravenInnocenceRaceInfo> {
    constructor() {
        super("GravenInnocenceRaceInfo", [
            { no: 9, name: "level_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GravenInnocenceRaceLevelInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: GravenInnocenceRaceInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.levelInfoList.length; i++)
            GravenInnocenceRaceLevelInfo.internalBinaryWrite(message.levelInfoList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
