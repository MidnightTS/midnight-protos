...
// @generated from protobuf file "IrodoriFillPoetryReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriFillPoetryReq
 */
export interface IrodoriFillPoetryReq {
    /**
     * @generated from protobuf field: uint32 line_id = 6;
     */
    lineId: number;
    /**
     * @generated from protobuf field: uint32 theme_id = 5;
     */
    themeId: number;
}
...
class IrodoriFillPoetryReq$Type extends MessageType<IrodoriFillPoetryReq> {
    ...
    internalBinaryWrite(message: IrodoriFillPoetryReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 line_id = 6; */
        if (message.lineId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.lineId);
        /* uint32 theme_id = 5; */
        if (message.themeId !== 0)
            writer.tag(5, WireType.Varint).uint32(message.themeId);
