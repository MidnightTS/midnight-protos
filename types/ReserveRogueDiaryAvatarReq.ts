...
// @generated from protobuf file "ReserveRogueDiaryAvatarReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ReserveRogueDiaryAvatarReq
 */
export interface ReserveRogueDiaryAvatarReq {
    /**
     * @generated from protobuf field: repeated RogueDiaryAvatar reserve_avatar_list = 3;
     */
...
class ReserveRogueDiaryAvatarReq$Type extends MessageType<ReserveRogueDiaryAvatarReq> {
    constructor() {
        super("ReserveRogueDiaryAvatarReq", [
            { no: 3, name: "reserve_avatar_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RogueDiaryAvatar }
        ]);
    }
    ...
    internalBinaryWrite(message: ReserveRogueDiaryAvatarReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.reserveAvatarList.length; i++)
            RogueDiaryAvatar.internalBinaryWrite(message.reserveAvatarList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
