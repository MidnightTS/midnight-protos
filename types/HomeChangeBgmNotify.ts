...
// @generated from protobuf file "HomeChangeBgmNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeChangeBgmNotify
 */
export interface HomeChangeBgmNotify {
    /**
     * @generated from protobuf field: uint32 bgm_id = 9;
     */
    bgmId: number;
}
...
class HomeChangeBgmNotify$Type extends MessageType<HomeChangeBgmNotify> {
    ...
    internalBinaryWrite(message: HomeChangeBgmNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 bgm_id = 9; */
        if (message.bgmId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.bgmId);
