...
exports.OneoffGatherPointDetectorDataNotify = void 0;
...
class OneoffGatherPointDetectorDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("OneoffGatherPointDetectorDataNotify", [
            { no: 2, name: "oneoff_gather_point_detector_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => OneoffGatherPointDetectorData_1.OneoffGatherPointDetectorData }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated OneoffGatherPointDetectorData oneoff_gather_point_detector_data_list */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.oneoffGatherPointDetectorDataList.length; i++)
            OneoffGatherPointDetectorData_1.OneoffGatherPointDetectorData.internalBinaryWrite(message.oneoffGatherPointDetectorDataList[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
