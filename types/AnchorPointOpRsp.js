...
class AnchorPointOpRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("AnchorPointOpRsp", [
            ...
            { no: 12, name: "anchor_point_op_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { anchorPointId: 0, retcode: 0, anchorPointOpType: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 retcode */ 4:
                    ...
                    break;
                case /* uint32 anchor_point_op_type */ 12:
