...
exports.InstableSprayGalleryInfoNotify = void 0;
...
class InstableSprayGalleryInfoNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("InstableSprayGalleryInfoNotify", [
            { no: 14, name: "score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message InstableSprayGalleryInfoNotify
 */
