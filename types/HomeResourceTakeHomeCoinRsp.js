...
class HomeResourceTakeHomeCoinRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeResourceTakeHomeCoinRsp", [
            { no: 4, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 12, name: "home_coin", kind: "message", T: () => HomeResource_1.HomeResource }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 4:
                    ...
                    break;
                case /* HomeResource home_coin */ 12:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.homeCoin)
            HomeResource_1.HomeResource.internalBinaryWrite(message.homeCoin, writer.tag(12, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message HomeResourceTakeHomeCoinRsp
 */
