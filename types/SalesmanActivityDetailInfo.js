...
var _SalesmanActivityDetailInfo_one_of_decls;
...
const dependency_1 = require("./SalesmanStatusType");
const pb_1 = require("google-protobuf");
class SalesmanActivityDetailInfo extends pb_1.Message {
    constructor(data) {
        super();
        _SalesmanActivityDetailInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SalesmanActivityDetailInfo_one_of_decls, "f"));
    ...
    set special_reward_preview_id(value) {
        pb_1.Message.setField(this, 3, value);
    }
    get status() {
        return pb_1.Message.getFieldWithDefault(this, 4, dependency_1.SalesmanStatusType.SALESMAN_STATUS_TYPE_NONE);
    }
    set status(value) {
    ...
    set is_today_has_delivered(value) {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 2:
                    ...
                    break;
                case 5:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.selected_reward_id_map, reader, reader.readUint32, reader.readUint32));
                    break;
                case 11:
...
exports.SalesmanActivityDetailInfo = SalesmanActivityDetailInfo;
_SalesmanActivityDetailInfo_one_of_decls = new WeakMap();
