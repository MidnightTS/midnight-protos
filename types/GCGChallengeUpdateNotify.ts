...
// @generated from protobuf file "GCGChallengeUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGChallengeUpdateNotify
 */
export interface GCGChallengeUpdateNotify {
    /**
     * @generated from protobuf field: uint32 server_seq = 15;
     */
    serverSeq: number;
    /**
     * @generated from protobuf field: GCGDuelChallenge challenge = 1;
     */
...
class GCGChallengeUpdateNotify$Type extends MessageType<GCGChallengeUpdateNotify> {
    constructor() {
        super("GCGChallengeUpdateNotify", [
            ...
            { no: 1, name: "challenge", kind: "message", T: () => GCGDuelChallenge }
        ]);
    }
    ...
    internalBinaryWrite(message: GCGChallengeUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.serverSeq !== 0)
            writer.tag(15, WireType.Varint).uint32(message.serverSeq);
        /* GCGDuelChallenge challenge = 1; */
        if (message.challenge)
            GCGDuelChallenge.internalBinaryWrite(message.challenge, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
