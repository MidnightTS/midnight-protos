...
class FriendBrief$Type extends runtime_5.MessageType {
    constructor() {
        super("FriendBrief", [
            ...
            { no: 7, name: "online_state", kind: "enum", T: () => ["FriendOnlineState", FriendOnlineState_1.FriendOnlineState, "FRIEND_ONLINE_STATE_"] },
            ...
            { no: 23, name: "friend_enter_home_option", kind: "enum", T: () => ["FriendEnterHomeOption", FriendEnterHomeOption_1.FriendEnterHomeOption, "FRIEND_ENTER_HOME_OPTION_"] },
            ...
            { no: 27, name: "platform_type", kind: "enum", T: () => ["PlatformType", PlatformType_1.PlatformType, "PLATFORM_TYPE_"] }
        ]);
    }
    create(value) {
