...
// @generated from protobuf file "CreateVehicleReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface CreateVehicleReq {
    ...
    pos?: Vector;
    /**
     * @generated from protobuf field: uint32 vehicle_id = 4;
     */
    vehicleId: number;
    /**
     * @generated from protobuf field: uint32 scene_point_id = 3;
     */
    scenePointId: number;
    /**
...
class CreateVehicleReq$Type extends MessageType<CreateVehicleReq> {
    ...
    internalBinaryWrite(message: CreateVehicleReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.vehicleId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.vehicleId);
