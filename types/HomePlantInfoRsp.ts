...
// @generated from protobuf file "HomePlantInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { HomePlantFieldData } from "./HomePlantFieldData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message HomePlantInfoRsp
 */
export interface HomePlantInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated HomePlantFieldData field_list = 10;
     */
...
class HomePlantInfoRsp$Type extends MessageType<HomePlantInfoRsp> {
    constructor() {
        super("HomePlantInfoRsp", [
            ...
            { no: 10, name: "field_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomePlantFieldData }
        ]);
    }
    ...
    internalBinaryWrite(message: HomePlantInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fieldList.length; i++)
            HomePlantFieldData.internalBinaryWrite(message.fieldList[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
