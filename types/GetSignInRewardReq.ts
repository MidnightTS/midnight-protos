...
// @generated from protobuf file "GetSignInRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetSignInRewardReq
 */
export interface GetSignInRewardReq {
    /**
     * @generated from protobuf field: uint32 reward_day = 4;
     */
    rewardDay: number;
    /**
...
class GetSignInRewardReq$Type extends MessageType<GetSignInRewardReq> {
    ...
    internalBinaryWrite(message: GetSignInRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rewardDay !== 0)
            writer.tag(4, WireType.Varint).uint32(message.rewardDay);
