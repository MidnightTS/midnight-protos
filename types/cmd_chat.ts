...
// @generated from protobuf file "cmd_chat.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class PullPrivateChatRsp$Type extends MessageType<PullPrivateChatRsp> {
    constructor() {
        super("com.midnights.game.PullPrivateChatRsp", [
            { no: 15, name: "chat_info", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ChatInfo },
