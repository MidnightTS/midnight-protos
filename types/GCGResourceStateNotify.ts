...
// @generated from protobuf file "GCGResourceStateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGResourceStateNotify
 */
export interface GCGResourceStateNotify {
    /**
     * @generated from protobuf field: bool is_complete = 12;
     */
    isComplete: boolean;
}
...
class GCGResourceStateNotify$Type extends MessageType<GCGResourceStateNotify> {
    ...
    internalBinaryWrite(message: GCGResourceStateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isComplete !== false)
            writer.tag(12, WireType.Varint).bool(message.isComplete);
