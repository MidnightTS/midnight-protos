...
export interface VehicleLocationInfo {
    ...
    uidList: number[];
    /**
     * @generated from protobuf field: float Unk3300_MLICEAKLOIH = 2 [json_name = "Unk3300MLICEAKLOIH"];
     */
    unk3300MLICEAKLOIH: number;
    /**
    ...
    entityId: number;
    /**
     * @generated from protobuf field: float Unk3300_MNNMOCIIEAJ = 15 [json_name = "Unk3300MNNMOCIIEAJ"];
     */
    unk3300MNNMOCIIEAJ: number;
}
...
class VehicleLocationInfo$Type extends MessageType<VehicleLocationInfo> {
    ...
    internalBinaryWrite(message: VehicleLocationInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300MLICEAKLOIH !== 0)
            writer.tag(2, WireType.Bit32).float(message.unk3300MLICEAKLOIH);
        /* Vector pos = 9; */
        if (message.pos)
        ...
        if (message.unk3300MNNMOCIIEAJ !== 0)
            writer.tag(15, WireType.Bit32).float(message.unk3300MNNMOCIIEAJ);
