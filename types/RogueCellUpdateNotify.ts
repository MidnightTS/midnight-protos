...
// @generated from protobuf file "RogueCellUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RogueCellUpdateNotify
 */
export interface RogueCellUpdateNotify {
    /**
     * @generated from protobuf field: RogueCellInfo cell_info = 5;
     */
...
class RogueCellUpdateNotify$Type extends MessageType<RogueCellUpdateNotify> {
    constructor() {
        super("RogueCellUpdateNotify", [
            { no: 5, name: "cell_info", kind: "message", T: () => RogueCellInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: RogueCellUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cellInfo)
            RogueCellInfo.internalBinaryWrite(message.cellInfo, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
