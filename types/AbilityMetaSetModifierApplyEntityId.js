...
exports.AbilityMetaSetModifierApplyEntityId = void 0;
...
class AbilityMetaSetModifierApplyEntityId$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityMetaSetModifierApplyEntityId", [
            { no: 10, name: "apply_entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 apply_entity_id */ 10:
...
/**
 * @generated MessageType for protobuf message AbilityMetaSetModifierApplyEntityId
 */
