...
// @generated from protobuf file "SceneGalleryBounceConjuringInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SceneGalleryBounceConjuringInfo
 */
export interface SceneGalleryBounceConjuringInfo {
    /**
     * @generated from protobuf field: uint32 total_score = 4;
     */
    totalScore: number;
    /**
     * @generated from protobuf field: uint32 total_destroyed_machine_count = 12;
     */
...
class SceneGalleryBounceConjuringInfo$Type extends MessageType<SceneGalleryBounceConjuringInfo> {
    ...
    internalBinaryWrite(message: SceneGalleryBounceConjuringInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.totalScore !== 0)
            writer.tag(4, WireType.Varint).uint32(message.totalScore);
        /* uint32 total_destroyed_machine_count = 12; */
        if (message.totalDestroyedMachineCount !== 0)
            writer.tag(12, WireType.Varint).uint32(message.totalDestroyedMachineCount);
