...
class TowerCurLevelRecord$Type extends runtime_5.MessageType {
    constructor() {
        super("TowerCurLevelRecord", [
            ...
            { no: 6, name: "Unk3300_KPGBPDIJJJJ", kind: "scalar", jsonName: "Unk3300KPGBPDIJJJJ", T: 13 /*ScalarType.UINT32*/ },
            ...
            { no: 9, name: "Unk3300_PMHCLPFPHBJ", kind: "scalar", jsonName: "Unk3300PMHCLPFPHBJ", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { buffIdList: [], isUpperPart: false, unk3300KPGBPDIJJJJ: 0, isEmpty: false, towerTeamList: [], unk3300PMHCLPFPHBJ: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool is_upper_part */ 4:
                    ...
                    break;
                case /* uint32 Unk3300_KPGBPDIJJJJ = 6 [json_name = "Unk3300KPGBPDIJJJJ"];*/ 6:
                    message.unk3300KPGBPDIJJJJ = reader.uint32();
                    break;
                ...
                case /* repeated TowerTeam tower_team_list */ 8:
                    ...
                    break;
                case /* uint32 Unk3300_PMHCLPFPHBJ = 9 [json_name = "Unk3300PMHCLPFPHBJ"];*/ 9:
                    message.unk3300PMHCLPFPHBJ = reader.uint32();
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 Unk3300_KPGBPDIJJJJ = 6 [json_name = "Unk3300KPGBPDIJJJJ"]; */
        if (message.unk3300KPGBPDIJJJJ !== 0)
            writer.tag(6, runtime_2.WireType.Varint).uint32(message.unk3300KPGBPDIJJJJ);
        /* bool is_empty = 1; */
        ...
        /* uint32 Unk3300_PMHCLPFPHBJ = 9 [json_name = "Unk3300PMHCLPFPHBJ"]; */
        if (message.unk3300PMHCLPFPHBJ !== 0)
            writer.tag(9, runtime_2.WireType.Varint).uint32(message.unk3300PMHCLPFPHBJ);
