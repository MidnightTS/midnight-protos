...
// @generated from protobuf file "RegionSearchNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { RegionSearchInfo } from "./RegionSearchInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message RegionSearchNotify
 */
export interface RegionSearchNotify {
    /**
     * @generated from protobuf field: repeated RegionSearchInfo region_search_list = 3;
     */
...
class RegionSearchNotify$Type extends MessageType<RegionSearchNotify> {
    constructor() {
        super("RegionSearchNotify", [
            { no: 3, name: "region_search_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RegionSearchInfo },
    ...
    internalBinaryWrite(message: RegionSearchNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.regionSearchList.length; i++)
            RegionSearchInfo.internalBinaryWrite(message.regionSearchList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* uint32 uid = 14; */
        if (message.uid !== 0)
