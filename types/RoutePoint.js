...
class RoutePoint extends pb_1.Message {
    constructor(data) {
        super();
        _RoutePoint_one_of_decls.set(this, [[11, 12], [21, 22, 23]]);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f"));
    ...
    set velocity(value) {
        pb_1.Message.setOneofField(this, 11, __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f")[0], value);
    }
    get has_velocity() {
    ...
    set time(value) {
        pb_1.Message.setOneofField(this, 12, __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f")[0], value);
    }
    get has_time() {
        return pb_1.Message.getField(this, 12) != null;
    }
    get rotation() {
        return pb_1.Message.getWrapperField(this, dependency_2.Vector, 21);
    }
    set rotation(value) {
        pb_1.Message.setOneofWrapperField(this, 21, __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f")[1], value);
    }
    get has_rotation() {
        return pb_1.Message.getField(this, 21) != null;
    }
    get rotation_speed() {
        return pb_1.Message.getWrapperField(this, dependency_1.MathQuaternion, 22);
    }
    set rotation_speed(value) {
        pb_1.Message.setOneofWrapperField(this, 22, __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f")[1], value);
    }
    get has_rotation_speed() {
        return pb_1.Message.getField(this, 22) != null;
    }
    get axis_speed() {
        return pb_1.Message.getWrapperField(this, dependency_1.MathQuaternion, 23);
    }
    set axis_speed(value) {
        pb_1.Message.setOneofWrapperField(this, 23, __classPrivateFieldGet(this, _RoutePoint_one_of_decls, "f")[1], value);
    }
    get has_axis_speed() {
...
_RoutePoint_one_of_decls = new WeakMap();
