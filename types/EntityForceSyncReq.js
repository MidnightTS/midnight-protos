...
class EntityForceSyncReq$Type extends runtime_5.MessageType {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 scene_time */ 13:
                    ...
                    break;
                case /* MotionInfo motion_info */ 10:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.motionInfo)
            MotionInfo_1.MotionInfo.internalBinaryWrite(message.motionInfo, writer.tag(10, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 5; */
...
/**
 * @generated MessageType for protobuf message EntityForceSyncReq
 */
