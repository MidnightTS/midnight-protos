...
// @generated from protobuf file "ScenePlayInfoListNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { ScenePlayInfo } from "./ScenePlayInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message ScenePlayInfoListNotify
 */
export interface ScenePlayInfoListNotify {
    /**
     * @generated from protobuf field: repeated ScenePlayInfo play_info_list = 15;
     */
...
class ScenePlayInfoListNotify$Type extends MessageType<ScenePlayInfoListNotify> {
    constructor() {
        super("ScenePlayInfoListNotify", [
            { no: 15, name: "play_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ScenePlayInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: ScenePlayInfoListNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.playInfoList.length; i++)
            ScenePlayInfo.internalBinaryWrite(message.playInfoList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
