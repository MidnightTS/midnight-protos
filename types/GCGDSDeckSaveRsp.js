...
exports.GCGDSDeckSaveRsp = void 0;
...
class GCGDSDeckSaveRsp$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isValid !== false)
            writer.tag(5, runtime_1.WireType.Varint).bool(message.isValid);
        /* uint32 deck_id = 15; */
        if (message.deckId !== 0)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.deckId);
        /* fixed32 create_time = 7; */
        if (message.createTime !== 0)
            writer.tag(7, runtime_1.WireType.Bit32).fixed32(message.createTime);
