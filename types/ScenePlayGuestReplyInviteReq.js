...
class ScenePlayGuestReplyInviteReq$Type extends runtime_5.MessageType {
    constructor() {
        super("ScenePlayGuestReplyInviteReq", [
            { no: 7, name: "is_agree", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 4, name: "play_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isAgree: false, playId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isAgree !== false)
            writer.tag(7, runtime_1.WireType.Varint).bool(message.isAgree);
        /* uint32 play_id = 4; */
        if (message.playId !== 0)
...
/**
 * @generated MessageType for protobuf message ScenePlayGuestReplyInviteReq
 */
