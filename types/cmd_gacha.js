...
class GachaUpInfo$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.itemIdList.length; i++)
            writer.tag(15, runtime_1.WireType.Varint).uint32(message.itemIdList[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GachaInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.GachaInfo", [
            ...
            { no: 1233, name: "gacha_up_info_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.GachaUpInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.displayUp4ItemList.length; i++)
            writer.tag(1875, runtime_1.WireType.Varint).uint32(message.displayUp4ItemList[i]);
        ...
        for (let i = 0; i < message.displayUp5ItemList.length; i++)
            writer.tag(2006, runtime_1.WireType.Varint).uint32(message.displayUp5ItemList[i]);
...
class GetGachaInfoRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.GetGachaInfoRsp", [
            ...
            { no: 13, name: "gacha_info_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.GachaInfo }
        ]);
    }
    create(value) {
...
class GachaItem$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.GachaItem", [
            ...
            { no: 9, name: "token_item_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => define_1.ItemParam },
            { no: 12, name: "transfer_items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.GachaTransferItem }
        ]);
    }
    create(value) {
...
class DoGachaRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("com.midnights.game.DoGachaRsp", [
            ...
            { no: 15, name: "gacha_item_list", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.GachaItem },
