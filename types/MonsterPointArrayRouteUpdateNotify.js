...
class MonsterPointArrayRouteUpdateNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MonsterPointArrayRouteUpdateNotify", [
            { no: 5, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "monster_route", kind: "message", T: () => MonsterRoute_1.MonsterRoute }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 entity_id */ 5:
                    ...
                    break;
                case /* MonsterRoute monster_route */ 11:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.monsterRoute)
            MonsterRoute_1.MonsterRoute.internalBinaryWrite(message.monsterRoute, writer.tag(11, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message MonsterPointArrayRouteUpdateNotify
 */
