...
// @generated from protobuf file "DragonSpineChapterFinishNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DragonSpineChapterFinishNotify
 */
export interface DragonSpineChapterFinishNotify {
    /**
     * @generated from protobuf field: uint32 chapter_id = 14;
     */
    chapterId: number;
    /**
     * @generated from protobuf field: uint32 weapon_enhance_level = 12;
     */
...
class DragonSpineChapterFinishNotify$Type extends MessageType<DragonSpineChapterFinishNotify> {
    ...
    internalBinaryWrite(message: DragonSpineChapterFinishNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chapterId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.chapterId);
        /* uint32 weapon_enhance_level = 12; */
        if (message.weaponEnhanceLevel !== 0)
            writer.tag(12, WireType.Varint).uint32(message.weaponEnhanceLevel);
