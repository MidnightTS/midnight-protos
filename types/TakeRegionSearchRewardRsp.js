...
class TakeRegionSearchRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("TakeRegionSearchRewardRsp", [
            { no: 8, name: "search_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 1, name: "id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { searchId: 0, retcode: 0, id: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.searchId !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.searchId);
        /* int32 retcode = 3; */
...
/**
 * @generated MessageType for protobuf message TakeRegionSearchRewardRsp
 */
