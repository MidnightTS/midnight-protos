...
// @generated from protobuf file "PlayerWorldSceneInfoListNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { PlayerWorldSceneInfo } from "./PlayerWorldSceneInfo";
/**
 * enum CmdId {
...
export interface PlayerWorldSceneInfoListNotify {
    /**
     * @generated from protobuf field: repeated PlayerWorldSceneInfo info_list = 2;
     */
...
class PlayerWorldSceneInfoListNotify$Type extends MessageType<PlayerWorldSceneInfoListNotify> {
    constructor() {
        super("PlayerWorldSceneInfoListNotify", [
            { no: 2, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PlayerWorldSceneInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerWorldSceneInfoListNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.infoList.length; i++)
            PlayerWorldSceneInfo.internalBinaryWrite(message.infoList[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
