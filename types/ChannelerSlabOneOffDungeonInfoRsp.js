...
class ChannelerSlabOneOffDungeonInfoRsp$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.ChannelerSlabOneOffDungeonInfoRsp = new ChannelerSlabOneOffDungeonInfoRsp$Type();
