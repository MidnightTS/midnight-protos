...
// @generated from protobuf file "CustomDungeonRoom.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message CustomDungeonRoom
 */
export interface CustomDungeonRoom {
    /**
     * @generated from protobuf field: uint32 room_id = 15;
     */
    roomId: number;
    /**
     * @generated from protobuf field: repeated CustomDungeonBlock block_list = 11;
     */
...
class CustomDungeonRoom$Type extends MessageType<CustomDungeonRoom> {
    constructor() {
        super("CustomDungeonRoom", [
            ...
            { no: 11, name: "block_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CustomDungeonBlock }
        ]);
    }
    ...
    internalBinaryWrite(message: CustomDungeonRoom, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.blockList.length; i++)
            CustomDungeonBlock.internalBinaryWrite(message.blockList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
