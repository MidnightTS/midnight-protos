...
export interface HomeLimitedShopInfo {
    ...
    uid: number;
    /**
     * @generated from protobuf field: fixed32 next_guest_open_time = 8;
     */
    ...
    djinnRot?: Vector;
    /**
     * @generated from protobuf field: fixed32 next_open_time = 5;
     */
    nextOpenTime: number;
    /**
    ...
    djinnPos?: Vector;
    /**
     * @generated from protobuf field: fixed32 next_close_time = 15;
     */
...
class HomeLimitedShopInfo$Type extends MessageType<HomeLimitedShopInfo> {
    ...
    internalBinaryWrite(message: HomeLimitedShopInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.nextGuestOpenTime !== 0)
            writer.tag(8, WireType.Bit32).fixed32(message.nextGuestOpenTime);
        /* Vector djinn_rot = 11; */
        if (message.djinnRot)
        ...
        if (message.nextOpenTime !== 0)
            writer.tag(5, WireType.Bit32).fixed32(message.nextOpenTime);
        /* Vector djinn_pos = 2; */
        if (message.djinnPos)
        ...
        if (message.nextCloseTime !== 0)
            writer.tag(15, WireType.Bit32).fixed32(message.nextCloseTime);
