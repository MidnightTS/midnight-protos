...
class GachaUpInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("GachaUpInfo", [
            { no: 15, name: "item_parent_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "item_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 item_parent_type */ 15:
                    message.itemParentType = reader.uint32();
                    break;
                case /* repeated uint32 item_id_list */ 6:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.itemParentType !== 0)
            writer.tag(15, runtime_2.WireType.Varint).uint32(message.itemParentType);
