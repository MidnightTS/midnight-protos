...
// @generated from protobuf file "BattlePassRewardTakeOption.proto" (syntax proto3)
// tslint:disable
//
...
export interface BattlePassRewardTakeOption {
    ...
    optionIdx: number;
    /**
     * @generated from protobuf field: BattlePassRewardTag tag = 15;
     */
...
class BattlePassRewardTakeOption$Type extends MessageType<BattlePassRewardTakeOption> {
    constructor() {
        super("BattlePassRewardTakeOption", [
            ...
            { no: 15, name: "tag", kind: "message", T: () => BattlePassRewardTag }
        ]);
    }
    ...
    internalBinaryWrite(message: BattlePassRewardTakeOption, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.tag)
            BattlePassRewardTag.internalBinaryWrite(message.tag, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
