...
// @generated from protobuf file "cmd_npc.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class GetSceneNpcPositionRsp$Type extends MessageType<GetSceneNpcPositionRsp> {
    constructor() {
        super("com.midnights.game.GetSceneNpcPositionRsp", [
            ...
            { no: 14, name: "npc_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => NpcPositionInfo },
