...
export interface HomeMarkPointSceneData {
    /**
     * @generated from protobuf field: Vector Unk3300_ONJJJEPFKJI = 9 [json_name = "Unk3300ONJJJEPFKJI"];
     */
    unk3300ONJJJEPFKJI?: Vector;
    /**
     * @generated from protobuf field: uint32 scene_id = 6;
     */
    sceneId: number;
    /**
     * @generated from protobuf field: Vector Unk3300_HFNOINGPMJP = 11 [json_name = "Unk3300HFNOINGPMJP"];
     */
    unk3300HFNOINGPMJP?: Vector;
    /**
...
class HomeMarkPointSceneData$Type extends MessageType<HomeMarkPointSceneData> {
    constructor() {
        super("HomeMarkPointSceneData", [
            { no: 9, name: "Unk3300_ONJJJEPFKJI", kind: "message", jsonName: "Unk3300ONJJJEPFKJI", T: () => Vector },
            { no: 6, name: "scene_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "Unk3300_HFNOINGPMJP", kind: "message", jsonName: "Unk3300HFNOINGPMJP", T: () => Vector },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* Vector Unk3300_ONJJJEPFKJI = 9 [json_name = "Unk3300ONJJJEPFKJI"];*/ 9:
                    message.unk3300ONJJJEPFKJI = Vector.internalBinaryRead(reader, reader.uint32(), options, message.unk3300ONJJJEPFKJI);
                    break;
                case /* uint32 scene_id */ 6:
                    message.sceneId = reader.uint32();
                    break;
                case /* Vector Unk3300_HFNOINGPMJP = 11 [json_name = "Unk3300HFNOINGPMJP"];*/ 11:
                    message.unk3300HFNOINGPMJP = Vector.internalBinaryRead(reader, reader.uint32(), options, message.unk3300HFNOINGPMJP);
                    break;
    ...
    internalBinaryWrite(message: HomeMarkPointSceneData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300ONJJJEPFKJI)
            Vector.internalBinaryWrite(message.unk3300ONJJJEPFKJI, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* uint32 scene_id = 6; */
        ...
        if (message.unk3300HFNOINGPMJP)
            Vector.internalBinaryWrite(message.unk3300HFNOINGPMJP, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* uint32 module_id = 8; */
