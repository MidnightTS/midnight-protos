...
class GadgetPlayDataNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GadgetPlayDataNotify", [
            { no: 13, name: "entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "progress", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "play_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { entityId: 0, progress: 0, playType: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.progress !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.progress);
        /* uint32 play_type = 11; */
...
/**
 * @generated MessageType for protobuf message GadgetPlayDataNotify
 */
