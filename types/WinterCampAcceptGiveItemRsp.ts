...
// @generated from protobuf file "WinterCampAcceptGiveItemRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message WinterCampAcceptGiveItemRsp
 */
export interface WinterCampAcceptGiveItemRsp {
    /**
     * @generated from protobuf field: WinterCampAcceptItemResultInfo accept_item_result_info = 15;
     */
...
class WinterCampAcceptGiveItemRsp$Type extends MessageType<WinterCampAcceptGiveItemRsp> {
    constructor() {
        super("WinterCampAcceptGiveItemRsp", [
            { no: 15, name: "accept_item_result_info", kind: "message", T: () => WinterCampAcceptItemResultInfo },
    ...
    internalBinaryWrite(message: WinterCampAcceptGiveItemRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.acceptItemResultInfo)
            WinterCampAcceptItemResultInfo.internalBinaryWrite(message.acceptItemResultInfo, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 6; */
