...
export interface FurnitureMakeData {
    ...
    index: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_GDIBLADMJIC = 8 [json_name = "Unk3300GDIBLADMJIC"];
     */
    unk3300GDIBLADMJIC: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_GBDHFLEFJLG = 7 [json_name = "Unk3300GBDHFLEFJLG"];
     */
    unk3300GBDHFLEFJLG: number;
}
...
class FurnitureMakeData$Type extends MessageType<FurnitureMakeData> {
    ...
    internalBinaryWrite(message: FurnitureMakeData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300GDIBLADMJIC !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300GDIBLADMJIC);
        /* uint32 Unk3300_GBDHFLEFJLG = 7 [json_name = "Unk3300GBDHFLEFJLG"]; */
        if (message.unk3300GBDHFLEFJLG !== 0)
            writer.tag(7, WireType.Varint).uint32(message.unk3300GBDHFLEFJLG);
