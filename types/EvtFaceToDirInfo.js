...
class EvtFaceToDirInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("EvtFaceToDirInfo", [
            { no: 2, name: "face_dir", kind: "message", T: () => Vector_1.Vector },
    ...
    internalBinaryWrite(message, writer, options) {
        /* Vector face_dir = 2; */
        if (message.faceDir)
            Vector_1.Vector.internalBinaryWrite(message.faceDir, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 5; */
