...
class MpPlayPrepareInterruptNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MpPlayPrepareInterruptNotify", [
            { no: 1, name: "mp_play_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { mpPlayId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.mpPlayId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.mpPlayId);
...
/**
 * @generated MessageType for protobuf message MpPlayPrepareInterruptNotify
 */
