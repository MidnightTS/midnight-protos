...
exports.ChooseCurAvatarTeamRsp = void 0;
...
class ChooseCurAvatarTeamRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("ChooseCurAvatarTeamRsp", [
            ...
            { no: 11, name: "cur_team_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.curTeamId !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.curTeamId);
