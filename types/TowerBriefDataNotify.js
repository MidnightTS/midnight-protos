...
class TowerBriefDataNotify$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.lastLevelIndex !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.lastLevelIndex);
        /* uint32 next_schedule_change_time = 9; */
        if (message.nextScheduleChangeTime !== 0)
            writer.tag(9, runtime_1.WireType.Varint).uint32(message.nextScheduleChangeTime);
        ...
        if (message.lastFloorIndex !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.lastFloorIndex);
        ...
        if (message.scheduleStartTime !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.scheduleStartTime);
        /* uint32 total_star_num = 7; */
        if (message.totalStarNum !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.totalStarNum);
