...
// @generated from protobuf file "VintageMarketTraderInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message VintageMarketTraderInfo
 */
export interface VintageMarketTraderInfo {
    /**
     * @generated from protobuf field: uint32 trader_id = 4;
     */
    traderId: number;
    /**
     * @generated from protobuf field: repeated ItemParam available_item_list = 15;
     */
...
class VintageMarketTraderInfo$Type extends MessageType<VintageMarketTraderInfo> {
    constructor() {
        super("VintageMarketTraderInfo", [
            ...
            { no: 15, name: "available_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam }
        ]);
    }
    ...
    internalBinaryWrite(message: VintageMarketTraderInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.traderId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.traderId);
        /* repeated ItemParam available_item_list = 15; */
        for (let i = 0; i < message.availableItemList.length; i++)
            ItemParam.internalBinaryWrite(message.availableItemList[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
