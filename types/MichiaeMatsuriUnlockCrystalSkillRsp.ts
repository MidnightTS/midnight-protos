...
// @generated from protobuf file "MichiaeMatsuriUnlockCrystalSkillRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MichiaeMatsuriUnlockCrystalSkillRsp
 */
export interface MichiaeMatsuriUnlockCrystalSkillRsp {
    /**
     * @generated from protobuf field: uint32 crystal_skill_id = 8;
     */
...
class MichiaeMatsuriUnlockCrystalSkillRsp$Type extends MessageType<MichiaeMatsuriUnlockCrystalSkillRsp> {
    ...
    internalBinaryWrite(message: MichiaeMatsuriUnlockCrystalSkillRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.crystalSkillId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.crystalSkillId);
        /* int32 retcode = 10; */
