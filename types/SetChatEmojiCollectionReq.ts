...
// @generated from protobuf file "SetChatEmojiCollectionReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SetChatEmojiCollectionReq
 */
export interface SetChatEmojiCollectionReq {
    /**
     * @generated from protobuf field: ChatEmojiCollectionData chat_emoji_collection_data = 13;
     */
...
class SetChatEmojiCollectionReq$Type extends MessageType<SetChatEmojiCollectionReq> {
    constructor() {
        super("SetChatEmojiCollectionReq", [
            { no: 13, name: "chat_emoji_collection_data", kind: "message", T: () => ChatEmojiCollectionData }
        ]);
    }
    ...
    internalBinaryWrite(message: SetChatEmojiCollectionReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chatEmojiCollectionData)
            ChatEmojiCollectionData.internalBinaryWrite(message.chatEmojiCollectionData, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
