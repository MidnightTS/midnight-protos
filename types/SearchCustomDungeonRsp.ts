...
// @generated from protobuf file "SearchCustomDungeonRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SearchCustomDungeonRsp
 */
export interface SearchCustomDungeonRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: OtherCustomDungeonBrief custom_dungeon_brief = 8;
     */
...
class SearchCustomDungeonRsp$Type extends MessageType<SearchCustomDungeonRsp> {
    constructor() {
        super("SearchCustomDungeonRsp", [
            ...
            { no: 8, name: "custom_dungeon_brief", kind: "message", T: () => OtherCustomDungeonBrief }
        ]);
    }
    ...
    internalBinaryWrite(message: SearchCustomDungeonRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customDungeonBrief)
            OtherCustomDungeonBrief.internalBinaryWrite(message.customDungeonBrief, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
