...
class HomeEditCustomFurnitureRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeEditCustomFurnitureRsp", [
            { no: 1, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "custom_furniture_info", kind: "message", T: () => HomeCustomFurnitureInfo_1.HomeCustomFurnitureInfo }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 1:
                    ...
                    break;
                case /* HomeCustomFurnitureInfo custom_furniture_info */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customFurnitureInfo)
            HomeCustomFurnitureInfo_1.HomeCustomFurnitureInfo.internalBinaryWrite(message.customFurnitureInfo, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message HomeEditCustomFurnitureRsp
 */
