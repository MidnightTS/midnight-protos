...
// @generated from protobuf file "TakeMaterialDeleteReturnReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message TakeMaterialDeleteReturnReq
 */
export interface TakeMaterialDeleteReturnReq {
    /**
     * @generated from protobuf field: MaterialDeleteReturnType type = 11;
     */
...
class TakeMaterialDeleteReturnReq$Type extends MessageType<TakeMaterialDeleteReturnReq> {
    constructor() {
        super("TakeMaterialDeleteReturnReq", [
            { no: 11, name: "type", kind: "enum", T: () => ["MaterialDeleteReturnType", MaterialDeleteReturnType, "MATERIAL_DELETE_RETURN_TYPE_"] }
        ]);
    }
