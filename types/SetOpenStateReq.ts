...
// @generated from protobuf file "SetOpenStateReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SetOpenStateReq
 */
export interface SetOpenStateReq {
    /**
     * @generated from protobuf field: uint32 key = 10;
     */
    key: number;
    /**
     * @generated from protobuf field: uint32 value = 12;
     */
    value: number;
}
...
class SetOpenStateReq$Type extends MessageType<SetOpenStateReq> {
    ...
    internalBinaryWrite(message: SetOpenStateReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 key = 10; */
        if (message.key !== 0)
            writer.tag(10, WireType.Varint).uint32(message.key);
        /* uint32 value = 12; */
        if (message.value !== 0)
            writer.tag(12, WireType.Varint).uint32(message.value);
