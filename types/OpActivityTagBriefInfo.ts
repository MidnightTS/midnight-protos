...
// @generated from protobuf file "OpActivityTagBriefInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message OpActivityTagBriefInfo
 */
export interface OpActivityTagBriefInfo {
    /**
     * @generated from protobuf field: bool has_reward = 14;
     */
    hasReward: boolean;
    /**
     * @generated from protobuf field: uint32 op_activity_type = 2;
     */
...
class OpActivityTagBriefInfo$Type extends MessageType<OpActivityTagBriefInfo> {
    ...
    internalBinaryWrite(message: OpActivityTagBriefInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hasReward !== false)
            writer.tag(14, WireType.Varint).bool(message.hasReward);
        /* uint32 op_activity_type = 2; */
        if (message.opActivityType !== 0)
            writer.tag(2, WireType.Varint).uint32(message.opActivityType);
        /* uint32 config_id = 13; */
