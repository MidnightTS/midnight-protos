...
// @generated from protobuf file "PlayerSignatureAuditDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { ContentAuditInfo } from "./ContentAuditInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message PlayerSignatureAuditDataNotify
 */
export interface PlayerSignatureAuditDataNotify {
    /**
     * @generated from protobuf field: ContentAuditInfo info = 11;
     */
...
class PlayerSignatureAuditDataNotify$Type extends MessageType<PlayerSignatureAuditDataNotify> {
    constructor() {
        super("PlayerSignatureAuditDataNotify", [
            { no: 11, name: "info", kind: "message", T: () => ContentAuditInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerSignatureAuditDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.info)
            ContentAuditInfo.internalBinaryWrite(message.info, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
