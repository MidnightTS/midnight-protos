...
// @generated from protobuf file "GachaActivityTakeRewardReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GachaActivityTakeRewardReq
 */
export interface GachaActivityTakeRewardReq {
    /**
     * @generated from protobuf field: map<uint32, uint32> robot_num_map = 7;
     */
    robotNumMap: {
        [key: number]: number;
    };
...
class GachaActivityTakeRewardReq$Type extends MessageType<GachaActivityTakeRewardReq> {
    ...
    private binaryReadMap7(map: GachaActivityTakeRewardReq["robotNumMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: GachaActivityTakeRewardReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.robotNumMap))
            writer.tag(7, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.robotNumMap[k as any]).join();
