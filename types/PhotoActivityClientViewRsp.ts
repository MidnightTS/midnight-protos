...
// @generated from protobuf file "PhotoActivityClientViewRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PhotoActivityClientViewRsp
 */
export interface PhotoActivityClientViewRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 pos_id = 2;
     */
    posId: number;
}
...
class PhotoActivityClientViewRsp$Type extends MessageType<PhotoActivityClientViewRsp> {
    ...
    internalBinaryWrite(message: PhotoActivityClientViewRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 pos_id = 2; */
        if (message.posId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.posId);
