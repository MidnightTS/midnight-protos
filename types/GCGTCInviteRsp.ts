...
// @generated from protobuf file "GCGTCInviteRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGTCInviteRsp
 */
export interface GCGTCInviteRsp {
    /**
     * @generated from protobuf field: uint32 character_id = 9;
     */
    characterId: number;
    /**
...
class GCGTCInviteRsp$Type extends MessageType<GCGTCInviteRsp> {
    ...
    internalBinaryWrite(message: GCGTCInviteRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.characterId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.characterId);
        /* int32 retcode = 11; */
