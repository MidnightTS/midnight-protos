...
// @generated from protobuf file "VintageMarketDeliverItemRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintageMarketDeliverItemRsp
 */
export interface VintageMarketDeliverItemRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 trader_id = 6;
     */
    traderId: number;
}
...
class VintageMarketDeliverItemRsp$Type extends MessageType<VintageMarketDeliverItemRsp> {
    ...
    internalBinaryWrite(message: VintageMarketDeliverItemRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.traderId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.traderId);
