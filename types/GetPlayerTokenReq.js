...
class GetPlayerTokenReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GetPlayerTokenReq", [
            ...
            { no: 1735, name: "Unk3300_DILMOPPLPEM", kind: "scalar", jsonName: "Unk3300DILMOPPLPEM", T: 13 /*ScalarType.UINT32*/ },
            ...
            { no: 7, name: "Unk3300_IADFJHNFKIB", kind: "scalar", jsonName: "Unk3300IADFJHNFKIB", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { uid: 0, unk3300DILMOPPLPEM: 0, platformType: 0, isGuest: false, onlineId: "", accountType: 0, channelId: 0, clientRandKey: "", unk3300PHNOHCKIHIA: "", lang: 0, unk3300PKONAOIDNFK: "", unk3300PMGFBMJNNCL: 0, psnId: "", keyId: 0, accountUid: "", clientIpStr: "", accountToken: "", countryCode: "", birthday: "", unk3300IADFJHNFKIB: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 uid */ 10:
                    ...
                    break;
                case /* uint32 Unk3300_DILMOPPLPEM = 1735 [json_name = "Unk3300DILMOPPLPEM"];*/ 1735:
                ...
                case /* string birthday */ 292:
                    ...
                    break;
                case /* uint32 Unk3300_IADFJHNFKIB = 7 [json_name = "Unk3300IADFJHNFKIB"];*/ 7:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 Unk3300_DILMOPPLPEM = 1735 [json_name = "Unk3300DILMOPPLPEM"]; */
        if (message.unk3300DILMOPPLPEM !== 0)
            writer.tag(1735, runtime_1.WireType.Varint).uint32(message.unk3300DILMOPPLPEM);
        ...
        /* uint32 Unk3300_IADFJHNFKIB = 7 [json_name = "Unk3300IADFJHNFKIB"]; */
        if (message.unk3300IADFJHNFKIB !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.unk3300IADFJHNFKIB);
