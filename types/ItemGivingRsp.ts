...
// @generated from protobuf file "ItemGivingRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface ItemGivingRsp {
    /**
     * @generated from protobuf field: uint32 giving_group_id = 15;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 giving_id = 12;
     */
    givingId: number;
}
...
class ItemGivingRsp$Type extends MessageType<ItemGivingRsp> {
    ...
    internalBinaryWrite(message: ItemGivingRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.givingGroupId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.givingGroupId);
        /* int32 retcode = 5; */
        if (message.retcode !== 0)
            writer.tag(5, WireType.Varint).int32(message.retcode);
        /* uint32 giving_id = 12; */
        if (message.givingId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.givingId);
