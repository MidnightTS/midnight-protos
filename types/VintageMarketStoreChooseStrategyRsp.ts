...
// @generated from protobuf file "VintageMarketStoreChooseStrategyRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message VintageMarketStoreChooseStrategyRsp
 */
export interface VintageMarketStoreChooseStrategyRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 store_id = 11;
     */
    storeId: number;
    /**
...
class VintageMarketStoreChooseStrategyRsp$Type extends MessageType<VintageMarketStoreChooseStrategyRsp> {
    ...
    internalBinaryWrite(message: VintageMarketStoreChooseStrategyRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.storeId !== 0)
            writer.tag(11, WireType.Varint).uint32(message.storeId);
