...
class PlayerMatchInfoNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerMatchInfoNotify", [
            ...
            { no: 5, name: "match_begin_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "estimate_match_cost_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { dungeonId: 0, matchBeginTime: 0, estimateMatchCostTime: 0, hostUid: 0, matchType: 0, mechanicusDifficultLevel: 0, mpPlayId: 0, matchId: 0, matchParamList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 dungeon_id */ 4:
                    ...
                    break;
                case /* uint32 match_begin_time */ 5:
                    message.matchBeginTime = reader.uint32();
                    break;
                case /* uint32 estimate_match_cost_time */ 10:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.matchBeginTime !== 0)
            writer.tag(5, runtime_2.WireType.Varint).uint32(message.matchBeginTime);
        /* uint32 estimate_match_cost_time = 10; */
        if (message.estimateMatchCostTime !== 0)
            writer.tag(10, runtime_2.WireType.Varint).uint32(message.estimateMatchCostTime);
        /* uint32 host_uid = 12; */
