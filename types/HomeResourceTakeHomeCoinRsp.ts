...
// @generated from protobuf file "HomeResourceTakeHomeCoinRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeResourceTakeHomeCoinRsp
 */
export interface HomeResourceTakeHomeCoinRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: HomeResource home_coin = 12;
     */
...
class HomeResourceTakeHomeCoinRsp$Type extends MessageType<HomeResourceTakeHomeCoinRsp> {
    constructor() {
        super("HomeResourceTakeHomeCoinRsp", [
            ...
            { no: 12, name: "home_coin", kind: "message", T: () => HomeResource }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeResourceTakeHomeCoinRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.homeCoin)
            HomeResource.internalBinaryWrite(message.homeCoin, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
