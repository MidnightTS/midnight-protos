...
// @generated from protobuf file "FinishedParentQuestNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface FinishedParentQuestNotify {
    /**
     * @generated from protobuf field: repeated ParentQuest parent_quest_list = 13;
     */
...
class FinishedParentQuestNotify$Type extends MessageType<FinishedParentQuestNotify> {
    constructor() {
        super("FinishedParentQuestNotify", [
            { no: 13, name: "parent_quest_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ParentQuest }
        ]);
    }
    ...
    internalBinaryWrite(message: FinishedParentQuestNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.parentQuestList.length; i++)
            ParentQuest.internalBinaryWrite(message.parentQuestList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
