...
var _GachaActivityDetailInfo_one_of_decls;
...
const dependency_1 = require("./GachaStage");
const pb_1 = require("google-protobuf");
class GachaActivityDetailInfo extends pb_1.Message {
    constructor(data) {
        super();
        _GachaActivityDetailInfo_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [6, 4], __classPrivateFieldGet(this, _GachaActivityDetailInfo_one_of_decls, "f"));
    ...
    set Unk2700_PIDHKNLDALB(value) {
        pb_1.Message.setField(this, 6, value);
    }
    get gacha_stage_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.GachaStage, 4);
    }
    set gacha_stage_list(value) {
        pb_1.Message.setRepeatedWrapperField(this, 4, value);
    }
    get Unk2700_KOHKBCABICD() {
        return pb_1.Message.getField(this, 8);
    }
    set Unk2700_KOHKBCABICD(value) {
        pb_1.Message.setField(this, 8, value);
    }
    get Unk2700_CDPAPBIOPCA() {
        return pb_1.Message.getFieldWithDefault(this, 3, 0);
    }
    set Unk2700_CDPAPBIOPCA(value) {
        pb_1.Message.setField(this, 3, value);
    }
    get Unk2700_DACHHINLDDJ() {
        return pb_1.Message.getField(this, 5);
    }
    set Unk2700_DACHHINLDDJ(value) {
        pb_1.Message.setField(this, 5, value);
    }
    get Unk2700_FGFGLDIJJEK() {
        return pb_1.Message.getFieldWithDefault(this, 12, 0);
    }
    set Unk2700_FGFGLDIJJEK(value) {
    ...
    toObject() {
        ...
        if (this.gacha_stage_list != null) {
            data.gacha_stage_list = this.gacha_stage_list.map((item) => item.toObject());
        }
    ...
    serialize(w) {
        ...
        if (this.gacha_stage_list.length)
            writer.writeRepeatedMessage(4, this.gacha_stage_list, (item) => item.serialize(writer));
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 4:
                    ...
                    break;
                case 8:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.Unk2700_KOHKBCABICD, reader, reader.readUint32, reader.readUint32));
                    break;
                case 3:
                    message.Unk2700_CDPAPBIOPCA = reader.readUint32();
                    break;
                case 5:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.Unk2700_DACHHINLDDJ, reader, reader.readUint32, reader.readUint32));
                    break;
                case 12:
...
exports.GachaActivityDetailInfo = GachaActivityDetailInfo;
_GachaActivityDetailInfo_one_of_decls = new WeakMap();
