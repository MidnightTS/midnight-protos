...
// @generated from protobuf file "HomeScenePointFishFarmingInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeScenePointFishFarmingInfoNotify
 */
export interface HomeScenePointFishFarmingInfoNotify {
    /**
     * @generated from protobuf field: repeated HomeScenePointFishFarmingInfo fish_farming_info_list = 13;
     */
...
class HomeScenePointFishFarmingInfoNotify$Type extends MessageType<HomeScenePointFishFarmingInfoNotify> {
    constructor() {
        super("HomeScenePointFishFarmingInfoNotify", [
            { no: 13, name: "fish_farming_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomeScenePointFishFarmingInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeScenePointFishFarmingInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fishFarmingInfoList.length; i++)
            HomeScenePointFishFarmingInfo.internalBinaryWrite(message.fishFarmingInfoList[i], writer.tag(13, WireType.LengthDelimited).fork(), options).join();
