...
// @generated from protobuf file "NpcTalkStateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message NpcTalkStateNotify
 */
export interface NpcTalkStateNotify {
    /**
     * @generated from protobuf field: bool is_ban = 2;
     */
    isBan: boolean;
}
...
class NpcTalkStateNotify$Type extends MessageType<NpcTalkStateNotify> {
    ...
    internalBinaryWrite(message: NpcTalkStateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isBan !== false)
            writer.tag(2, WireType.Varint).bool(message.isBan);
