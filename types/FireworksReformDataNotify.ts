...
// @generated from protobuf file "FireworksReformDataNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { FireworksReformData } from "./FireworksReformData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message FireworksReformDataNotify
 */
export interface FireworksReformDataNotify {
    /**
     * @generated from protobuf field: repeated FireworksReformData fireworks_reform_data_list = 9;
     */
...
class FireworksReformDataNotify$Type extends MessageType<FireworksReformDataNotify> {
    constructor() {
        super("FireworksReformDataNotify", [
            { no: 9, name: "fireworks_reform_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FireworksReformData }
        ]);
    }
    ...
    internalBinaryWrite(message: FireworksReformDataNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fireworksReformDataList.length; i++)
            FireworksReformData.internalBinaryWrite(message.fireworksReformDataList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
