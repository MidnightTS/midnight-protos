...
class PlayerCookRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerCookRsp", [
            ...
            { no: 1, name: "Unk3300_NDPHNNOFEBL", kind: "scalar", jsonName: "Unk3300NDPHNNOFEBL", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "extra_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam_1.ItemParam },
            { no: 11, name: "Unk3300_JPICLIDLIEC", kind: "scalar", jsonName: "Unk3300JPICLIDLIEC", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, itemList: [], unk3300NDPHNNOFEBL: 0, extraItemList: [], unk3300JPICLIDLIEC: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated ItemParam item_list */ 5:
                    ...
                    break;
                case /* uint32 Unk3300_NDPHNNOFEBL = 1 [json_name = "Unk3300NDPHNNOFEBL"];*/ 1:
                ...
                case /* repeated ItemParam extra_item_list */ 3:
                    ...
                    break;
                case /* uint32 Unk3300_JPICLIDLIEC = 11 [json_name = "Unk3300JPICLIDLIEC"];*/ 11:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 Unk3300_NDPHNNOFEBL = 1 [json_name = "Unk3300NDPHNNOFEBL"]; */
        if (message.unk3300NDPHNNOFEBL !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.unk3300NDPHNNOFEBL);
        ...
        /* uint32 Unk3300_JPICLIDLIEC = 11 [json_name = "Unk3300JPICLIDLIEC"]; */
        if (message.unk3300JPICLIDLIEC !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.unk3300JPICLIDLIEC);
