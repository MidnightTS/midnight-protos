...
// @generated from protobuf file "PlayerApplyEnterHomeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerApplyEnterHomeNotify
 */
export interface PlayerApplyEnterHomeNotify {
    /**
     * @generated from protobuf field: uint32 src_app_id = 8;
     */
    srcAppId: number;
    /**
     * @generated from protobuf field: OnlinePlayerInfo src_player_info = 10;
     */
...
class PlayerApplyEnterHomeNotify$Type extends MessageType<PlayerApplyEnterHomeNotify> {
    constructor() {
        super("PlayerApplyEnterHomeNotify", [
            ...
            { no: 10, name: "src_player_info", kind: "message", T: () => OnlinePlayerInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: PlayerApplyEnterHomeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.srcAppId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.srcAppId);
        /* OnlinePlayerInfo src_player_info = 10; */
        if (message.srcPlayerInfo)
            OnlinePlayerInfo.internalBinaryWrite(message.srcPlayerInfo, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
