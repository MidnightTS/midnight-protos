...
import * as dependency_1 from "./MailItem";
import * as dependency_2 from "./MailTextContent";
import * as dependency_3 from "./Unk2700_CBJEDMGOBPL";
import * as pb_1 from "google-protobuf";
export class MailData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        mail_id?: number;
        mail_text_content?: dependency_2.MailTextContent;
        item_list?: dependency_1.MailItem[];
        send_time?: number;
        expire_time?: number;
        importance?: number;
        is_read?: boolean;
        ...
        Unk2700_NDPPGJKJOMH?: dependency_3.Unk2700_CBJEDMGOBPL;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [7, 14], this.#one_of_decls);
    ...
    set mail_id(value: number) {
        pb_1.Message.setField(this, 1, value);
    }
    get mail_text_content() {
        return pb_1.Message.getWrapperField(this, dependency_2.MailTextContent, 4) as dependency_2.MailTextContent;
    }
    set mail_text_content(value: dependency_2.MailTextContent) {
    ...
    get item_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.MailItem, 7) as dependency_1.MailItem[];
    }
    set item_list(value: dependency_1.MailItem[]) {
        pb_1.Message.setRepeatedWrapperField(this, 7, value);
    }
    get send_time() {
        return pb_1.Message.getFieldWithDefault(this, 8, 0) as number;
    }
    set send_time(value: number) {
    ...
    set is_attachment_got(value: boolean) {
    ...
    set argument_list(value: string[]) {
        pb_1.Message.setField(this, 14, value);
    }
    get Unk2700_NDPPGJKJOMH() {
        return pb_1.Message.getFieldWithDefault(this, 15, dependency_3.Unk2700_CBJEDMGOBPL.Unk2700_CBJEDMGOBPL_Unk2700_MBLDLJOKLBL) as dependency_3.Unk2700_CBJEDMGOBPL;
    }
    set Unk2700_NDPPGJKJOMH(value: dependency_3.Unk2700_CBJEDMGOBPL) {
        pb_1.Message.setField(this, 15, value);
    }
    static fromObject(data: {
        mail_id?: number;
        mail_text_content?: ReturnType<typeof dependency_2.MailTextContent.prototype.toObject>;
        item_list?: ReturnType<typeof dependency_1.MailItem.prototype.toObject>[];
        send_time?: number;
        expire_time?: number;
        importance?: number;
        is_read?: boolean;
    ...
    toObject() {
        ...
        if (this.item_list != null) {
            data.item_list = this.item_list.map((item: dependency_1.MailItem) => item.toObject());
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.item_list.length)
            writer.writeRepeatedMessage(7, this.item_list, (item: dependency_1.MailItem) => item.serialize(writer));
        if (this.send_time != 0)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MailData {
    ...
    static deserializeBinary(bytes: Uint8Array): MailData {
