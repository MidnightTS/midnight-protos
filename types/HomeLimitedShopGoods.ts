...
export interface HomeLimitedShopGoods {
    ...
    buyLimit: number;
    /**
     * @generated from protobuf field: uint32 disable_type = 10;
     */
    disableType: number;
    /**
     * @generated from protobuf field: uint32 goods_id = 12;
     */
    goodsId: number;
    /**
...
class HomeLimitedShopGoods$Type extends MessageType<HomeLimitedShopGoods> {
    ...
    internalBinaryWrite(message: HomeLimitedShopGoods, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.disableType !== 0)
            writer.tag(10, WireType.Varint).uint32(message.disableType);
        /* uint32 goods_id = 12; */
        if (message.goodsId !== 0)
            writer.tag(12, WireType.Varint).uint32(message.goodsId);
        /* uint32 bought_num = 5; */
