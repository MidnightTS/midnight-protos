...
// @generated from protobuf file "PersistentDungeonSwitchAvatarReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PersistentDungeonSwitchAvatarReq
 */
export interface PersistentDungeonSwitchAvatarReq {
    /**
     * @generated from protobuf field: uint64 cur_avatar_guid = 14;
     */
    curAvatarGuid: bigint;
    /**
     * @generated from protobuf field: repeated uint64 avatar_team_guid_list = 2;
     */
...
class PersistentDungeonSwitchAvatarReq$Type extends MessageType<PersistentDungeonSwitchAvatarReq> {
    ...
    internalBinaryWrite(message: PersistentDungeonSwitchAvatarReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curAvatarGuid !== 0n)
            writer.tag(14, WireType.Varint).uint64(message.curAvatarGuid);
