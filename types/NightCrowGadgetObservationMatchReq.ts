...
// @generated from protobuf file "NightCrowGadgetObservationMatchReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message NightCrowGadgetObservationMatchReq
 */
export interface NightCrowGadgetObservationMatchReq {
    ...
    /**
     * @generated from protobuf field: uint32 target_gadget_state = 1;
     */
...
class NightCrowGadgetObservationMatchReq$Type extends MessageType<NightCrowGadgetObservationMatchReq> {
    ...
    internalBinaryWrite(message: NightCrowGadgetObservationMatchReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetGadgetState !== 0)
            writer.tag(1, WireType.Varint).uint32(message.targetGadgetState);
