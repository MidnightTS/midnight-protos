...
// @generated from protobuf file "FurnitureMakeCancelReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FurnitureMakeCancelReq
 */
export interface FurnitureMakeCancelReq {
    /**
     * @generated from protobuf field: uint32 make_id = 14;
     */
    makeId: number;
    /**
...
class FurnitureMakeCancelReq$Type extends MessageType<FurnitureMakeCancelReq> {
    ...
    internalBinaryWrite(message: FurnitureMakeCancelReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 make_id = 14; */
        if (message.makeId !== 0)
            writer.tag(14, WireType.Varint).uint32(message.makeId);
        /* uint32 index = 4; */
        if (message.index !== 0)
