...
class EvtBulletMoveNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("EvtBulletMoveNotify", [
            ...
            { no: 4, name: "cur_pos", kind: "message", T: () => Vector_1.Vector },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Vector cur_pos = 4; */
        if (message.curPos)
            Vector_1.Vector.internalBinaryWrite(message.curPos, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 13; */
