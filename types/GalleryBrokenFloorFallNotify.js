...
class GalleryBrokenFloorFallNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GalleryBrokenFloorFallNotify", [
            { no: 10, name: "fall_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 7, name: "gallery_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { fallCount: 0, galleryId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.fallCount !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.fallCount);
        /* uint32 gallery_id = 7; */
...
/**
 * @generated MessageType for protobuf message GalleryBrokenFloorFallNotify
 */
