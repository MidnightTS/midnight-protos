...
// @generated from protobuf file "IrodoriFillPoetryRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriFillPoetryRsp
 */
export interface IrodoriFillPoetryRsp {
    /**
     * @generated from protobuf field: IrodoriPoetryThemeData theme_data = 8;
     */
...
class IrodoriFillPoetryRsp$Type extends MessageType<IrodoriFillPoetryRsp> {
    constructor() {
        super("IrodoriFillPoetryRsp", [
            { no: 8, name: "theme_data", kind: "message", T: () => IrodoriPoetryThemeData },
    ...
    internalBinaryWrite(message: IrodoriFillPoetryRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.themeData)
            IrodoriPoetryThemeData.internalBinaryWrite(message.themeData, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 2; */
