...
// @generated from protobuf file "IrodoriChessPlayerInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message IrodoriChessPlayerInfo
 */
export interface IrodoriChessPlayerInfo {
    /**
     * @generated from protobuf field: uint32 settle_score = 11;
     */
    settleScore: number;
    /**
...
class IrodoriChessPlayerInfo$Type extends MessageType<IrodoriChessPlayerInfo> {
    ...
    internalBinaryWrite(message: IrodoriChessPlayerInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.settleScore !== 0)
            writer.tag(11, WireType.Varint).uint32(message.settleScore);
        /* uint32 uid = 10; */
        if (message.uid !== 0)
