...
exports.AbilityActionCreateTile = void 0;
...
class AbilityActionCreateTile$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityActionCreateTile", [
            { no: 15, name: "pos", kind: "message", T: () => Vector_1.Vector },
    ...
    internalBinaryWrite(message, writer, options) {
        /* Vector pos = 15; */
        if (message.pos)
            Vector_1.Vector.internalBinaryWrite(message.pos, writer.tag(15, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* Vector rot = 13; */
        if (message.rot)
...
/**
 * @generated MessageType for protobuf message AbilityActionCreateTile
 */
