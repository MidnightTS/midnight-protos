...
// @generated from protobuf file "GetChatEmojiCollectionRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { ChatEmojiCollectionData } from "./ChatEmojiCollectionData";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetChatEmojiCollectionRsp
 */
export interface GetChatEmojiCollectionRsp {
    /**
     * @generated from protobuf field: ChatEmojiCollectionData chat_emoji_collection_data = 15;
     */
...
class GetChatEmojiCollectionRsp$Type extends MessageType<GetChatEmojiCollectionRsp> {
    constructor() {
        super("GetChatEmojiCollectionRsp", [
            { no: 15, name: "chat_emoji_collection_data", kind: "message", T: () => ChatEmojiCollectionData },
    ...
    internalBinaryWrite(message: GetChatEmojiCollectionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chatEmojiCollectionData)
            ChatEmojiCollectionData.internalBinaryWrite(message.chatEmojiCollectionData, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 5; */
