...
export interface ParentQuest {
    ...
    videoKey: bigint;
    /**
     * @generated from protobuf field: uint32 Unk3300_BOMOHKDHMNH = 15 [json_name = "Unk3300BOMOHKDHMNH"];
     */
    unk3300BOMOHKDHMNH: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_PCIHJLPPHNJ = 14 [json_name = "Unk3300PCIHJLPPHNJ"];
     */
    unk3300PCIHJLPPHNJ: number;
}
...
class ParentQuest$Type extends MessageType<ParentQuest> {
    ...
    internalBinaryWrite(message: ParentQuest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300BOMOHKDHMNH !== 0)
            writer.tag(15, WireType.Varint).uint32(message.unk3300BOMOHKDHMNH);
        ...
        if (message.unk3300PCIHJLPPHNJ !== 0)
            writer.tag(14, WireType.Varint).uint32(message.unk3300PCIHJLPPHNJ);
