...
// @generated from protobuf file "AnchorPointOpReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface AnchorPointOpReq {
    /**
     * @generated from protobuf field: uint32 anchor_point_id = 4;
     */
    anchorPointId: number;
    /**
     * @generated from protobuf field: uint32 anchor_point_op_type = 10;
     */
...
class AnchorPointOpReq$Type extends MessageType<AnchorPointOpReq> {
    ...
    internalBinaryWrite(message: AnchorPointOpReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.anchorPointId !== 0)
            writer.tag(4, WireType.Varint).uint32(message.anchorPointId);
        /* uint32 anchor_point_op_type = 10; */
        if (message.anchorPointOpType !== 0)
            writer.tag(10, WireType.Varint).uint32(message.anchorPointOpType);
