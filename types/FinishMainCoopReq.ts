...
// @generated from protobuf file "FinishMainCoopReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FinishMainCoopReq
 */
export interface FinishMainCoopReq {
    ...
    id: number;
    /**
     * @generated from protobuf field: uint32 ending_save_point_id = 3;
     */
...
class FinishMainCoopReq$Type extends MessageType<FinishMainCoopReq> {
    ...
    internalBinaryWrite(message: FinishMainCoopReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.endingSavePointId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.endingSavePointId);
