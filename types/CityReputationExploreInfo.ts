...
// @generated from protobuf file "CityReputationExploreInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message CityReputationExploreInfo
 */
export interface CityReputationExploreInfo {
    /**
     * @generated from protobuf field: uint32 explore_percent = 1;
     */
    explorePercent: number;
    /**
     * @generated from protobuf field: repeated uint32 taken_explore_reward_list = 15;
     */
...
class CityReputationExploreInfo$Type extends MessageType<CityReputationExploreInfo> {
    ...
    internalBinaryWrite(message: CityReputationExploreInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.explorePercent !== 0)
            writer.tag(1, WireType.Varint).uint32(message.explorePercent);
