...
// @generated from protobuf file "SignInInfoRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SignInInfoRsp
 */
export interface SignInInfoRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: repeated SignInInfo sign_in_info_list = 8;
     */
...
class SignInInfoRsp$Type extends MessageType<SignInInfoRsp> {
    constructor() {
        super("SignInInfoRsp", [
            ...
            { no: 8, name: "sign_in_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SignInInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: SignInInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.signInInfoList.length; i++)
            SignInInfo.internalBinaryWrite(message.signInInfoList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
