...
// @generated from protobuf file "SceneGalleryBrokenFloorInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message SceneGalleryBrokenFloorInfo
 */
export interface SceneGalleryBrokenFloorInfo {
    ...
    endTime: number;
    /**
     * @generated from protobuf field: map<uint32, uint32> fall_count_map = 15;
     */
    fallCountMap: {
        [key: number]: number;
    };
...
class SceneGalleryBrokenFloorInfo$Type extends MessageType<SceneGalleryBrokenFloorInfo> {
    ...
    private binaryReadMap15(map: SceneGalleryBrokenFloorInfo["fallCountMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: SceneGalleryBrokenFloorInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.fallCountMap))
            writer.tag(15, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.fallCountMap[k as any]).join();
