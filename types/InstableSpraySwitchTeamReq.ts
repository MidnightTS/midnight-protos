...
// @generated from protobuf file "InstableSpraySwitchTeamReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message InstableSpraySwitchTeamReq
 */
export interface InstableSpraySwitchTeamReq {
    /**
     * @generated from protobuf field: repeated InstableSprayAvatarInfo avatar_info_list = 13;
     */
...
class InstableSpraySwitchTeamReq$Type extends MessageType<InstableSpraySwitchTeamReq> {
    constructor() {
        super("InstableSpraySwitchTeamReq", [
            { no: 13, name: "avatar_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => InstableSprayAvatarInfo }
        ]);
    }
