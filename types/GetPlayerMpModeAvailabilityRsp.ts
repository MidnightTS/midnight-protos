...
// @generated from protobuf file "GetPlayerMpModeAvailabilityRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetPlayerMpModeAvailabilityRsp
 */
export interface GetPlayerMpModeAvailabilityRsp {
    ...
    paramList: number[];
    /**
     * @generated from protobuf field: int32 mp_ret = 12;
     */
    mpRet: number;
    /**
...
class GetPlayerMpModeAvailabilityRsp$Type extends MessageType<GetPlayerMpModeAvailabilityRsp> {
    ...
    internalBinaryWrite(message: GetPlayerMpModeAvailabilityRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 mp_ret = 12; */
        if (message.mpRet !== 0)
            writer.tag(12, WireType.Varint).int32(message.mpRet);
        /* int32 retcode = 3; */
