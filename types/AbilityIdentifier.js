...
var _AbilityIdentifier_one_of_decls;
...
class AbilityIdentifier extends pb_1.Message {
    constructor(data) {
        super();
        _AbilityIdentifier_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AbilityIdentifier_one_of_decls, "f"));
...
_AbilityIdentifier_one_of_decls = new WeakMap();
