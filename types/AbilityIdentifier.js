...
class AbilityIdentifier$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityIdentifier", [
            ...
            { no: 10, name: "Unk3300_IHCKJKLCICI", kind: "scalar", jsonName: "Unk3300IHCKJKLCICI", T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "is_serverbuff_modifier", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 7, name: "local_id", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 1, name: "Unk3300_OOOLELPBDHJ", kind: "scalar", jsonName: "Unk3300OOOLELPBDHJ", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "instanced_modifier_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { instancedAbilityId: 0, unk3300IHCKJKLCICI: 0, isServerbuffModifier: false, localId: 0, unk3300OOOLELPBDHJ: 0, instancedModifierId: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 instanced_ability_id */ 4:
                    ...
                    break;
                case /* uint32 Unk3300_IHCKJKLCICI = 10 [json_name = "Unk3300IHCKJKLCICI"];*/ 10:
                    message.unk3300IHCKJKLCICI = reader.uint32();
                    break;
                ...
                case /* int32 local_id */ 7:
                    ...
                    break;
                case /* uint32 Unk3300_OOOLELPBDHJ = 1 [json_name = "Unk3300OOOLELPBDHJ"];*/ 1:
                    message.unk3300OOOLELPBDHJ = reader.uint32();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* uint32 Unk3300_IHCKJKLCICI = 10 [json_name = "Unk3300IHCKJKLCICI"]; */
        if (message.unk3300IHCKJKLCICI !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.unk3300IHCKJKLCICI);
        ...
        /* uint32 Unk3300_OOOLELPBDHJ = 1 [json_name = "Unk3300OOOLELPBDHJ"]; */
        if (message.unk3300OOOLELPBDHJ !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.unk3300OOOLELPBDHJ);
