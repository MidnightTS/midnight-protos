...
// @generated from protobuf file "MarkTargetInvestigationMonsterNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MarkTargetInvestigationMonsterNotify
 */
export interface MarkTargetInvestigationMonsterNotify {
    ...
    groupId: number;
    /**
     * @generated from protobuf field: uint32 investigation_monster_id = 3;
     */
...
class MarkTargetInvestigationMonsterNotify$Type extends MessageType<MarkTargetInvestigationMonsterNotify> {
    ...
    internalBinaryWrite(message: MarkTargetInvestigationMonsterNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.monsterId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.monsterId);
        /* uint32 scene_id = 7; */
        ...
        if (message.investigationMonsterId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.investigationMonsterId);
