...
class BartenderActivityDetailInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("BartenderActivityDetailInfo", [
            ...
            { no: 3, name: "Unk3300_BPCBOANPBHF", kind: "scalar", jsonName: "Unk3300BPCBOANPBHF", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "Unk3300_OGPLCBFDHCF", kind: "scalar", jsonName: "Unk3300OGPLCBFDHCF", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { isContentClosed: false, unlockLevelList: [], unk3300BPCBOANPBHF: [], unk3300OGPLCBFDHCF: [], unlockTaskList: [], isDevelopModuleOpen: false };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated BartenderLevelInfo unlock_level_list */ 10:
                    ...
                    break;
                case /* repeated uint32 Unk3300_BPCBOANPBHF = 3 [json_name = "Unk3300BPCBOANPBHF"];*/ 3:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.unk3300BPCBOANPBHF.push(reader.uint32());
                    else
                        message.unk3300BPCBOANPBHF.push(reader.uint32());
                    break;
                case /* repeated uint32 Unk3300_OGPLCBFDHCF = 6 [json_name = "Unk3300OGPLCBFDHCF"];*/ 6:
                    if (wireType === runtime_2.WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.unk3300OGPLCBFDHCF.push(reader.uint32());
                    else
                        message.unk3300OGPLCBFDHCF.push(reader.uint32());
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated uint32 Unk3300_BPCBOANPBHF = 3 [json_name = "Unk3300BPCBOANPBHF"]; */
        if (message.unk3300BPCBOANPBHF.length) {
            writer.tag(3, runtime_2.WireType.LengthDelimited).fork();
            for (let i = 0; i < message.unk3300BPCBOANPBHF.length; i++)
                writer.uint32(message.unk3300BPCBOANPBHF[i]);
            writer.join();
        }
        /* repeated uint32 Unk3300_OGPLCBFDHCF = 6 [json_name = "Unk3300OGPLCBFDHCF"]; */
        if (message.unk3300OGPLCBFDHCF.length) {
            writer.tag(6, runtime_2.WireType.LengthDelimited).fork();
            for (let i = 0; i < message.unk3300OGPLCBFDHCF.length; i++)
                writer.uint32(message.unk3300OGPLCBFDHCF[i]);
            writer.join();
        }
