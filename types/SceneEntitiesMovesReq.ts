...
// @generated from protobuf file "SceneEntitiesMovesReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SceneEntitiesMovesReq
 */
export interface SceneEntitiesMovesReq {
    /**
     * @generated from protobuf field: repeated EntityMoveInfo entity_move_info_list = 11;
     */
...
class SceneEntitiesMovesReq$Type extends MessageType<SceneEntitiesMovesReq> {
    constructor() {
        super("SceneEntitiesMovesReq", [
            { no: 11, name: "entity_move_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => EntityMoveInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: SceneEntitiesMovesReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.entityMoveInfoList.length; i++)
            EntityMoveInfo.internalBinaryWrite(message.entityMoveInfoList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
