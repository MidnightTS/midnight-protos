...
export interface EvtAvatarStandUpNotify {
    /**
     * @generated from protobuf field: int32 direction = 13;
     */
    direction: number;
    /**
    ...
    entityId: number;
    /**
     * @generated from protobuf field: int32 perform_id = 11;
     */
    performId: number;
}
...
class EvtAvatarStandUpNotify$Type extends MessageType<EvtAvatarStandUpNotify> {
    ...
    internalBinaryWrite(message: EvtAvatarStandUpNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.direction !== 0)
            writer.tag(13, WireType.Varint).int32(message.direction);
        /* uint64 chair_id = 3; */
        ...
        if (message.performId !== 0)
            writer.tag(11, WireType.Varint).int32(message.performId);
