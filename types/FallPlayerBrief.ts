...
// @generated from protobuf file "FallPlayerBrief.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message FallPlayerBrief
 */
export interface FallPlayerBrief {
    /**
     * @generated from protobuf field: bool is_ground = 7;
     */
    isGround: boolean;
    /**
...
class FallPlayerBrief$Type extends MessageType<FallPlayerBrief> {
    ...
    internalBinaryWrite(message: FallPlayerBrief, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isGround !== false)
            writer.tag(7, WireType.Varint).bool(message.isGround);
        /* uint32 uid = 2; */
        if (message.uid !== 0)
