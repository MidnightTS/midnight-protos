...
class DelScenePlayTeamEntityNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("DelScenePlayTeamEntityNotify", [
            { no: 5, name: "del_entity_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 10, name: "scene_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { delEntityIdList: [], sceneId: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 del_entity_id_list */ 5:
...
/**
 * @generated MessageType for protobuf message DelScenePlayTeamEntityNotify
 */
