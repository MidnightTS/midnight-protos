...
// @generated from protobuf file "McoinExchangeHcoinRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface McoinExchangeHcoinRsp {
    /**
     * @generated from protobuf field: uint32 mcoin_cost = 12;
     */
    mcoinCost: number;
    /**
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 hcoin = 1;
     */
    hcoin: number;
}
...
class McoinExchangeHcoinRsp$Type extends MessageType<McoinExchangeHcoinRsp> {
    ...
    internalBinaryWrite(message: McoinExchangeHcoinRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mcoinCost !== 0)
            writer.tag(12, WireType.Varint).uint32(message.mcoinCost);
        /* int32 retcode = 10; */
