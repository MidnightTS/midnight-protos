...
// @generated from protobuf file "MichiaeMatsuriStartDarkChallengeReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MichiaeMatsuriStartDarkChallengeReq
 */
export interface MichiaeMatsuriStartDarkChallengeReq {
    /**
     * @generated from protobuf field: uint32 worktop_entity_id = 15;
     */
...
class MichiaeMatsuriStartDarkChallengeReq$Type extends MessageType<MichiaeMatsuriStartDarkChallengeReq> {
    ...
    internalBinaryWrite(message: MichiaeMatsuriStartDarkChallengeReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.worktopEntityId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.worktopEntityId);
