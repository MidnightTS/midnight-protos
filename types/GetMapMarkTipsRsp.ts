...
// @generated from protobuf file "GetMapMarkTipsRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { MapMarkTipsInfo } from "./MapMarkTipsInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetMapMarkTipsRsp
 */
export interface GetMapMarkTipsRsp {
    /**
     * @generated from protobuf field: repeated MapMarkTipsInfo mark_tips_list = 8;
     */
...
class GetMapMarkTipsRsp$Type extends MessageType<GetMapMarkTipsRsp> {
    constructor() {
        super("GetMapMarkTipsRsp", [
            { no: 8, name: "mark_tips_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MapMarkTipsInfo },
    ...
    internalBinaryWrite(message: GetMapMarkTipsRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.markTipsList.length; i++)
            MapMarkTipsInfo.internalBinaryWrite(message.markTipsList[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 11; */
