...
// @generated from protobuf file "AvatarRenameAuditData.proto" (syntax proto3)
// tslint:disable
//
...
import { AvatarRenameContentAuditField } from "./AvatarRenameContentAuditField";
/**
 * @generated from protobuf message AvatarRenameAuditData
 */
export interface AvatarRenameAuditData {
    /**
    ...
    uid: number;
    /**
     * @generated from protobuf field: repeated AvatarRenameContentAuditField audit_field_list = 7;
     */
    auditFieldList: AvatarRenameContentAuditField[];
    /**
...
class AvatarRenameAuditData$Type extends MessageType<AvatarRenameAuditData> {
    constructor() {
        super("AvatarRenameAuditData", [
            ...
            { no: 7, name: "audit_field_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AvatarRenameContentAuditField },
            { no: 8, name: "aux_field_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ContentAuditAuxiliaryField }
        ]);
    }
    create(value?: PartialMessage<AvatarRenameAuditData>): AvatarRenameAuditData {
        const message = { aid: "", entityId: "", lang: "", queueKey: "", region: "", uid: 0, auditFieldList: [], auxFieldList: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AvatarRenameAuditData>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AvatarRenameAuditData): AvatarRenameAuditData {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated AvatarRenameContentAuditField audit_field_list */ 7:
                    message.auditFieldList.push(AvatarRenameContentAuditField.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: AvatarRenameAuditData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string aid = 1; */
        if (message.aid !== "")
        ...
        for (let i = 0; i < message.auditFieldList.length; i++)
            AvatarRenameContentAuditField.internalBinaryWrite(message.auditFieldList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const AvatarRenameAuditData = new AvatarRenameAuditData$Type();
