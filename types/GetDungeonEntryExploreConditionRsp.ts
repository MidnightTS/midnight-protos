...
// @generated from protobuf file "GetDungeonEntryExploreConditionRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { DungeonEntryCond } from "./DungeonEntryCond";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GetDungeonEntryExploreConditionRsp
 */
export interface GetDungeonEntryExploreConditionRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: DungeonEntryCond dungeon_entry_cond = 14;
     */
...
class GetDungeonEntryExploreConditionRsp$Type extends MessageType<GetDungeonEntryExploreConditionRsp> {
    constructor() {
        super("GetDungeonEntryExploreConditionRsp", [
            ...
            { no: 14, name: "dungeon_entry_cond", kind: "message", T: () => DungeonEntryCond }
        ]);
    }
    ...
    internalBinaryWrite(message: GetDungeonEntryExploreConditionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dungeonEntryCond)
            DungeonEntryCond.internalBinaryWrite(message.dungeonEntryCond, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
