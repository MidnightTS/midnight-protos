...
// @generated from protobuf file "GetRecentMpPlayerListRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetRecentMpPlayerListRsp
 */
export interface GetRecentMpPlayerListRsp {
    /**
     * @generated from protobuf field: repeated FriendBrief recent_mp_player_brief_list = 9;
     */
...
class GetRecentMpPlayerListRsp$Type extends MessageType<GetRecentMpPlayerListRsp> {
    constructor() {
        super("GetRecentMpPlayerListRsp", [
            { no: 9, name: "recent_mp_player_brief_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FriendBrief },
    ...
    internalBinaryWrite(message: GetRecentMpPlayerListRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.recentMpPlayerBriefList.length; i++)
            FriendBrief.internalBinaryWrite(message.recentMpPlayerBriefList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 13; */
