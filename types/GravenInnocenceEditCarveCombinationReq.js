...
exports.GravenInnocenceEditCarveCombinationReq = void 0;
...
class GravenInnocenceEditCarveCombinationReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GravenInnocenceEditCarveCombinationReq", [
            { no: 4, name: "combination_info", kind: "message", T: () => CustomGadgetTreeInfo_1.CustomGadgetTreeInfo },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* CustomGadgetTreeInfo combination_info */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.combinationInfo)
            CustomGadgetTreeInfo_1.CustomGadgetTreeInfo.internalBinaryWrite(message.combinationInfo, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 10; */
...
/**
 * @generated MessageType for protobuf message GravenInnocenceEditCarveCombinationReq
 */
