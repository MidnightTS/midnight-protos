...
// @generated from protobuf file "GravenInnocenceEditCarveCombinationReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GravenInnocenceEditCarveCombinationReq
 */
export interface GravenInnocenceEditCarveCombinationReq {
    /**
     * @generated from protobuf field: CustomGadgetTreeInfo combination_info = 4;
     */
...
class GravenInnocenceEditCarveCombinationReq$Type extends MessageType<GravenInnocenceEditCarveCombinationReq> {
    constructor() {
        super("GravenInnocenceEditCarveCombinationReq", [
            { no: 4, name: "combination_info", kind: "message", T: () => CustomGadgetTreeInfo },
    ...
    internalBinaryWrite(message: GravenInnocenceEditCarveCombinationReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.combinationInfo)
            CustomGadgetTreeInfo.internalBinaryWrite(message.combinationInfo, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 10; */
