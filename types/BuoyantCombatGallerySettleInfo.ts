...
export class BuoyantCombatGallerySettleInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        gallery_level?: number;
        final_score?: number;
        kill_monster_count?: number;
        kill_target_count?: number;
        kill_special_monster_count?: number;
        gallery_id?: number;
        gallery_multiple?: number;
    }) {
        super();
    ...
    set kill_target_count(value: number) {
    ...
    set gallery_multiple(value: number) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): BuoyantCombatGallerySettleInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): BuoyantCombatGallerySettleInfo {
