...
// @generated from protobuf file "GadgetTalkChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GadgetTalkChangeNotify
 */
export interface GadgetTalkChangeNotify {
    /**
     * @generated from protobuf field: uint32 cur_gadget_talk_state = 12;
     */
...
class GadgetTalkChangeNotify$Type extends MessageType<GadgetTalkChangeNotify> {
    ...
    internalBinaryWrite(message: GadgetTalkChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curGadgetTalkState !== 0)
            writer.tag(12, WireType.Varint).uint32(message.curGadgetTalkState);
