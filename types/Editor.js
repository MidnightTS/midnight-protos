...
/**
 * @generated from protobuf enum proto.SceneSurfaceMaterial
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional int32 maxz */ 4:
                    ...
                    break;
                case /* repeated proto.CellInfo cells */ 5:
...
/**
 * @generated MessageType for protobuf message proto.MapInfo
 */
exports.MapInfo = new MapInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CellInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("proto.CellInfo", [
            { no: 1, name: "type", kind: "enum", opt: true, T: () => ["proto.SceneSurfaceMaterial", SceneSurfaceMaterial] },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional proto.SceneSurfaceMaterial type */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* optional proto.SceneSurfaceMaterial type = 1; */
...
/**
 * @generated MessageType for protobuf message proto.CellInfo
 */
