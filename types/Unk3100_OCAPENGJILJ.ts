...
export class Unk3100_OCAPENGJILJ extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Unk3100_OCAPENGJILJ {
    ...
    static deserializeBinary(bytes: Uint8Array): Unk3100_OCAPENGJILJ {
