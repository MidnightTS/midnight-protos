...
// @generated from protobuf file "ToTheMoonRemoveObstacleRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ToTheMoonRemoveObstacleRsp
 */
export interface ToTheMoonRemoveObstacleRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: DynamicNodes dynamic_nodes = 12;
     */
...
class ToTheMoonRemoveObstacleRsp$Type extends MessageType<ToTheMoonRemoveObstacleRsp> {
    constructor() {
        super("ToTheMoonRemoveObstacleRsp", [
            ...
            { no: 12, name: "dynamic_nodes", kind: "message", T: () => DynamicNodes },
    ...
    internalBinaryWrite(message: ToTheMoonRemoveObstacleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.dynamicNodes)
            DynamicNodes.internalBinaryWrite(message.dynamicNodes, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* int32 query_id = 5; */
