...
// @generated from protobuf file "ReliquaryPromoteReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface ReliquaryPromoteReq {
    /**
     * @generated from protobuf field: uint64 target_guid = 3;
     */
    targetGuid: bigint;
    /**
     * @generated from protobuf field: uint64 item_guid = 2;
     */
    itemGuid: bigint;
}
...
class ReliquaryPromoteReq$Type extends MessageType<ReliquaryPromoteReq> {
    ...
    internalBinaryWrite(message: ReliquaryPromoteReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.targetGuid !== 0n)
            writer.tag(3, WireType.Varint).uint64(message.targetGuid);
        /* uint64 item_guid = 2; */
        if (message.itemGuid !== 0n)
            writer.tag(2, WireType.Varint).uint64(message.itemGuid);
