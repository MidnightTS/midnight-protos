...
class PlayerChatRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerChatRsp", [
            { no: 8, name: "chat_forbidden_endtime", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 12, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { chatForbiddenEndtime: 0, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 chat_forbidden_endtime */ 8:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chatForbiddenEndtime !== 0)
            writer.tag(8, runtime_1.WireType.Varint).uint32(message.chatForbiddenEndtime);
        /* int32 retcode = 12; */
