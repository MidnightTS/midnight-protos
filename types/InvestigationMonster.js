...
class InvestigationMonster$Type extends runtime_5.MessageType {
    constructor() {
        super("InvestigationMonster", [
            ...
            { no: 1, name: "next_boss_chest_refresh_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "weekly_boss_resin_discount_info", kind: "message", T: () => WeeklyBossResinDiscountInfo_1.WeeklyBossResinDiscountInfo },
            { no: 6, name: "boss_chest_num", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            ...
            { no: 10, name: "refresh_interval", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "is_area_locked", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "level", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 11, name: "max_boss_chest_num", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 15, name: "resin", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isAlive: false, sceneId: 0, nextRefreshTime: 0, cityId: 0, groupId: 0, nextBossChestRefreshTime: 0, bossChestNum: 0, id: 0, monsterId: 0, lockState: 0, refreshInterval: 0, isAreaLocked: false, level: 0, maxBossChestNum: 0, resin: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 group_id */ 1735:
                    ...
                    break;
                case /* uint32 next_boss_chest_refresh_time */ 1:
                ...
                case /* InvestigationMonster.LockState lock_state */ 4:
                    ...
                    break;
                case /* uint32 refresh_interval */ 10:
                ...
                case /* uint32 level */ 2:
                    ...
                    break;
                case /* uint32 max_boss_chest_num */ 11:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.nextBossChestRefreshTime !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.nextBossChestRefreshTime);
        ...
        /* uint32 boss_chest_num = 6; */
        if (message.bossChestNum !== 0)
            writer.tag(6, runtime_1.WireType.Varint).uint32(message.bossChestNum);
        /* uint32 id = 9; */
        if (message.id !== 0)
        ...
        if (message.refreshInterval !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.refreshInterval);
        ...
        if (message.maxBossChestNum !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.maxBossChestNum);
        /* uint32 resin = 15; */
        if (message.resin !== 0)
