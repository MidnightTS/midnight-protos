...
class FleurFairFallInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("FleurFairFallInfo", [
            { no: 11, name: "best_score", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { bestScore: 0 };
...
/**
 * @generated MessageType for protobuf message FleurFairFallInfo
 */
