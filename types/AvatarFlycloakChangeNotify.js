...
class AvatarFlycloakChangeNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("AvatarFlycloakChangeNotify", [
            { no: 1, name: "flycloak_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "avatar_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
        const message = { flycloakId: 0, avatarGuid: 0n };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.flycloakId !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.flycloakId);
