...
// @generated from protobuf file "StartRogueDiaryRoomReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message StartRogueDiaryRoomReq
 */
export interface StartRogueDiaryRoomReq {
    /**
     * @generated from protobuf field: bool is_select_hard = 10;
     */
    isSelectHard: boolean;
    /**
     * @generated from protobuf field: uint32 room_difficulty = 13;
     */
...
class StartRogueDiaryRoomReq$Type extends MessageType<StartRogueDiaryRoomReq> {
    ...
    internalBinaryWrite(message: StartRogueDiaryRoomReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isSelectHard !== false)
            writer.tag(10, WireType.Varint).bool(message.isSelectHard);
