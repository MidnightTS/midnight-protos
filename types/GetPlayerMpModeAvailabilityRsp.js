...
var _GetPlayerMpModeAvailabilityRsp_one_of_decls;
...
class GetPlayerMpModeAvailabilityRsp extends pb_1.Message {
    constructor(data) {
        super();
        _GetPlayerMpModeAvailabilityRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [8], __classPrivateFieldGet(this, _GetPlayerMpModeAvailabilityRsp_one_of_decls, "f"));
...
exports.GetPlayerMpModeAvailabilityRsp = GetPlayerMpModeAvailabilityRsp;
_GetPlayerMpModeAvailabilityRsp_one_of_decls = new WeakMap();
