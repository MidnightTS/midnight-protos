...
// @generated from protobuf file "EchoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EchoNotify
 */
export interface EchoNotify {
    ...
    content: string;
    /**
     * @generated from protobuf field: uint32 seq_id = 3;
     */
    seqId: number;
}
...
class EchoNotify$Type extends MessageType<EchoNotify> {
    ...
    internalBinaryWrite(message: EchoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 seq_id = 3; */
        if (message.seqId !== 0)
            writer.tag(3, WireType.Varint).uint32(message.seqId);
