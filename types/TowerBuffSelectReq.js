...
exports.TowerBuffSelectReq = void 0;
...
class TowerBuffSelectReq$Type extends runtime_5.MessageType {
    constructor() {
        super("TowerBuffSelectReq", [
            { no: 7, name: "tower_buff_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.towerBuffId !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.towerBuffId);
