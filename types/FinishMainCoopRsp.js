...
class FinishMainCoopRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("FinishMainCoopRsp", [
            { no: 4, name: "ending_save_point_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 13, name: "id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { endingSavePointId: 0, retcode: 0, id: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 ending_save_point_id */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.endingSavePointId !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.endingSavePointId);
        /* int32 retcode = 1; */
...
/**
 * @generated MessageType for protobuf message FinishMainCoopRsp
 */
