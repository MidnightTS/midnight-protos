...
// @generated from protobuf file "BuoyantCombatSettleNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { BuoyantCombatSettleInfo } from "./BuoyantCombatSettleInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message BuoyantCombatSettleNotify
 */
export interface BuoyantCombatSettleNotify {
    ...
    galleryId: number;
    /**
     * @generated from protobuf field: BuoyantCombatSettleInfo settle_info = 15;
     */
...
class BuoyantCombatSettleNotify$Type extends MessageType<BuoyantCombatSettleNotify> {
    constructor() {
        super("BuoyantCombatSettleNotify", [
            ...
            { no: 15, name: "settle_info", kind: "message", T: () => BuoyantCombatSettleInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: BuoyantCombatSettleNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.settleInfo)
            BuoyantCombatSettleInfo.internalBinaryWrite(message.settleInfo, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
