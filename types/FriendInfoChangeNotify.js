...
class FriendInfoChangeNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("FriendInfoChangeNotify", [
            { no: 6, name: "uid", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "online_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
        const message = { uid: 0, onlineId: "" };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string online_id = 3; */
        if (message.onlineId !== "")
            writer.tag(3, runtime_1.WireType.LengthDelimited).string(message.onlineId);
...
/**
 * @generated MessageType for protobuf message FriendInfoChangeNotify
 */
