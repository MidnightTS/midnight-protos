...
// @generated from protobuf file "SetPlayerBirthdayReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface SetPlayerBirthdayReq {
    /**
     * @generated from protobuf field: Birthday birthday = 8;
     */
    birthday?: Birthday;
}
...
class SetPlayerBirthdayReq$Type extends MessageType<SetPlayerBirthdayReq> {
    constructor() {
        super("SetPlayerBirthdayReq", [
            { no: 8, name: "birthday", kind: "message", T: () => Birthday }
        ]);
    }
    ...
    internalBinaryWrite(message: SetPlayerBirthdayReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* Birthday birthday = 8; */
        if (message.birthday)
            Birthday.internalBinaryWrite(message.birthday, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
