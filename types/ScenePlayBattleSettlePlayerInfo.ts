...
export class ScenePlayBattleSettlePlayerInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get card_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.ExhibitionDisplayInfo, 14) as dependency_1.ExhibitionDisplayInfo[];
    }
    set card_list(value: dependency_1.ExhibitionDisplayInfo[]) {
        pb_1.Message.setRepeatedWrapperField(this, 14, value);
    }
    get profile_picture() {
        return pb_1.Message.getWrapperField(this, dependency_2.ProfilePicture, 10) as dependency_2.ProfilePicture;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.card_list.length)
            writer.writeRepeatedMessage(14, this.card_list, (item: dependency_1.ExhibitionDisplayInfo) => item.serialize(writer));
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ScenePlayBattleSettlePlayerInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): ScenePlayBattleSettlePlayerInfo {
