...
import * as dependency_1 from "./FishtankFishInfo";
import * as dependency_2 from "./MonsterBornType";
import * as dependency_3 from "./MonsterRoute";
import * as dependency_4 from "./SceneFishInfo";
import * as dependency_5 from "./SceneWeaponInfo";
import * as pb_1 from "google-protobuf";
export class SceneMonsterInfo extends pb_1.Message {
    #one_of_decls: number[][] = [[50, 51]];
    constructor(data?: any[] | ({
        monster_id?: number;
        group_id?: number;
        config_id?: number;
        weapon_list?: dependency_5.SceneWeaponInfo[];
        ...
        pose_id?: number;
        born_type?: dependency_2.MonsterBornType;
        block_id?: number;
        mark_flag?: number;
        title_id?: number;
        special_name_id?: number;
        attack_target_id?: number;
        monster_route?: dependency_3.MonsterRoute;
        ai_config_id?: number;
        level_route_id?: number;
        init_pose_id?: number;
        Unk2800_JEGLENPDPNI?: boolean;
        Unk3000_CCKJDCBDEKD?: number;
    } & (({
        fish_info?: dependency_4.SceneFishInfo;
        fishtank_fish_info?: never;
    } | {
        fish_info?: never;
        fishtank_fish_info?: dependency_1.FishtankFishInfo;
    })))) {
        super();
    ...
    get weapon_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_5.SceneWeaponInfo, 4) as dependency_5.SceneWeaponInfo[];
    }
    set weapon_list(value: dependency_5.SceneWeaponInfo[]) {
    ...
    set pose_id(value: number) {
        pb_1.Message.setField(this, 11, value);
    }
    get born_type() {
        return pb_1.Message.getFieldWithDefault(this, 12, dependency_2.MonsterBornType.MONSTER_BORN_TYPE_NONE) as dependency_2.MonsterBornType;
    }
    set born_type(value: dependency_2.MonsterBornType) {
    ...
    set title_id(value: number) {
        pb_1.Message.setField(this, 15, value);
    }
    get special_name_id() {
        return pb_1.Message.getFieldWithDefault(this, 16, 0) as number;
    }
    set special_name_id(value: number) {
    ...
    get monster_route() {
        return pb_1.Message.getWrapperField(this, dependency_3.MonsterRoute, 18) as dependency_3.MonsterRoute;
    }
    set monster_route(value: dependency_3.MonsterRoute) {
    ...
    get fishtank_fish_info() {
        return pb_1.Message.getWrapperField(this, dependency_1.FishtankFishInfo, 51) as dependency_1.FishtankFishInfo;
    }
    set fishtank_fish_info(value: dependency_1.FishtankFishInfo) {
    ...
    get content() {
        const cases: {
            [index: number]: "none" | "fish_info" | "fishtank_fish_info";
        } = {
            0: "none",
            50: "fish_info",
    ...
    static fromObject(data: {
        ...
        group_id?: number;
        config_id?: number;
        weapon_list?: ReturnType<typeof dependency_5.SceneWeaponInfo.prototype.toObject>[];
        authority_peer_id?: number;
        affix_list?: number[];
        is_elite?: boolean;
        owner_entity_id?: number;
        ...
        special_name_id?: number;
        attack_target_id?: number;
        monster_route?: ReturnType<typeof dependency_3.MonsterRoute.prototype.toObject>;
        ai_config_id?: number;
        level_route_id?: number;
        init_pose_id?: number;
        Unk2800_JEGLENPDPNI?: boolean;
        Unk3000_CCKJDCBDEKD?: number;
        fish_info?: ReturnType<typeof dependency_4.SceneFishInfo.prototype.toObject>;
        fishtank_fish_info?: ReturnType<typeof dependency_1.FishtankFishInfo.prototype.toObject>;
    }): SceneMonsterInfo {
    ...
    toObject() {
        ...
        if (this.weapon_list != null) {
            data.weapon_list = this.weapon_list.map((item: dependency_5.SceneWeaponInfo) => item.toObject());
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.weapon_list.length)
            writer.writeRepeatedMessage(4, this.weapon_list, (item: dependency_5.SceneWeaponInfo) => item.serialize(writer));
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SceneMonsterInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): SceneMonsterInfo {
