...
var _AvatarLifeStateChangeNotify_one_of_decls;
...
class AvatarLifeStateChangeNotify extends pb_1.Message {
    constructor(data) {
        super();
        _AvatarLifeStateChangeNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [12], __classPrivateFieldGet(this, _AvatarLifeStateChangeNotify_one_of_decls, "f"));
    ...
    get die_type() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_1.PlayerDieType.PLAYER_DIE_TYPE_NONE);
    }
    set die_type(value) {
        pb_1.Message.setField(this, 2, value);
    }
    get server_buff_list() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_2.ServerBuff, 12);
    }
    ...
    serialize(w) {
        ...
        if (this.server_buff_list.length)
            writer.writeRepeatedMessage(12, this.server_buff_list, (item) => item.serialize(writer));
...
exports.AvatarLifeStateChangeNotify = AvatarLifeStateChangeNotify;
_AvatarLifeStateChangeNotify_one_of_decls = new WeakMap();
