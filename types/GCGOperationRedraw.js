...
exports.GCGOperationRedraw = void 0;
...
class GCGOperationRedraw$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGOperationRedraw", [
            { no: 7, name: "card_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 card_list */ 7:
...
/**
 * @generated MessageType for protobuf message GCGOperationRedraw
 */
