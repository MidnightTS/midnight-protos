...
// @generated from protobuf file "IrodoriChessPlayerInfoNotify.proto" (syntax proto3)
// tslint:disable
//
...
import { IrodoriChessPlayerInfo } from "./IrodoriChessPlayerInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message IrodoriChessPlayerInfoNotify
 */
export interface IrodoriChessPlayerInfoNotify {
    /**
     * @generated from protobuf field: IrodoriChessPlayerInfo player_info = 10;
     */
...
class IrodoriChessPlayerInfoNotify$Type extends MessageType<IrodoriChessPlayerInfoNotify> {
    constructor() {
        super("IrodoriChessPlayerInfoNotify", [
            { no: 10, name: "player_info", kind: "message", T: () => IrodoriChessPlayerInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: IrodoriChessPlayerInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.playerInfo)
            IrodoriChessPlayerInfo.internalBinaryWrite(message.playerInfo, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
