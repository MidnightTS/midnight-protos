...
// @generated from protobuf file "UgcMusicRecord.proto" (syntax proto3)
// tslint:disable
//
...
import { UgcMusicTrack } from "./UgcMusicTrack";
/**
 * @generated from protobuf message UgcMusicRecord
 */
export interface UgcMusicRecord {
    ...
    musicId: number;
    /**
     * @generated from protobuf field: repeated UgcMusicTrack music_track_list = 4;
     */
...
class UgcMusicRecord$Type extends MessageType<UgcMusicRecord> {
    constructor() {
        super("UgcMusicRecord", [
            ...
            { no: 4, name: "music_track_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => UgcMusicTrack }
        ]);
    }
