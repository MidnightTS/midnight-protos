...
exports.UpdatePlayerShowNameCardListRsp = void 0;
...
class UpdatePlayerShowNameCardListRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("UpdatePlayerShowNameCardListRsp", [
            { no: 1, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "show_name_card_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { retcode: 0, showNameCardIdList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int32 retcode */ 1:
                    ...
                    break;
                case /* repeated uint32 show_name_card_id_list */ 2:
...
/**
 * @generated MessageType for protobuf message UpdatePlayerShowNameCardListRsp
 */
