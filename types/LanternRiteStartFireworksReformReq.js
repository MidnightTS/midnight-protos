...
exports.LanternRiteStartFireworksReformReq = void 0;
...
class LanternRiteStartFireworksReformReq$Type extends runtime_5.MessageType {
    constructor() {
        super("LanternRiteStartFireworksReformReq", [
            { no: 2, name: "challenge_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 1, name: "stage_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { challengeId: 0, stageId: 0 };
...
/**
 * @generated MessageType for protobuf message LanternRiteStartFireworksReformReq
 */
