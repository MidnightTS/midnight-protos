...
class GetShopRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("GetShopRsp", [
            ...
            { no: 8, name: "shop", kind: "message", T: () => Shop_1.Shop }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Shop shop = 8; */
        if (message.shop)
            Shop_1.Shop.internalBinaryWrite(message.shop, writer.tag(8, runtime_1.WireType.LengthDelimited).fork(), options).join();
