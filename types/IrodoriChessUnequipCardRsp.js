...
exports.IrodoriChessUnequipCardRsp = void 0;
...
class IrodoriChessUnequipCardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("IrodoriChessUnequipCardRsp", [
            { no: 10, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 12, name: "level_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "is_hard_map", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
        const message = { cardId: 0, retcode: 0, levelId: 0, isHardMap: false };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isHardMap !== false)
            writer.tag(6, runtime_1.WireType.Varint).bool(message.isHardMap);
...
/**
 * @generated MessageType for protobuf message IrodoriChessUnequipCardRsp
 */
