...
// @generated from protobuf file "SeaLampFlyLampRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message SeaLampFlyLampRsp
 */
export interface SeaLampFlyLampRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 item_num = 9;
     */
    itemNum: number;
    /**
     * @generated from protobuf field: uint32 item_id = 10;
     */
    itemId: number;
}
...
class SeaLampFlyLampRsp$Type extends MessageType<SeaLampFlyLampRsp> {
    ...
    internalBinaryWrite(message: SeaLampFlyLampRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 item_id = 10; */
        if (message.itemId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.itemId);
