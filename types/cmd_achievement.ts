...
// @generated from protobuf file "cmd_achievement.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class AchievementAllDataNotify$Type extends MessageType<AchievementAllDataNotify> {
    constructor() {
        super("com.midnights.game.AchievementAllDataNotify", [
            { no: 4, name: "achievement_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Achievement },
...
class AchievementUpdateNotify$Type extends MessageType<AchievementUpdateNotify> {
    constructor() {
        super("com.midnights.game.AchievementUpdateNotify", [
            { no: 14, name: "achievement_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Achievement }
        ]);
    }
