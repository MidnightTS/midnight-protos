...
export class TakeHuntingOfferRsp extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    get hunting_pair() {
        return pb_1.Message.getWrapperField(this, dependency_1.HuntingPair, 13) as dependency_1.HuntingPair;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TakeHuntingOfferRsp {
    ...
    static deserializeBinary(bytes: Uint8Array): TakeHuntingOfferRsp {
