...
exports.FungusFighterUseBackupFungusReq = void 0;
...
class FungusFighterUseBackupFungusReq$Type extends runtime_5.MessageType {
    constructor() {
        super("FungusFighterUseBackupFungusReq", [
            { no: 8, name: "backup_fungus_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 backup_fungus_id_list */ 8:
...
/**
 * @generated MessageType for protobuf message FungusFighterUseBackupFungusReq
 */
