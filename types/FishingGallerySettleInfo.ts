...
// @generated from protobuf file "FishingGallerySettleInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { FishingScore } from "./FishingScore";
/**
 * @generated from protobuf message FishingGallerySettleInfo
 */
export interface FishingGallerySettleInfo {
    /**
     * @generated from protobuf field: repeated FishingScore fishing_score_list = 15;
     */
    fishingScoreList: FishingScore[];
    /**
     * @generated from protobuf field: map<uint32, FishInfo> fish_map = 10;
     */
    fishMap: {
        [key: number]: FishInfo;
    };
...
class FishingGallerySettleInfo$Type extends MessageType<FishingGallerySettleInfo> {
    constructor() {
        super("FishingGallerySettleInfo", [
            ...
            { no: 10, name: "fish_map", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => FishInfo } }
        ]);
    }
    ...
    private binaryReadMap10(map: FishingGallerySettleInfo["fishMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
