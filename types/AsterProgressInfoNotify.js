...
var _AsterProgressInfoNotify_one_of_decls;
...
const dependency_1 = require("./AsterProgressDetailInfo");
const pb_1 = require("google-protobuf");
class AsterProgressInfoNotify extends pb_1.Message {
    constructor(data) {
        super();
        _AsterProgressInfoNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _AsterProgressInfoNotify_one_of_decls, "f"));
    ...
    get info() {
        return pb_1.Message.getWrapperField(this, dependency_1.AsterProgressDetailInfo, 1);
    }
    set info(value) {
...
exports.AsterProgressInfoNotify = AsterProgressInfoNotify;
_AsterProgressInfoNotify_one_of_decls = new WeakMap();
