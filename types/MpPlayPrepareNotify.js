...
var _MpPlayPrepareNotify_one_of_decls;
...
class MpPlayPrepareNotify extends pb_1.Message {
    constructor(data) {
        super();
        _MpPlayPrepareNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MpPlayPrepareNotify_one_of_decls, "f"));
...
exports.MpPlayPrepareNotify = MpPlayPrepareNotify;
_MpPlayPrepareNotify_one_of_decls = new WeakMap();
