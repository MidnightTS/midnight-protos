...
class RogueStageInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("RogueStageInfo", [
            ...
            { no: 14, name: "Unk3300_HMCJOLLKMMB", kind: "scalar", jsonName: "Unk3300HMCJOLLKMMB", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "rune_record_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => RoguelikeRuneRecord_1.RoguelikeRuneRecord },
            { no: 6, name: "Unk3300_HMAELBBOFDN", kind: "scalar", jsonName: "Unk3300HMAELBBOFDN", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "Unk3300_CMMGKMMMOAL", kind: "scalar", jsonName: "Unk3300CMMGKMMMOAL", T: 13 /*ScalarType.UINT32*/ },
            { no: 13, name: "is_open", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 7, name: "stage_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "Unk3300_DABPFCPCNCB", kind: "scalar", jsonName: "Unk3300DABPFCPCNCB", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value) {
        const message = { reviseMonsterLevel: 0, isPassed: false, unk3300GGHMFKNHPAJ: 0, isTakenReward: false, unk3300HMCJOLLKMMB: false, runeRecordList: [], unk3300HMAELBBOFDN: false, unk3300CMMGKMMMOAL: 0, isOpen: false, stageId: 0, unk3300DABPFCPCNCB: 0, curLevel: 0, unk3300OHHBEPOICLI: 0, unk3300HPKFHLLCJBM: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool is_taken_reward */ 9:
                    ...
                    break;
                case /* bool Unk3300_HMCJOLLKMMB = 14 [json_name = "Unk3300HMCJOLLKMMB"];*/ 14:
                    message.unk3300HMCJOLLKMMB = reader.bool();
                    break;
                case /* repeated RoguelikeRuneRecord rune_record_list */ 5:
                    ...
                    break;
                case /* bool Unk3300_HMAELBBOFDN = 6 [json_name = "Unk3300HMAELBBOFDN"];*/ 6:
                    message.unk3300HMAELBBOFDN = reader.bool();
                    break;
                case /* uint32 Unk3300_CMMGKMMMOAL = 3 [json_name = "Unk3300CMMGKMMMOAL"];*/ 3:
                    message.unk3300CMMGKMMMOAL = reader.uint32();
                    break;
                ...
                case /* uint32 stage_id */ 7:
                    ...
                    break;
                case /* uint32 Unk3300_DABPFCPCNCB = 4 [json_name = "Unk3300DABPFCPCNCB"];*/ 4:
                    message.unk3300DABPFCPCNCB = reader.uint32();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* bool Unk3300_HMCJOLLKMMB = 14 [json_name = "Unk3300HMCJOLLKMMB"]; */
        if (message.unk3300HMCJOLLKMMB !== false)
            writer.tag(14, runtime_1.WireType.Varint).bool(message.unk3300HMCJOLLKMMB);
        ...
        /* bool Unk3300_HMAELBBOFDN = 6 [json_name = "Unk3300HMAELBBOFDN"]; */
        if (message.unk3300HMAELBBOFDN !== false)
            writer.tag(6, runtime_1.WireType.Varint).bool(message.unk3300HMAELBBOFDN);
        /* uint32 Unk3300_CMMGKMMMOAL = 3 [json_name = "Unk3300CMMGKMMMOAL"]; */
        if (message.unk3300CMMGKMMMOAL !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.unk3300CMMGKMMMOAL);
        /* bool is_open = 13; */
        ...
        /* uint32 Unk3300_DABPFCPCNCB = 4 [json_name = "Unk3300DABPFCPCNCB"]; */
        if (message.unk3300DABPFCPCNCB !== 0)
            writer.tag(4, runtime_1.WireType.Varint).uint32(message.unk3300DABPFCPCNCB);
        /* uint32 cur_level = 12; */
