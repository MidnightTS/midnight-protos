...
export interface TowerCurLevelRecord {
    ...
    isUpperPart: boolean;
    /**
     * @generated from protobuf field: uint32 Unk3300_KPGBPDIJJJJ = 6 [json_name = "Unk3300KPGBPDIJJJJ"];
     */
    unk3300KPGBPDIJJJJ: number;
    /**
    ...
    /**
     * @generated from protobuf field: uint32 Unk3300_PMHCLPFPHBJ = 9 [json_name = "Unk3300PMHCLPFPHBJ"];
     */
    unk3300PMHCLPFPHBJ: number;
}
...
class TowerCurLevelRecord$Type extends MessageType<TowerCurLevelRecord> {
    ...
    internalBinaryWrite(message: TowerCurLevelRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300KPGBPDIJJJJ !== 0)
            writer.tag(6, WireType.Varint).uint32(message.unk3300KPGBPDIJJJJ);
        /* bool is_empty = 1; */
        ...
        if (message.unk3300PMHCLPFPHBJ !== 0)
            writer.tag(9, WireType.Varint).uint32(message.unk3300PMHCLPFPHBJ);
