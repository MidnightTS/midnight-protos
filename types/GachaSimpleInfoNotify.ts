...
// @generated from protobuf file "GachaSimpleInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GachaSimpleInfoNotify
 */
export interface GachaSimpleInfoNotify {
    /**
     * @generated from protobuf field: bool is_new = 11;
     */
    isNew: boolean;
}
...
class GachaSimpleInfoNotify$Type extends MessageType<GachaSimpleInfoNotify> {
    ...
    internalBinaryWrite(message: GachaSimpleInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isNew !== false)
            writer.tag(11, WireType.Varint).bool(message.isNew);
