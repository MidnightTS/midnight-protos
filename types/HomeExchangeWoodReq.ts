...
// @generated from protobuf file "HomeExchangeWoodReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeExchangeWoodReq
 */
export interface HomeExchangeWoodReq {
    ...
    woodId: number;
    /**
     * @generated from protobuf field: map<uint32, uint32> material_count_map = 4;
     */
    materialCountMap: {
        [key: number]: number;
    };
...
class HomeExchangeWoodReq$Type extends MessageType<HomeExchangeWoodReq> {
    ...
    private binaryReadMap4(map: HomeExchangeWoodReq["materialCountMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: HomeExchangeWoodReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.materialCountMap))
            writer.tag(4, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.materialCountMap[k as any]).join();
