...
exports.TakeCompoundOutputRsp = void 0;
...
class TakeCompoundOutputRsp$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { itemList: [], retcode: 0 };
...
/**
 * @generated MessageType for protobuf message TakeCompoundOutputRsp
 */
