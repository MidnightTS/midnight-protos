...
// @generated from protobuf file "BonusOpActivityInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message BonusOpActivityInfo
 */
export interface BonusOpActivityInfo {
    /**
     * @generated from protobuf field: uint32 left_bonus_count = 8;
     */
...
class BonusOpActivityInfo$Type extends MessageType<BonusOpActivityInfo> {
    ...
    internalBinaryWrite(message: BonusOpActivityInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.leftBonusCount !== 0)
            writer.tag(8, WireType.Varint).uint32(message.leftBonusCount);
