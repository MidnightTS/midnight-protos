...
export class MusicBriefInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        Unk2700_JNENCBCGPGO?: number;
        Unk2700_OJBPHCIDAEB?: boolean;
        Unk2700_FGCJEGHOKPG?: boolean;
        Unk2700_DFIBAIILJHN?: number;
        Unk2700_MKBNLEKMIMD?: number;
        Unk2700_PINGIIAANMO?: number;
        Unk2700_MONNIDCNDFI?: string;
        version?: number;
        Unk2700_GGHNLPMAGME?: number;
        Unk2700_GDCGOMNBMEO?: number[];
        Unk2700_JAEONBMBFJJ?: number[];
        Unk2700_GBCGGDONMCD?: boolean;
        Unk2700_LPEKFJBNEJM?: number;
        Unk2700_DNLEGADDHKM?: boolean;
        Unk2700_BFMNMPPNBHH?: number;
        max_score?: number;
        Unk2700_KAMOCHAKPGP?: number;
        Unk2700_KLPHBLCIOEC?: number;
        Unk2700_CEPGMKAHHCD?: number;
        Unk2700_PMCPLPMJCEC?: number;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1002, 982], this.#one_of_decls);
    ...
    set Unk2700_JNENCBCGPGO(value: number) {
        pb_1.Message.setField(this, 5, value);
    }
    get Unk2700_OJBPHCIDAEB() {
        return pb_1.Message.getFieldWithDefault(this, 8, false) as boolean;
    }
    set Unk2700_OJBPHCIDAEB(value: boolean) {
        pb_1.Message.setField(this, 8, value);
    }
    get Unk2700_FGCJEGHOKPG() {
        return pb_1.Message.getFieldWithDefault(this, 1, false) as boolean;
    }
    set Unk2700_FGCJEGHOKPG(value: boolean) {
        pb_1.Message.setField(this, 1, value);
    }
    get Unk2700_DFIBAIILJHN() {
        return pb_1.Message.getFieldWithDefault(this, 2, 0) as number;
    }
    set Unk2700_DFIBAIILJHN(value: number) {
        pb_1.Message.setField(this, 2, value);
    }
    get Unk2700_MKBNLEKMIMD() {
        return pb_1.Message.getFieldWithDefault(this, 1182, 0) as number;
    }
    set Unk2700_MKBNLEKMIMD(value: number) {
        pb_1.Message.setField(this, 1182, value);
    }
    get Unk2700_PINGIIAANMO() {
        return pb_1.Message.getFieldWithDefault(this, 12, 0) as number;
    }
    set Unk2700_PINGIIAANMO(value: number) {
        pb_1.Message.setField(this, 12, value);
    }
    get Unk2700_MONNIDCNDFI() {
        return pb_1.Message.getFieldWithDefault(this, 10, "") as string;
    }
    set Unk2700_MONNIDCNDFI(value: string) {
    ...
    set Unk2700_GGHNLPMAGME(value: number) {
        pb_1.Message.setField(this, 3, value);
    }
    get Unk2700_GDCGOMNBMEO() {
        return pb_1.Message.getFieldWithDefault(this, 1002, []) as number[];
    }
    set Unk2700_GDCGOMNBMEO(value: number[]) {
        pb_1.Message.setField(this, 1002, value);
    }
    get Unk2700_JAEONBMBFJJ() {
        return pb_1.Message.getFieldWithDefault(this, 982, []) as number[];
    }
    set Unk2700_JAEONBMBFJJ(value: number[]) {
        pb_1.Message.setField(this, 982, value);
    }
    get Unk2700_GBCGGDONMCD() {
        return pb_1.Message.getFieldWithDefault(this, 9, false) as boolean;
    }
    set Unk2700_GBCGGDONMCD(value: boolean) {
        pb_1.Message.setField(this, 9, value);
    }
    get Unk2700_LPEKFJBNEJM() {
        return pb_1.Message.getFieldWithDefault(this, 1822, 0) as number;
    }
    set Unk2700_LPEKFJBNEJM(value: number) {
        pb_1.Message.setField(this, 1822, value);
    }
    get Unk2700_DNLEGADDHKM() {
        return pb_1.Message.getFieldWithDefault(this, 11, false) as boolean;
    }
    set Unk2700_DNLEGADDHKM(value: boolean) {
        pb_1.Message.setField(this, 11, value);
    }
    get Unk2700_BFMNMPPNBHH() {
        return pb_1.Message.getFieldWithDefault(this, 13, 0) as number;
    }
    set Unk2700_BFMNMPPNBHH(value: number) {
    ...
    get Unk2700_KAMOCHAKPGP() {
        return pb_1.Message.getFieldWithDefault(this, 576, 0) as number;
    }
    set Unk2700_KAMOCHAKPGP(value: number) {
        pb_1.Message.setField(this, 576, value);
    }
    get Unk2700_KLPHBLCIOEC() {
        return pb_1.Message.getFieldWithDefault(this, 7, 0) as number;
    }
    set Unk2700_KLPHBLCIOEC(value: number) {
    ...
    set Unk2700_PMCPLPMJCEC(value: number) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MusicBriefInfo {
    ...
    static deserializeBinary(bytes: Uint8Array): MusicBriefInfo {
