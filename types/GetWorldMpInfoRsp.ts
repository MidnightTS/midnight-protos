...
// @generated from protobuf file "GetWorldMpInfoRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface GetWorldMpInfoRsp {
    /**
     * @generated from protobuf field: uint32 quit_mp_valid_time = 15;
     */
    ...
    retcode: number;
    /**
     * @generated from protobuf field: bool is_in_mp_mode = 14;
     */
    isInMpMode: boolean;
}
...
class GetWorldMpInfoRsp$Type extends MessageType<GetWorldMpInfoRsp> {
    ...
    internalBinaryWrite(message: GetWorldMpInfoRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isInMpMode !== false)
            writer.tag(14, WireType.Varint).bool(message.isInMpMode);
