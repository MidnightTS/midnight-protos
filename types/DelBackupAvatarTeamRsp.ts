...
// @generated from protobuf file "DelBackupAvatarTeamRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DelBackupAvatarTeamRsp
 */
export interface DelBackupAvatarTeamRsp {
    /**
     * @generated from protobuf field: uint32 backup_avatar_team_id = 9;
     */
...
class DelBackupAvatarTeamRsp$Type extends MessageType<DelBackupAvatarTeamRsp> {
    ...
    internalBinaryWrite(message: DelBackupAvatarTeamRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.backupAvatarTeamId !== 0)
            writer.tag(9, WireType.Varint).uint32(message.backupAvatarTeamId);
        /* int32 retcode = 3; */
