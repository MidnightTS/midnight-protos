...
exports.HomeUpdatePictureFrameInfoRsp = void 0;
...
class HomeUpdatePictureFrameInfoRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeUpdatePictureFrameInfoRsp", [
            { no: 6, name: "picture_frame_info", kind: "message", T: () => HomePictureFrameInfo_1.HomePictureFrameInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.pictureFrameInfo)
            HomePictureFrameInfo_1.HomePictureFrameInfo.internalBinaryWrite(message.pictureFrameInfo, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 9; */
