...
var _EvtAvatarEnterFocusNotify_one_of_decls;
...
class EvtAvatarEnterFocusNotify extends pb_1.Message {
    constructor(data) {
        super();
        _EvtAvatarEnterFocusNotify_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EvtAvatarEnterFocusNotify_one_of_decls, "f"));
...
exports.EvtAvatarEnterFocusNotify = EvtAvatarEnterFocusNotify;
_EvtAvatarEnterFocusNotify_one_of_decls = new WeakMap();
