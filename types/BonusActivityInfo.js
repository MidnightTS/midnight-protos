...
class BonusActivityInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("BonusActivityInfo", [
            { no: 14, name: "bonus_activity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "state", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { bonusActivityId: 0, state: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 bonus_activity_id */ 14:
...
/**
 * @generated MessageType for protobuf message BonusActivityInfo
 */
