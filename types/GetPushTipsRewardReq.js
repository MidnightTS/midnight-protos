...
exports.GetPushTipsRewardReq = void 0;
...
class GetPushTipsRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("GetPushTipsRewardReq", [
            { no: 7, name: "push_tips_id_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 push_tips_id_list */ 7:
...
/**
 * @generated MessageType for protobuf message GetPushTipsRewardReq
 */
