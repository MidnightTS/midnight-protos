...
// @generated from protobuf file "ChannelerSlabLoopDungeonChallengeInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChannelerSlabLoopDungeonChallengeInfoNotify
 */
export interface ChannelerSlabLoopDungeonChallengeInfoNotify {
    /**
     * @generated from protobuf field: repeated uint32 scheme_buff_id_list = 6;
     */
    schemeBuffIdList: number[];
    /**
     * @generated from protobuf field: uint32 dungeon_index = 10;
     */
    dungeonIndex: number;
    /**
     * @generated from protobuf field: repeated uint32 condition_id_list = 8;
     */
    conditionIdList: number[];
    /**
     * @generated from protobuf field: uint32 difficulty_id = 13;
     */
    difficultyId: number;
    /**
...
class ChannelerSlabLoopDungeonChallengeInfoNotify$Type extends MessageType<ChannelerSlabLoopDungeonChallengeInfoNotify> {
    constructor() {
    ...
    create(value?: PartialMessage<ChannelerSlabLoopDungeonChallengeInfoNotify>): ChannelerSlabLoopDungeonChallengeInfoNotify {
        const message = { schemeBuffIdList: [], dungeonIndex: 0, conditionIdList: [], difficultyId: 0, challengeScore: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ChannelerSlabLoopDungeonChallengeInfoNotify>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChannelerSlabLoopDungeonChallengeInfoNotify): ChannelerSlabLoopDungeonChallengeInfoNotify {
    ...
    internalBinaryWrite(message: ChannelerSlabLoopDungeonChallengeInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.difficultyId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.difficultyId);
 ...
 */
export const ChannelerSlabLoopDungeonChallengeInfoNotify = new ChannelerSlabLoopDungeonChallengeInfoNotify$Type();
