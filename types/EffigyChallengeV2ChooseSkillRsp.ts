...
// @generated from protobuf file "EffigyChallengeV2ChooseSkillRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EffigyChallengeV2ChooseSkillRsp
 */
export interface EffigyChallengeV2ChooseSkillRsp {
    /**
     * @generated from protobuf field: uint32 challenge_mode_skill_no = 12;
     */
...
class EffigyChallengeV2ChooseSkillRsp$Type extends MessageType<EffigyChallengeV2ChooseSkillRsp> {
    ...
    internalBinaryWrite(message: EffigyChallengeV2ChooseSkillRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.challengeModeSkillNo !== 0)
            writer.tag(12, WireType.Varint).uint32(message.challengeModeSkillNo);
        /* int32 retcode = 1; */
