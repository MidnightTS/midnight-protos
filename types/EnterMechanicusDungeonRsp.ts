...
// @generated from protobuf file "EnterMechanicusDungeonRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EnterMechanicusDungeonRsp
 */
export interface EnterMechanicusDungeonRsp {
    /**
     * @generated from protobuf field: uint32 wrong_uid = 13;
     */
    wrongUid: number;
    /**
     * @generated from protobuf field: uint32 difficult_level = 15;
     */
...
class EnterMechanicusDungeonRsp$Type extends MessageType<EnterMechanicusDungeonRsp> {
    ...
    internalBinaryWrite(message: EnterMechanicusDungeonRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.wrongUid !== 0)
            writer.tag(13, WireType.Varint).uint32(message.wrongUid);
        /* uint32 difficult_level = 15; */
        if (message.difficultLevel !== 0)
            writer.tag(15, WireType.Varint).uint32(message.difficultLevel);
        /* int32 retcode = 12; */
