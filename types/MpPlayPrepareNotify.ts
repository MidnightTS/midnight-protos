...
// @generated from protobuf file "MpPlayPrepareNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MpPlayPrepareNotify
 */
export interface MpPlayPrepareNotify {
    /**
     * @generated from protobuf field: uint32 mp_play_id = 3;
     */
    mpPlayId: number;
    /**
     * @generated from protobuf field: uint32 prepare_end_time = 13;
     */
...
class MpPlayPrepareNotify$Type extends MessageType<MpPlayPrepareNotify> {
    ...
    internalBinaryWrite(message: MpPlayPrepareNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.prepareEndTime !== 0)
            writer.tag(13, WireType.Varint).uint32(message.prepareEndTime);
