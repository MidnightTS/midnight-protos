...
// @generated from protobuf file "GCGDSCardFaceUnlockNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSCardFaceUnlockNotify
 */
export interface GCGDSCardFaceUnlockNotify {
    /**
     * @generated from protobuf field: uint32 face_type = 13;
     */
    faceType: number;
    /**
...
class GCGDSCardFaceUnlockNotify$Type extends MessageType<GCGDSCardFaceUnlockNotify> {
    ...
    internalBinaryWrite(message: GCGDSCardFaceUnlockNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.faceType !== 0)
            writer.tag(13, WireType.Varint).uint32(message.faceType);
        /* uint32 card_id = 8; */
        if (message.cardId !== 0)
