...
exports.IrodoriChessEquipCardReq = void 0;
...
class IrodoriChessEquipCardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("IrodoriChessEquipCardReq", [
    ...
    create(value) {
        const message = { isHardMap: false, levelId: 0, cardId: 0 };
...
/**
 * @generated MessageType for protobuf message IrodoriChessEquipCardReq
 */
