...
class DungeonCandidateTeamInviteReq$Type extends runtime_5.MessageType {
    constructor() {
        super("DungeonCandidateTeamInviteReq", [
            { no: 4, name: "player_uids", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated uint32 player_uids */ 4:
...
/**
 * @generated MessageType for protobuf message DungeonCandidateTeamInviteReq
 */
