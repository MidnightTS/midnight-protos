...
// @generated from protobuf file "UnionCmdNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface UnionCmdNotify {
    /**
     * @generated from protobuf field: repeated UnionCmd cmd_list = 7;
     */
    cmdList: UnionCmd[];
}
...
class UnionCmdNotify$Type extends MessageType<UnionCmdNotify> {
    constructor() {
        super("UnionCmdNotify", [
            { no: 7, name: "cmd_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => UnionCmd }
        ]);
    }
    ...
    internalBinaryWrite(message: UnionCmdNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.cmdList.length; i++)
            UnionCmd.internalBinaryWrite(message.cmdList[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
