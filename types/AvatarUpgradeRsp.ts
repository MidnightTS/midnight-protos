...
export interface AvatarUpgradeRsp {
    ...
    curLevel: number;
    /**
     * @generated from protobuf field: map<uint32, float> Unk3300_OIMPFCDCDGA = 13 [json_name = "Unk3300OIMPFCDCDGA"];
     */
    unk3300OIMPFCDCDGA: {
        [key: number]: number;
    };
    /**
     * @generated from protobuf field: map<uint32, float> Unk3300_BFNHHNKOLBH = 6 [json_name = "Unk3300BFNHHNKOLBH"];
     */
    unk3300BFNHHNKOLBH: {
        [key: number]: number;
    };
...
class AvatarUpgradeRsp$Type extends MessageType<AvatarUpgradeRsp> {
    ...
    private binaryReadMap13(map: AvatarUpgradeRsp["unk3300OIMPFCDCDGA"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof AvatarUpgradeRsp["unk3300OIMPFCDCDGA"] | undefined, val: AvatarUpgradeRsp["unk3300OIMPFCDCDGA"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    private binaryReadMap6(map: AvatarUpgradeRsp["unk3300BFNHHNKOLBH"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof AvatarUpgradeRsp["unk3300BFNHHNKOLBH"] | undefined, val: AvatarUpgradeRsp["unk3300BFNHHNKOLBH"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
    ...
    internalBinaryWrite(message: AvatarUpgradeRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.unk3300OIMPFCDCDGA))
            writer.tag(13, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Bit32).float(message.unk3300OIMPFCDCDGA[k as any]).join();
        /* map<uint32, float> Unk3300_BFNHHNKOLBH = 6 [json_name = "Unk3300BFNHHNKOLBH"]; */
        for (let k of Object.keys(message.unk3300BFNHHNKOLBH))
            writer.tag(6, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Bit32).float(message.unk3300BFNHHNKOLBH[k as any]).join();
        /* uint32 old_level = 12; */
