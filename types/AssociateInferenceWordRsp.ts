...
// @generated from protobuf file "AssociateInferenceWordRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message AssociateInferenceWordRsp
 */
export interface AssociateInferenceWordRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_FDGLBLJOKOK = 8 [json_name = "Unk3300FDGLBLJOKOK"];
     */
    unk3300FDGLBLJOKOK: number;
    /**
     * @generated from protobuf field: uint32 Unk3300_EPMGHELECNH = 9 [json_name = "Unk3300EPMGHELECNH"];
     */
...
class AssociateInferenceWordRsp$Type extends MessageType<AssociateInferenceWordRsp> {
    ...
    internalBinaryWrite(message: AssociateInferenceWordRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300FDGLBLJOKOK !== 0)
            writer.tag(8, WireType.Varint).uint32(message.unk3300FDGLBLJOKOK);
        /* uint32 Unk3300_EPMGHELECNH = 9 [json_name = "Unk3300EPMGHELECNH"]; */
        if (message.unk3300EPMGHELECNH !== 0)
            writer.tag(9, WireType.Varint).uint32(message.unk3300EPMGHELECNH);
        /* uint32 page_id = 6; */
        if (message.pageId !== 0)
