...
exports.VintageMarketDeliverItemReq = void 0;
...
class VintageMarketDeliverItemReq$Type extends runtime_5.MessageType {
    constructor() {
        super("VintageMarketDeliverItemReq", [
            { no: 12, name: "deliver_item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam_1.ItemParam },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated ItemParam deliver_item_list */ 12:
                    message.deliverItemList.push(ItemParam_1.ItemParam.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.deliverItemList.length; i++)
            ItemParam_1.ItemParam.internalBinaryWrite(message.deliverItemList[i], writer.tag(12, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 trader_id = 3; */
