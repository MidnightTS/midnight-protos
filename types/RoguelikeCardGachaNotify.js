...
class RoguelikeCardGachaNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("RoguelikeCardGachaNotify", [
            { no: 7, name: "is_can_refresh", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 15, name: "card_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { isCanRefresh: false, cardList: [] };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isCanRefresh !== false)
            writer.tag(7, runtime_2.WireType.Varint).bool(message.isCanRefresh);
...
/**
 * @generated MessageType for protobuf message RoguelikeCardGachaNotify
 */
