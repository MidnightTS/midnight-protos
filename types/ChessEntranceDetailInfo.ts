...
// @generated from protobuf file "ChessEntranceDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { ChessEntranceInfo } from "./ChessEntranceInfo";
/**
 * @generated from protobuf message ChessEntranceDetailInfo
 */
export interface ChessEntranceDetailInfo {
    /**
     * @generated from protobuf field: repeated ChessEntranceInfo info_list = 9;
     */
...
class ChessEntranceDetailInfo$Type extends MessageType<ChessEntranceDetailInfo> {
    constructor() {
        super("ChessEntranceDetailInfo", [
            { no: 9, name: "info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ChessEntranceInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: ChessEntranceDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.infoList.length; i++)
            ChessEntranceInfo.internalBinaryWrite(message.infoList[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
