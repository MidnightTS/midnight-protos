...
// @generated from protobuf file "GCGWaitingCharacter.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message GCGWaitingCharacter
 */
export interface GCGWaitingCharacter {
    /**
     * @generated from protobuf field: uint32 cond_count = 1;
     */
    condCount: number;
    /**
     * @generated from protobuf field: uint32 card_id = 11;
     */
    cardId: number;
}
...
class GCGWaitingCharacter$Type extends MessageType<GCGWaitingCharacter> {
    ...
    internalBinaryWrite(message: GCGWaitingCharacter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.condCount !== 0)
            writer.tag(1, WireType.Varint).uint32(message.condCount);
        /* uint32 card_id = 11; */
        if (message.cardId !== 0)
