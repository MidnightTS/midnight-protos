...
// @generated from protobuf file "HomePreChangeEditModeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomePreChangeEditModeNotify
 */
export interface HomePreChangeEditModeNotify {
    /**
     * @generated from protobuf field: bool is_enter_edit_mode = 10;
     */
...
class HomePreChangeEditModeNotify$Type extends MessageType<HomePreChangeEditModeNotify> {
    ...
    internalBinaryWrite(message: HomePreChangeEditModeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isEnterEditMode !== false)
            writer.tag(10, WireType.Varint).bool(message.isEnterEditMode);
