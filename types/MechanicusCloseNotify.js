...
exports.MechanicusCloseNotify = void 0;
...
class MechanicusCloseNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("MechanicusCloseNotify", [
            { no: 9, name: "mechanicus_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message MechanicusCloseNotify
 */
