...
// @generated from protobuf file "GCGDSCardNumChangeNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSCardNumChangeNotify
 */
export interface GCGDSCardNumChangeNotify {
    ...
    num: number;
    /**
     * @generated from protobuf field: uint32 card_id = 15;
     */
    cardId: number;
}
...
class GCGDSCardNumChangeNotify$Type extends MessageType<GCGDSCardNumChangeNotify> {
    ...
    internalBinaryWrite(message: GCGDSCardNumChangeNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 card_id = 15; */
        if (message.cardId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.cardId);
