...
// @generated from protobuf file "editor.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class MapInfo$Type extends MessageType<MapInfo> {
    constructor() {
        super("com.midnights.game.MapInfo", [
            ...
            { no: 5, name: "cells", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CellInfo }
        ]);
    }
