...
// @generated from protobuf file "IrodoriChessLeftMonsterNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message IrodoriChessLeftMonsterNotify
 */
export interface IrodoriChessLeftMonsterNotify {
    /**
     * @generated from protobuf field: uint32 left_monsters = 4;
     */
    leftMonsters: number;
}
...
class IrodoriChessLeftMonsterNotify$Type extends MessageType<IrodoriChessLeftMonsterNotify> {
    ...
    internalBinaryWrite(message: IrodoriChessLeftMonsterNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.leftMonsters !== 0)
            writer.tag(4, WireType.Varint).uint32(message.leftMonsters);
