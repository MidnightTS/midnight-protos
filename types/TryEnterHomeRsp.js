...
var _TryEnterHomeRsp_one_of_decls;
...
class TryEnterHomeRsp extends pb_1.Message {
    constructor(data) {
        super();
        _TryEnterHomeRsp_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [10], __classPrivateFieldGet(this, _TryEnterHomeRsp_one_of_decls, "f"));
...
exports.TryEnterHomeRsp = TryEnterHomeRsp;
_TryEnterHomeRsp_one_of_decls = new WeakMap();
