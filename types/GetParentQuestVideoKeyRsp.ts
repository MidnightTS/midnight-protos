...
// @generated from protobuf file "GetParentQuestVideoKeyRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GetParentQuestVideoKeyRsp
 */
export interface GetParentQuestVideoKeyRsp {
    ...
    /**
     * @generated from protobuf field: uint64 video_key = 12;
     */
    videoKey: bigint;
    /**
...
class GetParentQuestVideoKeyRsp$Type extends MessageType<GetParentQuestVideoKeyRsp> {
    ...
    internalBinaryWrite(message: GetParentQuestVideoKeyRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.videoKey !== 0n)
            writer.tag(12, WireType.Varint).uint64(message.videoKey);
        /* int32 retcode = 4; */
