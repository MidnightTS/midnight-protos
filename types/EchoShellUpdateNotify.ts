...
// @generated from protobuf file "EchoShellUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EchoShellUpdateNotify
 */
export interface EchoShellUpdateNotify {
    /**
     * @generated from protobuf field: uint32 shell_id = 10;
     */
    shellId: number;
}
...
class EchoShellUpdateNotify$Type extends MessageType<EchoShellUpdateNotify> {
    ...
    internalBinaryWrite(message: EchoShellUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.shellId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.shellId);
