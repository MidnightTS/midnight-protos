...
exports.PotionLevelData = void 0;
...
class PotionLevelData$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.difficultyLevel !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.difficultyLevel);
        /* uint32 mode_id = 7; */
        if (message.modeId !== 0)
            writer.tag(7, runtime_1.WireType.Varint).uint32(message.modeId);
        /* uint32 score = 1; */
        if (message.score !== 0)
