...
class MiracleRingTakeRewardReq$Type extends runtime_5.MessageType {
    constructor() {
        super("MiracleRingTakeRewardReq", [
            { no: 14, name: "gadget_entity_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 9, name: "gadget_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { gadgetEntityId: 0, gadgetId: 0 };
...
/**
 * @generated MessageType for protobuf message MiracleRingTakeRewardReq
 */
