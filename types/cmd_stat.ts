...
// @generated from protobuf file "cmd_stat.proto" (package "com.midnights.game", syntax proto2)
// tslint:disable
...
class AISnapshotEntityData$Type extends MessageType<AISnapshotEntityData> {
    constructor() {
        super("com.midnights.game.AISnapshotEntityData", [
            ...
            { no: 9, name: "finished_skill_cycles", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AISnapshotEntitySkillCycle },
...
class AISnapshotInfo$Type extends MessageType<AISnapshotInfo> {
    constructor() {
        super("com.midnights.game.AISnapshotInfo", [
            { no: 13, name: "ai_snapshots", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => AISnapshotEntityData }
        ]);
    }
