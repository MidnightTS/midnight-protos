...
// @generated from protobuf file "SetPlayerPropReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface SetPlayerPropReq {
    /**
     * @generated from protobuf field: repeated PropValue prop_list = 3;
     */
    propList: PropValue[];
}
...
class SetPlayerPropReq$Type extends MessageType<SetPlayerPropReq> {
    constructor() {
        super("SetPlayerPropReq", [
            { no: 3, name: "prop_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PropValue }
        ]);
    }
    ...
    internalBinaryWrite(message: SetPlayerPropReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.propList.length; i++)
            PropValue.internalBinaryWrite(message.propList[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
