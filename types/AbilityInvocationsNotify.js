...
exports.AbilityInvocationsNotify = void 0;
...
class AbilityInvocationsNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("AbilityInvocationsNotify", [
            { no: 5, name: "invokes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AbilityInvokeEntry_1.AbilityInvokeEntry }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.invokes.length; i++)
            AbilityInvokeEntry_1.AbilityInvokeEntry.internalBinaryWrite(message.invokes[i], writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
