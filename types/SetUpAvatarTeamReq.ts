...
// @generated from protobuf file "SetUpAvatarTeamReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface SetUpAvatarTeamReq {
    /**
     * @generated from protobuf field: uint32 team_id = 13;
     */
    teamId: number;
    /**
...
class SetUpAvatarTeamReq$Type extends MessageType<SetUpAvatarTeamReq> {
    ...
    internalBinaryWrite(message: SetUpAvatarTeamReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 team_id = 13; */
        if (message.teamId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.teamId);
