...
class GCGMsgMoveCard$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGMsgMoveCard", [
            { no: 9, name: "Unk3300_EJHNJMBJBKG", kind: "enum", jsonName: "Unk3300EJHNJMBJBKG", T: () => ["GCGZoneType", GCGZoneType_1.GCGZoneType] },
            { no: 2, name: "fail_guid_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ },
            { no: 14, name: "Unk3300_NJILOBDEECC", kind: "enum", jsonName: "Unk3300NJILOBDEECC", T: () => ["GCGZoneType", GCGZoneType_1.GCGZoneType] },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300EJHNJMBJBKG !== 0)
            writer.tag(9, runtime_2.WireType.Varint).int32(message.unk3300EJHNJMBJBKG);
        ...
        if (message.unk3300NJILOBDEECC !== 0)
            writer.tag(14, runtime_2.WireType.Varint).int32(message.unk3300NJILOBDEECC);
