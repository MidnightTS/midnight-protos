...
// @generated from protobuf file "ProjectorOptionRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ProjectorOptionRsp
 */
export interface ProjectorOptionRsp {
    ...
    entityId: number;
    /**
     * @generated from protobuf field: uint32 op_type = 14;
     */
    opType: number;
}
...
class ProjectorOptionRsp$Type extends MessageType<ProjectorOptionRsp> {
    ...
    internalBinaryWrite(message: ProjectorOptionRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 op_type = 14; */
        if (message.opType !== 0)
            writer.tag(14, WireType.Varint).uint32(message.opType);
