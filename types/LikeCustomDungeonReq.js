...
exports.LikeCustomDungeonReq = void 0;
...
class LikeCustomDungeonReq$Type extends runtime_5.MessageType {
    constructor() {
        super("LikeCustomDungeonReq", [
            { no: 2, name: "is_cancel_like", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "dungeon_guid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
        const message = { isCancelLike: false, dungeonGuid: 0n };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isCancelLike !== false)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.isCancelLike);
...
/**
 * @generated MessageType for protobuf message LikeCustomDungeonReq
 */
