...
// @generated from protobuf file "FleurFairReplayMiniGameRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FleurFairReplayMiniGameRsp
 */
export interface FleurFairReplayMiniGameRsp {
    /**
     * @generated from protobuf field: uint32 minigame_id = 6;
     */
    minigameId: number;
    /**
...
class FleurFairReplayMiniGameRsp$Type extends MessageType<FleurFairReplayMiniGameRsp> {
    ...
    internalBinaryWrite(message: FleurFairReplayMiniGameRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.minigameId !== 0)
            writer.tag(6, WireType.Varint).uint32(message.minigameId);
        /* int32 retcode = 5; */
