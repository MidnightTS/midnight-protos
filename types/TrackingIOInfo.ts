...
export interface TrackingIOInfo {
    /**
     * @generated from protobuf field: string Unk3300_KGGPDKGDELG = 10 [json_name = "Unk3300KGGPDKGDELG"];
     */
    ...
    /**
     * @generated from protobuf field: string Unk3300_GEJJKDLGFPH = 5 [json_name = "Unk3300GEJJKDLGFPH"];
     */
...
class TrackingIOInfo$Type extends MessageType<TrackingIOInfo> {
    ...
    internalBinaryWrite(message: TrackingIOInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.unk3300KGGPDKGDELG !== "")
            writer.tag(10, WireType.LengthDelimited).string(message.unk3300KGGPDKGDELG);
        ...
        if (message.unk3300GEJJKDLGFPH !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.unk3300GEJJKDLGFPH);
