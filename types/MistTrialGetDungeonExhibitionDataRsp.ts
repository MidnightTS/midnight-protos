...
// @generated from protobuf file "MistTrialGetDungeonExhibitionDataRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message MistTrialGetDungeonExhibitionDataRsp
 */
export interface MistTrialGetDungeonExhibitionDataRsp {
    /**
     * @generated from protobuf field: uint32 trial_id = 10;
     */
    trialId: number;
    /**
...
class MistTrialGetDungeonExhibitionDataRsp$Type extends MessageType<MistTrialGetDungeonExhibitionDataRsp> {
    ...
    internalBinaryWrite(message: MistTrialGetDungeonExhibitionDataRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.trialId !== 0)
            writer.tag(10, WireType.Varint).uint32(message.trialId);
        /* int32 retcode = 2; */
