...
// @generated from protobuf file "MusicGameStartRsp.proto" (syntax proto3)
// tslint:disable
//
...
export interface MusicGameStartRsp {
    ...
    retcode: number;
    /**
     * @generated from protobuf field: uint32 music_basic_id = 13;
     */
    musicBasicId: number;
    /**
     * @generated from protobuf field: uint64 ugc_guid = 5;
     */
    ugcGuid: bigint;
}
...
class MusicGameStartRsp$Type extends MessageType<MusicGameStartRsp> {
    ...
    internalBinaryWrite(message: MusicGameStartRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.musicBasicId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.musicBasicId);
        /* uint64 ugc_guid = 5; */
