...
// @generated from protobuf file "ChangeWidgetBackgroundActiveStateReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChangeWidgetBackgroundActiveStateReq
 */
export interface ChangeWidgetBackgroundActiveStateReq {
    ...
    isActive: boolean;
    /**
     * @generated from protobuf field: uint32 material_id = 13;
     */
    materialId: number;
}
...
class ChangeWidgetBackgroundActiveStateReq$Type extends MessageType<ChangeWidgetBackgroundActiveStateReq> {
    ...
    internalBinaryWrite(message: ChangeWidgetBackgroundActiveStateReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.materialId !== 0)
            writer.tag(13, WireType.Varint).uint32(message.materialId);
