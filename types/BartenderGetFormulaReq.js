...
exports.BartenderGetFormulaReq = void 0;
...
class BartenderGetFormulaReq$Type extends runtime_5.MessageType {
    constructor() {
        super("BartenderGetFormulaReq", [
            { no: 1, name: "item_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ItemParam_1.ItemParam },
            { no: 4, name: "quest_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { itemList: [], questId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.itemList.length; i++)
            ItemParam_1.ItemParam.internalBinaryWrite(message.itemList[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 quest_id = 4; */
...
/**
 * @generated MessageType for protobuf message BartenderGetFormulaReq
 */
