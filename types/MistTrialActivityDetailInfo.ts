...
// @generated from protobuf file "MistTrialActivityDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { MistTrialLevelData } from "./MistTrialLevelData";
/**
 * @generated from protobuf message MistTrialActivityDetailInfo
 */
export interface MistTrialActivityDetailInfo {
    /**
     * @generated from protobuf field: repeated MistTrialLevelData trial_level_data_list = 1;
     */
...
class MistTrialActivityDetailInfo$Type extends MessageType<MistTrialActivityDetailInfo> {
    constructor() {
        super("MistTrialActivityDetailInfo", [
            { no: 1, name: "trial_level_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MistTrialLevelData }
        ]);
    }
    ...
    internalBinaryWrite(message: MistTrialActivityDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.trialLevelDataList.length; i++)
            MistTrialLevelData.internalBinaryWrite(message.trialLevelDataList[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
