...
class AvatarEnterSceneInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("AvatarEnterSceneInfo", [
            ...
            { no: 1, name: "avatar_ability_info", kind: "message", T: () => AbilitySyncStateInfo_1.AbilitySyncStateInfo },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.weaponAbilityInfo)
            AbilitySyncStateInfo_1.AbilitySyncStateInfo.internalBinaryWrite(message.weaponAbilityInfo, writer.tag(6, runtime_2.WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.avatarAbilityInfo)
            AbilitySyncStateInfo_1.AbilitySyncStateInfo.internalBinaryWrite(message.avatarAbilityInfo, writer.tag(1, runtime_2.WireType.LengthDelimited).fork(), options).join();
