...
// @generated from protobuf file "HomePlantInfoNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomePlantInfoNotify
 */
export interface HomePlantInfoNotify {
    /**
     * @generated from protobuf field: repeated HomePlantFieldData field_list = 11;
     */
...
class HomePlantInfoNotify$Type extends MessageType<HomePlantInfoNotify> {
    constructor() {
        super("HomePlantInfoNotify", [
            { no: 11, name: "field_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => HomePlantFieldData }
        ]);
    }
    ...
    internalBinaryWrite(message: HomePlantInfoNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fieldList.length; i++)
            HomePlantFieldData.internalBinaryWrite(message.fieldList[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
