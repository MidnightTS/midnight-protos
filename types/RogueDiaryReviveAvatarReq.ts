...
// @generated from protobuf file "RogueDiaryReviveAvatarReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message RogueDiaryReviveAvatarReq
 */
export interface RogueDiaryReviveAvatarReq {
    /**
     * @generated from protobuf field: RogueDiaryAvatar revive_avatar = 15;
     */
...
class RogueDiaryReviveAvatarReq$Type extends MessageType<RogueDiaryReviveAvatarReq> {
    constructor() {
        super("RogueDiaryReviveAvatarReq", [
            { no: 15, name: "revive_avatar", kind: "message", T: () => RogueDiaryAvatar }
        ]);
    }
    ...
    internalBinaryWrite(message: RogueDiaryReviveAvatarReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.reviveAvatar)
            RogueDiaryAvatar.internalBinaryWrite(message.reviveAvatar, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
