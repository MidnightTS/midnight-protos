...
// @generated from protobuf file "CoopProgressUpdateNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message CoopProgressUpdateNotify
 */
export interface CoopProgressUpdateNotify {
    /**
     * @generated from protobuf field: uint32 cur_coop_point = 4;
     */
    curCoopPoint: number;
    /**
     * @generated from protobuf field: bool is_have_progress = 8;
     */
...
class CoopProgressUpdateNotify$Type extends MessageType<CoopProgressUpdateNotify> {
    ...
    internalBinaryWrite(message: CoopProgressUpdateNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.curCoopPoint !== 0)
            writer.tag(4, WireType.Varint).uint32(message.curCoopPoint);
        /* bool is_have_progress = 8; */
        if (message.isHaveProgress !== false)
            writer.tag(8, WireType.Varint).bool(message.isHaveProgress);
