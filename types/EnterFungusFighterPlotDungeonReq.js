...
exports.EnterFungusFighterPlotDungeonReq = void 0;
...
class EnterFungusFighterPlotDungeonReq$Type extends runtime_5.MessageType {
    constructor() {
        super("EnterFungusFighterPlotDungeonReq", [
    ...
    create(value) {
        const message = { fungusIdList: [], dungeonId: 0 };
...
/**
 * @generated MessageType for protobuf message EnterFungusFighterPlotDungeonReq
 */
