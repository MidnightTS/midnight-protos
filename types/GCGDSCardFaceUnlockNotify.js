...
exports.GCGDSCardFaceUnlockNotify = void 0;
...
class GCGDSCardFaceUnlockNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("GCGDSCardFaceUnlockNotify", [
            { no: 13, name: "face_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 8, name: "card_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { faceType: 0, cardId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.faceType !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.faceType);
        /* uint32 card_id = 8; */
        if (message.cardId !== 0)
...
/**
 * @generated MessageType for protobuf message GCGDSCardFaceUnlockNotify
 */
