...
// @generated from protobuf file "ChangeWorldToSingleModeRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ChangeWorldToSingleModeRsp
 */
export interface ChangeWorldToSingleModeRsp {
    /**
     * @generated from protobuf field: uint32 quit_mp_valid_time = 6;
     */
...
class ChangeWorldToSingleModeRsp$Type extends MessageType<ChangeWorldToSingleModeRsp> {
    ...
    internalBinaryWrite(message: ChangeWorldToSingleModeRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.quitMpValidTime !== 0)
            writer.tag(6, WireType.Varint).uint32(message.quitMpValidTime);
        /* int32 retcode = 14; */
