...
// @generated from protobuf file "PlantFlowerGetCanGiveFriendFlowerRsp.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlantFlowerGetCanGiveFriendFlowerRsp
 */
export interface PlantFlowerGetCanGiveFriendFlowerRsp {
    /**
     * @generated from protobuf field: map<uint32, uint32> flower_num_map = 5;
     */
    flowerNumMap: {
        [key: number]: number;
    };
...
class PlantFlowerGetCanGiveFriendFlowerRsp$Type extends MessageType<PlantFlowerGetCanGiveFriendFlowerRsp> {
    ...
    private binaryReadMap5(map: PlantFlowerGetCanGiveFriendFlowerRsp["flowerNumMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: PlantFlowerGetCanGiveFriendFlowerRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.flowerNumMap))
            writer.tag(5, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.flowerNumMap[k as any]).join();
        /* int32 retcode = 3; */
