...
class ActivityDungeonAvatar$Type extends runtime_5.MessageType {
    ...
    create(value) {
        const message = { avatarId: 0, isTrial: false, costumeId: 0 };
...
/**
 * @generated MessageType for protobuf message ActivityDungeonAvatar
 */
