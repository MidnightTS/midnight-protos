...
exports.PlayerSetPauseReq = void 0;
...
class PlayerSetPauseReq$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerSetPauseReq", [
            { no: 15, name: "is_paused", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isPaused !== false)
            writer.tag(15, runtime_1.WireType.Varint).bool(message.isPaused);
