...
// @generated from protobuf file "ClientHashDebugNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message ClientHashDebugNotify
 */
export interface ClientHashDebugNotify {
    /**
     * @generated from protobuf field: uint32 job_id = 15;
     */
    jobId: number;
}
...
class ClientHashDebugNotify$Type extends MessageType<ClientHashDebugNotify> {
    ...
    internalBinaryWrite(message: ClientHashDebugNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 job_id = 15; */
        if (message.jobId !== 0)
            writer.tag(15, WireType.Varint).uint32(message.jobId);
