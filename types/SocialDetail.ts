...
import * as dependency_2 from "./FriendEnterHomeOption";
import * as dependency_3 from "./FriendOnlineState";
import * as dependency_4 from "./ProfilePicture";
import * as dependency_5 from "./SocialShowAvatarInfo";
import * as pb_1 from "google-protobuf";
export class SocialDetail extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        ...
        world_level?: number;
        reserved_list?: number[];
        online_state?: dependency_3.FriendOnlineState;
        param?: number;
        is_friend?: boolean;
        ...
        friend_enter_home_option?: dependency_2.FriendEnterHomeOption;
        profile_picture?: dependency_4.ProfilePicture;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [8, 22, 23], this.#one_of_decls);
    ...
    get birthday() {
        return pb_1.Message.getWrapperField(this, dependency_1.Birthday, 6) as dependency_1.Birthday;
    }
    ...
    set reserved_list(value: number[]) {
        pb_1.Message.setField(this, 8, value);
    }
    get online_state() {
        return pb_1.Message.getFieldWithDefault(this, 9, dependency_3.FriendOnlineState.FRIEND_ONLINE_STATE_FREIEND_DISCONNECT) as dependency_3.FriendOnlineState;
    }
    set online_state(value: dependency_3.FriendOnlineState) {
    ...
    set is_in_blacklist(value: boolean) {
    ...
    get show_name_card_id_list() {
        return pb_1.Message.getFieldWithDefault(this, 23, []) as number[];
    }
    set show_name_card_id_list(value: number[]) {
        pb_1.Message.setField(this, 23, value);
    }
    get friend_enter_home_option() {
        return pb_1.Message.getFieldWithDefault(this, 24, dependency_2.FriendEnterHomeOption.FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM) as dependency_2.FriendEnterHomeOption;
    }
    set friend_enter_home_option(value: dependency_2.FriendEnterHomeOption) {
        pb_1.Message.setField(this, 24, value);
    }
    get profile_picture() {
        return pb_1.Message.getWrapperField(this, dependency_4.ProfilePicture, 25) as dependency_4.ProfilePicture;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SocialDetail {
    ...
    static deserializeBinary(bytes: Uint8Array): SocialDetail {
