...
class PlayerGetForceQuitBanInfoRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("PlayerGetForceQuitBanInfoRsp", [
            { no: 13, name: "match_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "expire_time", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { matchId: 0, expireTime: 0, retcode: 0 };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 match_id */ 13:
                    message.matchId = reader.uint32();
                    break;
                case /* uint32 expire_time */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.matchId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.matchId);
        /* uint32 expire_time = 2; */
        if (message.expireTime !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.expireTime);
        /* int32 retcode = 4; */
