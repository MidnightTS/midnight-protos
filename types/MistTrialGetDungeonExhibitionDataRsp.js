...
exports.MistTrialGetDungeonExhibitionDataRsp = void 0;
...
class MistTrialGetDungeonExhibitionDataRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("MistTrialGetDungeonExhibitionDataRsp", [
            { no: 10, name: "trial_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.trialId !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.trialId);
        /* int32 retcode = 2; */
...
/**
 * @generated MessageType for protobuf message MistTrialGetDungeonExhibitionDataRsp
 */
