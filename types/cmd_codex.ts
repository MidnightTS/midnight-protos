...
// @generated from protobuf file "cmd_codex.proto" (package "com.midnights.game", syntax proto3)
// tslint:disable
...
class CodexDataFullNotify$Type extends MessageType<CodexDataFullNotify> {
    constructor() {
        super("com.midnights.game.CodexDataFullNotify", [
            ...
            { no: 6, name: "type_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CodexTypeData }
        ]);
    }
...
class ViewCodexReq$Type extends MessageType<ViewCodexReq> {
    constructor() {
        super("com.midnights.game.ViewCodexReq", [
            { no: 10, name: "type_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CodexTypeData }
        ]);
    }
...
class ViewCodexRsp$Type extends MessageType<ViewCodexRsp> {
    constructor() {
        super("com.midnights.game.ViewCodexRsp", [
            ...
            { no: 9, name: "type_data_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CodexTypeData },
