...
class BargainSnapshot$Type extends runtime_5.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.unk3300KOCJELACJLM !== 0)
            writer.tag(11, runtime_1.WireType.Varint).uint32(message.unk3300KOCJELACJLM);
        /* uint32 Unk3300_MHFDEBOBFNE = 14 [json_name = "Unk3300MHFDEBOBFNE"]; */
        if (message.unk3300MHFDEBOBFNE !== 0)
            writer.tag(14, runtime_1.WireType.Varint).uint32(message.unk3300MHFDEBOBFNE);
        /* uint32 bargain_id = 3; */
        if (message.bargainId !== 0)
            writer.tag(3, runtime_1.WireType.Varint).uint32(message.bargainId);
        /* int32 cur_mood = 8; */
        if (message.curMood !== 0)
            writer.tag(8, runtime_1.WireType.Varint).int32(message.curMood);
