...
class PacketHead extends pb_1.Message {
    constructor(data) {
        super();
        _PacketHead_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PacketHead_one_of_decls, "f"));
    ...
    set client_sequence_id(value) {
        pb_1.Message.setField(this, 3, value);
    }
    get enet_channel_id() {
        return pb_1.Message.getFieldWithDefault(this, 4, 0);
    }
    set enet_channel_id(value) {
        pb_1.Message.setField(this, 4, value);
    }
    get enet_is_reliable() {
        return pb_1.Message.getFieldWithDefault(this, 5, 0);
    }
    set enet_is_reliable(value) {
    ...
    set sender_app_id(value) {
        pb_1.Message.setField(this, 24, value);
    }
    get source_service() {
        return pb_1.Message.getFieldWithDefault(this, 31, 0);
    }
    set source_service(value) {
        pb_1.Message.setField(this, 31, value);
    }
    get target_service() {
        return pb_1.Message.getFieldWithDefault(this, 32, 0);
    }
    set target_service(value) {
        pb_1.Message.setField(this, 32, value);
    }
    get service_app_id_map() {
        return pb_1.Message.getField(this, 33);
    }
    set service_app_id_map(value) {
        pb_1.Message.setField(this, 33, value);
    }
    get is_set_game_thread() {
        return pb_1.Message.getFieldWithDefault(this, 34, false);
    }
    set is_set_game_thread(value) {
        pb_1.Message.setField(this, 34, value);
    }
    get game_thread_index() {
        return pb_1.Message.getFieldWithDefault(this, 35, 0);
    }
    set game_thread_index(value) {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 22:
                    ...
                    break;
                case 23:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.ext_map, reader, reader.readUint32, reader.readUint32));
                    break;
                case 24:
                ...
                case 32:
                    ...
                    break;
                case 33:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.service_app_id_map, reader, reader.readUint32, reader.readUint32));
                    break;
                case 34:
...
_PacketHead_one_of_decls = new WeakMap();
