...
exports.MichiaeMatsuriChallengePositionInfo = void 0;
...
class MichiaeMatsuriChallengePositionInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("MichiaeMatsuriChallengePositionInfo", [
            { no: 7, name: "gadget_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 4, name: "pos", kind: "message", T: () => Vector_1.Vector },
            { no: 11, name: "group_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { gadgetId: 0, groupId: 0 };
...
/**
 * @generated MessageType for protobuf message MichiaeMatsuriChallengePositionInfo
 */
