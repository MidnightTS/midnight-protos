...
exports.MPLevelEntityInfo = void 0;
...
class MPLevelEntityInfo$Type extends runtime_5.MessageType {
    constructor() {
        super("MPLevelEntityInfo", [
            { no: 15, name: "ability_info", kind: "message", T: () => AbilitySyncStateInfo_1.AbilitySyncStateInfo },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* AbilitySyncStateInfo ability_info */ 15:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.abilityInfo)
            AbilitySyncStateInfo_1.AbilitySyncStateInfo.internalBinaryWrite(message.abilityInfo, writer.tag(15, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 10; */
        ...
        if (message.authorityPeerId !== 0)
            writer.tag(5, runtime_1.WireType.Varint).uint32(message.authorityPeerId);
