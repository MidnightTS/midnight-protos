...
// @generated from protobuf file "LunchBoxData.proto" (syntax proto3)
// tslint:disable
//
...
export interface LunchBoxData {
    /**
     * @generated from protobuf field: map<uint32, uint32> slot_material_map = 4;
     */
    slotMaterialMap: {
        [key: number]: number;
    };
...
class LunchBoxData$Type extends MessageType<LunchBoxData> {
    ...
    private binaryReadMap4(map: LunchBoxData["slotMaterialMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
    ...
    internalBinaryWrite(message: LunchBoxData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of Object.keys(message.slotMaterialMap))
            writer.tag(4, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k)).tag(2, WireType.Varint).uint32(message.slotMaterialMap[k as any]).join();
