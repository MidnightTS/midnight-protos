...
exports.MistTrialGetChallengeMissionReq = void 0;
...
class MistTrialGetChallengeMissionReq$Type extends runtime_5.MessageType {
    constructor() {
        super("MistTrialGetChallengeMissionReq", [
            { no: 12, name: "trial_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { trialId: 0 };
...
/**
 * @generated MessageType for protobuf message MistTrialGetChallengeMissionReq
 */
