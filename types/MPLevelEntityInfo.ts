...
// @generated from protobuf file "MPLevelEntityInfo.proto" (syntax proto3)
// tslint:disable
//
...
export interface MPLevelEntityInfo {
    /**
     * @generated from protobuf field: AbilitySyncStateInfo ability_info = 15;
     */
...
class MPLevelEntityInfo$Type extends MessageType<MPLevelEntityInfo> {
    constructor() {
        super("MPLevelEntityInfo", [
            { no: 15, name: "ability_info", kind: "message", T: () => AbilitySyncStateInfo },
    ...
    internalBinaryWrite(message: MPLevelEntityInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.abilityInfo)
            AbilitySyncStateInfo.internalBinaryWrite(message.abilityInfo, writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* uint32 entity_id = 10; */
