...
// @generated from protobuf file "GCGDSChangeCardFaceReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message GCGDSChangeCardFaceReq
 */
export interface GCGDSChangeCardFaceReq {
    ...
    cardId: number;
    /**
     * @generated from protobuf field: uint32 face_type = 14;
     */
    faceType: number;
}
...
class GCGDSChangeCardFaceReq$Type extends MessageType<GCGDSChangeCardFaceReq> {
    ...
    internalBinaryWrite(message: GCGDSChangeCardFaceReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.faceType !== 0)
            writer.tag(14, WireType.Varint).uint32(message.faceType);
