...
// @generated from protobuf file "FinishLanternProjectionReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message FinishLanternProjectionReq
 */
export interface FinishLanternProjectionReq {
    /**
     * @generated from protobuf field: uint32 finish_time = 8;
     */
    finishTime: number;
    /**
...
class FinishLanternProjectionReq$Type extends MessageType<FinishLanternProjectionReq> {
    ...
    internalBinaryWrite(message: FinishLanternProjectionReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.finishTime !== 0)
            writer.tag(8, WireType.Varint).uint32(message.finishTime);
        /* uint32 level_id = 15; */
