...
// @generated from protobuf file "PlayerInjectFixNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerInjectFixNotify
 */
export interface PlayerInjectFixNotify {
    ...
    id: number;
    /**
     * @generated from protobuf field: bytes inject_fix = 12;
     */
...
class PlayerInjectFixNotify$Type extends MessageType<PlayerInjectFixNotify> {
    ...
    internalBinaryWrite(message: PlayerInjectFixNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.injectFix.length)
            writer.tag(12, WireType.LengthDelimited).bytes(message.injectFix);
