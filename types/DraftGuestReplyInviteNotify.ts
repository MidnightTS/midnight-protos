...
// @generated from protobuf file "DraftGuestReplyInviteNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DraftGuestReplyInviteNotify
 */
export interface DraftGuestReplyInviteNotify {
    ...
    isAgree: boolean;
    /**
     * @generated from protobuf field: uint32 guest_uid = 13;
     */
    guestUid: number;
    /**
     * @generated from protobuf field: uint32 draft_id = 2;
     */
    draftId: number;
}
...
class DraftGuestReplyInviteNotify$Type extends MessageType<DraftGuestReplyInviteNotify> {
    ...
    internalBinaryWrite(message: DraftGuestReplyInviteNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.guestUid !== 0)
            writer.tag(13, WireType.Varint).uint32(message.guestUid);
        /* uint32 draft_id = 2; */
        if (message.draftId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.draftId);
