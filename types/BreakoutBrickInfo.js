...
exports.BreakoutBrickInfo = void 0;
...
class BreakoutBrickInfo$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        /* uint32 hp = 1; */
        if (message.hp !== 0)
            writer.tag(1, runtime_1.WireType.Varint).uint32(message.hp);
 ...
 */
exports.BreakoutBrickInfo = new BreakoutBrickInfo$Type();
