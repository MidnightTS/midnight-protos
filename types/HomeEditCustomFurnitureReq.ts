...
// @generated from protobuf file "HomeEditCustomFurnitureReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message HomeEditCustomFurnitureReq
 */
export interface HomeEditCustomFurnitureReq {
    /**
     * @generated from protobuf field: HomeCustomFurnitureInfo custom_furniture_info = 9;
     */
...
class HomeEditCustomFurnitureReq$Type extends MessageType<HomeEditCustomFurnitureReq> {
    constructor() {
        super("HomeEditCustomFurnitureReq", [
            { no: 9, name: "custom_furniture_info", kind: "message", T: () => HomeCustomFurnitureInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: HomeEditCustomFurnitureReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customFurnitureInfo)
            HomeCustomFurnitureInfo.internalBinaryWrite(message.customFurnitureInfo, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
