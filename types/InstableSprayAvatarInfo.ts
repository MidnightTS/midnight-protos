...
// @generated from protobuf file "InstableSprayAvatarInfo.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message InstableSprayAvatarInfo
 */
export interface InstableSprayAvatarInfo {
    ...
    avatarId: bigint;
    /**
     * @generated from protobuf field: bool is_trial = 12;
     */
    isTrial: boolean;
}
...
class InstableSprayAvatarInfo$Type extends MessageType<InstableSprayAvatarInfo> {
    ...
    internalBinaryWrite(message: InstableSprayAvatarInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isTrial !== false)
            writer.tag(12, WireType.Varint).bool(message.isTrial);
