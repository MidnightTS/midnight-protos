...
// @generated from protobuf file "GMShowObstacleRsp.proto" (syntax proto3)
// tslint:disable
//
...
import { GMObstacleInfo } from "./GMObstacleInfo";
/**
 * enum CmdId {
 ...
 * }
 *
 * @generated from protobuf message GMShowObstacleRsp
 */
export interface GMShowObstacleRsp {
    /**
     * @generated from protobuf field: repeated GMObstacleInfo obstacles = 8;
     */
...
class GMShowObstacleRsp$Type extends MessageType<GMShowObstacleRsp> {
    constructor() {
        super("GMShowObstacleRsp", [
            { no: 8, name: "obstacles", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GMObstacleInfo },
    ...
    internalBinaryWrite(message: GMShowObstacleRsp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.obstacles.length; i++)
            GMObstacleInfo.internalBinaryWrite(message.obstacles[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* int32 retcode = 12; */
