...
// @generated from protobuf file "PhotoPosData.proto" (syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message PhotoPosData
 */
export interface PhotoPosData {
    ...
    center?: Vector;
    /**
     * @generated from protobuf field: bool is_view = 13;
     */
    isView: boolean;
    /**
...
class PhotoPosData$Type extends MessageType<PhotoPosData> {
    ...
    internalBinaryWrite(message: PhotoPosData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isView !== false)
            writer.tag(13, WireType.Varint).bool(message.isView);
        /* bool is_open = 3; */
