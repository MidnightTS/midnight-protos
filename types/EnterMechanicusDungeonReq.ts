...
// @generated from protobuf file "EnterMechanicusDungeonReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message EnterMechanicusDungeonReq
 */
export interface EnterMechanicusDungeonReq {
    /**
     * @generated from protobuf field: uint32 difficult_level = 5;
     */
...
class EnterMechanicusDungeonReq$Type extends MessageType<EnterMechanicusDungeonReq> {
    ...
    internalBinaryWrite(message: EnterMechanicusDungeonReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.difficultLevel !== 0)
            writer.tag(5, WireType.Varint).uint32(message.difficultLevel);
