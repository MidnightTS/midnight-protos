...
class HomeAvatarTalkReq$Type extends runtime_5.MessageType {
    constructor() {
        super("HomeAvatarTalkReq", [
            { no: 10, name: "talk_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "avatar_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { talkId: 0, avatarId: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        /* uint32 talk_id = 10; */
        if (message.talkId !== 0)
            writer.tag(10, runtime_1.WireType.Varint).uint32(message.talkId);
        /* uint32 avatar_id = 5; */
...
/**
 * @generated MessageType for protobuf message HomeAvatarTalkReq
 */
