...
class SceneAreaUnlockNotify$Type extends runtime_5.MessageType {
    constructor() {
        super("SceneAreaUnlockNotify", [
            { no: 1, name: "scene_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 5, name: "area_list", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { sceneId: 0, areaList: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 scene_id */ 1:
                    ...
                    break;
                case /* repeated uint32 area_list */ 5:
...
/**
 * @generated MessageType for protobuf message SceneAreaUnlockNotify
 */
