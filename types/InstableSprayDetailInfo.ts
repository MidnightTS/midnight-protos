...
// @generated from protobuf file "InstableSprayDetailInfo.proto" (syntax proto3)
// tslint:disable
//
...
import { InstableSprayStageInfo } from "./InstableSprayStageInfo";
/**
 * @generated from protobuf message InstableSprayDetailInfo
 */
export interface InstableSprayDetailInfo {
    /**
     * @generated from protobuf field: repeated InstableSprayStageInfo stage_info_list = 2;
     */
...
class InstableSprayDetailInfo$Type extends MessageType<InstableSprayDetailInfo> {
    constructor() {
        super("InstableSprayDetailInfo", [
            { no: 2, name: "stage_info_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => InstableSprayStageInfo }
        ]);
    }
    ...
    internalBinaryWrite(message: InstableSprayDetailInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.stageInfoList.length; i++)
            InstableSprayStageInfo.internalBinaryWrite(message.stageInfoList[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
