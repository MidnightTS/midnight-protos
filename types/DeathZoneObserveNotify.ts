...
// @generated from protobuf file "DeathZoneObserveNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message DeathZoneObserveNotify
 */
export interface DeathZoneObserveNotify {
    /**
     * @generated from protobuf field: uint32 source_entity_id = 2;
     */
...
class DeathZoneObserveNotify$Type extends MessageType<DeathZoneObserveNotify> {
    ...
    internalBinaryWrite(message: DeathZoneObserveNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sourceEntityId !== 0)
            writer.tag(2, WireType.Varint).uint32(message.sourceEntityId);
