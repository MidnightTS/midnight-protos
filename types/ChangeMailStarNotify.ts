...
// @generated from protobuf file "ChangeMailStarNotify.proto" (syntax proto3)
// tslint:disable
//
...
export interface ChangeMailStarNotify {
    /**
     * @generated from protobuf field: repeated uint32 mail_id_list = 13;
     */
    mailIdList: number[];
    /**
     * @generated from protobuf field: bool is_star = 15;
     */
    isStar: boolean;
}
...
class ChangeMailStarNotify$Type extends MessageType<ChangeMailStarNotify> {
    ...
    internalBinaryWrite(message: ChangeMailStarNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isStar !== false)
            writer.tag(15, WireType.Varint).bool(message.isStar);
