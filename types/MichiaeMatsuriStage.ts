...
export class MichiaeMatsuriStage extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MichiaeMatsuriStage {
    ...
    static deserializeBinary(bytes: Uint8Array): MichiaeMatsuriStage {
