...
var _BlessingRecvPicRecord_one_of_decls;
...
class BlessingRecvPicRecord extends pb_1.Message {
    constructor(data) {
        super();
        _BlessingRecvPicRecord_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BlessingRecvPicRecord_one_of_decls, "f"));
    ...
    get profile_picture() {
        return pb_1.Message.getWrapperField(this, dependency_1.ProfilePicture, 9);
    }
...
exports.BlessingRecvPicRecord = BlessingRecvPicRecord;
_BlessingRecvPicRecord_one_of_decls = new WeakMap();
