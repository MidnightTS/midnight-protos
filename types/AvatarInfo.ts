...
// @generated from protobuf file "AvatarInfo.proto" (syntax proto3)
// tslint:disable
//
...
class AvatarInfo$Type extends MessageType<AvatarInfo> {
    constructor() {
        super("AvatarInfo", [
            ...
            { no: 16, name: "expedition_state", kind: "enum", T: () => ["AvatarExpeditionState", AvatarExpeditionState, "AVATAR_EXPEDITION_STATE_"] },
