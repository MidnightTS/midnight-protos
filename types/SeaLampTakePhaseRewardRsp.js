...
class SeaLampTakePhaseRewardRsp$Type extends runtime_5.MessageType {
    constructor() {
        super("SeaLampTakePhaseRewardRsp", [
            { no: 13, name: "phase_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 6, name: "retcode", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value) {
        const message = { phaseId: 0, retcode: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.phaseId !== 0)
            writer.tag(13, runtime_1.WireType.Varint).uint32(message.phaseId);
        /* int32 retcode = 6; */
...
/**
 * @generated MessageType for protobuf message SeaLampTakePhaseRewardRsp
 */
