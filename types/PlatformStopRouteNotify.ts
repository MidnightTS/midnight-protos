...
// @generated from protobuf file "PlatformStopRouteNotify.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlatformStopRouteNotify
 */
export interface PlatformStopRouteNotify {
    /**
     * @generated from protobuf field: PlatformInfo platform = 7;
     */
    platform?: PlatformInfo;
    /**
     * @generated from protobuf field: uint32 scene_time = 10;
     */
    sceneTime: number;
    /**
...
class PlatformStopRouteNotify$Type extends MessageType<PlatformStopRouteNotify> {
    constructor() {
        super("PlatformStopRouteNotify", [
            { no: 7, name: "platform", kind: "message", T: () => PlatformInfo },
    ...
    internalBinaryWrite(message: PlatformStopRouteNotify, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.platform)
            PlatformInfo.internalBinaryWrite(message.platform, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
