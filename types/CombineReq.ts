...
// @generated from protobuf file "CombineReq.proto" (syntax proto3)
// tslint:disable
//
...
export interface CombineReq {
    ...
    combineId: number;
    /**
     * @generated from protobuf field: uint32 combine_count = 15;
     */
    combineCount: number;
}
...
class CombineReq$Type extends MessageType<CombineReq> {
    ...
    internalBinaryWrite(message: CombineReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.combineCount !== 0)
            writer.tag(15, WireType.Varint).uint32(message.combineCount);
