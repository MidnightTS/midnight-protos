...
exports.GameplayRecommendationElementReliquaryRequest = void 0;
...
class GameplayRecommendationElementReliquaryRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("GameplayRecommendationElementReliquaryRequest", [
            { no: 2, name: "element_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 3, name: "equip_type", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value) {
        const message = { elementType: 0, equipType: 0 };
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.elementType !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.elementType);
        /* uint32 equip_type = 3; */
...
/**
 * @generated MessageType for protobuf message GameplayRecommendationElementReliquaryRequest
 */
