...
// @generated from protobuf file "PlayerSetOnlyMPWithPSPlayerReq.proto" (syntax proto3)
// tslint:disable
//
 ...
 * }
 *
 * @generated from protobuf message PlayerSetOnlyMPWithPSPlayerReq
 */
export interface PlayerSetOnlyMPWithPSPlayerReq {
    /**
     * @generated from protobuf field: bool is_only = 10;
     */
    isOnly: boolean;
}
...
class PlayerSetOnlyMPWithPSPlayerReq$Type extends MessageType<PlayerSetOnlyMPWithPSPlayerReq> {
    ...
    internalBinaryWrite(message: PlayerSetOnlyMPWithPSPlayerReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.isOnly !== false)
            writer.tag(10, WireType.Varint).bool(message.isOnly);
