...
export interface ActivityInfo {
    ...
    scheduleId: number;
    /**
     * @generated from protobuf field: uint32 score_limit = 1870;
     */
    scoreLimit: number;
    /**
    ...
    /**
     * @generated from protobuf field: repeated uint32 meet_cond_list = 11;
     */
    meetCondList: number[];
    /**
    ...
    /**
     * @generated from protobuf field: uint32 selected_avatar_reward_id = 697;
     */
    ...
    /**
     * @generated from protobuf field: uint32 activity_type = 3;
     */
    activityType: number;
    /**
    ...
    endTime: number;
    /**
     * @generated from protobuf field: repeated uint32 expire_cond_list = 5;
     */
...
class ActivityInfo$Type extends MessageType<ActivityInfo> {
    ...
    internalBinaryWrite(message: ActivityInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.scoreLimit !== 0)
            writer.tag(1870, WireType.Varint).uint32(message.scoreLimit);
        ...
        if (message.selectedAvatarRewardId !== 0)
            writer.tag(697, WireType.Varint).uint32(message.selectedAvatarRewardId);
        ...
        if (message.activityType !== 0)
            writer.tag(3, WireType.Varint).uint32(message.activityType);
